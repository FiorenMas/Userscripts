...
!function(){"use strict";const e={name:"BestPornComix",url:/https?:\/\/(www\.)?bestporncomix.com\/gallery\/.+/,homepage:"https://www.bestporncomix.com",language:["English"],category:"hentai",timer:5e3,run(){const e=[...document.querySelectorAll("figure a")];return{title:document.querySelector("h1.entry-title")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("href")))}}},n={name:"DoujinMoeNM",url:/https?:\/\/(www\.)?doujins.com\/.+/,homepage:"https://doujins.com/",language:["English"],category:"hentai",waitEle:".doujin",run(){const e=[...document.querySelectorAll(".doujin")];return{title:document.querySelector(".folder-title a:last-child")?.textContent?.trim(),series:document.querySelector(".folder-title a:nth-last-child(2)")?.getAttribute("href"),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("data-file")))}}};function t(e){return null==e||void 0===e||"string"==typeof e&&""===e||Array.isArray(e)&&0===e.length||"object"==typeof e&&0===Object.keys(e).length}function a(e){const n=e=>{if(!Array.isArray(e)){return!Object.keys(e).some((n=>!a(e[n])))&&n(Object.keys(e))}return!e.some((e=>e instanceof Promise||!a(e)))};return!e||0===e||t(e)||"object"==typeof e&&n(e)}function o(e,n,t=document.body){return new Promise((a=>{if(t.querySelector(e)?.getAttribute(n))return void a(t.querySelector(e)?.getAttribute(n)??"");const o=new MutationObserver((()=>{t.querySelector(e)?.getAttribute(n)&&(a(t.querySelector(e)?.getAttribute(n)??""),o.disconnect())}));o.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[n]})}))}function i(e=1e3,n=!0){return new Promise((t=>{setTimeout((()=>t(n)),e)}))}async function r(e){const n=t=>{const a=e();a?t(a):setTimeout((()=>{n(t)}),500)};return new Promise(n)}async function l(e,n=1e3){return(await Promise.all([e,i(n)]))[0]}const s={name:["8Muses.com","8Muses.io"],obs:"Slow start, bruteforce may be required",url:/https?:\/\/(comics.)?8muses.(com|io)\/(comics\/)?picture\/.+/,homepage:["https://comics.8muses.com/","https://8muses.io/"],language:["English"],category:"hentai",async run(){const e=unsafeWindow.link_images?.slice(1,unsafeWindow.link_images.length),n=e?.length??parseInt(document.querySelector('link[rel="last"]')?.getAttribute("href")?.match(/\d+$/)?.at(0)??"",10);return{title:[...document.querySelectorAll(".top-menu-breadcrumb li:not(:last-child)")].map((e=>e?.textContent?.trim())).join("/"),series:document.querySelector(".top-menu-breadcrumb li:nth-last-child(2) a")?.getAttribute("href"),pages:n,prev:"#",next:"#",lazy:!1,timer:10,listImages:e,async before(){if(!unsafeWindow.link_images?.length){const e=document.createElement("div");e.setAttribute("style","height: 100vh;width: 100vw;position: fixed;top: 0;left: 0;z-index: 100000;background: white;opacity: 0.5;"),document.body.append(e);const n=document.querySelector(".page-prev");for(;"1"!==document.querySelector(".c-dropdown-toggle")?.textContent?.match(/\d+/)?.at(0);)n?.dispatchEvent(new Event("click"));const t=document.querySelector(".page-next"),a=document.querySelector(".p-picture"),i=[];for(let e=1;e<=this.pages;e+=1)i[e-1]=await l(o(".photo img","src",a??document.body),100),a?.querySelector("img")?.removeAttribute("src"),t?.dispatchEvent(new Event("click"));this.listImages=i}}}}},c={name:["ExHentai","e-Hentai"],url:/https?:\/\/(g\.)?(exhentai|e-hentai).org\/s\/.+\/.+/,homepage:["https://exhentai.org/","https://e-hentai.org/"],language:["English"],obs:"May get your IP Banned, use with moderation",category:"hentai",async run(){const e=parseInt(document.querySelector(".sn div span:nth-child(2)")?.textContent??"0",10),n=parseInt(document.querySelector(".ptt td:nth-last-of-type(2) a")?.textContent??"0",10)||Math.ceil(e/40),t=document.querySelector(".sb a")?.getAttribute("href")?.replace(/\?p=\d+/,""),a=Array(n).fill(0).map((async(e,n)=>fetch(`${t}?p=${n}`).then((async e=>e.text())).then((e=>(new DOMParser).parseFromString(e,"text/html"))))),o=(await Promise.all(a)).flatMap((e=>[...e.querySelectorAll(".gdtm a, .gdtl a")].map((e=>e.getAttribute("href")))));return{title:document.querySelector("#i1 h1")?.textContent?.trim(),series:t,pages:e,begin:parseInt(document.querySelector("div#i2 span")?.textContent??"1",10),prev:"#",next:"#",listPages:o,img:"#img",lazy:!0}}},d={name:"Fakku.cc",url:/https?:\/\/(spy.)?fakku.cc/,homepage:"https://spy.fakku.cc/",language:["English"],category:"hentai",waitEle:"div div + img[alt^=Page]",async run(){const e=await fetch(`${window.location.href}/__data.json?x-sveltekit-invalidated=011`).then((async e=>e.text())),{data:n}=JSON.parse(e.split("\n").filter((e=>e.length))[1]),t=n[5],a=n[12].length;return{title:document.querySelector(".title")?.textContent?.trim().replace(/Page \d+ • /,""),series:window.location.href.replace(/read\/.+/,""),pages:a,prev:"#",next:"#",listImages:Array(a).fill(0).map(((e,n)=>`https://cdn.fakku.cc/image/${t}/${n+1}`))}}},m={name:"FSIComics",url:/https?:\/\/(www\.)?fsicomics.com\/.+/,homepage:"https://fsicomics.com/",language:["English"],category:"hentai",run(){const e=[...document.querySelectorAll(".wp-block-gallery img")];return{title:document.querySelector(".s-title")?.textContent?.trim(),series:"",pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("data-large-file")))}}},u={name:"GNTAI.net",url:/https?:\/\/(www\.)?gntai.net\/(?!(category|tags|autores))[^/]+\/.+/,homepage:"https://www.gntai.net/",language:["Spanish"],category:"hentai",run(){const e=document.querySelector("#main > script")?.innerHTML.match(/var pages = [^;]+/)?.at(0)?.toString().match(/https?[^"]+/g);return{title:document.querySelector(".entry-header h1")?.textContent?.trim(),pages:e?.length,prev:"#",next:"#",listImages:e}}},g={name:"HBrowser",url:/https?:\/\/(www\.)?hbrowse.com\/.+/,homepage:"https://www.hbrowse.com/",language:["English"],category:"hentai",run(){const e=window.location.href+(window.location.href.endsWith("/")?"":"/"),n=parseInt(document.querySelector("#jsPageList a:last-child")?.textContent??"",10),t=[...document.querySelectorAll("#chapters + table a.listLink")],a=t.findIndex((e=>window.location.href.endsWith(e.getAttribute("href")??"undefined")));return{title:document.querySelector(".listTable td.listLong")?.textContent?.trim(),series:/.+\/\d+\//.exec(window.location.href)?.at(0),pages:n,prev:t.at(a-1)?.getAttribute("href"),next:t.at(a+1)?.getAttribute("href"),listPages:Array(n).fill(0).map(((n,t)=>e+String(`0000${t+1}`).slice(-5))),img:"td.pageImage a img"}}},p={name:"Hentai2Read",url:/https?:\/\/(www\.)?hentai2read.com\/[^/]+\/\d+(.\d+)?\//,homepage:"https://hentai2read.com/",language:["English"],category:"hentai",run:()=>({title:document.querySelector(".reader-left-text")?.textContent?.trim(),series:unsafeWindow.gData.mainURL,pages:unsafeWindow.gData.images.length,prev:unsafeWindow.gData.previousURL,next:unsafeWindow.gData.nextURL,listImages:unsafeWindow.gData.images.map((e=>`https://static.hentaicdn.com/hentai${e}`))})},h={name:"HentaiEra",url:/https?:\/\/(www\.)?hentaiera.com\/view\/.+\/\d+\/?/,homepage:"https://hentaiera.com/",language:["English"],category:"hentai",run(){const e=parseInt(document.querySelector(".total_pages")?.textContent??"0",10);return{title:document.querySelector("h1")?.textContent?.trim().replace(/ - Page .+$/,""),series:document.querySelector(".return_btn ")?.getAttribute("href"),pages:e,prev:"#",next:"#",listPages:Array(e).fill(0).map(((e,n)=>window.location.href.replace(/\/\d*\/?$/,`/${n+1}`))),img:"#gimg",lazyAttr:"data-src"}}},w={name:"HentaiFox",url:/https?:\/\/(www\.)?hentaifox.com\/g\/.+/,homepage:"https://www.hentaifox.com/",language:["English"],category:"hentai",waitVar:"g_th",waitFunc:()=>document.querySelector("#gimg")?.classList.contains("loaded"),run(){const e=parseInt(document.querySelector(".total_pages")?.textContent??"",10),n=document.querySelector("#gimg")?.getAttribute("src")?.replace(/\d+.\w+$/,"")??"";return{title:document.querySelector("title")?.textContent?.replace(/ - Page .+/,"").trim(),series:document.querySelector(".browse_buttons a")?.getAttribute("href"),pages:e,prev:"#",next:"#",listImages:Array(e).fill(0).map(((e,t)=>n+(t+1)+function(e){const n=unsafeWindow.g_th[e][0];return"p"===n?".png":"b"===n?".bmp":"g"===n?".gif":".jpg"}(t+1)))}}},b={name:["HentaiHand","nHentai.com"],url:/https?:\/\/(www\.)?(hentaihand|nhentai).com\/.+\/reader/,homepage:["https://hentaihand.com/","https://nhentai.com"],language:["English"],category:"hentai",waitEle:".reader img",run(){const e=[...document.querySelectorAll(".reader img")];return{title:document.querySelector(".reader-header h5")?.textContent?.trim(),series:document.querySelector(".reader-header h5 a")?.getAttribute("href"),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("data-src")??e.getAttribute("src")))}}},f={name:"HentaIHere",url:/https?:\/\/(www\.)?hentaihere.com\/.+\/.+\/.+/,homepage:"https://www.hentaihere.com/",language:["English"],category:"hentai",waitVar:"rff_imageList",run(){const e=document.querySelector("#arf-reader-img")?.getAttribute("src")?.replace(/\d.+/,"");return{title:unsafeWindow.rff_pageTitle.replace(/.+\|/,"").trim(),series:unsafeWindow.rff_thisManga,pages:unsafeWindow.rff_imageList.length,prev:unsafeWindow.rff_previousChapter,next:unsafeWindow.rff_nextChapter,listImages:unsafeWindow.rff_imageList.map((n=>e+n))}}},v={name:"HentaiNexus",url:/https?:\/\/((www\.)?hentainexus.com|nexus.fakku.cc)\/read\/.+/,homepage:"https://hentainexus.com/",language:["English"],category:"hentai",run(){const e=unsafeWindow.pageData?.map((e=>e.image))??unsafeWindow.images?.map((e=>e.url));return{title:document.querySelector("title")?.textContent?.replace(/^\[[\d/]+\]/,"").trim(),series:document.querySelector("#returnGalleryFooter a")?.getAttribute("href"),pages:e.length,prev:"#",next:"#",listImages:e}}},y={name:"hitomi",url:/https?:\/\/hitomi.la\/reader\/.+/,homepage:"https://hitomi.la/",language:["English"],category:"hentai",waitAttr:["#comicImages img","src"],waitVar:"galleryinfo",run:()=>({title:document.querySelector("title")?.textContent?.replace("| Hitomi.la","").trim(),series:document.querySelector(".brand")?.getAttribute("href"),pages:unsafeWindow.galleryinfo.files.length,prev:"#",next:"#",listImages:unsafeWindow.galleryinfo.files.map((e=>unsafeWindow.url_from_url_from_hash(unsafeWindow.galleryinfo,e,"webp",void 0,"a")))})};const E={name:"Imhentai",url:/https?:\/\/(www\.)?imhentai.xxx\/view\/.+\/.+\//,homepage:"https://imhentai.xxx/",language:["English"],category:"hentai",waitVar:"g_th",run(){const e=document.querySelector("#gallery_id")?.getAttribute("value"),n=document.querySelector("#image_dir")?.getAttribute("value"),t=parseInt(document.querySelector("#pages")?.getAttribute("value")??"",10),a=parseInt(document.querySelector("#u_id")?.getAttribute("value")??"",10),o=unsafeWindow.random_server??`${function(e){const n=[{min:0,max:274825,name:"m1"},{min:274826,max:403818,name:"m2"},{min:403819,max:527143,name:"m3"},{min:527144,max:632481,name:"m4"},{min:632482,max:816010,name:"m5"},{min:816011,max:970098,name:"m6"},{min:970099,max:1121113,name:"m7"},{min:1121114,max:1259410,name:"m8"},{min:1259411,max:1/0,name:"m9"}];return n.find((n=>e>=n.min&&e<=n.max))?.name}(a)}.imhentai.xxx`;return{title:document.querySelector("title")?.textContent?.trim(),series:document.querySelector(".return_btn")?.getAttribute("href"),pages:t,prev:"#",next:"#",listImages:Array(t).fill(0).map(((t,a)=>`//${o}/${n}/${e}/${a+1}${function(e){const n=unsafeWindow.g_th[e][0];return"p"===n?".png":"b"===n?".bmp":"g"===n?".gif":".jpg"}(a+1)}`))}}},k={name:"KingComix",url:/https?:\/\/(www\.)?kingcomix.com\/.+/,homepage:"https://kingcomix.com/",language:["English"],category:"hentai",run(){const e=[...document.querySelectorAll("figure img, .entry-content img.lazy")];return{title:document.querySelector("h1.singleTitle-h1")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("data-src")??e.getAttribute("data-full-url")??e.getAttribute("data-lazy-src")??e.getAttribute("src")))}}},x={name:"Luscious",url:/https?:\/\/(www\.)?luscious.net\/.+\/read\/.+/,homepage:"https://luscious.net/",language:["English"],category:"hentai",waitEle:".album-info div",async run(){const e=parseInt(document.querySelector('input[name="page_number"] + span')?.textContent?.match(/\d+/)?.pop()??"0",10),n=Math.ceil(e/50),t=parseInt(document.querySelector(".album-heading a")?.getAttribute("href")?.match(/\d+\//)?.toString()??"0",10),a=Array(n).fill(0).map((async(e,n)=>{const a=`https://apicdn.luscious.net/graphql/nobatch/?operationName=PictureListInsideAlbum&variables={"input":{"filters":[{"name":"album_id","value":"${t}"}],"display":"position","items_per_page":50,"page":${n+1}}}&query=%20query%20PictureListInsideAlbum(%24input%3A%20PictureListInput!)%20%7B%20picture%20%7B%20list(input%3A%20%24input)%20%7B%20info%20%7B%20...FacetCollectionInfo%20%7D%20items%20%7B%20__typename%20id%20title%20description%20created%20like_status%20number_of_comments%20number_of_favorites%20moderation_status%20width%20height%20resolution%20aspect_ratio%20url_to_original%20url_to_video%20is_animated%20position%20permissions%20url%20tags%20%7B%20category%20text%20url%20%7D%20thumbnails%20%7B%20width%20height%20size%20url%20%7D%20%7D%20%7D%20%7D%20%7D%20fragment%20FacetCollectionInfo%20on%20FacetCollectionInfo%20%7B%20page%20has_next_page%20has_previous_page%20total_items%20total_pages%20items_per_page%20url_complete%20%7D%20`;return GM.xmlHttpRequest({method:"GET",url:a}).then((e=>JSON.parse(e.responseText)))})),o=(await Promise.all(a)).flatMap((e=>e.data.picture.list.items.map((e=>e.url_to_original))));return{title:document.querySelector(".album-heading a")?.textContent?.trim(),series:document.querySelector(".album-heading a")?.getAttribute("href"),pages:e,prev:"#",next:"#",listImages:o}}},M=/^([\t\n])*(https?:\/\/)?.+\.(jpg|jpeg|png|gif|bmp|webp).*$/;function S(){return[...document.querySelectorAll(".wp-manga-chapter-img, .blocks-gallery-item img, .reading-content img, #chapter-images img, #chapterContent img")].map((e=>[...e.attributes].filter((e=>/.*(src|url).*/i.test(e.name)&&!/^.*(blank|lazy|load).*$/.test(e.value))).find((e=>M.test(e.value)))?.value??e?.getAttribute("src")))}const O={...{name:["Madara WordPress Plugin","MangaHaus","Isekai Scan","Comic Kiba","Zinmanga","mangatx","Toonily","Mngazuki","JaiminisBox","DisasterScans","ManhuaPlus","TopManhua","NovelMic","Reset-Scans","LeviatanScans","Dragon Tea","SetsuScans","ToonGod"],url:/https?:\/\/.+\/(manga|series|manhua|comic|ch|novel|webtoon)\/.+\/.+/,homepage:["https://mangabooth.com/","https://manhuaus.com","https://isekaiscan.com/","https://comickiba.com/","https://zinmanga.com/","https://mangatx.com/","https://toonily.net/","https://mangazuki.me/","https://jaiminisbox.net","https://disasterscans.com/","https://manhuaplus.org/","https://www.topmanhua.com/","https://novelmic.com/","https://reset-scans.com/","https://leviatanscans.com/","https://dragontea.ink/","https://setsuscans.com/","https://toongod.org/home/"],language:["English"],obs:"Any Site that uses Madara Wordpress Plugin",category:"manga",waitFunc:()=>{const e=S();return e.length>0&&e.every((e=>e&&M.test(e)))},run(){const e=S();return{title:document.querySelector("#chapter-heading")?.textContent?.trim(),series:(document.querySelector(".breadcrumb li:nth-child(3) a")??document.querySelector(".breadcrumb li:nth-child(2) a"))?.getAttribute("href"),pages:e.length,prev:document.querySelector(".prev_page")?.getAttribute("href"),next:document.querySelector(".next_page")?.getAttribute("href"),listImages:e}}},name:["Madara WordPress Plugin","AllPornComic","Manytoon","Manga District"],url:/https?:\/\/.+\/(porncomic|read-scan)\/.+\/.+/,homepage:["#","https://allporncomic.com/","https://manytoon.com/","https://mangadistrict.com/"],category:"hentai"},A={name:"MultPorn",url:/https?:\/\/(www\.)?multporn.net\/(comics|hentai_manga)\/.+/,homepage:"https://multporn.net/",language:["English"],category:"hentai",async run(){const e=document.head.textContent?.match(/"configUrl":"(.+?)",/)?.at(1)?.replaceAll("\\","")??"",n=await fetch(e).then((async e=>e.text())).then((e=>(new DOMParser).parseFromString(e,"text/xml"))),t=[...n.querySelectorAll("image")];return{title:document.querySelector("#page-title")?.textContent?.trim(),pages:t.length,prev:"#",next:"#",listImages:t.map((e=>e.getAttribute("imageURL")))}}},C={name:"MyHentaiGallery",url:/https?:\/\/(www\.)?myhentaigallery.com\/gallery\/show\/.+\/\d+/,homepage:"https://www.myhentaigallery.com",language:["English"],category:"hentai",run(){const e=document.querySelector(".gallery-slide img")?.getAttribute("src")??"",n=document.getElementById("js__pagination__next")?.parentElement?.previousElementSibling?.querySelector("a"),t=parseInt(n?.textContent??"",10);return{title:document.querySelector("title")?.textContent?.trim(),series:document.querySelector(".back-to-gallery a")?.getAttribute("href"),pages:t,prev:"#",next:"#",listImages:Array(t).fill(0).map(((n,t)=>e.replace(/\d+\./,`${String(t+1).padStart(3,"0").slice(-3)}.`)))}}},I={name:["nHentai.net","nHentai.xxx","lhentai"],url:/https?:\/\/(www\.)?(nhentai|lhentai).(net|xxx|com|to)\/g\/.+\/.+/,homepage:["https://nhentai.net/","https://nhentai.xxx/","https://lhentai.com/"],language:["English"],category:"hentai",run(){function e(e){return"g"===e?"gif":"b"===e?"bmp":"p"===e?"png":"jpg"}const n=parseInt(document.querySelector(".num-pages")?.textContent??"",10),t=document.querySelector("#image-container img")?.getAttribute("src")?.replace(/\d+.\w\w\w$/,""),a=unsafeWindow.images_ext?.map(e)??unsafeWindow._gallery?.images?.pages?.map((n=>e(n.t)))??Array(n).fill("jpg");return{title:document.querySelector("title")?.textContent?.split("- Page")[0].trim(),series:document.querySelector(".go-back")?.getAttribute("href"),pages:n,prev:"#",next:"#",listImages:Array(n).fill(0).map(((e,n)=>`${t}${n+1}.${a[n]}`))}}},L={name:"9Hentai",url:/https?:\/\/(www\.)?9hentai.(ru|to|com)\/g\/.+\/.+/,homepage:"https://9hentai.to",language:["English"],category:"hentai",waitAttr:["#jumpPageModal input","max"],async run(){const e={id:parseInt(/\d+/.exec(window.location.pathname)?.at(0)??"0",10)},n={method:"POST",body:JSON.stringify(e),headers:{"Content-Type":"application/json"}},t=await fetch("/api/getBookByID",n).then((async e=>e.json()));return{title:t.results.title,series:`/g/${t.results.id}/`,pages:t.results.total_page,prev:"#",next:"#",listImages:Array(t.results.total_page).fill(0).map(((e,n)=>`${t.results.image_server+t.results.id}/${n+1}.jpg`))}}},T={...{name:"YugenMangas",url:/https?:\/\/(www\.)?(yugenmangas).(com|net|lat)\/series\/.+/,homepage:"https://yugenmangas.lat/",language:["Spanish"],category:"manga",async run(){const e=[...document.querySelectorAll("p.flex > img")];return{title:document.querySelector("title")?.textContent?.trim(),series:document.querySelector("div.justify-between:nth-child(2) > a:nth-child(2)")?.getAttribute("href"),pages:e.length,prev:document.querySelector("div.justify-between:nth-child(2) > a:nth-child(1)")?.getAttribute("href"),next:document.querySelector("div.justify-between:nth-child(2) > a:nth-child(3)")?.getAttribute("href"),listImages:e.map((e=>e.classList.contains("lazy")?e.getAttribute("data-src"):e.getAttribute("src")))}}},name:["OmegaScans"],url:/https?:\/\/(www\.)?(omegascans).(org)\/.+/,homepage:["https://omegascans.org/"],language:["English"],category:"hentai"},R={name:"PornComixOnline",url:/https?:\/\/(www\.)?porncomixone.net\/comic\/.+/,homepage:"https://www.porncomixone.net",language:["English"],category:"hentai",run(){const e=[...document.querySelectorAll("figure a")];return{title:document.querySelector(".post-title")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("href")))}}},D={name:"Pururin",url:/https?:\/\/(www\.)?pururin.to\/(view|read)\/.+\/.+\/.+/,homepage:"https://pururin.to/",language:["English"],category:"hentai",waitAttr:[".img-viewer img","src"],run(){const e=document.querySelector(".img-viewer img")?.getAttribute("src")??"",n=[...document.querySelectorAll(".img-select option")];return{title:document.querySelector(".title")?.textContent?.trim(),series:document.querySelector(".breadcrumb-item:nth-child(4) a")?.getAttribute("href"),pages:n.length,prev:"#",next:"#",listImages:n.map(((n,t)=>e.replace(/\/\d+\./,`/${t+1}.`)))}}},B={name:"Simply-Hentai",url:/https?:\/\/(www\.)?simply-hentai.com\/.+\/page\/.+/,homepage:"https://simply-hentai.com/",language:["English"],category:"hentai",waitEle:"#__NEXT_DATA__",async run(){const e=JSON.parse(document.querySelector("#__NEXT_DATA__")?.innerHTML??"").props.pageProps.data.pages.map((e=>e.sizes.full));return{title:document.querySelector(".content-headline a")?.textContent?.trim(),series:document.querySelector(".content-headline a")?.getAttribute("href"),pages:e.length,prev:"#",next:"#",listImages:e}}},N={name:"3Hentai",url:/https?:\/\/(www\.)?3hentai.net\/d\/.+\/.+/,homepage:"https://3hentai.net/",language:["English"],category:"hentai",waitVar:"readerPages",run:()=>({title:unsafeWindow.readerPages.title.replace(/- Page.+/,"").trim(),series:unsafeWindow.readerPages.baseUri.replace("%s",""),pages:unsafeWindow.readerPages.lastPage,prev:"#",next:"#",listImages:Object.keys(unsafeWindow.readerPages.pages).map((e=>unsafeWindow.readerPages.baseUriImg.replace("%s",unsafeWindow.readerPages.pages[e].f)))})},V={name:"TMOHentai",url:/https?:\/\/(www\.)?tmohentai.com\/reader\/.+\/paginated\/\d+/,homepage:"https://tmohentai.com/",language:["Spanish"],category:"hentai",run(){const e=parseInt(document.querySelector("#select-page option:last-child")?.getAttribute("value")??"",10);return{title:document.querySelector(".reader-title")?.textContent?.trim(),series:document.querySelector(".nav-justified li a")?.getAttribute("href"),pages:e,prev:"#",next:"#",listPages:Array(e).fill(0).map(((e,n)=>window.location.href.replace(/\/\d*$/,`/${n+1}`))),img:".content-image",lazyAttr:"data-original"}}},$={name:"Tsumino",url:/https?:\/\/(www\.)?tsumino.com\/Read\/Index\/\d+(\?page=.+)?/,homepage:"https://tsumino.com/",language:["English"],category:"hentai",async run(){const e=document.querySelector("#image-container")?.getAttribute("data-opt"),n=document.querySelector("#image-container")?.getAttribute("data-cdn")??"",t=`https://www.tsumino.com/Read/Load?q=${e}`,a=await fetch(t).then((async e=>e.json()));return{title:document.querySelector("title")?.textContent?.replace(/.+Read/,"").trim(),series:a.reader_start_url,pages:a.reader_page_total,prev:"#",next:"#",listImages:Array(a.reader_page_total).fill(0).map(((e,t)=>n.replace("[PAGE]",`${t+1}`)))}}},F={name:["vermangasporno","vercomicsporno"],url:/https?:\/\/(www\.)?(vermangasporno|vercomicsporno).com\/.+/,homepage:["https://vermangasporno.com/","https://vercomicsporno.com/"],language:["Spanish"],category:"hentai",waitEle:'img[loading="lazy"].size-full, .comicimg picture img, .wp-content img',run(){const e=[...document.querySelectorAll('img[loading="lazy"].size-full, .comicimg picture img, .wp-content img')];return{title:document.querySelector("h1.titl, title")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("data-lazy-src")??e.getAttribute("data-src")??e.getAttribute("src")))}}},z={name:"wnacg",url:/https?:\/\/(www\.)?wnacg.com\/photos-view-id-.+/,homepage:"https://wnacg.com/",language:["English","Raw","Chinese"],category:"hentai",run(){const e=[...document.querySelectorAll(".pageselect option")];return{title:document.querySelector(".bread a:last-of-type")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listPages:e.map((e=>window.location.pathname.replace(/\d+/,e.value))),img:"#picarea"}}},G=[e,n,s,c,d,m,u,g,p,h,w,b,f,v,y,E,k,x,A,C,I,L,T,R,D,B,V,N,$,F,z,{name:"XlecxOne",url:/https?:\/\/(www\.)?xlecx.one\/.+/,homepage:"https://xlecx.one/",language:["English"],category:"hentai",run(){const e=[...new Set([...document.querySelectorAll("article .page__text img , article #content-2 img")].map((e=>e.getAttribute("data-src")??e.getAttribute("data-srce")??e.getAttribute("src"))))];return{title:document.querySelector("title")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e}}},{name:"xyzcomics",url:/https?:\/\/(www\.)?xyzcomics.com\/.+/,homepage:"https://xyzcomics.com/",language:["English"],category:"hentai",run(){const e=[...document.querySelectorAll(".jig-link")];return{title:document.querySelector(".entry-title")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("href")))}}},O],P=".range-slider{touch-action:none;-webkit-tap-highlight-color:transparent;-webkit-user-select:none;user-select:none;cursor:pointer;display:block;position:relative;width:100%;height:8px;background:#ddd;border-radius:4px}.range-slider[data-vertical]{height:100%;width:8px}.range-slider[data-disabled]{opacity:.5;cursor:not-allowed}.range-slider .range-slider__thumb{position:absolute;z-index:3;top:50%;width:24px;height:24px;transform:translate(-50%,-50%);border-radius:50%;background:#2196f3}.range-slider .range-slider__thumb:focus-visible{outline:0;box-shadow:0 0 0 6px rgba(33,150,243,.5)}.range-slider[data-vertical] .range-slider__thumb{left:50%}.range-slider .range-slider__thumb[data-disabled]{z-index:2}.range-slider .range-slider__range{position:absolute;z-index:1;transform:translate(0,-50%);top:50%;width:100%;height:100%;background:#51adf6}.range-slider[data-vertical] .range-slider__range{left:50%;transform:translate(-50%,0)}.range-slider input[type=range]{-webkit-appearance:none;pointer-events:none;position:absolute;z-index:2;top:0;left:0;width:0;height:0;background-color:transparent}.range-slider input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;appearance:none}.range-slider input[type=range]::-moz-range-thumb{width:0;height:0;border:0}.range-slider input[type=range]:focus{outline:0}",Z=(e,...n)=>0===n.length?e[0]:String.raw({raw:e},...n),H=Z,W=Z;function U(...e){return console.log("MangaOnlineViewer: ",...e),e}const q="undefined"!=typeof GM_info?GM_info:{scriptHandler:"Console",script:{name:"Debug",version:"Testing"}};function j(e,n=null){const t=function(e,n=null){return"undefined"!=typeof GM_getValue?GM_getValue(e,n):(U("Fake Getting: ",e," = ",n),n)}(e,n);return"string"==typeof t?JSON.parse(t):t}function Q(e){return function(e,n){try{return GM_setValue(e,n),n.toString()}catch(t){return U("Fake Setting: ",e," = ",n),String(n)}}("settings",e)}const Y=new UAParser,X=()=>{const e=Y.getDevice().type;return"mobile"!==e&&"tablet"!==e?window.matchMedia("screen and (max-width: 600px)").matches?"mobile":window.matchMedia("screen and (max-width: 992px)").matches?"tablet":"desktop":e},K=(e,n)=>{const t=(e,n)=>_.transform(e,((e,a,o)=>{_.isEqual(a,n[o])||(_.isArray(a)?e[o]=_.difference(a,n[o]):_.isObject(a)&&_.isObject(n[o])?e[o]=t(a,n[o]):e[o]=a)}));return t(e,n)},J=[{ID:"en_US",NAME:"English (US)",STARTING:"Starting<br>Manga OnlineViewer",RESUME:"Resuming reading from Page ",WAITING:"Please wait, 3 seconds...",CHOOSE_BEGINNING:"Choose the Page to start from:",BUTTON_START:"Start Manga OnlineViewer",SETTINGS:"Settings",LANGUAGE:"Language",COLOR_SCHEME:"Color Scheme",THEME:"Theme",THEME_HUE:"Theme Primary Color Hue",THEME_SHADE:"Theme Primary Color Shade",DEFAULT_LOAD_MODE:"Default Load Mode",LOAD_MODE_NORMAL:"Normal(Wait 3 sec)",LOAD_MODE_ALWAYS:"Always(Immediately)",LOAD_MODE_NEVER:"Never(Manually)",LOAD_SPEED:"Load Speed Pages/Second",DEFAULT_ZOOM:"Default Zoom (between 5 and 200)",DEFAULT_ZOOM_MODE:"Default Zoom Mode",MINIMUM_ZOOM:"Minimum Zoom relative to the width of screen (between 30 and 100)",ZOOM_STEP:"Zoom Change Step (between 5 and 50)",DEFAULT_VIEW_MODE:"Default View Mode",VIEW_MODE_VERTICAL:"Vertical",VIEW_MODE_LEFT:"Left to Right",VIEW_MODE_RIGHT:"Right to Left",VIEW_MODE_WEBCOMIC:"WebComic",FIT_WIDTH_OVERSIZED:"Fit Width if Oversized",SHOW_THUMBNAILS:"Show Thumbnails",ENABLE_COMMENTS:"Capture Comments (When available)",HIDE_CONTROLS:"Always Hide Page Controls",HEADER_TYPE:"Change Header Type",HEADER_HOVER:"Hover",HEADER_SCROLL:"Scroll",HEADER_CLICK:"Click",HEADER_FIXED:"Fixed",HEADER_SIMPLE:"Simple",BUTTON_DOWNLOAD:"Download",DOWNLOAD_ZIP:"Download Zip file",DOWNLOAD_IMAGES:"Download Images as Zip Automatically",BUTTON_NEXT:"Next",NEXT_CHAPTER:"Next Chapter",BUTTON_PREVIOUS:"Previous",PREVIOUS_CHAPTER:"Previous Chapter",BOOKMARKS:"Bookmarks",BOOKMARK:"Bookmark",BOOKMARK_REMOVED:"Bookmark Removed",BOOKMARK_SAVED:"Bookmark Saved",BOOKMARK_MESSAGE:"Next time you open this chapter it will resume from:<h4>Page ##num##</h4>(Only <i>ONCE</i> per Bookmark)",KEYBINDINGS:"Keybindings",EDIT_KEYBINDS:"Edit KeyBindings",SAVE_KEYBINDS:"Save KeyBindings",BUTTON_EDIT:"Edit",BUTTON_SAVE:"Save",KEYBIND_RULES:"\n    <h3>Supported Keys</h3>\n    Allowed modifiers: shift, option, alt, ctrl, control, command. </br>\n    Special keys: backspace, tab, clear, enter, return, esc, escape, space, up, down, left, right, home, end, pageup, pagedown, del, delete, f1 - f19, num_0 - num_9, num_multiply, num_add, num_enter, num_subtract, num_decimal, num_divide. </br>\n    Examples: <kbd>a</kbd>, <kbd>ctrl+a</kbd> , <kbd>shift+a</kbd> , <kbd>num_2</kbd> , <kbd>2</kbd> \n  ",ATTENTION:"Attention",WARNING:"Warning",BUTTON_RESET_SETTINGS:"Reset Settings",SETTINGS_RESET:"Settings have been reset, reload the page to take effect",LANGUAGE_CHANGED:"Language has been changed, reload the page to take effect",AUTO_DOWNLOAD:"Next time a chapter finish loading you will be prompted to save automatically",LAZY_LOAD:"Lazy load is incompatible with zip download, you will not be able to download with this setting ON.<br/> Suggestion: <span style='color:red;font-weight:bold'>Disable Thumbnails</span> to save Bandwidth/Memory.",LAZY_LOAD_IMAGES_ENABLE:"Enable Lazy Load Images",LAZY_LOAD_IMAGES:"Lazy Start From Page (between 5 and 100)",RETURN_CHAPTER_LIST:"Return to Chapter List",PAGES_LOADED:"Pages Loaded",GO_TO_PAGE:"Go to Page",ENLARGE:"Enlarge",RESTORE:"Restore",REDUCE:"Restore",FIT_WIDTH:"Fit Width",FIT_HEIGHT:"Fit Height",PERCENT:"Percent",TOGGLE_CONTROLS:"Toggle page controls",ZOOM_IN:"Zoom In",ZOOM_OUT:"Zoom Out",ZOOM_RESET:"Zoom Reset",ZOOM_WIDTH:"Zoom to Width",ZOOM_HEIGHT:"Zoom to Height",HIDE:"Hide",RELOAD:"Reload",SLOWLY:"Slowly",NORMAL:"Normal",FAST:"Fast",EXTREME:"Extreme",ALL_PAGES:"All Pages",SPEED_WARNING:"Loading Speed too High",SPEED_WARNING_MESSAGE:"This speed is not recommended.<br> It may hurt some servers or get your IP marked as DDoS attacker.<br> Please use with caution!",SCROLL_UP:"Scroll Up",SCROLL_DOWN:"Scroll Down",CLOSE:"Close",LIST_EMPTY:"List Empty",DISPLAY_COMMENTS:"Display Comments",COMMENTS:"Comments Section",SCROLL_START:"Toggle Auto Scroll",AUTO_SCROLL_HEIGHT:"Auto Scroll Speed in Pixels",VERTICAL_SEPARATOR:"Show Vertical Separators",END:"End"},{ID:"es_ES",NAME:"Español (ES)",STARTING:"Iniciando<br>Manga OnlineViewer",RESUME:"Continuando lectura desde la Página ",WAITING:"Por favor espere, 3 segundos...",CHOOSE_BEGINNING:"Elija la página en la que comenzar:",BUTTON_START:"Iniciar Manga OnlineViewer",SETTINGS:"Ajustes",LANGUAGE:"Idioma",COLOR_SCHEME:"Esquema de color",THEME:"Tema",THEME_HUE:"Matiz del color primario",THEME_SHADE:"Saturación del color primario",DEFAULT_LOAD_MODE:"Modo de carga por defecto",LOAD_MODE_NORMAL:"Normal (Espera 3s)",LOAD_MODE_ALWAYS:"Siempre (Inmediatamente)",LOAD_MODE_NEVER:"Nunca (Manualmente)",LOAD_SPEED:"Velocidad carga página/segundo",DEFAULT_ZOOM:"Zoom por defecto (entre 5 y 200)",DEFAULT_ZOOM_MODE:"Modo de zoom por defecto",MINIMUM_ZOOM:"Zoom mínimo relativo al ancho de la pantalla",ZOOM_STEP:"Paso entre cambios de zoom (entre 5 y 50)",DEFAULT_VIEW_MODE:"Modo de visualización por defecto",VIEW_MODE_VERTICAL:"Vertical",VIEW_MODE_LEFT:"Izquierda a derecha",VIEW_MODE_RIGHT:"Derecha a izquierda",VIEW_MODE_WEBCOMIC:"WebComic",FIT_WIDTH_OVERSIZED:"Ajustar ancho si es demasiado grande",SHOW_THUMBNAILS:"Mostrar miniaturas",ENABLE_COMMENTS:"Capturar comentarios (cuando esté disponible)",HIDE_CONTROLS:"Ocultar siempre la barra de controles",HEADER_TYPE:"Cambiar tipo de cabecera",HEADER_HOVER:"Pasar por encima",HEADER_SCROLL:"Desplazamiento",HEADER_CLICK:"Hacer click",HEADER_FIXED:"Fijo",HEADER_SIMPLE:"Sencillo",BUTTON_DOWNLOAD:"Descargar",DOWNLOAD_ZIP:"Descargar fichero Zip",DOWNLOAD_IMAGES:"Autodescargar imágenes como Zip",BUTTON_NEXT:"Siguiente",NEXT_CHAPTER:"Siguiente capítulo",BUTTON_PREVIOUS:"Anterior",PREVIOUS_CHAPTER:"Capítulo anterior",BOOKMARKS:"Marcadores",BOOKMARK:"Marcador",BOOKMARK_REMOVED:"Marcador eliminado",BOOKMARK_SAVED:"Marcador guardado",BOOKMARK_MESSAGE:"La próxima vez que abra este capítulo, continuará desde la <h4>página ##num##</h4>(Sólo <i>UNA VEZ</i> por Marcador)",KEYBINDINGS:"Atajos de teclado",EDIT_KEYBINDS:"Editar atajos",SAVE_KEYBINDS:"Guardar atajos",BUTTON_EDIT:"Editar",BUTTON_SAVE:"Guardar",KEYBIND_RULES:"\n    <h3>Teclas soportadas</h3>\n    Modificadores permitidos: shift, option, alt, ctrl, control, command. </br>\n    Teclas especiales: backspace, tab, clear, enter, return, esc, escape, space, up, down, left, right, home, end, pageup, pagedown, del, delete, f1 - f19, num_0 - num_9, num_multiply, num_add, num_enter, num_subtract, num_decimal, num_divide. <br>\n    Ejemplos: <kbd>a</kbd>, <kbd>ctrl+a</kbd> , <kbd>shift+a</kbd> , <kbd>num_2</kbd> , <kbd>2</kbd> \n  ",ATTENTION:"Atención",WARNING:"Alerta",BUTTON_RESET_SETTINGS:"Reiniciar ajustes(Reset Settings)",SETTINGS_RESET:"Se han restablecido los ajustes, vuelve a cargar la página para que surta efecto",LANGUAGE_CHANGED:"Se ha cambiado el idioma, vuelve a cargar la página para que surta efecto",AUTO_DOWNLOAD:"La próxima vez que termine de cargarse un capítulo, se le pedirá que guarde automáticamente",LAZY_LOAD:"La carga diferida es incompatible con la descarga zip, no podrá descargar con este ajuste activado.<br/> Sugerencia: <span style='color:red;font-weight:bold'>Desactivar miniaturas</span> para ahorrar Ancho de banda/Memoria.",LAZY_LOAD_IMAGES_ENABLE:"Habilitar carga de imágenes diferida",LAZY_LOAD_IMAGES:"Empezar carga diferida a partir de la página (entre 5 y 100)",RETURN_CHAPTER_LIST:"Regresar a la lista de capítulos",PAGES_LOADED:"Páginas cargadas",GO_TO_PAGE:"Ir a página",ENLARGE:"Agrandar",RESTORE:"Restaurar",REDUCE:"Reducir",FIT_WIDTH:"Ajustar al ancho",FIT_HEIGHT:"Ajustar al alto",PERCENT:"Porcentual",TOGGLE_CONTROLS:"Alternar controles de página",ZOOM_IN:"Acercar",ZOOM_OUT:"Alejar",ZOOM_RESET:"Restablecer zoom",ZOOM_WIDTH:"Zoom al ancho",ZOOM_HEIGHT:"Zoom al alto",HIDE:"Ocultar",RELOAD:"Recargar",SLOWLY:"Lento",NORMAL:"Normal",FAST:"Rápido",EXTREME:"Extremo",ALL_PAGES:"Todas las páginas",SPEED_WARNING:"Velocidad de carga muy alta",SPEED_WARNING_MESSAGE:"No se recomienda esta velocidad.<br> Puede dañar algunos servidores o marcar su IP como atacante DDoS.<br> ¡Utilícelo con precaución!",SCROLL_UP:"Desplazar arriba",SCROLL_DOWN:"Desplazar abajo",CLOSE:"Cerrar",LIST_EMPTY:"Lista vacía",DISPLAY_COMMENTS:"Mostrar comentarios",COMMENTS:"Sección de comentarios",SCROLL_START:"Alternar desplazamiento automático",AUTO_SCROLL_HEIGHT:"Velocidad de desplazamiento automático en píxeles",VERTICAL_SEPARATOR:"Mostrar separadores verticales",END:"Fin"},{ID:"pt_BR",NAME:"Portugues (Brasil)",STARTING:"Iniciando<br>Manga OnlineViewer",RESUME:"Continuando leitura na Pagina ",WAITING:"Por Favor espere, 3 segundos...",CHOOSE_BEGINNING:"Escolha a pagina de onde começar:",BUTTON_START:"Iniciar Manga OnlineViewer",SETTINGS:"Configurações",LANGUAGE:"Idioma",COLOR_SCHEME:"Esquema de Color",THEME:"Tema",THEME_HUE:"Coloração primaria",THEME_SHADE:"Saturação de Cor",DEFAULT_LOAD_MODE:"Forma de Carregamento Padrão",LOAD_MODE_NORMAL:"Normal(Esperando 3 sec)",LOAD_MODE_ALWAYS:"Sempre(Imediatamente)",LOAD_MODE_NEVER:"Nunca(Manualmente)",LOAD_SPEED:"Velocidade de Carregamento Paginas/Segundo",DEFAULT_ZOOM:"Zoom padrão (entre 5 e 200)",DEFAULT_ZOOM_MODE:"Modo de Zoom padrão",MINIMUM_ZOOM:"Zoom minimo, relativo ao tamanho da tela (entre 30 e 100)",ZOOM_STEP:"Precisão da Mudança do Zoom (entre 5 e 50)",DEFAULT_VIEW_MODE:"Modo de Visualização Padrão",VIEW_MODE_VERTICAL:"Vertical",VIEW_MODE_LEFT:"Esquerda para Direita",VIEW_MODE_RIGHT:"Direita para Esquerda",VIEW_MODE_WEBCOMIC:"WebComic",FIT_WIDTH_OVERSIZED:"Encher a tela se grande demais",SHOW_THUMBNAILS:"Mostra Miniaturas",ENABLE_COMMENTS:"Capturar comentários (quando disponível)",HIDE_CONTROLS:"Sempre esconder controles das paginas",HEADER_TYPE:"Mudar Tipo de Cabeçalho",HEADER_HOVER:"Passar por perto",HEADER_SCROLL:"Rolagem do Mouse",HEADER_CLICK:"Click",HEADER_FIXED:"Fixo",HEADER_SIMPLE:"Simples",BUTTON_DOWNLOAD:"Download",DOWNLOAD_ZIP:"Baixar arquivo Zip",DOWNLOAD_IMAGES:"Download das Imagens como Zip Automaticamente",BUTTON_NEXT:"Proximo",NEXT_CHAPTER:"Proximo Capitulo",BUTTON_PREVIOUS:"Anterior",PREVIOUS_CHAPTER:"Capitulo Anterior",BOOKMARKS:"Marca paginas",BOOKMARK:"Marcar pagina",BOOKMARK_REMOVED:"Marca pagina Removido",BOOKMARK_SAVED:"Marca pagina Salvo",BOOKMARK_MESSAGE:"Proxima vez que abrir este capitulo continuará a partir da <h4>Pagina ##num##</h4>(Apenas <i>UMA VEZ</i> por marca pagina)",KEYBINDINGS:"Atalhos",EDIT_KEYBINDS:"Editar Atalhos",SAVE_KEYBINDS:"Salvar Atalhos",BUTTON_EDIT:"Editar",BUTTON_SAVE:"Salvar",KEYBIND_RULES:"\n    <h3>Teclas Suportadas</h3>\n    Modificadores permitidos: shift, option, alt, ctrl, control, command. </br>\n    Teclas Especiais: backspace, tab, clear, enter, return, esc, escape, space, up, down, left, right, home, end, pageup, pagedown, del, delete, f1 - f19, num_0 - num_9, num_multiply, num_add, num_enter, num_subtract, num_decimal, num_divide.</br>\n    Exemplos: <kbd>a</kbd>, <kbd>ctrl+a</kbd> , <kbd>shift+a</kbd> , <kbd>num_2</kbd> , <kbd>2</kbd> \n  ",ATTENTION:"Atenção",WARNING:"Alerta",BUTTON_RESET_SETTINGS:"Limpar Configurações(Reset Settings)",SETTINGS_RESET:"Configurações foram limpas, recarregue o site para efetivar a alteração",LANGUAGE_CHANGED:"Idioma foi alterado, recarregue o site para efetivar a alteração",AUTO_DOWNLOAD:"Proxima vez que abrir um capitulo download iniciara automaticamente",LAZY_LOAD:"Carregamento preguiçoso não é compativel com download de zip, não conseguira com essa configuração ativa.<br/> Sugestão: <span style='color:red;font-weight:bold'>Desative Miniaturas</span> para economizar memoria e cota de internet.",LAZY_LOAD_IMAGES_ENABLE:"Ativar Carregamento de imagens preguiçoso",LAZY_LOAD_IMAGES:"Carregamento de paginas preguiçoso começa a partir de (entre 5 e 100)",RETURN_CHAPTER_LIST:"Voltar a lista de Capitulos",PAGES_LOADED:"Paginas Carregadas",GO_TO_PAGE:"Pular para",ENLARGE:"Aumentar",RESTORE:"Restaurar",REDUCE:"Diminuir",FIT_WIDTH:"Preencher Largura",FIT_HEIGHT:"Preencher Altura ",PERCENT:"Percentual",TOGGLE_CONTROLS:"Mostar controles de pagina",ZOOM_IN:"Mais Zoom",ZOOM_OUT:"Menos Zoom",ZOOM_RESET:"Resetar Zoom",ZOOM_WIDTH:"Zoom para Largura",ZOOM_HEIGHT:"Zoom para Altura",HIDE:"Esconder",RELOAD:"Recarregar",SLOWLY:"Devagar",NORMAL:"Normal",FAST:"Rapido",EXTREME:"Extremo",ALL_PAGES:"Todas as Paginas",SPEED_WARNING:"Velocidade de Carregamento muito alta",SPEED_WARNING_MESSAGE:"Essa velocidade não é recomendada.<br> Ela pode derrubar um servidor or marcar voce como um ataque hacker de DDoS.<br> Use com cuidado!",SCROLL_UP:"Subir Pagina",SCROLL_DOWN:"Descer Pagina",CLOSE:"Fechar",LIST_EMPTY:"Lista Vazia",DISPLAY_COMMENTS:"Mostar Comentarios",COMMENTS:"Seção de comentários",SCROLL_START:"Ativar Rolagem Automatica",AUTO_SCROLL_HEIGHT:"Velocidade da Rolagem Automatica em Pixels",VERTICAL_SEPARATOR:"Mostrar Separadores Verticais",END:"Fin"},{ID:"zh_CN",NAME:"中文 (简体)",STARTING:"正在启动<br>Manga OnlineViewer",RESUME:"从页面继续阅读 ",WAITING:"请等待3秒钟...",CHOOSE_BEGINNING:"选择要开始的页数:",BUTTON_START:"启动Manga OnlineViewer",SETTINGS:"设置",LANGUAGE:"语言",COLOR_SCHEME:"配色方案",THEME:"主题",THEME_HUE:"主题色调",THEME_SHADE:"主题阴影",DEFAULT_LOAD_MODE:"默认加载模式",LOAD_MODE_NORMAL:"等待模式(等待3秒自动加载 )",LOAD_MODE_ALWAYS:"自动模式(无需等待)",LOAD_MODE_NEVER:"手动模式(点击启动)",LOAD_SPEED:"加载速度页数/秒",DEFAULT_ZOOM:"默认缩放 (最小 5 最大 200)",DEFAULT_ZOOM_MODE:"默认缩放模式",MINIMUM_ZOOM:"相对于屏幕宽度的最小缩放 (最小 30 最大 100)",ZOOM_STEP:"缩放级别 (最小 5 最大 50)",DEFAULT_VIEW_MODE:"默认视图模式",VIEW_MODE_VERTICAL:"垂直有缝",VIEW_MODE_LEFT:"从左到右",VIEW_MODE_RIGHT:"从右到左",VIEW_MODE_WEBCOMIC:"垂直无缝",FIT_WIDTH_OVERSIZED:"如果尺寸过大、则适合宽度",SHOW_THUMBNAILS:"显示缩略图",ENABLE_COMMENTS:"捕获评论（如果可用）",HIDE_CONTROLS:"始终隐藏页面控件",HEADER_TYPE:"更改标题显示方式",HEADER_HOVER:"悬停",HEADER_SCROLL:"滚动",HEADER_CLICK:"点击",HEADER_FIXED:"固定",HEADER_SIMPLE:"简单",BUTTON_DOWNLOAD:"下载",DOWNLOAD_ZIP:"下载压缩文件",DOWNLOAD_IMAGES:"自动将图片下载成ZIP",BUTTON_NEXT:"下一页",NEXT_CHAPTER:"下一章",BUTTON_PREVIOUS:"上一页",PREVIOUS_CHAPTER:"上一章",BOOKMARKS:"书签",BOOKMARK:"Bookmark",BOOKMARK_REMOVED:"删除书签",BOOKMARK_SAVED:"保存书签",BOOKMARK_MESSAGE:"下次打开本章时，将从:<h4>页码 ##num##</h4>(<i>仅一次</i> 每个书签)",KEYBINDINGS:"快捷键",EDIT_KEYBINDS:"编辑键绑定",SAVE_KEYBINDS:"保存键绑定",BUTTON_EDIT:"编辑",BUTTON_SAVE:"救",KEYBIND_RULES:"\n    <h3>支持的密钥</h3>\n    允许的修饰符: shift, option, alt, ctrl, control, command. </br>\n    特殊键: backspace, tab, clear, enter, return, esc, escape, space, up, down, left, right, home, end, pageup, pagedown, del, delete, f1 - f19, num_0 - num_9, num_multiply, num_add, num_enter, num_subtract, num_decimal, num_divide.</br>\n    例子: <kbd>a</kbd>, <kbd>ctrl+a</kbd> , <kbd>shift+a</kbd> , <kbd>num_2</kbd> , <kbd>2</kbd> \n  ",ATTENTION:"注意",WARNING:"警告",BUTTON_RESET_SETTINGS:"重置设置(Reset Settings)",SETTINGS_RESET:"设置已重置、重新加载页面才能生效",LANGUAGE_CHANGED:"语言已更改、重新加载页面才能生效",AUTO_DOWNLOAD:"下次章节加载完成时、系统将提示您自动保存",LAZY_LOAD:"延迟加载与zip下载不兼容、您将无法使用此设置下载.<br/> 建议: <span style='color:red;font-weight:bold'>禁用缩略图</span> 以节省流量和内存.",LAZY_LOAD_IMAGES_ENABLE:"启用延迟加载图像",LAZY_LOAD_IMAGES:"惰性加载从页面 (最小 5 最大 100)",RETURN_CHAPTER_LIST:"返回章节列表",PAGES_LOADED:"已加载的页数",GO_TO_PAGE:"转到页数",ENLARGE:"放大",RESTORE:"还原",REDUCE:"缩小",FIT_WIDTH:"适合宽度",FIT_HEIGHT:"适合高度",PERCENT:"百分之",TOGGLE_CONTROLS:"显示隐藏页面控件",ZOOM_IN:"放大",ZOOM_OUT:"缩小",ZOOM_RESET:"还原",ZOOM_WIDTH:"适合宽度",ZOOM_HEIGHT:"适合高度",HIDE:"显示隐藏页面控件",RELOAD:"重新加载",SLOWLY:"慢速",NORMAL:"正常",FAST:"快速",EXTREME:"极端",ALL_PAGES:"所有页面",SPEED_WARNING:"加载速度过高",SPEED_WARNING_MESSAGE:"不建议使用此速度.<br>它可能会伤害某些服务器或将您的 IP 标记为 DDoS 攻击者.<br>请谨慎使用!",SCROLL_UP:"向上滚动",SCROLL_DOWN:"向下滚动",CLOSE:"关闭",LIST_EMPTY:"没有收藏书签",DISPLAY_COMMENTS:"显示注释",COMMENTS:"评论部分",SCROLL_START:"切换自动滚动",AUTO_SCROLL_HEIGHT:"自动滚动速度（以像素为单位）",VERTICAL_SEPARATOR:"显示垂直分隔符",END:"结尾"}],ee={locale:"en_US",theme:"darkblue",customTheme:"#263e3a",themeShade:600,colorScheme:"dark",fitWidthIfOversize:!0,showThumbnails:!0,enableComments:!0,downloadZip:!1,verticalSeparator:!1,throttlePageLoad:1e3,zoomMode:"percent",defaultZoom:100,zoomStep:25,minZoom:30,loadMode:"wait",viewMode:"WebComic",bookmarks:[],lazyLoadImages:!1,lazyStart:50,hidePageControls:!1,header:"hover",maxReload:5,scrollHeight:20,keybinds:{SCROLL_UP:["up","W","num_8"],SCROLL_DOWN:["down","S","num_2"],NEXT_CHAPTER:["right","/","D","num_6"],PREVIOUS_CHAPTER:["left",";","A","num_4"],ENLARGE:["-","num_add","E"],REDUCE:["=","num_subtract","Q"],RESTORE:["9","num_divide","R"],FIT_WIDTH:["0","num_multiply","F"],FIT_HEIGHT:["H"],SETTINGS:["num_divide","num_5","X"],VIEW_MODE_WEBCOMIC:["C"],VIEW_MODE_VERTICAL:["V"],VIEW_MODE_LEFT:["N"],VIEW_MODE_RIGHT:["B"],SCROLL_START:["space"]}},ne=()=>navigator?.userAgentData?.mobile||"mobile"===X()||"tablet"===X()?_.defaultsDeep({lazyLoadImages:!0,fitWidthIfOversize:!0,showThumbnails:!1,viewMode:"WebComic",header:"click"},ee):ee;let te=_.defaultsDeep(function(e){return j("settings",e)}(ne()),ne());function ae(){return te}function oe(e){const n=J.find((e=>e.ID===te.locale));return n?.[e]?n[e]:J?.at(1)?.[e]?J[1][e]:"##MISSING_STRING##"}function ie(e){U(JSON.stringify(e)),te={...te,...e},Q(K(te,ne()))}function re(){("undefined"!=typeof GM_listValues?GM_listValues():[]).forEach((e=>{var n;n=e,"undefined"!=typeof GM_deleteValue?GM_deleteValue(n):U("Removing: ",n)})),ie(ne())}function le(e=window.location.href){return te.bookmarks.find((n=>n.url===e))?.page}const se=te.bookmarks.filter((e=>Date.now()-new Date(e.date).valueOf()<31104e6));te.bookmarks.length!==se.length&&ie({bookmarks:se});const ce={dark:{name:"dark",50:"#C1C2C5",100:"#A6A7AB",200:"#909296",300:"#5c5f66",400:"#373A40",500:"#2C2E33",600:"#25262b",700:"#1A1B1E",800:"#141517",900:"#101113"},gray:{name:"gray",50:"#f8f9fa",100:"#f1f3f5",200:"#e9ecef",300:"#dee2e6",400:"#ced4da",500:"#adb5bd",600:"#868e96",700:"#495057",800:"#343a40",900:"#212529"},red:{name:"red",50:"#fff5f5",100:"#ffe3e3",200:"#ffc9c9",300:"#ffa8a8",400:"#ff8787",500:"#ff6b6b",600:"#fa5252",700:"#f03e3e",800:"#e03131",900:"#c92a2a"},pink:{name:"pink",50:"#fff0f6",100:"#ffdeeb",200:"#fcc2d7",300:"#faa2c1",400:"#f783ac",500:"#f06595",600:"#e64980",700:"#d6336c",800:"#c2255c",900:"#a61e4d"},grape:{name:"grape",50:"#f8f0fc",100:"#f3d9fa",200:"#eebefa",300:"#e599f7",400:"#da77f2",500:"#cc5de8",600:"#be4bdb",700:"#ae3ec9",800:"#9c36b5",900:"#862e9c"},violet:{name:"violet",50:"#f3f0ff",100:"#e5dbff",200:"#d0bfff",300:"#b197fc",400:"#9775fa",500:"#845ef7",600:"#7950f2",700:"#7048e8",800:"#6741d9",900:"#5f3dc4"},indigo:{name:"purple",50:"#edf2ff",100:"#dbe4ff",200:"#bac8ff",300:"#91a7ff",400:"#748ffc",500:"#5c7cfa",600:"#4c6ef5",700:"#4263eb",800:"#3b5bdb",900:"#364fc7"},blue:{name:"blue",50:"#e7f5ff",100:"#d0ebff",200:"#a5d8ff",300:"#74c0fc",400:"#4dabf7",500:"#339af0",600:"#228be6",700:"#1c7ed6",800:"#1971c2",900:"#1864ab"},cyan:{name:"cyan",50:"#e3fafc",100:"#c5f6fa",200:"#99e9f2",300:"#66d9e8",400:"#3bc9db",500:"#22b8cf",600:"#15aabf",700:"#1098ad",800:"#0c8599",900:"#0b7285"},teal:{name:"teal",50:"#e6fcf5",100:"#c3fae8",200:"#96f2d7",300:"#63e6be",400:"#38d9a9",500:"#20c997",600:"#12b886",700:"#0ca678",800:"#099268",900:"#087f5b"},green:{name:"green",50:"#ebfbee",100:"#d3f9d8",200:"#b2f2bb",300:"#8ce99a",400:"#69db7c",500:"#51cf66",600:"#40c057",700:"#37b24d",800:"#2f9e44",900:"#2b8a3e"},lime:{name:"lime",50:"#f4fce3",100:"#e9fac8",200:"#d8f5a2",300:"#c0eb75",400:"#a9e34b",500:"#94d82d",600:"#82c91e",700:"#74b816",800:"#66a80f",900:"#5c940d"},yellow:{name:"yellow",50:"#fff9db",100:"#fff3bf",200:"#ffec99",300:"#ffe066",400:"#ffd43b",500:"#fcc419",600:"#fab005",700:"#f59f00",800:"#f08c00",900:"#e67700"},orange:{name:"orange",50:"#fff4e6",100:"#ffe8cc",200:"#ffd8a8",300:"#ffc078",400:"#ffa94d",500:"#ff922b",600:"#fd7e14",700:"#f76707",800:"#e8590c",900:"#d9480f"},darkblue:{name:"darkblue",50:"#E8F4F9",100:"#D9DEE9",200:"#B7C2DA",300:"#6482C0",400:"#4267B2",500:"#385898",600:"#314E89",700:"#29487D",800:"#223B67",900:"#1E355B"}},de=10,me=95;function ue(e){const n=tinycolor(e);return function(e,n){return e.l=n,tinycolor(e).toHexString()}(n.toHsl(),n.isDark()?me:de)}function ge(e){const n=e.replace(/[\t\n\r]/gim,"").replace(/\s\s+/g," ");return`data:image/svg+xml;charset=UTF-8,${encodeURIComponent(n).replace(/\(/g,"%28").replace(/\)/g,"%29")}`}const pe=e=>e%100==0?15:e%50==0?10:e%25==0?5:2.5;function he(e,n,t="#0F1C3F",a="#ECEAD9"){const o=function(e,n,t,a){let o="";for(let n=0;n<=e;n+=5)o+=H` <line
      ...
      />`,0!==n&&n%50==0&&(o+=H` <text
        ...
        >
          ${n}
        </text>`);for(let e=0;e<=n;e+=5)o+=H` <line
        x1="0"
        y1="${e}"
        x2="${pe(e)}"
        y2="${e}"
    ...
    </svg>`}(e,n,t,a);return ge(o)}const we=Object.values(ce).map((e=>e[900])),be=[400,600,900,1200,1400,1600,1970],fe=[600,800,1e3,1200,1400,2e3,2600];function ve(){const e=Math.floor(Math.random()*be.length),n=Math.floor(Math.random()*fe.length),t=Math.floor(Math.random()*we.length);return he(be[e],fe[n],we[t])}const ye='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-autofit-height" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M12 20h-6a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h6" />\n  <path d="M18 14v7" />\n  <path d="M18 3v7" />\n  <path d="M15 18l3 3l3 -3" />\n  <path d="M15 6l3 -3l3 3" />\n</svg>\n\n\n',Ee='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-autofit-width" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M4 12v-6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v6" />\n  <path d="M10 18h-7" />\n  <path d="M21 18h-7" />\n  <path d="M6 15l-3 3l3 3" />\n  <path d="M18 15l3 3l-3 3" />\n</svg>\n\n\n',ke='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-bookmark" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M18 7v14l-6 -4l-6 4v-14a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4z" />\n</svg>\n\n\n',xe='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-bookmark-off" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M7.708 3.721a3.982 3.982 0 0 1 2.292 -.721h4a4 4 0 0 1 4 4v7m0 4v3l-6 -4l-6 4v-14c0 -.308 .035 -.609 .1 -.897" />\n  <path d="M3 3l18 18" />\n</svg>\n\n\n',Me='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-check" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M5 12l5 5l10 -10" />\n</svg>\n\n\n',Se='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-moon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z" />\n</svg>\n\n\n',Oe='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-palette" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M12 21a9 9 0 0 1 0 -18c4.97 0 9 3.582 9 8c0 1.06 -.474 2.078 -1.318 2.828c-.844 .75 -1.989 1.172 -3.182 1.172h-2.5a2 2 0 0 0 -1 3.75a1.3 1.3 0 0 1 -1 2.25" />\n  <path d="M8.5 10.5m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" />\n  <path d="M12.5 7.5m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" />\n  <path d="M16.5 10.5m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" />\n</svg>\n\n\n',Ae='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-photo" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M15 8h.01" />\n  <path d="M3 6a3 3 0 0 1 3 -3h12a3 3 0 0 1 3 3v12a3 3 0 0 1 -3 3h-12a3 3 0 0 1 -3 -3v-12z" />\n  <path d="M3 16l5 -5c.928 -.893 2.072 -.893 3 0l5 5" />\n  <path d="M14 14l1 -1c.928 -.893 2.072 -.893 3 0l3 3" />\n</svg>\n\n\n',Ce='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-sun" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" />\n  <path d="M3 12h1m8 -9v1m8 8h1m-9 8v1m-6.4 -15.4l.7 .7m12.1 -.7l-.7 .7m0 11.4l.7 .7m-12.1 -.7l-.7 .7" />\n</svg>\n\n\n',Ie='<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-x" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M18 6l-12 12" />\n  <path d="M6 6l12 12" />\n</svg>\n\n\n',Le=W`
    :root,
    .dark,
    .dark .default,
    [data-theme="dark"] {
      ...
      --theme-primary-color: ${ce.dark[700]};
      --theme-primary-text-color: ${ce.dark[50]};
    ...
    [data-theme="light"] {
      ...
      --theme-primary-color: ${ce.gray[300]};
      --theme-primary-text-color: ${ce.gray[900]};
    ...
    #MangaOnlineViewer .PageContent .PageImg:not([src]) {
      background-image: url("${ge(Ae)}");
    }

    #MangaOnlineViewer .PageContent .PageImg.imgBroken {
      background-image: url("${ge('<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-photo-off" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M15 8h.01" />\n  <path d="M7 3h11a3 3 0 0 1 3 3v11m-.856 3.099a2.991 2.991 0 0 1 -2.144 .901h-12a3 3 0 0 1 -3 -3v-12c0 -.845 .349 -1.608 .91 -2.153" />\n  <path d="M3 16l5 -5c.928 -.893 2.072 -.893 3 0l5 5" />\n  <path d="M16.33 12.338c.574 -.054 1.155 .166 1.67 .662l3 3" />\n  <path d="M3 3l18 18" />\n</svg>\n\n\n')}");
    }
  ...
  `;function Te(e,n){if(!document.querySelector(`#${e}`)){(document.head??document.querySelector("head")).appendChild(function(e,n){const t=document.createElement("style");return t.id=e,t.appendChild(document.createTextNode(n)),t}(e,n))}}function _e(e,n){!function(e){document.querySelectorAll(`style[id="${e}"]`).forEach((e=>{e.remove()}))}(e),Te(e,n)}function Re(e,n){return H`
    ...
    <div id="ThemeSection">
      ...
      <div class="ControlLabel ThemeSelector">
        ...
        ${"custom"===ae().theme?"selected":""}"
          title="custom"
        >
          ${Oe} ${Me}
        </span>
        ${[...Object.keys(ce).map((e=>ce[e].name))].map((e=>H`
          <span
            title="${e}"
            class="${e} ThemeRadio ${ae().theme===e?"selected":""}"
          >
            ${Me}
          </span>
        `)).join("")}
      ...
      ${ae().theme.startsWith("custom")?"show":""}"
      >
        ${oe("THEME_HUE")}
        <input
          id="CustomThemeHue"
          type="color"
          value="${ae().customTheme}"
  ...
  `,Pe=H`
    <div class="ControlLabel loadMode">
      ${oe("DEFAULT_LOAD_MODE")}
      <select id="loadMode">
        <option
          value="wait"
          ${"wait"===ae().loadMode?"selected":""}
        >
          ${oe("LOAD_MODE_NORMAL")}
        </option>
        <option
          value="always"
          ${"always"===ae().loadMode?"selected":""}
        >
          ${oe("LOAD_MODE_ALWAYS")}
        </option>
        <option
          value="never"
          ${"never"===ae().loadMode?"selected":""}
        >
          ${oe("LOAD_MODE_NEVER")}
        </option>
      </select>
  ...
  `,Ze=H`
    <div class="ControlLabel PagesPerSecond">
      ...
      <select id="PagesPerSecond">
        <option
          value="3000"
          ${3e3===ae().throttlePageLoad?"selected":""}
        >
          0.3(${oe("SLOWLY")})
        </option>
        <option
          value="2000"
          ${2e3===ae().throttlePageLoad?"selected":""}
        >
          0.5
        </option>
        <option
          value="1000"
          ${1e3===ae().throttlePageLoad?"selected":""}
        >
          01(${oe("NORMAL")})
        </option>
        <option
          value="500"
          ${500===ae().throttlePageLoad?"selected":""}
        >
          02
        </option>
        <option
          value="250"
          ${250===ae().throttlePageLoad?"selected":""}
        >
          04(${oe("FAST")})
        </option>
        <option
          value="125"
          ${125===ae().throttlePageLoad?"selected":""}
        >
          08
        </option>
        <option
          value="100"
          ${100===ae().throttlePageLoad?"selected":""}
        >
          10(${oe("EXTREME")})
        </option>
        <option
          value="1"
          ${1===ae().throttlePageLoad?"selected":""}
        >
          ${oe("ALL_PAGES")}
        </option>
      </select>
    </div>
  `,He=H` <div class="ControlLabel DefaultZoomMode">
    ${oe("DEFAULT_ZOOM_MODE")}
    <select id="DefaultZoomMode">
      <option
        value="percent"
        ${"percent"===ae().zoomMode?"selected":""}
      >
        ${oe("PERCENT")}
      </option>
      <option
        value="width"
        ${"width"===ae().zoomMode?"selected":""}
      >
        ${oe("FIT_WIDTH")}
      </option>
      <option
        value="height"
        ${"height"===ae().zoomMode?"selected":""}
      >
        ${oe("FIT_HEIGHT")}
      </option>
    </select>
  ...
  `,je=H`
    <div class="ControlLabel viewMode">
      ${oe("DEFAULT_VIEW_MODE")}
      <select id="viewMode">
        <option
          value="Vertical"
          ${"Vertical"===ae().viewMode?"selected":""}
        >
          ${oe("VIEW_MODE_VERTICAL")}
        </option>
        <option
          value="WebComic"
          ${"WebComic"===ae().viewMode?"selected":""}
        >
          ${oe("VIEW_MODE_WEBCOMIC")}
        </option>
        <option
          value="FluidLTR"
          ${"FluidLTR"===ae().viewMode?"selected":""}
        >
          ${oe("VIEW_MODE_LEFT")}
        </option>
        <option
          value="FluidRTL"
          ${"FluidRTL"===ae().viewMode?"selected":""}
        >
          ${oe("VIEW_MODE_RIGHT")}
        </option>
      </select>
  ...
  `,Ye=H`
    <div class="ControlLabel headerType">
      ...
      <select id="headerType">
        <option
          value="hover"
          ${"hover"===ae().header?"selected":""}
        >
          ${oe("HEADER_HOVER")}
        </option>
        <option
          value="scroll"
          ${"scroll"===ae().header?"selected":""}
        >
          ${oe("HEADER_SCROLL")}
        </option>
        <option
          value="click"
          ${"click"===ae().header?"selected":""}
        >
          ${oe("HEADER_CLICK")}
        </option>
        <option
          value="fixed"
          ${"fixed"===ae().header?"selected":""}
        >
          ${oe("HEADER_FIXED")}
        </option>
        <option
          value="simple"
          ${"simple"===ae().header?"selected":""}
        >
          ${oe("HEADER_SIMPLE")}
        </option>
      </select>
  ...
  `,Xe=H`
    <div class="ControlLabel verticalSeparator">
      ${oe("VERTICAL_SEPARATOR")}
      <input
        type="checkbox"
        value="true"
        name="verticalSeparator"
        id="verticalSeparator"
        ${ae().verticalSeparator?"checked":""}
      />
    </div>
    <div class="ControlLabel fitIfOversize">
      ${oe("FIT_WIDTH_OVERSIZED")}
      <input
        type="checkbox"
        value="true"
        name="fitIfOversize"
        id="fitIfOversize"
        ${ae().fitWidthIfOversize?"checked":""}
      />
    </div>
    ...
    <div class="ControlLabel enableComments">
      ...
      <input
        ...
        name="enableComments"
        id="enableComments"
        ${ae().enableComments?"checked":""}
      />
    </div>
    <div class="ControlLabel lazyLoadImages">
      ${oe("LAZY_LOAD_IMAGES_ENABLE")}
      <input
        type="checkbox"
        value="true"
        name="lazyLoadImages"
        id="lazyLoadImages"
        ${ae().lazyLoadImages?"checked":""}
      />
    </div>
    ${Qe}
    ...
    <div class="ControlLabel hidePageControls">
      ...
      <input
        ...
        id="hidePageControls"
        ${ae().hidePageControls?"checked":""}
      />
    </div>
  `,Ke=H`
    <div class="ControlLabel autoScroll">
      <span>
        ${oe("AUTO_SCROLL_HEIGHT")}
        <output id="scrollHeightVal" for="scrollHeight">
          ${ae().scrollHeight} </output
        >px
      </span>
      <input
        type="range"
        value="${ae().scrollHeight}"
        name="scrollHeight"
        id="scrollHeight"
        min="1"
        max="100"
  ...
  `,Je=()=>H`
    <div id="SettingsPanel" class="panel">
      ...
      <button id="ResetSettings" class="ControlButton">
        ${oe("BUTTON_RESET_SETTINGS")}
      </button>
      ${ze} ${Ge} ${Pe} ${Ze} ${He}
      ${We} ${Ue} ${qe} ${je} ${Xe}
      ${Ye} ${Ke}
    </div>
  `,en=()=>Object.keys(ae().keybinds).map((e=>{const n=ae().keybinds[e]?.length?ae().keybinds[e]?.map((e=>H`<kbd class="dark">${e}</kbd>`)).join(" / "):"";return H`<span>${oe(e)}:</span> <span>${n}</span>`})),nn=()=>Object.keys(ae().keybinds).map((e=>H`<label for="${e}">${oe(e)}:</label>
            <input
              type="text"
              class="KeybindInput"
              id="${e}"
              name="${e}"
              value="${ae().keybinds[e]?.join(" , ")??""}"
            />`)).concat(H`<div id="HotKeysRules">${oe("KEYBIND_RULES")}</div>`),tn=()=>H`
    <div id="KeybindingsPanel" class="panel">
      <h2>${oe("KEYBINDINGS")}</h2>
      <button
        id="CloseKeybindings"
        class="closeButton"
        title="${oe("CLOSE")}"
      ...
      <div class="controls">
        ...
        <button
          ...
          type="button"
          title="${oe("SAVE_KEYBINDS")}"
        >
          ${'<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-device-floppy" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M6 4h10l4 4v10a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2" />\n  <path d="M12 14m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" />\n  <path d="M14 4l0 4l-6 0l0 -4" />\n</svg>\n\n\n'} ${oe("BUTTON_SAVE")}
        </button>
      </div>
      <div id="KeybindingsList">${en().join("\n")}</div>
    </div>
  `;function an(e,n=1){return Array(e).fill(0).map(((e,n)=>n+1)).filter((e=>e>=n))}const on=()=>t(ae().bookmarks)?[oe("LIST_EMPTY")]:ae().bookmarks.map(((e,n)=>H`
  ...
  `;function ln(){const e=document.getElementById("BookmarksList");e&&(e.innerHTML=on().join(""))}const sn=e=>{return H`
    <header id="Header" class="${ae().header} headroom-top">
      <aside id="GlobalFunctions">
        ...
        <span id="ZoomSlider">
          <output id="ZoomVal" class="RangeValue" for="Zoom">
            ${"percent"===ae().zoomMode?`${ae().defaultZoom}%`:ae().zoomMode}
          </output>
          <input
            type="range"
            value="${ae().defaultZoom}"
      ...
      <nav id="ChapterNavigation">
        <div id="Counters" class="ControlLabel">
          ...
          >
          <span class="ControlLabel"> ${oe("GO_TO_PAGE")}: </span>
          <select id="gotoPage">
            <option selected>#</option>
            ${(n=e.pages,t=e.begin,an(n,t).map((e=>H` <option value="${e}">${e}</option>`))).join("")}
          </select>
        </div>
        <div id="ChapterControl" class="ChapterControl">
          ...
          <span>
            ...
            <a
              ...
              type="button"
              href="${e.next??""}"
              title="${oe("NEXT_CHAPTER")}"
            >
              ${oe("BUTTON_NEXT")} ${'<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-big-right" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M4 9h8v-3.586a1 1 0 0 1 1.707 -.707l6.586 6.586a1 1 0 0 1 0 1.414l-6.586 6.586a1 1 0 0 1 -1.707 -.707v-3.586h-8a1 1 0 0 1 -1 -1v-4a1 1 0 0 1 1 -1z" />\n</svg>\n\n\n'}
            </a>
          </span>
        </div>
      </nav>
    </header>
  `;var n,t},cn=e=>{return H`
    <main
      id="Chapter"
      class="${ae().fitWidthIfOversize?"fitWidthIfOversize":""}
  ${ae().verticalSeparator?"separator":""}
  ${ae().viewMode}"
    >
      ${(n=e.pages,t=e.begin,an(n,t).map((e=>H`
  ...
  `;var n,t},dn=()=>H`
    <div id="CommentsPanel" class="panel">
      ...
      <h2>${oe("COMMENTS")}</h2>
      <div id="CommentsArea" class="${ae().colorScheme}"></div>
      <button id="CommentsColorScheme" class="simpleButton ColorScheme">
        ${Ce} ${Se}
      </button>
    </div>
  `;function mn(e){const n=document.querySelector("#Chapter");n?.classList.contains("FluidLTR")||n?.classList.contains("FluidRTL")?n?.scroll(e?.offsetLeft??0,e?.offsetTop??0):window?.scroll(e?.offsetLeft??0,e?.offsetTop??0)}function un(e,n){return t=>t.addEventListener(e,n)}function gn(e){e.deltaY&&(e.currentTarget.scrollLeft+=e.deltaY+e.deltaX,e.preventDefault())}function pn(e){e.deltaY&&(e.currentTarget.scrollLeft-=e.deltaY+e.deltaX,e.preventDefault())}function hn(){document.querySelector("#BookmarksPanel")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function wn(e=window.location.href){a(le(e))||(U(`Bookmark Removed ${e}`),ie({bookmarks:ae().bookmarks.filter((n=>n.url!==e))}),e===window.location.href&&document.querySelector("#MangaOnlineViewer")?.classList.remove("bookmarked"))}function bn(e){const n=e.currentTarget.value;U(`Bookmark Removed ${n}`),Swal.fire({title:oe("BOOKMARK_REMOVED"),timer:1e4,icon:"error"}),wn(n),ln(),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(un("click",bn))}function fn(){ln(),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(un("click",bn)),document.querySelector("#BookmarksPanel")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function vn(e){document.querySelector("#MangaOnlineViewer")?.classList.toggle("bookmarked");const n=[...document.querySelectorAll(".MangaPage")].map((e=>Math.abs(e.offsetTop-window.scrollY))),t=parseInt(e.currentTarget.parentElement?.querySelector(".PageIndex")?.textContent??"0",10)||n.indexOf(Math.min(...n))+1,a={name:document.querySelector("title")?.textContent?.trim().replace(/^\(\d+%\) */,"")??"",url:window.location.href,page:t,date:(new Date).toISOString().slice(0,10)};le(a.url)?(ie({bookmarks:ae().bookmarks.filter((e=>e.url!==a.url))}),Swal.fire({title:oe("BOOKMARK_REMOVED"),timer:1e4,icon:"error"})):(ie({bookmarks:[...ae().bookmarks,a]}),Swal.fire({title:oe("BOOKMARK_SAVED"),html:oe("BOOKMARK_SAVED").replace("##NUM##",t.toString()),icon:"success"})),ln(),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(un("click",bn))}var yn,En="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},kn={exports:{}};yn=kn,function(){function e(e,n){return void 0===n?n={autoBom:!1}:"object"!=typeof n&&(console.warn("Deprecated: Expected third argument to be a object"),n={autoBom:!n}),n.autoBom&&/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(e.type)?new Blob(["\ufeff",e],{type:e.type}):e}function n(e,n,t){var a=new XMLHttpRequest;a.open("GET",e),a.responseType="blob",a.onload=function(){r(a.response,n,t)},a.onerror=function(){console.error("could not download file")},a.send()}function t(e){var n=new XMLHttpRequest;n.open("HEAD",e,!1);try{n.send()}catch(e){}return 200<=n.status&&299>=n.status}function a(e){try{e.dispatchEvent(new MouseEvent("click"))}catch(t){var n=document.createEvent("MouseEvents");n.initMouseEvent("click",!0,!0,window,0,0,0,80,20,!1,!1,!1,!1,0,null),e.dispatchEvent(n)}}var o="object"==typeof window&&window.window===window?window:"object"==typeof self&&self.self===self?self:"object"==typeof En&&En.global===En?En:void 0,i=o.navigator&&/Macintosh/.test(navigator.userAgent)&&/AppleWebKit/.test(navigator.userAgent)&&!/Safari/.test(navigator.userAgent),r=o.saveAs||("object"!=typeof window||window!==o?function(){}:"download"in HTMLAnchorElement.prototype&&!i?function(e,i,r){var l=o.URL||o.webkitURL,s=document.createElement("a");i=i||e.name||"download",s.download=i,s.rel="noopener","string"==typeof e?(s.href=e,s.origin===location.origin?a(s):t(s.href)?n(e,i,r):a(s,s.target="_blank")):(s.href=l.createObjectURL(e),setTimeout((function(){l.revokeObjectURL(s.href)}),4e4),setTimeout((function(){a(s)}),0))}:"msSaveOrOpenBlob"in navigator?function(o,i,r){if(i=i||o.name||"download","string"!=typeof o)navigator.msSaveOrOpenBlob(e(o,r),i);else if(t(o))n(o,i,r);else{var l=document.createElement("a");l.href=o,l.target="_blank",setTimeout((function(){a(l)}))}}:function(e,t,a,r){if((r=r||open("","_blank"))&&(r.document.title=r.document.body.innerText="downloading..."),"string"==typeof e)return n(e,t,a);var l="application/octet-stream"===e.type,s=/constructor/i.test(o.HTMLElement)||o.safari,c=/CriOS\/[\d]+/.test(navigator.userAgent);if((c||l&&s||i)&&"undefined"!=typeof FileReader){var d=new FileReader;d.onloadend=function(){var e=d.result;e=c?e:e.replace(/^data:[^;]*;/,"data:attachment/file;"),r?r.location.href=e:location=e,r=null},d.readAsDataURL(e)}else{var m=o.URL||o.webkitURL,u=m.createObjectURL(e);r?r.location=u:location.href=u,r=null,setTimeout((function(){m.revokeObjectURL(u)}),4e4)}});o.saveAs=r.saveAs=r,yn.exports=r}();var xn=kn.exports;const Mn=/^data:(?<mimeType>image\/\w+);base64,+(?<data>.+)/,Sn=/^blob:(.+?)\/(.+)$/;function On(e){return/^data:image\/(png|jpg|jpeg|gif);base64,/.test(e)}function An(e){return Sn.test(e)}const Cn=e=>/image\/(?<ext>jpe?g|png|webp)/.exec(e)?.groups?.ext??"png";let In;const Ln=(e,n,t,a)=>`${e}${(n+1).toString().padStart(Math.floor(Math.log10(t))+1,"0")}.${a.replace("jpeg","jpg")}`;async function Tn(e,n,t){let a=e.getAttribute("src");if((null==a||An(a))&&(a=e.getAttribute("data-src"),null==a||An(a)))return Promise.reject(new Error("Image source not specified"));const o=Mn.exec(a);return o?.groups?Promise.resolve({name:Ln("Page-",n,t.length,Cn(o.groups?.mimeType)),data:o.groups.data}):new Promise((e=>{(async function(e){return new Promise((n=>{U(`Getting Image data: ${e}`),GM_xmlhttpRequest({method:"GET",url:e,headers:{referer:e,origin:e},responseType:"blob",onload(e){n(e)}})}))})(a).then((a=>{e({name:Ln("Page-",n,t.length,Cn(a.response.type)),data:a.response})})).catch(U)}))}function _n(e){U(`${e.name} Added to Zip from Base64 Image`),In.file(e.name,e.data,{base64:!0,createFolders:!0,compression:"DEFLATE"})}function Rn(e){const n=e.currentTarget;n.classList.contains("loading")||(U("Downloading Chapter"),n.classList.add("loading"),async function(){In=new JSZip;const e=[...document.querySelectorAll(".PageImg")];Promise.all(e.map(Tn)).then((e=>{e.forEach(_n),U("Generating Zip"),In.generateAsync({type:"blob"}).then((e=>{U("Download Ready");const n=`${document.querySelector("#MangaTitle")?.textContent?.trim()}.zip`;xn.saveAs(e,n,{autoBom:!1}),document.getElementById("download")?.classList.remove("loading")})).catch(U)})).catch((e=>U("One or more images couldn't be Downloaded",e)))}().catch((e=>U("Error downloading chapter",e))))}function Dn(){document.querySelector("#MangaOnlineViewer")?.classList.toggle("hideControls")}function Bn(e){const n=e.target,t=n.getAttribute("value")??n.getAttribute("href");1===e.button||e.ctrlKey||(t&&"#"!==t?window.location.href=t:"series"===n.id&&window.history.back())}function Nn(){document.querySelector("#CommentsPanel")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function Vn(){document.querySelector("#CommentsPanel")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function $n(){const e=document.querySelector("#CommentsArea");e?.classList.toggle("light"),e?.classList.toggle("dark")}const Fn=e=>document.querySelector(e)?.dispatchEvent(new Event("click"));function zn(e){const n=document.querySelector("#Chapter");if(n?.classList.contains("FluidLTR")||n?.classList.contains("FluidRTL"))n.scrollBy({left:window.innerWidth/2*e*(n?.classList.contains("FluidRTL")?-1:1),behavior:"smooth"});else if("height"===ae().zoomMode){const n=[...document.querySelectorAll(".MangaPage")],t=n.map((e=>Math.abs(e.offsetTop-window.scrollY))),a=_.indexOf(t,_.min(t)),o=a+e,i=document.querySelector("#Header");o<0?mn(i):o>=n.length?i.classList.add("headroom-end"):(U(`Current array page ${a},`,`Scrolling to page ${o}`),mn(n.at(o)))}else window.scrollBy({top:e*window.innerHeight/2,behavior:"smooth"})}const Gn={SCROLL_UP(){zn(-1)},SCROLL_DOWN(){zn(1)},NEXT_CHAPTER(){Fn("#next")},PREVIOUS_CHAPTER(){Fn("#prev")},ENLARGE(){Fn("#enlarge")},REDUCE(){Fn("#reduce")},RESTORE(){Fn("#restore")},FIT_WIDTH(){Fn("#fitWidth")},FIT_HEIGHT(){Fn("#fitHeight")},SETTINGS(){Fn("#settings")},VIEW_MODE_WEBCOMIC(){Fn("#webComic")},VIEW_MODE_VERTICAL(){Fn("#verticalMode")},VIEW_MODE_LEFT(){Fn("#rtlMode")},VIEW_MODE_RIGHT(){Fn("#ltrMode")},SCROLL_START(){Fn("#AutoScroll")}};function Pn(){document.onkeydown=null,document.onkeyup=null,window.onkeydown=null,window.onkeyup=null,window.onload=null,document.body.onload=null,hotkeys.unbind(),Object.keys(ae().keybinds).forEach((e=>{hotkeys(ae().keybinds[e]?.join(",")??"",_.throttle((n=>{n.preventDefault(),n.stopImmediatePropagation(),n.stopPropagation(),Gn[e]()}),100))}))}async function Zn(e){return async function(e,n){return new Promise((t=>{U("Fetching page: ",e),fetch(e).then((async e=>e.text())).then((e=>{const a=(new DOMParser).parseFromString(e,n);t(a)})).catch((e=>{U("Failed to fetch page: ",e)}))}))}(e,"text/html")}const Hn={threshold:2e3,throttle:500,lazyAttribute:"data-src",targetAttribute:"src"};let Wn=[],Un=!1;function qn(e){const{element:n}=e,t=n.getBoundingClientRect(),a=(window.innerHeight||document.documentElement.clientHeight)+Hn.threshold;return t.top<=a||t.bottom<=a}async function jn(e){let n=e.element.getAttribute(Hn.lazyAttribute)??"";n&&(An(n)||On(n)||!e.fetchOptions||(n=await fetch(n,e.fetchOptions).then((e=>e.blob())).then((e=>blobUtil.blobToDataURL(e)))),e.element.setAttribute(Hn.targetAttribute,n)),e.callback(e.element)?.catch(U)}const Qn=_.throttle((function(){const e=Wn.filter(qn);Wn=Wn.filter((e=>!qn(e))),e.forEach(jn)}),Hn.throttle);function Yn(e,n,t){Un||(window.addEventListener("scroll",Qn,{passive:!0}),window.addEventListener("touchmove",Qn,{passive:!0}),window.addEventListener("resize",Qn,{passive:!0}),Un=!0),Wn.push({element:e,callback:n,fetchOptions:t}),Qn()}function Xn(e=ae().zoomMode,n=".PageContent img"){[...document.querySelectorAll(n)].forEach((n=>{if(n.removeAttribute("width"),n.removeAttribute("height"),n.removeAttribute("style"),"width"===e)n.style.width=`${window.innerWidth}px`;else if("height"===e){const e=window.innerHeight+(ae().showThumbnails?-29:0);n.style.height=`${e}px`,n.style.minWidth="unset"}else"percent"===e?n.style.width=n.naturalWidth*(ae().defaultZoom/100)+"px":e>=0&&100!==e&&(n.style.width=n.naturalWidth*(e/100)+"px")}))}function Kn(e){let n=1;const t=e?.match(/cache=(\d+)$/);return t?.at(1)&&(n=parseInt(t[1],10)+1),n}function Jn(e){const n=e.getAttribute("src");n&&(e.removeAttribute("src"),On(n)||An(n)?e.setAttribute("src",n):e.setAttribute("src",function(e,n){const t=e.replace(/[?&]cache=\d+$/,""),a=t.includes("?")?"&":"?";return`${t+a}cache=${n}`}(n,Kn(n))))}function et(){const e=document.querySelectorAll(".PageContent .PageImg").length,n=document.querySelectorAll(".PageContent .PageImg.imgLoaded").length,t=Math.floor(n/e*100),a=document.querySelector("title");a&&(a.innerHTML=H`(${t}%)
      ${document.querySelector("#MangaTitle")?.textContent}`),document.querySelectorAll("#Counters i, #NavigationCounters i").forEach((e=>{e.textContent=n.toString()})),NProgress.configure({showSpinner:!1}).set(n/e),U(`Progress: ${t}%`),n===e&&(U("Images Loading Complete"),ae().downloadZip&&document.getElementById("download")?.dispatchEvent(new Event("click")),document.getElementById("download")?.classList.remove("disabled"))}const nt=(e=".PageContent img")=>{const n=document.querySelector("#ZoomVal")?.textContent?.trim();n?.match(/^\d+%$/)?Xn(parseInt(n,10),e):Xn(n,e)};function tt(e){e.images.forEach((e=>{e.img.classList.add("imgLoaded"),e.img.classList.remove("imgBroken");const n=e.img.id.replace("PageImg","ThumbnailImg"),t=document.getElementById(n);t&&t.setAttribute("src",e.img.getAttribute("src")),nt(`#${e.img.id}`),et()}))}function at(e){e.images.forEach((e=>{e.img.classList.add("imgBroken");const n=e.img.getAttribute("src");n&&Kn(n)<=ae().maxReload&&setTimeout((()=>{Jn(e.img);const n=imagesLoaded(e.img.parentElement);n.on("done",tt),n.on("fail",at)}),2e3)}))}function ot(e){if(e){let n=e.trim();return n.startsWith("//")&&(n=`https:${n}`),n}return""}function it(e,n,t,a){const o=a-e.begin;let i=ot(t);const r=document.querySelector(`#PageImg${n}`);r&&(!ae().lazyLoadImages||o<=ae().lazyStart?setTimeout((async()=>{An(i)||On(i)||!e.fetchOptions||(i=await fetch(i,e.fetchOptions).then((e=>e.blob())).then((e=>blobUtil.blobToDataURL(e))));const t=imagesLoaded(r.parentElement);t.on("done",tt),t.on("fail",at),r.setAttribute("src",i),U("Loaded Image:",n,"Source:",i)}),(e.timer??ae().throttlePageLoad)*o):(r.setAttribute("data-src",ot(i)),Yn(r,(()=>{const e=imagesLoaded(r.parentElement);e.on("done",tt),e.on("fail",at),U("Lazy Image: ",n," Source: ",r.getAttribute("src"))}),e.fetchOptions)),e.pages===a&&wn())}function rt(e,n,t,a){return async()=>{const o=await async function(e,n,t){return Zn(e).then((e=>e.querySelector(n)?.getAttribute(t)))}(t,e.img,e.lazyAttr??"src"),i=document.querySelector(`#PageImg${n}`);if(o&&i){i.style.width="auto";const e=imagesLoaded(i.parentElement);e.on("done",tt),e.on("fail",at),i.setAttribute("src",o),U(`${a&&"Lazy "}Page: `,n," Source: ",i.getAttribute("src"))}}}function lt(e,n){an(n.pages,e).forEach(((e,t)=>{(async function(e,n,t,a){const o=a-e.begin,i=document.querySelector(`#PageImg${n}`);i&&(!ae().lazyLoadImages||o<=ae().lazyStart?setTimeout((()=>{rt(e,n,t,!1)().catch(U)}),(e.timer??ae().throttlePageLoad)*o):(i.setAttribute("data-src","data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),Yn(i,rt(e,n,t,!0))),e.pages===a&&wn())})(n,e,n.listPages[e-1],t).catch(U)}))}function st(e,n){an(n.pages,e).forEach(((e,t)=>{it(n,e,n.listImages[e-1],t)}))}function ct(e,n=1){ae().lazyLoadImages=e.lazy??ae().lazyLoadImages,U("Loading Images"),U(`Intervals: ${e.timer??ae().throttlePageLoad??"Default(1000)"}`),U(`Lazy: ${ae().lazyLoadImages}, Starting from: ${ae().lazyStart}`),!function(e){return"listImages"in e&&!a(e.listImages)}(e)?!function(e){return"listPages"in e&&!a(e.listPages)}(e)?!function(e){return"bruteForce"in e&&!a(e.bruteForce)}(e)?U("No Loading Method Found"):(U("Method: Brute Force"),e.bruteForce({begin:n,addImg:it,loadImages(t){st(n,{...e,listImages:t})},loadPages(t,a,o){lt(n,{...e,listPages:t,img:a,lazyAttr:o})},wait:ae().throttlePageLoad})):(U("Method: Pages:",e.listPages),lt(n,e)):(U("Method: Images:",e.listImages),st(n,e))}function dt(e){const n=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg");Jn(n)}function mt(e){const n=e.currentTarget.parentElement?.parentElement;n.classList.toggle("hide")}function ut(e){const n=e.currentTarget.value;Xn(),mn(document.querySelector(`#Page${n}`))}function gt(e){Xn(),mn(document.querySelector(`#Page${e.currentTarget.querySelector(".ThumbnailIndex")?.textContent}`))}function pt(){re();const e=document.getElementById("MangaOnlineViewer");e?.removeAttribute("locale"),e?.dispatchEvent(new Event("locale"))}function ht(e){const n=e.currentTarget.value;ie({locale:n});const t=document.getElementById("MangaOnlineViewer");t?.setAttribute("locale",n),t?.dispatchEvent(new Event("locale"))}function wt(e){ie({loadMode:e.currentTarget.value})}function bt(e){document.querySelector("#Chapter")?.classList.toggle("fitWidthIfOversize"),ie({fitWidthIfOversize:e.currentTarget.checked})}function ft(e){document.querySelector("#Chapter")?.classList.toggle("separator"),ie({verticalSeparator:e.currentTarget.checked})}function vt(e){document.querySelector("#Navigation")?.classList.toggle("disabled"),ie({showThumbnails:e.currentTarget.checked}),Xn()}function yt(e){document.querySelector("#CommentsButton")?.classList.toggle("disabled"),ie({enableComments:e.currentTarget.checked}),Xn()}function Et(e){ie({downloadZip:e.currentTarget.checked}),e.currentTarget.checked&&Swal.fire({title:oe("ATTENTION"),text:oe("AUTO_DOWNLOAD"),timer:1e4,icon:"info"})}function kt(e){ie({lazyLoadImages:e.currentTarget.checked});const n=document.querySelector(".lazyStart");ae().lazyLoadImages?n?.classList.add("show"):n?.classList.remove("show"),e.currentTarget.checked&&Swal.fire({title:oe("WARNING"),html:oe("LAZY_LOAD"),icon:"warning"})}function xt(e){const n=e.currentTarget.value;ie({lazyStart:parseInt(n,10)})}function Mt(e){const n=parseInt(e.currentTarget.value,10);ie({throttlePageLoad:n}),n<100&&Swal.fire({title:oe("SPEED_WARNING"),html:oe("SPEED_WARNING_MESSAGE"),icon:"warning"})}function St(e){const n=e.currentTarget.value;ie({zoomStep:parseInt(n,10)})}function Ot(e){const n=e.currentTarget.value;_e("MinZoom",`#MangaOnlineViewer .PageContent .PageImg {min-width: ${n}vw;}`),ie({minZoom:parseInt(n,10)})}function At(e){document.querySelector("#MangaOnlineViewer")?.classList.toggle("hideControls"),ie({hidePageControls:e.currentTarget.checked})}function Ct(e){const n=document.querySelector("#Header"),t=document.querySelector("#menu");n?.classList.remove("scroll","click","hover","fixed","simple","visible"),t?.classList.remove("scroll","click","hover","fixed","simple","hide"),n?.classList.add(e),t?.classList.add(e)}function It(e){const n=e.currentTarget.value;Ct(n),ie({header:n})}function Lt(e){const{value:n}=e.currentTarget;ie({scrollHeight:parseInt(n,10)})}function Tt(){const e=document.querySelector("#Header");e?.classList.contains("click")&&e?.classList.toggle("visible")}function _t(e){const n=document.querySelector("#Header");n?.classList.contains("hover")&&(!function(e,n,t){return e.clientX>=0&&e.clientX<=n&&e.clientY>=0&&e.clientY<=t}(e,n.clientWidth,n.clientHeight)?(document.querySelector("#menu")?.classList.remove("hide"),n?.classList.remove("visible")):(document.querySelector("#menu")?.classList.add("hide"),n?.classList.add("visible")))}function Rt(){document.querySelector("#SettingsPanel")?.classList.add("visible"),document.querySelector("#Navigation")?.classList.add("visible"),document.querySelector("#Header")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function Dt(){document.querySelector("#SettingsPanel")?.classList.remove("visible"),document.querySelector("#Navigation")?.classList.remove("visible"),document.querySelector("#Header")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function Bt(){document.querySelector("#KeybindingsList").innerHTML=en().join("\n"),document.querySelector("#SaveKeybindings")?.classList.add("hidden"),document.querySelector("#EditKeybindings")?.classList.remove("hidden"),document.querySelector("#KeybindingsPanel")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function Nt(){document.querySelector("#SaveKeybindings")?.classList.add("hidden"),document.querySelector("#EditKeybindings")?.classList.remove("hidden"),document.querySelector("#KeybindingsPanel")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function Vt(){const e=ae().keybinds;Object.keys(ae().keybinds).forEach((n=>{const t=document.querySelector(`#${n}`)?.value.split(",")?.map((e=>e.trim()));e[n]=a(t)?void 0:t})),ie({keybinds:e}),document.querySelector("#KeybindingsList").innerHTML=en().join("\n"),document.querySelector("#SaveKeybindings")?.classList.add("hidden"),document.querySelector("#EditKeybindings")?.classList.remove("hidden"),Pn()}function $t(){document.querySelector("#KeybindingsList").innerHTML=nn().join("\n"),document.querySelector("#SaveKeybindings")?.classList.remove("hidden"),document.querySelector("#EditKeybindings")?.classList.add("hidden")}function Ft(e){const n=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg");Xn(n.width/n.naturalWidth*(100+ae().zoomStep),`#${n.getAttribute("id")}`)}function zt(e){const n=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg");Xn(n.width/n.naturalWidth*(100-ae().zoomStep),`#${n.getAttribute("id")}`)}function Gt(){document.querySelector(".PageContent .PageImg")?.removeAttribute("width")}function Pt(e){const n=e.currentTarget.parentElement?.parentElement,t=n?.querySelector(".PageImg");Xn("width",`#${t.getAttribute("id")}`),n?.classList.toggle("DoublePage")}function Zt(e){const n=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg");Xn("height",`#${n.getAttribute("id")}`)}function Ht(){const e="dark"===ae().colorScheme;ie({colorScheme:e?"light":"dark"});const n=document.getElementById("MangaOnlineViewer");n?.classList.remove(e?"dark":"light"),n?.classList.add(ae().colorScheme)}function Wt(e){const n=e.currentTarget;[...document.querySelectorAll(".ThemeRadio")].forEach((e=>{e.classList.remove("selected")})),n.classList.add("selected"),document.getElementById("MangaOnlineViewer")?.setAttribute("data-theme",n.title),ie({theme:n.title});const t=document.querySelector("#Hue"),a=document.querySelector("#Shade");n.title.startsWith("custom")?(t?.classList.add("show"),a?.classList.remove("show")):(t?.classList.remove("show"),a?.classList.add("show"))}function Ut(e){const n=e.currentTarget.value;ie({customTheme:n}),_e("custom",Ne(n))}function qt(e){ie({themeShade:parseInt(e.currentTarget.value,10)}),Ve().forEach((e=>{_e(e.name,Be(e))})),_e("custom",Ne(ae().customTheme))}function jt(e){return()=>{ae().zoomMode="number"!=typeof e?e:"percent",Ct("height"===e?"click":ae().header);const n=document.querySelector("#ZoomVal");Number.isInteger(e)?(n.textContent=`${e}%`,document.querySelector("#Zoom").value=e.toString()):n.textContent=e,Xn(e)}}function Qt(e=1){return()=>{const n=document.querySelector("#Zoom"),t=parseInt(n.value,10)+e*ae().zoomStep;n.value=t.toString(),n?.dispatchEvent(new Event("input",{bubbles:!0}))}}function Yt(e){const n=e.currentTarget.value;ie({zoomMode:n}),jt(n)();const t=document.querySelector(".DefaultZoom");"percent"===ae().zoomMode?t?.classList.add("show"):t?.classList.remove("show")}function Xt(e){const n=parseInt(e.currentTarget.value,10);ie({defaultZoom:n}),jt(n)()}function Kt(e){const n=parseInt(e.currentTarget.value,10);jt(n)(),document.querySelector("#ZoomVal").textContent=`${n}%`}function Jt(e){const n=document.querySelector("#Chapter");document.querySelector("#Header")?.classList.remove("visible"),document.querySelector("#menu")?.classList.remove("hide"),jt("height")(),mn(n),n?.addEventListener("wheel","FluidLTR"===e?gn:pn)}function ea(e){return()=>{const n=document.querySelector("#Chapter");n?.classList.remove("Vertical","WebComic","FluidLTR","FluidRTL"),n?.classList.add(e),n?.removeEventListener("wheel",gn),n?.removeEventListener("wheel",pn),"FluidLTR"===e||"FluidRTL"===e?Jt(e):(document.querySelector("#Header").className=ae().header,document.querySelector("#menu").className=ae().header,jt(100)())}}function na(e){const n=e.currentTarget.value;ea(n)(),ie({viewMode:n})}let ta;function aa(){const e=document.querySelector("#Chapter");e?.classList.contains("FluidLTR")||e?.classList.contains("FluidRTL")?e?.scrollBy({top:0,left:ae().scrollHeight*(e?.classList.contains("FluidRTL")?-1:1),behavior:"smooth"}):window.scrollBy({top:ae().scrollHeight,left:0,behavior:"smooth"}),document.querySelector("#Header")?.classList.contains("headroom-end")&&(clearInterval(ta),ta=void 0,document.querySelector("#ScrollControl")?.classList.remove("running"),U("Finished auto scroll"))}function oa(){const e=document.querySelector("#AutoScroll");ta?(clearInterval(ta),ta=void 0,e?.classList.remove("running"),U("Stopped auto scroll")):(aa(),ta=setInterval(aa,1e3/60),e?.classList.add("running"),U("Start auto scroll"))}let ia=!1;const ra=_.debounce((()=>{oa(),ia=!1}),500);function la(){!ia&&ta&&(oa(),ia=!0),ia&&!ta&&ra()}let sa,ca=!1;function da(){ca||(!function(e=0){let n=0;const t=e=>{const n=document.querySelector("#Header");n.classList.remove("headroom-end","headroom-hide","headroom-show","headroom-top"),e&&n.classList.add(`headroom-${e}`)};window.addEventListener("scroll",_.debounce((function(){const{scrollY:a}=window;e&&"height"!==ae().zoomMode&&a+window.innerHeight+e>document.body.scrollHeight?t("end"):t(a>n&&a>50?"hide":a<n&&a>50?"show":a<=100?"top":""),n=a}),50))}(100),Pn(),document.querySelectorAll(".Reload")?.forEach(un("click",dt)),document.querySelectorAll(".Hide")?.forEach(un("click",mt)),document.querySelectorAll(".ZoomIn")?.forEach(un("click",Ft)),document.querySelectorAll(".ZoomOut")?.forEach(un("click",zt)),document.querySelectorAll(".ZoomRestore")?.forEach(un("click",Gt)),document.querySelectorAll(".ZoomWidth")?.forEach(un("click",Pt)),document.querySelectorAll(".ZoomHeight")?.forEach(un("click",Zt)),window.addEventListener("resize",(()=>{const e=document.querySelector("#MangaOnlineViewer");e?.classList.remove("mobile","tablet","desktop"),e?.classList.add(X())})),ca=!0),document.querySelector("#bookmarks")?.addEventListener("click",fn),document.querySelectorAll(".closeButton")?.forEach(un("click",hn)),document.querySelector("#Overlay")?.addEventListener("click",hn),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(un("click",bn)),document.querySelectorAll(".Bookmark")?.forEach(un("click",vn)),document.querySelector(".AddBookmark")?.addEventListener("click",vn),document.querySelector("#download")?.addEventListener("click",Rn),document.querySelector("#pageControls")?.addEventListener("click",Dn),document.querySelector("#next")?.addEventListener("click",Bn),document.querySelector("#prev")?.addEventListener("click",Bn),document.querySelector("#series")?.addEventListener("click",Bn),document.querySelector("#CommentsButton")?.addEventListener("click",Nn),document.querySelector("#CommentsColorScheme")?.addEventListener("click",$n),document.querySelectorAll(".closeButton")?.forEach(un("click",Vn)),document.querySelector("#Overlay")?.addEventListener("click",Vn),document.querySelector("#gotoPage")?.addEventListener("change",ut),document.querySelectorAll(".Thumbnail")?.forEach(un("click",gt)),document.querySelector("#Thumbnails")?.addEventListener("wheel",gn),document.querySelector("#ResetSettings")?.addEventListener("click",pt),document.querySelector("#locale")?.addEventListener("change",ht),document.querySelector("#fitIfOversize")?.addEventListener("change",bt),document.querySelector("#verticalSeparator")?.addEventListener("change",ft),document.querySelector("#loadMode")?.addEventListener("change",wt),document.querySelector("#showThumbnails")?.addEventListener("change",vt),document.querySelector("#enableComments")?.addEventListener("change",yt),document.querySelector("#downloadZip")?.addEventListener("change",Et),document.querySelector("#lazyLoadImages")?.addEventListener("change",kt),document.querySelector("#lazyStart")?.addEventListener("change",xt),document.querySelector("#PagesPerSecond")?.addEventListener("change",Mt),document.querySelector("#zoomStep")?.addEventListener("change",St),document.querySelector("#minZoom")?.addEventListener("input",Ot),document.querySelector("#hidePageControls")?.addEventListener("change",At),document.querySelector("#headerType")?.addEventListener("change",It),document.querySelector("#scrollHeight")?.addEventListener("change",Lt),document.querySelector("#menu")?.addEventListener("click",Tt),document.addEventListener("mousemove",_.throttle(_t,300)),document.querySelector("#settings")?.addEventListener("click",function(e,n){let t=!0;return()=>{(t?e:n)(),t=!t}}(Rt,Dt)),document.querySelectorAll(".closeButton")?.forEach(un("click",Dt)),document.querySelector("#Overlay")?.addEventListener("click",Dt),document.querySelector("#keybindings")?.addEventListener("click",Bt),document.querySelectorAll(".closeButton")?.forEach(un("click",Nt)),document.querySelector("#Overlay")?.addEventListener("click",Nt),document.querySelector("#EditKeybindings")?.addEventListener("click",$t),document.querySelector("#SaveKeybindings")?.addEventListener("click",Vt),document.querySelector("#ColorScheme")?.addEventListener("click",Ht),document.querySelectorAll(".ThemeRadio").forEach(un("click",Wt)),document.querySelector("#CustomThemeHue")?.addEventListener("change",Ut),document.querySelector("#ThemeShade")?.addEventListener("input",qt),document.querySelector("#viewMode")?.addEventListener("change",na),document.querySelector("#webComic")?.addEventListener("click",ea("WebComic")),document.querySelector("#ltrMode")?.addEventListener("click",ea("FluidLTR")),document.querySelector("#rtlMode")?.addEventListener("click",ea("FluidRTL")),document.querySelector("#verticalMode")?.addEventListener("click",ea("Vertical")),"FluidLTR"!==ae().viewMode&&"FluidRTL"!==ae().viewMode||Jt(ae().viewMode),document.querySelector("#DefaultZoomMode")?.addEventListener("change",Yt),document.querySelector("#DefaultZoom")?.addEventListener("input",Xt),document.querySelector("#Zoom")?.addEventListener("input",Kt),document.querySelector("#enlarge")?.addEventListener("click",Qt()),document.querySelector("#reduce")?.addEventListener("click",Qt(-1)),document.querySelector("#restore")?.addEventListener("click",jt(100)),document.querySelector("#fitWidth")?.addEventListener("click",jt("width")),document.querySelector("#fitHeight")?.addEventListener("click",jt("height")),window.addEventListener("wheel",_.throttle(la,500)),document.querySelector("#AutoScroll")?.addEventListener("click",oa)}function ma(){ea(ae().viewMode)();const e={"#Header":sn(sa),"#CommentsPanel":dn(),"#SettingsPanel":Je(),"#KeybindingsPanel":tn(),"#Bookmarks":rn()};document.querySelector("#ScrollControl")?.classList.contains("running")&&oa();const n=document.querySelector("#MangaOnlineViewer");n&&(n.className=`${ae().colorScheme} \n        ${ae().hidePageControls?"hideControls":""}\n        ${le()?"bookmarked":""}\n        ${X()}`,n.setAttribute("data-theme",ae().theme));const t=document.querySelector("#Chapter");t&&(t.className=`${ae().fitWidthIfOversize?"fitWidthIfOversize":""}  ${ae().viewMode}`),Object.entries(e).forEach((([e,n])=>{const t=document.querySelector(e);t&&(t.outerHTML=n)})),document.querySelector("#Overlay")?.dispatchEvent(new Event("click")),da()}const ua=e=>(sa=e,H`
      <div
        id="MangaOnlineViewer"
        class="${ae().colorScheme} 
        ${ae().hidePageControls?"hideControls":""}
        ${le()?"bookmarked":""}
        ${X()}"
        data-theme="${ae().theme}"
      >
        <div id="menu" class="${ae().header}">${'<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-menu-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M4 6l16 0" />\n  <path d="M4 12l16 0" />\n  <path d="M4 18l16 0" />\n</svg>\n\n\n'}</div>
        ${sn(e)} ${cn(e)} ${(e=>H`
    <nav
      id="Navigation"
      class="panel ${ae().showThumbnails?"":"disabled"}"
    >
  ...
  `)(e)}
    ...
    `);function ga(e){document.head.innerHTML=function(e){return H`
      <title>${e.title}</title>
      <meta charset="UTF-8" />
      ${Re("externals",Fe)}
      ${Re("reader",Le)} ${$e}
      ${Re("MinZoom",`#MangaOnlineViewer .PageContent .PageImg {min-width: ${ae().minZoom}vw;}`)}
    `}(e),document.body.innerHTML=ua(e),da(),ct(e),document.querySelector("#MangaOnlineViewer")?.addEventListener("locale",ma),e.comments&&document.querySelector("#CommentsArea")?.append(e.comments)}const pa=(...e)=>e.forEach((e=>{e.getAttributeNames().forEach((n=>{e.removeAttribute(n)}))}));async function ha(){if(!ae().enableComments)return null;const e=document.querySelector("#disqus_thread, #fb-comments");if(e){U("Waiting to Comments to load",e),window.scrollTo(0,document.body.scrollHeight);await async function(e,n){return Promise.race([r(e),i(n,!1)])}((()=>{const n=e?.querySelector("iframe:not(#indicator-north, #indicator-south)");return void 0!==n&&!t(n?.src)&&(void 0!==n?.contentDocument||void 0!==n?.contentWindow?.document)}),5e3)||U("Timeout Comments",e)}return window.scrollTo(0,0),e}async function wa(e){void 0!==e.before&&await e.before(e.begin),ae().enableComments&&!e.comments&&(e.comments=await ha()),setTimeout((()=>{try{pa(document.documentElement,document.head,document.body),window.scrollTo(0,0),ga(e)}catch(e){U(e)}}),50)}const ba="#StartMOV {\n    all: revert;\n    backface-visibility: hidden;\n    font-size: 2rem;\n    color: #fff;\n    cursor: pointer;\n    margin: 0 auto;\n    padding: 0.5rem 1rem;\n    text-align: center;\n    border: none;\n    border-radius: 10px;\n    min-height: 50px;\n    width: 80%;\n    position: fixed;\n    right: 0;\n    left: 0;\n    bottom: 0;\n    z-index: 105000;\n    transition: all 0.4s ease-in-out;\n    background-size: 300% 100%;\n    background-image: linear-gradient(to right, #667eea, #764ba2, #6b8dd6, #8e37d7);\n    box-shadow: 0 4px 15px 0 rgba(116, 79, 168, 0.75);\n}\n\n#StartMOV:hover {\n    background-position: 100% 0;\n    transition: all 0.4s ease-in-out;\n}\n\n#StartMOV:focus {\n    outline: none;\n}\n";async function fa(e){if(void 0!==e.waitAttr){U(`Waiting for Attribute ${e.waitAttr[1]} of ${e.waitAttr[0]}`);const n=await o(e.waitAttr[0],e.waitAttr[1]);U(`Found Attribute ${e.waitAttr[1]} of ${e.waitAttr[0]} = ${n}`)}}async function va(e){if(void 0!==e.waitEle){U(`Waiting for Element ${e.waitEle}`);const n=await function(e,n=document.body){return new Promise((t=>{if(document.querySelector(e))return void t(document.querySelector(e));const a=new MutationObserver((()=>{document.querySelector(e)&&(t(document.querySelector(e)),a.disconnect())}));a.observe(n,{childList:!0,subtree:!0,attributes:!0})}))}(e.waitEle);U(`Found Element ${e.waitEle} = `,n)}}async function ya(e){if(void 0!==e.waitVar){U(`Waiting for Variable ${e.waitVar}`);const n=await function(e,n=document.body){return new Promise((t=>{if(!a(unsafeWindow[e]))return void t(unsafeWindow[e]);const o=new MutationObserver((()=>{a(unsafeWindow[e])||(t(unsafeWindow[e]),o.disconnect())}));o.observe(n,{childList:!0,subtree:!0,attributes:!0})}))}(e.waitVar);U(`Found Variable ${e.waitVar} = ${n}`)}}async function Ea(e){if(void 0!==e.waitFunc){U(`Waiting to pass Function check ${e.waitFunc}`);const n=await function(e,n=document.body){return new Promise((t=>{const a=e();if(a)return void t(a);const o=new MutationObserver((()=>{const n=e();n&&(t(n),o.disconnect())}));o.observe(n,{childList:!0,subtree:!0,attributes:!0})}))}(e.waitFunc);U(`Found Function check ${e.waitFunc} = ${n}`)}}async function ka(e){void 0!==e.waitTime&&(U(`Waiting to for ${e.waitTime} milliseconds`),await new Promise((n=>{setTimeout(n,e.waitTime)})),U("Continuing"))}const xa={name:"Local Files",url:/(file:\/\/\/.+(index)?.html)/,homepage:"/index.html?raw=1",language:["Raw"],category:"manga",run(){const e=parseInt(/\d+/.exec(window.location.search)?.toString()??"5",10),n=document.createElement("div");return n.innerHTML=Array(100).fill("Testing Comment<br/>").join(""),{title:"Placeholder Manga Loaded",series:"?reload",pages:e,begin:1,prev:"?pages=50",next:"?pages=1",listImages:[he(1970,1400,"#2D1657"),he(985,1400,"#152C55"),he(985,1400,"#7A1420"),he(985,1400,"#0F5B30"),he(1970,1400,"#806D15"),...Array(e).fill(0).map(ve)],comments:n}}},Ma=["image/apng","image/bmp","image/gif","image/jpeg","image/pjpeg","image/png","image/svg+xml","image/tiff","image/webp","image/x-icon"],Sa=/.(png|jpg|jpeg|gif|bmp|webp)$/i,Oa=(e,n)=>e.localeCompare(n,navigator.languages[0]||navigator.language,{numeric:!0,ignorePunctuation:!0});function Aa(e){return Ma.includes(e.type)}const Ca=e=>{const n=new Uint8Array(e),t=new Blob([n.buffer]);return URL.createObjectURL(t)};function Ia(e,n){wa({title:e,series:"?reload",pages:n.length,begin:1,prev:"#",next:"#",lazy:!1,listImages:n}).then((()=>U("Page loaded")))}async function La(e){const n=await async function(e){const n=await JSZip.loadAsync(e),t=n.filter(((e,n)=>!n.dir&&Sa.test(n.name))).sort(((e,n)=>Oa(e.name,n.name)));return U("Files in zip:",n.files),Promise.all(t.map((e=>e.async("arraybuffer").then(Ca))))}(e);Ia("string"==typeof e?e:e.name,n)}function Ta(e){const n=e.target,t=Array.from(n.files).filter(Aa).sort(((e,n)=>Oa(e.webkitRelativePath||e.name,n.webkitRelativePath||n.name)));U("Local Files: ",t,t.map((e=>e.webkitRelativePath||e.name))),n.files?.[0]&&Ia(n.files[0].webkitRelativePath.split("/")[0]||"Local Images",t.map(URL.createObjectURL))}async function _a(e,n=1){const t=await e.run();U("LateStart");let a=n,o=t.pages;const i={title:oe("STARTING"),html:H`
        ${oe("CHOOSE_BEGINNING")}
      ...
      `,showCancelButton:!0,cancelButtonColor:"#d33",reverseButtons:!0,icon:"question",didOpen(){const e=document.querySelector("#pageBegin"),n=document.querySelector("#pageEnd"),i=rangeSlider(document.getElementById("pagesSlider"),{min:1,max:t.pages,value:[a,o],onInput(t,i){i&&([a,o]=t,e&&(e.value=a.toString()),n&&(n.value=o.toString()))}});const r=_.debounce((function(){if(""===e.value||""===n.value)return;const t=function(e,n,t){let a=e;return Number.isNaN(a)||a<t.min()?a=t.min():a>t.max()?a=t.max():a>n&&(a=n),a}(parseInt(e.value,10),o,i),r=function(e,n,t){let a=e;return Number.isNaN(a)||a>t.max()?a=t.max():a<t.min()?a=t.min():a<n&&(a=n),a}(parseInt(n.value,10),a,i);e.value=t.toString(),n.value=r.toString(),a=t,o=r,i.value([t,r])}),600);["change","mouseup","keyup","touchend"].forEach((t=>{e?.addEventListener(t,r),n?.addEventListener(t,r)}))}};Swal.fire(i).then((e=>{e.value?(U(`Choice: ${a} - ${o}`),t.begin=a,t.pages=o,wa(t).then((()=>U("Page loaded")))):U(e.dismiss)}))}function Ra(e,n){const t=document.createElement("button");t.innerText=oe("BUTTON_START"),t.id="StartMOV",t.onclick=()=>{_a(e,n).catch(U)},document.body.appendChild(t);const a=document.createElement("style");a.appendChild(document.createTextNode(ba+P)),document.head.appendChild(a),U("Start Button added to page",t)}async function Da(e){const n=await e.run();if(U(`Found Pages: ${n.pages}`),n.pages<=0)return;n.title||(n.title=document.querySelector("title")?.textContent?.trim()),n.begin=le()??n.begin??1;const t=document.createElement("style");switch(t.appendChild(document.createTextNode(Fe)),document.body.appendChild(t),unsafeWindow.MOV=(e,t)=>{void 0!==e&&(n.begin=e),void 0!==t&&(n.pages=t),wa(n).then((()=>U("Page loaded")))},e.start??ae()?.loadMode){case"never":Ra(e,n.begin);break;case"always":wa(n).then((()=>U("Page loaded")));break;default:!function(e,n){Swal.fire({title:oe("STARTING"),html:H`${n.begin>1?`${oe("RESUME")}${n.begin}.<br/>`:""}${oe("WAITING")}`,showCancelButton:!0,cancelButtonColor:"#d33",reverseButtons:!0,timer:3e3}).then((t=>{t.value||t.dismiss===Swal.DismissReason.timer?wa(n).then((()=>U("Page loaded"))):(Ra(e,n.begin),U(t.dismiss))}))}(e,n)}}(async function(e){if(U(`Starting ${q.script.name} ${q.script.version} on ${function(){let e;const n=/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i.exec(navigator.userAgent)??[];if(/trident/i.test(n[1]))return e=/\brv[ :]+(\d+)/g.exec(navigator.userAgent)??[],`IE ${e[1]??""}`;if("Chrome"===n[1]&&(e=/\b(OPR|Edge)\/(\d+)/.exec(navigator.userAgent),null!==e))return e.slice(1).join(" ").replace("OPR","Opera");const t=[n[1],n[2]];return e=/version\/(\d+)/i.exec(navigator.userAgent),null!==e&&t.splice(1,1,e[1]),t.join(" ")}()} with ${q.scriptHandler??"Greasemonkey"}`),xa.url.test(window.location.href)&&(document.querySelector("#MangaOnlineViewer, #LocalTest")&&(document.querySelector("#LocalTest")?.setAttribute("style","display:none"),document.querySelector("#file")?.addEventListener("change",(e=>{const n=e.target;n.files?.[0]&&La(n.files[0])})),document.querySelector("#folder")?.addEventListener("change",Ta),document.querySelector("#images")?.addEventListener("change",Ta),U("Waiting for zip/images upload")),1))return;U(e.length," Known Manga Sites:",e);const n=e.filter((e=>e.url.test(window.location.href)));if(U(n.length," Matches Possible:",n),n.length>0){const e=n[0];U(`Found site: ${e.name}`),await Promise.all([ka(e),va(e),fa(e),ya(e),Ea(e)]).then((async()=>Da(e).catch(U)))}else U("Sorry, didnt find any valid site")})(G).catch(U)}();