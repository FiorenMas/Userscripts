...
`,kn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-autofit-left" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Sn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-autofit-right" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,xn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-big-left" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M20 15h-8v3.586a1 1 0 0 1 -1.707 .707l-6.586 -6.586a1 1 0 0 1 0 -1.414l6.586 -6.586a1 1 0 0 1 1.707 .707v3.586h8a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1z" />
</svg>


`,Mn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-big-right" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,On=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-bookmarks" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,In=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-category" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M4 4h6v6h-6z" />
...
`,Cn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-device-floppy" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Ln=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Tn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye-off" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,_n=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-download" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Rn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-keyboard" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Bn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-list-numbers" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M11 6h9" />
  <path d="M11 12h9" />
  <path d="M12 18h8" />
...
`,Dn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-loader-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M12 3a9 9 0 1 0 9 9" />
</svg>


`,Nn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-menu-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M4 6l16 0" />
  <path d="M4 12l16 0" />
  <path d="M4 18l16 0" />
...
`,Vn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-message" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M8 9h8" />
  <path d="M8 13h6" />
...
`,$n=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-pencil" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Fn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-photo-off" width="24"
...
`,Pn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-refresh" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,zn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-settings" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Gn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-spacing-vertical" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Zn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M4 7l16 0" />
  <path d="M10 11l0 6" />
  <path d="M14 11l0 6" />
...
`,Hn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-zoom-cancel" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Wn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-zoom-in" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" />
  <path d="M7 10l6 0" />
  <path d="M10 7l0 6" />
...
`,Un=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-zoom-in-area" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M15 13v4" />
  <path d="M13 15h4" />
...
`,qn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-zoom-out" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" />
  <path d="M7 10l6 0" />
  <path d="M21 21l-6 -6" />
...
`,jn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-zoom-out-area" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M13 15h4" />
  <path d="M15 15m-5 0a5 5 0 1 0 10 0a5 5 0 1 0 -10 0" />
  <path d="M22 22l-3 -3" />
...
`,Qn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-zoom-pan" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Yn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-player-play" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M7 4v16l13 -8z" />
</svg>


`,Xn=`<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-player-pause" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
`,Kn=xe`
    :root,
    .dark {
      --theme-body-background: ${f.dark[600]};
      --theme-body-text-color: ${f.dark[50]};
      --theme-text-color: ${f.dark[50]};
      --theme-primary-color: ${f.dark[700]};
      --theme-primary-text-color: ${f.dark[50]};
      --theme-background-color: ${f.dark[600]};
      --theme-hightlight-color: ${f.dark[500]};
      --theme-border-color: ${f.dark[400]};
    }

    .light {
      --theme-body-background: ${f.gray[50]};
      --theme-body-text-color: ${f.gray[900]};
      --theme-text-color: ${f.gray[900]};
      --theme-primary-color: ${f.gray[300]};
      --theme-primary-text-color: ${f.gray[900]};
      --theme-background-color: ${f.gray[50]};
      --theme-hightlight-color: ${f.gray[500]};
      --theme-border-color: ${f.gray[100]};
    }
...
`}
  `;function Jn(e,t){const n=document.createElement("style");return n.id=e,n.appendChild(document.createTextNode(t)),n}function eo(e,t){document.querySelector(`#${e}`)||(document.head??document.querySelector("head")).appendChild(Jn(e,t))}function to(e){document.querySelectorAll(`style[id="${e}"]`).forEach(t=>{t.remove()})}function W(e,t){to(e),eo(e,t)}function B(e,t){return h`
    ...
    `}function Fe(e){return $e(e.name,e[a().themeShade],a().themeShade<500?e[900]:e[50])}function ae(e){return $e("custom",e,vn(e))}function no(e){return B(e.name,Fe(e))}function oo(e){W("custom",ae(e))}const Pe=()=>Object.values(f);function ao(){Pe().forEach(e=>{W(e.name,Fe(e))}),W("custom",ae(a().customTheme))}const io=Pe().map(no).join("")+B("custom",ae(a().customTheme)),ze=[`/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */
...
`);function ro(e){return h`
    ...
    `}const so=()=>G.map(e=>h`
        ...
        `).join(""),co=h` <div class="ControlLabel locale">
    ${i("LANGUAGE")}
    <select id="locale">
      ${so()}
    </select>
  ...
  `,po=h` <div class="ControlLabel DefaultZoomMode">
    ${i("DEFAULT_ZOOM_MODE")}
  ...
  `,Ge=()=>h`
    <div id="SettingsPanel" class="panel">
      ...
      ${co} ${mo} ${uo} ${go} ${po} ${ho} ${wo}
      ${bo} ${fo} ${Eo} ${vo} ${ko}
    </div>
  `,ie=()=>Object.keys(a().keybinds).map(e=>{const t=a().keybinds[e]?.length?a().keybinds[e]?.map(n=>h`<kbd class="dark">${n}</kbd>`).join(" / "):"";return h`<span>${i(e)}:</span> <span>${t}</span>`}),So=()=>Object.keys(a().keybinds).map(e=>h`<label for="${e}">${i(e)}:</label>
            <input
              type="text"
              class="KeybindInput"
              id="${e}"
...
`)}</div>
  ...
  `;function D(e,t=1){return Array(e).fill(0).map((n,o)=>o+1).filter(n=>n>=t)}const xo=e=>h`
  ...
  `,Mo=()=>he(a().bookmarks)?[i("LIST_EMPTY")]:a().bookmarks.map((e,t)=>h`
  ...
  `;function re(){const e=document.getElementById("BookmarksList");e&&(e.innerHTML=Mo().join(""))}const Oo=(e,t)=>D(e,t).map(n=>h` <option value="${n}">${n}</option>`),We=e=>h`
  ...
  `;function N(e){const t=document.querySelector("#Chapter");t?.classList.contains("FluidLTR")||t?.classList.contains("FluidRTL")?t?.scroll(e?.offsetLeft??0,e?.offsetTop??0):window?.scroll(e?.offsetLeft??0,e?.offsetTop??0)}function v(e,t){return n=>n.addEventListener(e,t)}function se(e){e.deltaY&&(e.currentTarget.scrollLeft+=e.deltaY+e.deltaX,e.preventDefault())}function qe(e){e.deltaY&&(e.currentTarget.scrollLeft-=e.deltaY+e.deltaX,e.preventDefault())}function je(){document.querySelector("#BookmarksPanel")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function le(e=window.location.href){x(R(e))||(s(`Bookmark Removed ${e}`),w({bookmarks:a().bookmarks.filter(t=>t.url!==e)}),e===window.location.href&&document.querySelector("#MangaOnlineViewer")?.classList.remove("bookmarked"))}function U(e){const t=e.currentTarget.value;s(`Bookmark Removed ${t}`),Swal.fire({title:i("BOOKMARK_REMOVED"),timer:1e4,icon:"error"}),le(t),re(),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(v("click",U))}function Ao(){re(),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(v("click",U)),document.querySelector("#BookmarksPanel")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function Qe(e){document.querySelector("#MangaOnlineViewer")?.classList.toggle("bookmarked");const t=[...document.querySelectorAll(".MangaPage")].map(l=>Math.abs(l.offsetTop-window.scrollY)),o=parseInt(e.currentTarget.parentElement?.querySelector(".PageIndex")?.textContent??"0",10)||t.indexOf(Math.min(...t))+1,r={name:document.querySelector("title")?.textContent?.trim().replace(/^\(\d+%\) */,"")??"",url:window.location.href,page:o,date:new Date().toISOString().slice(0,10)};R(r.url)?(w({bookmarks:a().bookmarks.filter(l=>l.url!==r.url)}),Swal.fire({title:i("BOOKMARK_REMOVED"),timer:1e4,icon:"error"})):(w({bookmarks:[...a().bookmarks,r]}),Swal.fire({title:i("BOOKMARK_SAVED"),html:i("BOOKMARK_SAVED").replace("##NUM##",o.toString()),icon:"success"})),re(),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(v("click",U))}function Lo(){document.querySelector("#bookmarks")?.addEventListener("click",Ao),document.querySelectorAll(".closeButton")?.forEach(v("click",je)),document.querySelector("#Overlay")?.addEventListener("click",je),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(v("click",U)),document.querySelectorAll(".Bookmark")?.forEach(v("click",Qe)),document.querySelector(".AddBookmark")?.addEventListener("click",Qe)}var q=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},j={exports:{}},To=j.exports,Ye;function _o(){return Ye||(Ye=1,function(e,t){(function(n,o){o()})(To,function(){function n(u,d){return typeof d>"u"?d={autoBom:!1}:typeof d!="object"&&(console.warn("Deprecated: Expected third argument to be a object"),d={autoBom:!d}),d.autoBom&&/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(u.type)?new Blob(["\uFEFF",u],{type:u.type}):u}function o(u,d,b){var p=new XMLHttpRequest;p.open("GET",u),p.responseType="blob",p.onload=function(){g(p.response,d,b)},p.onerror=function(){console.error("could not download file")},p.send()}function r(u){var d=new XMLHttpRequest;d.open("HEAD",u,!1);try{d.send()}catch{}return 200<=d.status&&299>=d.status}function l(u){try{u.dispatchEvent(new MouseEvent("click"))}catch{var d=document.createEvent("MouseEvents");d.initMouseEvent("click",!0,!0,window,0,0,0,80,20,!1,!1,!1,!1,0,null),u.dispatchEvent(d)}}var c=typeof window=="object"&&window.window===window?window:typeof self=="object"&&self.self===self?self:typeof q=="object"&&q.global===q?q:void 0,m=c.navigator&&/Macintosh/.test(navigator.userAgent)&&/AppleWebKit/.test(navigator.userAgent)&&!/Safari/.test(navigator.userAgent),g=c.saveAs||(typeof window!="object"||window!==c?function(){}:"download"in HTMLAnchorElement.prototype&&!m?function(u,d,b){var p=c.URL||c.webkitURL,E=document.createElement("a");d=d||u.name||"download",E.download=d,E.rel="noopener",typeof u=="string"?(E.href=u,E.origin===location.origin?l(E):r(E.href)?o(u,d,b):l(E,E.target="_blank")):(E.href=p.createObjectURL(u),setTimeout(function(){p.revokeObjectURL(E.href)},4e4),setTimeout(function(){l(E)},0))}:"msSaveOrOpenBlob"in navigator?function(u,d,b){if(d=d||u.name||"download",typeof u!="string")navigator.msSaveOrOpenBlob(n(u,b),d);else if(r(u))o(u,d,b);else{var p=document.createElement("a");p.href=u,p.target="_blank",setTimeout(function(){l(p)})}}:function(u,d,b,p){if(p=p||open("","_blank"),p&&(p.document.title=p.document.body.innerText="downloading..."),typeof u=="string")return o(u,d,b);var E=u.type==="application/octet-stream",C=/constructor/i.test(c.HTMLElement)||c.safari,xt=/CriOS\/[\d]+/.test(navigator.userAgent);if((xt||E&&C||m)&&typeof FileReader<"u"){var ge=new FileReader;ge.onloadend=function(){var F=ge.result;F=xt?F:F.replace(/^data:[^;]*;/,"data:attachment/file;"),p?p.location.href=F:location=F,p=null},ge.readAsDataURL(u)}else{var Mt=c.URL||c.webkitURL,pe=Mt.createObjectURL(u);p?p.location=pe:location.href=pe,p=null,setTimeout(function(){Mt.revokeObjectURL(pe)},4e4)}});c.saveAs=g.saveAs=g,e.exports=g})}(j)),j.exports}var Ro=_o();let ce;const Xe=(e,t,n,o)=>`${e}${(t+1).toString().padStart(Math.floor(Math.log10(n))+1,"0")}.${o.replace("jpeg","jpg")}`;async function Bo(e){return new Promise((t,n)=>{s(`Getting Image data: ${e}`),GM_xmlhttpRequest({method:"GET",url:e,headers:{referer:window.location.host,origin:window.location.host},responseType:"blob",onload(o){o.status!==200&&n(o),t(o)}})})}async function Do(e,t,n){const o=e.getAttribute("src")??e.getAttribute("data-src")??"";if(z(o))throw new Error("Image source unusable");return P(o)?Promise.resolve({name:Xe("Page-",t,n.length,Zt(o)),data:zt(o)??""}):new Promise(r=>{Bo(o).then(l=>{r({name:Xe("Page-",t,n.length,Gt(o)),data:l.response})}).catch(nn("Image not Available"))})}function No(e){s(`${e.name} Added to Zip from Base64 Image`),ce.file(e.name,e.data,{base64:!0,createFolders:!0,compression:"DEFLATE"})}async function Vo(){ce=new JSZip;const e=[...document.querySelectorAll(".PageImg")];Promise.all(e.map(Do)).then(t=>{t.forEach(No),s("Generating Zip"),ce.generateAsync({type:"blob"}).then(n=>{s("Download Ready");const o=`${document.querySelector("#MangaTitle")?.textContent?.trim()}.zip`;Ro.saveAs(n,o,{autoBom:!1}),document.getElementById("download")?.classList.remove("loading")}).catch(s)}).catch(t=>s("One or more images couldn't be Downloaded",t))}var V={},y={},Ke;function $o(){return Ke||(Ke=1,Object.defineProperty(y,"__esModule",{value:!0}),y.BLANK_URL=y.relativeFirstCharacters=y.whitespaceEscapeCharsRegex=y.urlSchemeRegex=y.ctrlCharactersRegex=y.htmlCtrlEntityRegex=y.htmlEntitiesRegex=y.invalidProtocolRegex=void 0,y.invalidProtocolRegex=/^([^\w]*)(javascript|data|vbscript)/im,y.htmlEntitiesRegex=/&#(\w+)(^\w|;)?/g,y.htmlCtrlEntityRegex=/&(newline|tab);/gi,y.ctrlCharactersRegex=/[\u0000-\u001F\u007F-\u009F\u2000-\u200D\uFEFF]/gim,y.urlSchemeRegex=/^.+(:|&colon;)/gim,y.whitespaceEscapeCharsRegex=/(\\|%5[cC])((%(6[eE]|72|74))|[nrt])/g,y.relativeFirstCharacters=[".","/"],y.BLANK_URL="about:blank"),y}var Je;function Fo(){if(Je)return V;Je=1,Object.defineProperty(V,"__esModule",{value:!0}),V.sanitizeUrl=void 0;var e=$o();function t(c){return e.relativeFirstCharacters.indexOf(c[0])>-1}function n(c){var m=c.replace(e.ctrlCharactersRegex,"");return m.replace(e.htmlEntitiesRegex,function(g,u){return String.fromCharCode(u)})}function o(c){return URL.canParse(c)}function r(c){try{return decodeURIComponent(c)}catch{return c}}function l(c){if(!c)return e.BLANK_URL;var m,g=r(c.trim());do g=n(g).replace(e.htmlCtrlEntityRegex,"").replace(e.ctrlCharactersRegex,"").replace(e.whitespaceEscapeCharsRegex,"").trim(),g=r(g),m=g.match(e.ctrlCharactersRegex)||g.match(e.htmlEntitiesRegex)||g.match(e.htmlCtrlEntityRegex)||g.match(e.whitespaceEscapeCharsRegex);while(m&&m.length>0);var u=g;if(!u)return e.BLANK_URL;if(t(u))return u;var d=u.trimStart(),b=d.match(e.urlSchemeRegex);if(!b)return u;var p=b[0].toLowerCase().trim();if(e.invalidProtocolRegex.test(p))return e.BLANK_URL;var E=d.replace(/\\/g,"/");if(p==="mailto:"||p.includes("://"))return E;if(p==="http:"||p==="https:"){if(!o(E))return e.BLANK_URL;var C=new URL(E);return C.protocol=C.protocol.toLowerCase(),C.hostname=C.hostname.toLowerCase(),C.toString()}return E}return V.sanitizeUrl=l,V}var Po=Fo();function zo(e){const t=e.currentTarget;t.classList.contains("loading")||(s("Downloading Chapter"),t.classList.add("loading"),Vo().catch(n=>s("Error downloading chapter",n)))}function Go(){document.querySelector("#MangaOnlineViewer")?.classList.toggle("hideControls")}function de(e){const t=e.target,n=t.getAttribute("value")??t.getAttribute("href");e.button!==1&&!e.ctrlKey&&(n&&n!=="#"?window.location.href=Po.sanitizeUrl(n):t.id==="series"&&window.history.back())}function Zo(){document.querySelector("#CommentsPanel")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function et(){document.querySelector("#CommentsPanel")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function Ho(){const e=document.querySelector("#CommentsArea");e?.classList.toggle("light"),e?.classList.toggle("dark")}function Wo(){document.querySelector("#download")?.addEventListener("click",zo),document.querySelector("#pageControls")?.addEventListener("click",Go),document.querySelector("#next")?.addEventListener("click",de),document.querySelector("#prev")?.addEventListener("click",de),document.querySelector("#series")?.addEventListener("click",de),document.querySelector("#CommentsButton")?.addEventListener("click",Zo),document.querySelector("#CommentsColorScheme")?.addEventListener("click",Ho),document.querySelectorAll(".closeButton")?.forEach(v("click",et)),document.querySelector("#Overlay")?.addEventListener("click",et)}function Uo(e=0){let t=0;const n=r=>{const l=document.querySelector("#Header");l.classList.remove("headroom-end","headroom-hide","headroom-show","headroom-top"),r&&l.classList.add(`headroom-${r}`)};function o(){const{scrollY:r}=window;e&&a().zoomMode!=="height"&&r+window.innerHeight+e>document.body.scrollHeight?n("end"):r>t&&r>50?n("hide"):r<t&&r>50?n("show"):r<=100?n("top"):n(""),t=r}window.addEventListener("scroll",_.debounce(o,50))}const k=e=>document.querySelector(e)?.dispatchEvent(new Event("click"));function tt(e){const t=document.querySelector("#Chapter");if(t?.classList.contains("FluidLTR")||t?.classList.contains("FluidRTL"))t.scrollBy({left:window.innerWidth/2*e*(t?.classList.contains("FluidRTL")?-1:1),behavior:"smooth"});else if(a().zoomMode==="height"){const n=[...document.querySelectorAll(".MangaPage")],o=n.map(m=>Math.abs(m.offsetTop-window.scrollY)),r=_.indexOf(o,_.min(o)),l=r+e,c=document.querySelector("#Header");l<0?N(c):l>=n.length?c.classList.add("headroom-end"):(s(`Current array page ${r},`,`Scrolling to page ${l}`),N(n.at(l)))}else window.scrollBy({top:e*window.innerHeight/2,behavior:"smooth"})}const qo={SCROLL_UP(){tt(-1)},SCROLL_DOWN(){tt(1)},NEXT_CHAPTER(){k("#next")},PREVIOUS_CHAPTER(){k("#prev")},ENLARGE(){k("#enlarge")},REDUCE(){k("#reduce")},RESTORE(){k("#restore")},FIT_WIDTH(){k("#fitWidth")},FIT_HEIGHT(){k("#fitHeight")},SETTINGS(){k("#settings")},VIEW_MODE_WEBCOMIC(){k("#webComic")},VIEW_MODE_VERTICAL(){k("#verticalMode")},VIEW_MODE_LEFT(){k("#rtlMode")},VIEW_MODE_RIGHT(){k("#ltrMode")},SCROLL_START(){k("#AutoScroll")}};function nt(){document.onkeydown=null,document.onkeyup=null,window.onkeydown=null,window.onkeyup=null,window.onload=null,document.body.onload=null,hotkeys.unbind(),Object.keys(a().keybinds).forEach(e=>{hotkeys(a().keybinds[e]?.join(",")??"",_.throttle(t=>{t.preventDefault(),t.stopImmediatePropagation(),t.stopPropagation(),qo[e]()},100))})}function jo(e){return"listImages"in e&&!x(e.listImages)}function Qo(e){return"listPages"in e&&!x(e.listPages)}function Yo(e){return"bruteForce"in e&&!x(e.bruteForce)}async function Xo(e,t){return new Promise(n=>{s("Fetching page: ",e),fetch(e).then(async o=>o.text()).then(o=>{const l=new DOMParser().parseFromString(o,t);n(l)}).catch(o=>{s("Failed to fetch page: ",o)})})}async function Ko(e){return Xo(e,"text/html")}async function Jo(e,t,n){return Ko(e).then(o=>o.querySelector(t)?.getAttribute(n))}const Q={threshold:2e3,throttle:500,lazyAttribute:"data-src",targetAttribute:"src"};let Y=[],ot=!1;function at(e){const{element:t}=e,n=t.getBoundingClientRect(),o=(window.innerHeight||document.documentElement.clientHeight)+Q.threshold;return n.top<=o||n.bottom<=o}async function ea(e){let t=e.element.getAttribute(Q.lazyAttribute)??"";t&&(!z(t)&&!P(t)&&e.fetchOptions&&(t=await fetch(t,e.fetchOptions).then(n=>n.blob()).then(n=>blobUtil.blobToDataURL(n))),e.element.setAttribute(Q.targetAttribute,t)),e.callback(e.element)?.catch(s)}function ta(){const e=Y.filter(at);Y=Y.filter(t=>!at(t)),e.forEach(ea)}const X=_.throttle(ta,Q.throttle);function it(e,t,n){ot||(window.addEventListener("scroll",X,{passive:!0}),window.addEventListener("touchmove",X,{passive:!0}),window.addEventListener("resize",X,{passive:!0}),ot=!0),Y.push({element:e,callback:t,fetchOptions:n}),X()}function S(e=a().zoomMode,t=".PageContent img"){[...document.querySelectorAll(t)].forEach(o=>{if(o.removeAttribute("width"),o.removeAttribute("height"),o.removeAttribute("style"),e==="width")o.style.width=`${window.innerWidth}px`;else if(e==="height"){const r=window.innerHeight+(a().showThumbnails?-29:0);o.style.height=`${r}px`,o.style.minWidth="unset"}else e==="percent"?o.style.width=`${o.naturalWidth*(a().defaultZoom/100)}px`:e>=0&&e!==100&&(o.style.width=`${o.naturalWidth*(e/100)}px`)})}function na(e,t){const n=e.replace(/[?&]forceReload=\d+$/,""),o=n.includes("?")?"&":"?";return`${n+o}forceReload=${t}`}function rt(e){let t=1;const n=e?.match(/forceReload=(\d+)$/);return n?.at(1)&&(t=parseInt(n[1],10)+1),t}function st(e){const t=e.getAttribute("src");t&&(e.removeAttribute("src"),P(t)||z(t)?e.setAttribute("src",t):e.setAttribute("src",na(t,rt(t))))}function oa(){s("Images Loading Complete"),a().downloadZip&&document.getElementById("download")?.dispatchEvent(new Event("click")),document.getElementById("download")?.classList.remove("disabled")}function aa(){const e=document.querySelectorAll(".PageContent .PageImg").length,t=document.querySelectorAll(".PageContent .PageImg.imgLoaded").length,n=Math.floor(t/e*100),o=document.querySelector("title");o&&(o.innerHTML=h`(${n}%) ${document.querySelector("#MangaTitle")?.textContent}`),document.querySelectorAll("#Counters i, #NavigationCounters i").forEach(r=>{r.textContent=t.toString()}),NProgress.configure({showSpinner:!1}).set(t/e),s(`Progress: ${n}%`),t===e&&oa()}const ia=(e=".PageContent img")=>{const t=document.querySelector("#ZoomVal")?.textContent?.trim();t?.match(/^\d+%$/)?S(parseInt(t,10),e):S(t,e)};function K(){return e=>{e.images.forEach(t=>{t.img.classList.add("imgLoaded"),t.img.classList.remove("imgBroken");const n=t.img.id.replace("PageImg","ThumbnailImg"),o=document.getElementById(n);o?.classList.remove("imgBroken"),o&&o.setAttribute("src",t.img.getAttribute("src")),ia(`#${t.img.id}`),aa()})}}function J(e){return t=>{t.images.forEach(n=>{n.img.classList.add("imgBroken");const o=n.img.id.replace("PageImg","ThumbnailImg");document.getElementById(o)?.classList.add("imgBroken");const l=n.img.getAttribute("src");l&&rt(l)<=a().maxReload&&setTimeout(async()=>{if(e.reload){const m=parseInt(`0${/\d+/.exec(n.img.id)}`,10),g=await e.reload(m);n.img.setAttribute("src",g)}else st(n.img);const c=imagesLoaded(n.img.parentElement);c.on("done",K()),c.on("fail",J(e))},2e3)})}}function lt(e){if(e){let t=e.trim();return t.startsWith("//")&&(t=`https:${t}`),t}return""}function ct(e,t,n,o){const r=o-e.begin;let l=lt(n);const c=document.querySelector(`#PageImg${t}`);c&&(!a().lazyLoadImages||r<=a().lazyStart?setTimeout(async()=>{!z(l)&&!P(l)&&e.fetchOptions&&(l=await fetch(l,e.fetchOptions).then(g=>g.blob()).then(g=>blobUtil.blobToDataURL(g)));const m=imagesLoaded(c.parentElement);m.on("done",K()),m.on("fail",J(e)),c.setAttribute("src",l),s("Loaded Image:",t,"Source:",l)},(e.timer??a().throttlePageLoad)*r):(c.setAttribute("data-src",lt(l)),it(c,()=>{const m=imagesLoaded(c.parentElement);m.on("done",K()),m.on("fail",J(e)),s("Lazy Image: ",t," Source: ",c.getAttribute("src"))},e.fetchOptions)),e.pages===o&&le())}function dt(e,t,n,o){return async()=>{const r=await Jo(n,e.img,e.lazyAttr??"src"),l=document.querySelector(`#PageImg${t}`);if(r&&l){l.style.width="auto";const c=imagesLoaded(l.parentElement);c.on("done",K()),c.on("fail",J(e)),l.setAttribute("src",r),s(`${o&&"Lazy "}Page: `,t," Source: ",l.getAttribute("src"))}}}async function ra(e,t,n,o){const r=o-e.begin,l=document.querySelector(`#PageImg${t}`);l&&(!a().lazyLoadImages||r<=a().lazyStart?setTimeout(()=>{dt(e,t,n,!1)().catch(s)},(e.timer??a().throttlePageLoad)*r):(l.setAttribute("data-src","data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),it(l,dt(e,t,n,!0))),e.pages===o&&le())}function mt(e,t){D(t.pages,e).forEach((n,o)=>{ra(t,n,t.listPages[n-1],o).catch(s)})}function ut(e,t){D(t.pages,e).forEach((n,o)=>{ct(t,n,t.listImages[n-1],o)})}function sa(e,t=1){a().lazyLoadImages=e.lazy??a().lazyLoadImages,s("Loading Images"),s(`Intervals: ${e.timer??a().throttlePageLoad??"Default(1000)"}`),s(`Lazy: ${a().lazyLoadImages}, Starting from: ${a().lazyStart}`),jo(e)?(s("Method: Images:",e.listImages),ut(t,e)):Qo(e)?(s("Method: Pages:",e.listPages),mt(t,e)):Yo(e)?(s("Method: Brute Force"),e.bruteForce({begin:t,addImg:ct,loadImages(n){ut(t,{...e,listImages:n})},loadPages(n,o,r){mt(t,{...e,listPages:n,img:o,lazyAttr:r})},wait:a().throttlePageLoad})):s("No Loading Method Found")}function la(e){const t=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg");st(t)}function ca(e){(e.currentTarget.parentElement?.parentElement).classList.toggle("hide")}function da(){document.querySelectorAll(".Reload")?.forEach(v("click",la)),document.querySelectorAll(".Hide")?.forEach(v("click",ca))}function ma(e){const t=e.currentTarget.value;S(),N(document.querySelector(`#Page${t}`))}function ua(e){S(),N(document.querySelector(`#Page${e.currentTarget.querySelector(".ThumbnailIndex")?.textContent}`))}function ga(){document.querySelector("#gotoPage")?.addEventListener("change",ma),document.querySelectorAll(".Thumbnail")?.forEach(v("click",ua)),document.querySelector("#Thumbnails")?.addEventListener("wheel",se)}function pa(){hn();const e=document.getElementById("MangaOnlineViewer");e?.removeAttribute("locale"),e?.dispatchEvent(new Event("hydrate"))}function ha(e){const t=e.currentTarget.value;w({locale:t});const n=document.getElementById("MangaOnlineViewer");n?.setAttribute("locale",t),n?.dispatchEvent(new Event("hydrate"))}function wa(e){const t=e.currentTarget.value;w({loadMode:t})}function ba(e){document.querySelector("#Chapter")?.classList.toggle("fitWidthIfOversize"),w({fitWidthIfOversize:e.currentTarget.checked})}function fa(e){document.querySelector("#Chapter")?.classList.toggle("separator"),w({verticalSeparator:e.currentTarget.checked})}function ya(e){document.querySelector("#Navigation")?.classList.toggle("disabled"),w({showThumbnails:e.currentTarget.checked}),S()}function va(e){document.querySelector("#CommentsButton")?.classList.toggle("disabled"),w({enableComments:e.currentTarget.checked}),S()}function Ea(e){w({downloadZip:e.currentTarget.checked}),e.currentTarget.checked&&Swal.fire({title:i("ATTENTION"),text:i("AUTO_DOWNLOAD"),timer:1e4,icon:"info"})}function ka(e){w({lazyLoadImages:e.currentTarget.checked});const t=document.querySelector(".lazyStart");a().lazyLoadImages?t?.classList.add("show"):t?.classList.remove("show"),e.currentTarget.checked&&Swal.fire({title:i("WARNING"),html:i("LAZY_LOAD"),icon:"warning"})}function Sa(e){const t=e.currentTarget.value;w({lazyStart:parseInt(t,10)})}function xa(e){const t=parseInt(e.currentTarget.value,10);w({throttlePageLoad:t}),t<100&&Swal.fire({title:i("SPEED_WARNING"),html:i("SPEED_WARNING_MESSAGE"),icon:"warning"})}function Ma(e){const t=e.currentTarget.value;w({zoomStep:parseInt(t,10)})}function Oa(e){const t=e.currentTarget.value;W("MinZoom",`#MangaOnlineViewer .PageContent .PageImg {min-width: ${t}vw;}`),w({minZoom:parseInt(t,10)})}function Ia(e){document.querySelector("#MangaOnlineViewer")?.classList.toggle("hideControls"),w({hidePageControls:e.currentTarget.checked})}function me(e){const t=document.querySelector("#Header");if(!t?.classList.contains(e)){const n=document.querySelector("#menu");t?.classList.remove("scroll","click","hover","fixed","simple","visible"),n?.classList.remove("scroll","click","hover","fixed","simple","hide"),t?.classList.add(e),n?.classList.add(e)}}function Ca(e){const t=e.currentTarget.value;me(t),w({header:t})}function Aa(e){const{value:t}=e.currentTarget;w({scrollHeight:parseInt(t,10)})}function La(){document.querySelector("#ResetSettings")?.addEventListener("click",pa),document.querySelector("#locale")?.addEventListener("change",ha),document.querySelector("#fitIfOversize")?.addEventListener("change",ba),document.querySelector("#verticalSeparator")?.addEventListener("change",fa),document.querySelector("#loadMode")?.addEventListener("change",wa),document.querySelector("#showThumbnails")?.addEventListener("change",ya),document.querySelector("#enableComments")?.addEventListener("change",va),document.querySelector("#downloadZip")?.addEventListener("change",Ea),document.querySelector("#lazyLoadImages")?.addEventListener("change",ka),document.querySelector("#lazyStart")?.addEventListener("change",Sa),document.querySelector("#PagesPerSecond")?.addEventListener("change",xa),document.querySelector("#zoomStep")?.addEventListener("change",Ma),document.querySelector("#minZoom")?.addEventListener("input",Oa),document.querySelector("#hidePageControls")?.addEventListener("change",Ia),document.querySelector("#headerType")?.addEventListener("change",Ca),document.querySelector("#scrollHeight")?.addEventListener("change",Aa)}function Ta(e,t,n,o){return()=>{document.querySelector(e)?.className.includes(t)?o():n()}}function _a(){const e=document.querySelector("#Header");e?.classList.contains("click")&&e?.classList.toggle("visible")}function Ra(e,t,n){return e.clientX>=0&&e.clientX<=t&&e.clientY>=0&&e.clientY<=n}function Ba(e){const t=document.querySelector("#Header");t?.classList.contains("hover")&&(Ra(e,t.clientWidth,t.clientHeight)?(document.querySelector("#menu")?.classList.add("hide"),t?.classList.add("visible")):(document.querySelector("#menu")?.classList.remove("hide"),t?.classList.remove("visible")))}function Da(){document.querySelector("#SettingsPanel")?.classList.add("visible"),document.querySelector("#Navigation")?.classList.add("visible"),document.querySelector("#Header")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function ue(){document.querySelector("#SettingsPanel")?.classList.remove("visible"),document.querySelector("#Navigation")?.classList.remove("visible"),document.querySelector("#Header")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function Na(){document.querySelector("#KeybindingsList").innerHTML=ie().join(`
`),document.querySelector("#SaveKeybindings")?.classList.add("hidden"),document.querySelector("#EditKeybindings")?.classList.remove("hidden"),document.querySelector("#KeybindingsPanel")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function gt(){document.querySelector("#SaveKeybindings")?.classList.add("hidden"),document.querySelector("#EditKeybindings")?.classList.remove("hidden"),document.querySelector("#KeybindingsPanel")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function Va(){const e=a().keybinds;Object.keys(a().keybinds).forEach(t=>{const n=document.querySelector(`#${t}`)?.value.split(",")?.map(o=>o.trim());e[t]=x(n)?void 0:n}),w({keybinds:e}),document.querySelector("#KeybindingsList").innerHTML=ie().join(`
`),document.querySelector("#SaveKeybindings")?.classList.add("hidden"),document.querySelector("#EditKeybindings")?.classList.remove("hidden"),nt()}function $a(){document.querySelector("#KeybindingsList").innerHTML=So().join(`
`),document.querySelector("#SaveKeybindings")?.classList.remove("hidden"),document.querySelector("#EditKeybindings")?.classList.add("hidden")}function Fa(){document.querySelector("#menu")?.addEventListener("click",_a),document.addEventListener("mousemove",_.throttle(Ba,300)),document.querySelector("#settings")?.addEventListener("click",Ta("#SettingsPanel","visible",Da,ue)),document.querySelectorAll(".closeButton")?.forEach(v("click",ue)),document.querySelector("#Overlay")?.addEventListener("click",ue),document.querySelector("#keybindings")?.addEventListener("click",Na),document.querySelectorAll(".closeButton")?.forEach(v("click",gt)),document.querySelector("#Overlay")?.addEventListener("click",gt),document.querySelector("#EditKeybindings")?.addEventListener("click",$a),document.querySelector("#SaveKeybindings")?.addEventListener("click",Va)}function Pa(e){const t=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg"),n=t.width/t.naturalWidth*(100+a().zoomStep);S(n,`#${t.getAttribute("id")}`)}function za(e){const t=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg"),n=t.width/t.naturalWidth*(100-a().zoomStep);S(n,`#${t.getAttribute("id")}`)}function Ga(){document.querySelector(".PageContent .PageImg")?.removeAttribute("width")}function Za(e){const t=e.currentTarget.parentElement?.parentElement,n=t?.querySelector(".PageImg");S("width",`#${n.getAttribute("id")}`),t?.classList.toggle("DoublePage")}function Ha(e){const t=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg");S("height",`#${t.getAttribute("id")}`)}function Wa(){document.querySelectorAll(".ZoomIn")?.forEach(v("click",Pa)),document.querySelectorAll(".ZoomOut")?.forEach(v("click",za)),document.querySelectorAll(".ZoomRestore")?.forEach(v("click",Ga)),document.querySelectorAll(".ZoomWidth")?.forEach(v("click",Za)),document.querySelectorAll(".ZoomHeight")?.forEach(v("click",Ha))}function Ua(){const e=a().colorScheme==="dark";w({colorScheme:e?"light":"dark"});const t=document.getElementById("MangaOnlineViewer");t?.classList.remove(e?"dark":"light"),t?.classList.add(a().colorScheme)}function qa(e){const t=e.currentTarget;[...document.querySelectorAll(".ThemeRadio")].forEach(r=>{r.classList.remove("selected")}),t.classList.add("selected"),document.getElementById("MangaOnlineViewer")?.setAttribute("data-theme",t.title),w({theme:t.title});const n=document.querySelector("#Hue"),o=document.querySelector("#Shade");t.title.startsWith("custom")?(n?.classList.add("show"),o?.classList.remove("show")):(n?.classList.remove("show"),o?.classList.add("show"))}function ja(e){const t=e.currentTarget.value;w({customTheme:t}),oo(t)}function Qa(e){const t=parseInt(e.currentTarget.value,10);w({themeShade:t}),ao()}function Ya(){document.querySelector("#ColorScheme")?.addEventListener("click",Ua),document.querySelectorAll(".ThemeRadio").forEach(v("click",qa)),document.querySelector("#CustomThemeHue")?.addEventListener("change",ja),document.querySelector("#ThemeShade")?.addEventListener("input",Qa)}function O(e){return()=>{typeof e!="number"?a().zoomMode=e:a().zoomMode="percent",me(e==="height"?"click":a().header);const t=document.querySelector("#ZoomVal");Number.isInteger(e)?(t.textContent=`${e}%`,document.querySelector("#Zoom").value=e.toString()):t.textContent=e,S(e)}}function pt(e=1){return()=>{const t=document.querySelector("#Zoom"),n=parseInt(t.value,10)+e*a().zoomStep;t.value=n.toString(),t?.dispatchEvent(new Event("input",{bubbles:!0}))}}function Xa(e){const t=e.currentTarget.value;w({zoomMode:t}),O(t)();const n=document.querySelector(".DefaultZoom");a().zoomMode==="percent"?n?.classList.add("show"):n?.classList.remove("show")}function Ka(e){const t=parseInt(e.currentTarget.value,10);w({defaultZoom:t}),O(t)()}function Ja(e){const t=parseInt(e.currentTarget.value,10);O(t)(),document.querySelector("#ZoomVal").textContent=`${t}%`}function ei(){document.querySelector("#DefaultZoomMode")?.addEventListener("change",Xa),document.querySelector("#DefaultZoom")?.addEventListener("input",Ka),document.querySelector("#Zoom")?.addEventListener("input",Ja),document.querySelector("#enlarge")?.addEventListener("click",pt()),document.querySelector("#reduce")?.addEventListener("click",pt(-1)),document.querySelector("#restore")?.addEventListener("click",O(100)),document.querySelector("#fitWidth")?.addEventListener("click",O("width")),document.querySelector("#fitHeight")?.addEventListener("click",O("height"))}function ht(e){const t=document.querySelector("#Chapter");document.querySelector("#Header")?.classList.remove("visible"),document.querySelector("#menu")?.classList.remove("hide"),O("height")(),N(t),t?.addEventListener("wheel",e==="FluidLTR"?se:qe)}function L(e){return()=>{const t=document.querySelector("#Chapter");t?.classList.remove("Vertical","WebComic","FluidLTR","FluidRTL"),t?.classList.add(e),t?.removeEventListener("wheel",se),t?.removeEventListener("wheel",qe),e==="FluidLTR"||e==="FluidRTL"?ht(e):(document.querySelector("#Header").className=a().header,document.querySelector("#menu").className=a().header,O(100)())}}function ti(e){const t=e.currentTarget.value;L(t)(),w({viewMode:t})}function ni(){document.querySelector("#viewMode")?.addEventListener("change",ti),document.querySelector("#webComic")?.addEventListener("click",L("WebComic")),document.querySelector("#ltrMode")?.addEventListener("click",L("FluidLTR")),document.querySelector("#rtlMode")?.addEventListener("click",L("FluidRTL")),document.querySelector("#verticalMode")?.addEventListener("click",L("Vertical")),(a().viewMode==="FluidLTR"||a().viewMode==="FluidRTL")&&ht(a().viewMode)}let I;function wt(){const e=document.querySelector("#Chapter");e?.classList.contains("FluidLTR")||e?.classList.contains("FluidRTL")?e?.scrollBy({top:0,left:a().scrollHeight*(e?.classList.contains("FluidRTL")?-1:1),behavior:"smooth"}):window.scrollBy({top:a().scrollHeight,left:0,behavior:"smooth"}),document.querySelector("#Header")?.classList.contains("headroom-end")&&(clearInterval(I),I=void 0,document.querySelector("#ScrollControl")?.classList.remove("running"),s("Finished auto scroll"))}function ee(){const e=document.querySelector("#AutoScroll");I?(clearInterval(I),I=void 0,e?.classList.remove("running"),s("Stopped auto scroll")):(wt(),I=setInterval(wt,1e3/60),e?.classList.add("running"),s("Start auto scroll"))}let te=!1;const oi=_.debounce(()=>{ee(),te=!1},500);function ai(){!te&&I&&(ee(),te=!0),te&&!I&&oi()}function ii(){window.addEventListener("wheel",_.throttle(ai,500)),document.querySelector("#AutoScroll")?.addEventListener("click",ee)}let bt=!1;function ft(){bt||(Uo(100),nt(),da(),Wa(),window.addEventListener("resize",()=>{const e=document.querySelector("#MangaOnlineViewer");e?.classList.remove("mobile","tablet","desktop"),e?.classList.add(A())}),bt=!0),Lo(),Wo(),ga(),La(),Fa(),Ya(),ni(),ei(),ii()}let yt;function ri(){L(a().viewMode)();const e={"#Header":We(yt),"#CommentsPanel":Ue(),"#SettingsPanel":Ge(),"#KeybindingsPanel":Ze(),"#Bookmarks":He()};document.querySelector("#ScrollControl")?.classList.contains("running")&&ee();const t=document.querySelector("#MangaOnlineViewer");t&&(t.className=`${a().colorScheme} 
        ${a().hidePageControls?"hideControls":""}
        ${R()?"bookmarked":""}
        ${A()}`,t.setAttribute("data-theme",a().theme));const n=document.querySelector("#Chapter");n&&(n.className=`${a().fitWidthIfOversize?"fitWidthIfOversize":""}  ${a().viewMode}`),Object.entries(e).forEach(([o,r])=>{const l=document.querySelector(o);l&&(l.outerHTML=r)}),document.querySelector("#Overlay")?.dispatchEvent(new Event("click")),ft()}const si=e=>{yt=e;const t=document.createElement("div");return t.id="MangaOnlineViewer",t.className=`
        ${a().colorScheme} 
        ${a().hidePageControls?"hideControls":""}
        ${R()?"bookmarked":""}
        ${A()}`,t.setAttribute("data-theme",a().theme),t.innerHTML=h`
      <div id="menu" class="${a().header}">${Nn}</div>
      ${We(e)} ${Co(e)} ${xo(e)}
      <div id="Overlay" class="overlay"></div>
      ${Ue()} ${Ze()} ${He()} ${Ge()}
    `,t.outerHTML},li=e=>{e.getAttributeNames().forEach(t=>e?.removeAttribute(t))},ci=(...e)=>{e?.forEach(li)};function di(e){ci(document.documentElement,document.head,document.body),window.scrollTo(0,0),document.head.innerHTML=ro(e),document.body.innerHTML=si(e),ft(),sa(e),document.querySelector("#MangaOnlineViewer")?.addEventListener("hydrate",ri),e.comments&&document.querySelector("#CommentsArea")?.append(e.comments)}async function mi(){if(!a().enableComments)return null;let e=document.querySelector("#disqus_thread, #fb-comments");return e&&(s("Waiting to Comments to load",e),window.scrollTo(0,document.body.scrollHeight),await Tt(we(()=>{e=document.querySelector("#disqus_thread, #fb-comments");const t=e?.querySelector("iframe:not(#indicator-north, #indicator-south)");return t?.contentWindow?.document.readyState==="complete"&&t?.contentWindow?.document?.body?.textContent?.length})),e.children.length?s("Got Comments",e):s("Timeout Comments")),window.scrollTo(0,0),e}async function $(e){e.before!==void 0&&await e.before(e.begin),a().enableComments&&!e.comments&&(e.comments=await mi()),setTimeout(()=>{try{di(e)}catch(t){s(t)}},50)}const ui=`#StartMOV {
    all: revert;
...
`;async function gi(e){if(e.waitAttr!==void 0){s(`Waiting for Attribute ${e.waitAttr[1]} of ${e.waitAttr[0]}`);const t=await be(e.waitAttr[0],e.waitAttr[1]);s(`Found Attribute ${e.waitAttr[1]} of ${e.waitAttr[0]} = ${t}`)}}async function pi(e){if(e.waitEle!==void 0){s(`Waiting for Element ${e.waitEle}`);const t=await At(e.waitEle);s(`Found Element ${e.waitEle} = `,t)}}async function hi(e){if(e.waitVar!==void 0){s(`Waiting for Variable ${e.waitVar}`);const t=await fe(e.waitVar);s(`Found Variable ${e.waitVar} = ${t}`)}}async function wi(e){if(e.waitFunc!==void 0){s(`Waiting to pass Function check ${e.waitFunc}`);const t=await we(e.waitFunc);s(`Found Function check ${e.waitFunc} = ${t}`)}}async function bi(e){e.waitTime!==void 0&&(s(`Waiting to for ${e.waitTime} milliseconds`),await new Promise(t=>{setTimeout(t,e.waitTime)}),s("Continuing after timer"))}const fi={url:/(file:\/\/\/.+(index)?.html)/},yi=["image/apng","image/bmp","image/gif","image/jpeg","image/pjpeg","image/png","image/svg+xml","image/tiff","image/webp","image/x-icon"],vi=/.(png|jpg|jpeg|gif|bmp|webp)$/i,vt=(e,t)=>e.localeCompare(t,navigator.languages[0]||navigator.language,{numeric:!0,ignorePunctuation:!0});function Ei(e){return yi.includes(e.type)}const ki=e=>{const t=new Uint8Array(e),n=new Blob([t.buffer]);return URL.createObjectURL(n)};async function Si(e){const t=await JSZip.loadAsync(e),n=t.filter((o,r)=>!r.dir&&vi.test(r.name)).sort((o,r)=>vt(o.name,r.name));return s("Files in zip:",t.files),Promise.all(n.map(o=>o.async("arraybuffer").then(ki)))}function Et(e,t){$({title:e,series:"?reload",pages:t.length,begin:1,prev:"#",next:"#",lazy:!1,listImages:t}).then(()=>s("Page loaded"))}async function xi(e){const t=await Si(e);Et(typeof e=="string"?e:e.name,t)}function kt(e){const t=e.target,n=Array.from(t.files).filter(Ei).sort((o,r)=>vt(o.webkitRelativePath||o.name,r.webkitRelativePath||r.name));s("Local Files: ",n,n.map(o=>o.webkitRelativePath||o.name)),t.files?.[0]&&Et(t.files[0].webkitRelativePath.split("/")[0]||"Local Images",n.map(URL.createObjectURL))}function Mi(){return fi.url.test(window.location.href)?(document.querySelector("#MangaOnlineViewer, #LocalTest")&&(document.querySelector("#LocalTest")?.setAttribute("style","display:none"),document.querySelector("#file")?.addEventListener("change",e=>{const t=e.target;t.files?.[0]&&xi(t.files[0])}),document.querySelector("#folder")?.addEventListener("change",kt),document.querySelector("#images")?.addEventListener("change",kt),s("Waiting for zip/images upload")),!0):!1}function Oi(e,t,n){let o=e;return Number.isNaN(o)||o<n.min()?o=n.min():o>n.max()?o=n.max():o>t&&(o=t),o}function Ii(e,t,n){let o=e;return Number.isNaN(o)||o>n.max()?o=n.max():o<n.min()?o=n.min():o<t&&(o=t),o}async function Ci(e,t=1){const n=await e.run();s("LateStart");let o=t,r=n.pages;const l={title:i("STARTING"),html:h`
        ${i("CHOOSE_BEGINNING")}
      ...
      `,showCancelButton:!0,cancelButtonColor:"#d33",reverseButtons:!0,icon:"question",didOpen(){const c=document.querySelector("#pageBegin"),m=document.querySelector("#pageEnd"),g=rangeSlider(document.getElementById("pagesSlider"),{min:1,max:n.pages,value:[o,r],onInput(b,p){p&&([o,r]=b,c&&(c.value=o.toString()),m&&(m.value=r.toString()))}});function u(){if(c.value===""||m.value==="")return;const b=Oi(parseInt(c.value,10),r,g),p=Ii(parseInt(m.value,10),o,g);c.value=b.toString(),m.value=p.toString(),o=b,r=p,g.value([b,p])}const d=_.debounce(u,600);["change","mouseup","keyup","touchend"].forEach(b=>{c?.addEventListener(b,d),m?.addEventListener(b,d)})}};Swal.fire(l).then(c=>{c.value?(s(`Choice: ${o} - ${r}`),n.begin=o,n.pages=r,$(n).then(()=>s("Page loaded"))):s(c.dismiss)})}function St(e,t){const n=document.createElement("button");n.innerText=i("BUTTON_START"),n.id="StartMOV",n.onclick=()=>{Ci(e,t).catch(s)},document.body.appendChild(n);const o=document.createElement("style");o.appendChild(document.createTextNode(ui+tn)),document.head.appendChild(o),s("Start Button added to page",n)}function Ai(e,t){Swal.fire({title:i("STARTING"),html:h`${t.begin>1?`${i("RESUME")}${t.begin}.<br/>`:""}${i("WAITING")}`,showCancelButton:!0,cancelButtonColor:"#d33",reverseButtons:!0,timer:3e3}).then(n=>{n.value||n.dismiss===Swal.DismissReason.timer?$(t).then(()=>s("Page loaded")):(St(e,t.begin),s(n.dismiss))})}async function Li([e,t]){s(`Found Pages: ${t.pages} in ${e.name}`),t.title||(t.title=document.querySelector("title")?.textContent?.trim()),t.begin=R()??t.begin??1;const n=document.createElement("style");switch(n.appendChild(document.createTextNode(ze)),document.body.appendChild(n),unsafeWindow.MOV=(o,r)=>{o!==void 0&&(t.begin=o),r!==void 0&&(t.pages=r),$(t).then(()=>s("Page loaded"))},e.start??a()?.loadMode){case"never":St(e,t.begin);break;case"always":$(t).then(()=>s("Page loaded"));break;case"wait":default:Ai(e,t);break}}async function Ti(e){if(s(`Starting ${oe.script.name} ${oe.script.version} on ${A()} ${dn()} with ${mn()}`),Mi())return;s(e.length,"Known Manga Sites:",e);const t=e.filter(o=>o.url.test(window.location.href));s(t.length,"Found sites:",t);const n=t.map(async o=>(s(`Testing site: ${o.name}`),new Promise((r,l)=>{Promise.all([bi(o),pi(o),gi(o),hi(o),wi(o)]).then(async()=>o.run()).then(c=>c.pages>0?r([o,c]):l(new Error(`${o.name} found ${c.pages} pages`)))})));Promise.race(n.map((o,r)=>o.then(()=>r))).then(o=>{n.forEach((r,l)=>{l!==o&&s(`Failed/Skipped: ${t[l].name}`)}),n[o].then(r=>{Li(r)})})}Ti(en).catch(s)})();
