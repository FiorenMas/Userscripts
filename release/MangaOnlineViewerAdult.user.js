...
!function(){"use strict";const e={name:"AkumaMoe",url:/https?:\/\/(www\.)?akuma\.moe\/g\/.+\/.+/,homepage:"https://akuma.moe",language:["Raw"],category:"hentai",waitFunc:()=>unsafeWindow.img_lst?.length===document.querySelectorAll(".reader-nav:first-child .nav-select option")?.length,run:async()=>({title:document.querySelector("h1.sr-only")?.textContent?.trim().replace(/^Reading /,""),series:`https://akuma.moe/g/${/\/g\/([^/]+)\//.exec(window.location.pathname)?.[1]}/`,pages:unsafeWindow.img_lst.length,prev:"#",next:"#",listImages:unsafeWindow.img_lst.map((e=>`${unsafeWindow.img_prt}/${e}`))})},n={name:"BestPornComix",url:/https?:\/\/(www\.)?bestporncomix.com\/gallery\/.+/,homepage:"https://www.bestporncomix.com",language:["English"],category:"hentai",timer:5e3,run(){const e=[...document.querySelectorAll("figure a")];return{title:document.querySelector("h1.entry-title")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("href")))}}},t={name:"DoujinMoeNM",url:/https?:\/\/(www\.)?doujins.com\/.+/,homepage:"https://doujins.com/",language:["English"],category:"hentai",waitEle:".doujin",run(){const e=[...document.querySelectorAll(".doujin")];return{title:document.querySelector(".folder-title a:last-child")?.textContent?.trim(),series:document.querySelector(".folder-title a:nth-last-child(2)")?.getAttribute("href"),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("data-file")))}}};function a(e){return null==e||void 0===e||"string"==typeof e&&""===e||Array.isArray(e)&&0===e.length||"object"==typeof e&&0===Object.keys(e).length}function o(e){const n=e=>{if(!Array.isArray(e)){return!Object.keys(e).some((n=>!o(e[n])))&&n(Object.keys(e))}return!e.some((e=>e instanceof Promise||!o(e)))};return!e||0===e||a(e)||"object"==typeof e&&n(e)}function i(e,n=250){return new Promise((t=>{const a=setInterval((()=>{e()&&(clearInterval(a),t(!0))}),n)}))}function r(e,n,t=document.body){return new Promise((a=>{if(t.querySelector(e)?.getAttribute(n))return void a(t.querySelector(e)?.getAttribute(n)??"");const o=new MutationObserver((()=>{t.querySelector(e)?.getAttribute(n)&&(a(t.querySelector(e)?.getAttribute(n)??""),o.disconnect())}));o.observe(t,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[n]})}))}function l(e=1e3,n=!0){return new Promise((t=>{setTimeout((()=>t(n)),e)}))}async function s(e,n=1e3){return(await Promise.all([e,l(n)]))[0]}const c={name:["8Muses.com","8Muses.io"],obs:"Slow start, bruteforce may be required",url:/https?:\/\/(comics.)?8muses.(com|io)\/(comics\/)?picture\/.+/,homepage:["https://comics.8muses.com/","https://8muses.io/"],language:["English"],category:"hentai",async run(){const e=unsafeWindow.link_images?.slice(1,unsafeWindow.link_images.length),n=e?.length??parseInt(document.querySelector('link[rel="last"]')?.getAttribute("href")?.match(/\d+$/)?.at(0)??"",10);return{title:[...document.querySelectorAll(".top-menu-breadcrumb li:not(:last-child)")].map((e=>e?.textContent?.trim())).join("/"),series:document.querySelector(".top-menu-breadcrumb li:nth-last-child(2) a")?.getAttribute("href"),pages:n,prev:"#",next:"#",lazy:!1,timer:10,listImages:e,async before(){if(!unsafeWindow.link_images?.length){const e=document.createElement("div");e.setAttribute("style","height: 100vh;width: 100vw;position: fixed;top: 0;left: 0;z-index: 100000;background: white;opacity: 0.5;"),document.body.append(e);const n=document.querySelector(".page-prev");for(;"1"!==document.querySelector(".c-dropdown-toggle")?.textContent?.match(/\d+/)?.at(0);)n?.dispatchEvent(new Event("click"));const t=document.querySelector(".page-next"),a=document.querySelector(".p-picture"),o=[];for(let e=1;e<=this.pages;e+=1)o[e-1]=await s(r(".photo img","src",a??document.body),100),a?.querySelector("img")?.removeAttribute("src"),t?.dispatchEvent(new Event("click"));this.listImages=o}}}}},d={name:["ExHentai","e-Hentai"],url:/https?:\/\/(g\.)?(exhentai|e-hentai).org\/s\/.+\/.+/,homepage:["https://exhentai.org/","https://e-hentai.org/"],language:["English"],obs:"May get your IP Banned, use with moderation",category:"hentai",async run(){const e=parseInt(document.querySelector(".sn div span:nth-child(2)")?.textContent??"0",10),n=Math.ceil(e/20),t=document.querySelector(".sb a")?.getAttribute("href")?.replace(/\?p=\d+/,""),a=Array(n).fill(0).map((async(e,n)=>fetch(`${t}?p=${n}`).then((async e=>e.text())).then((e=>(new DOMParser).parseFromString(e,"text/html"))))),o=(await Promise.all(a)).flatMap((e=>[...e.querySelectorAll("#gdt a")].map((e=>e.getAttribute("href")))));return{title:document.querySelector("#i1 h1")?.textContent?.trim(),series:t,pages:e,begin:parseInt(document.querySelector("div#i2 span")?.textContent??"1",10),prev:"#",next:"#",listPages:o,img:"#img",lazy:!0,async reload(e){const n=`${o[e-1]}`,t=await fetch(n).then((e=>e.text())).then((e=>/nl\('([\d-]+)'\)/.exec(e)?.[1])),a=`${n}${n.indexOf("?")?"&":"?"}nl=${t}`;return fetch(a).then((e=>e.text())).then((e=>(new DOMParser).parseFromString(e,"text/html").querySelector(this.img)?.getAttribute("src")))}}}},m={name:"FSIComics",url:/https?:\/\/(www\.)?fsicomics.com\/.+/,homepage:"https://fsicomics.com/",language:["English"],category:"hentai",run(){const e=[...document.querySelectorAll(".wp-block-gallery img")];return{title:document.querySelector(".s-title")?.textContent?.trim(),series:"",pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("data-large-file")))}}},u={name:"GNTAI.net",url:/https?:\/\/(www\.)?gntai.net\/(?!(category|tags|autores))[^/]+\/.+/,homepage:"https://www.gntai.net/",language:["Spanish"],category:"hentai",run(){const e=document.querySelector("#main > script")?.innerHTML.match(/var pages = [^;]+/)?.at(0)?.toString().match(/https?[^"]+/g);return{title:document.querySelector(".entry-header h1")?.textContent?.trim(),pages:e?.length,prev:"#",next:"#",listImages:e}}},g={name:"HBrowser",url:/https?:\/\/(www\.)?hbrowse.com\/.+/,homepage:"https://www.hbrowse.com/",language:["English"],category:"hentai",run(){const e=window.location.href+(window.location.href.endsWith("/")?"":"/"),n=parseInt(document.querySelector("#jsPageList a:last-child")?.textContent??"",10),t=[...document.querySelectorAll("#chapters + table a.listLink")],a=t.findIndex((e=>window.location.href.endsWith(e.getAttribute("href")??"undefined")));return{title:document.querySelector(".listTable td.listLong")?.textContent?.trim(),series:/.+\/\d+\//.exec(window.location.href)?.at(0),pages:n,prev:t.at(a-1)?.getAttribute("href"),next:t.at(a+1)?.getAttribute("href"),listPages:Array(n).fill(0).map(((n,t)=>e+String(`0000${t+1}`).slice(-5))),img:"td.pageImage a img"}}},p={name:"Hentai2Read",url:/https?:\/\/(www\.)?hentai2read.com\/[^/]+\/\d+(.\d+)?\//,homepage:"https://hentai2read.com/",language:["English"],category:"hentai",run:()=>({title:document.querySelector(".reader-left-text")?.textContent?.trim(),series:unsafeWindow.gData.mainURL,pages:unsafeWindow.gData.images.length,prev:unsafeWindow.gData.previousURL,next:unsafeWindow.gData.nextURL,listImages:unsafeWindow.gData.images.map((e=>`https://static.hentaicdn.com/hentai${e}`))})},h={name:"HentaiEra",url:/https?:\/\/(www\.)?hentaiera.com\/view\/.+\/\d+\/?/,homepage:"https://hentaiera.com/",language:["English"],category:"hentai",run(){const e=parseInt(document.querySelector(".total_pages")?.textContent??"0",10);return{title:document.querySelector("h1")?.textContent?.trim().replace(/ - Page .+$/,""),series:document.querySelector(".return_btn ")?.getAttribute("href"),pages:e,prev:"#",next:"#",listPages:Array(e).fill(0).map(((e,n)=>window.location.href.replace(/\/\d*\/?$/,`/${n+1}`))),img:"#gimg",lazyAttr:"data-src"}}},w=/^blob:(.+?)\/(.+)$/;function b(e){return e.slice(e.indexOf(";base64,")+8)}function f(e){return/^data:image\/(png|jpg|jpeg|gif);base64,/.test(e)}function v(e){return w.test(e)}function y(e){const n=e.split("?")[0].split("/").pop(),t=n?.match(/\.[A-Za-z]{2,4}$/);return t?t[0].slice(1):""}const E=e=>{switch(e.substring(e.indexOf("/")+1,e.indexOf(";base64"))){case"/":return"jpg";case"R":return"gif";case"U":return"webp";default:return"png"}};function k(e){switch(e){case"p":return"png";case"b":return"bmp";case"g":return"gif";case"w":return"webp";default:return"jpg"}}const x={name:"HentaiFox",url:/https?:\/\/(www\.)?hentaifox.com\/g\/.+/,homepage:"https://www.hentaifox.com/",language:["English"],category:"hentai",waitVar:"g_th",waitFunc:()=>document.querySelector("#gimg")?.classList.contains("loaded"),run(){const e=parseInt(document.querySelector(".total_pages")?.textContent??"",10),n=document.querySelector("#gimg")?.getAttribute("src")?.replace(/\d+.\w+$/,"")??"";return{title:document.querySelector("title")?.textContent?.replace(/ - Page .+/,"").trim(),series:document.querySelector(".browse_buttons a")?.getAttribute("href"),pages:e,prev:"#",next:"#",listImages:Array(e).fill(0).map(((e,t)=>`${n+(t+1)}.${k(unsafeWindow.g_th[t+1][0])}`))}}},S={name:["HentaiHand","nHentai.com"],url:/https?:\/\/(www\.)?(hentaihand|nhentai).com\/.+\/reader/,homepage:["https://hentaihand.com/","https://nhentai.com"],language:["English"],category:"hentai",waitEle:".reader img",run(){const e=[...document.querySelectorAll(".reader img")];return{title:document.querySelector(".reader-header h5")?.textContent?.trim(),series:document.querySelector(".reader-header h5 a")?.getAttribute("href"),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("data-src")??e.getAttribute("src")))}}},M={name:"HentaIHere",url:/https?:\/\/(www\.)?hentaihere.com\/.+\/.+\/.+/,homepage:"https://www.hentaihere.com/",language:["English"],category:"hentai",waitVar:"rff_imageList",run(){const e=document.querySelector("#arf-reader-img")?.getAttribute("src")?.replace(/\d.+/,"");return{title:unsafeWindow.rff_pageTitle.replace(/.+\|/,"").trim(),series:unsafeWindow.rff_thisManga,pages:unsafeWindow.rff_imageList.length,prev:unsafeWindow.rff_previousChapter,next:unsafeWindow.rff_nextChapter,listImages:unsafeWindow.rff_imageList.map((n=>e+n))}}},O={name:"HentaiNexus",url:/https?:\/\/((www\.)?hentainexus.com|nexus.fakku.cc)\/read\/.+/,homepage:"https://hentainexus.com/",language:["English"],category:"hentai",run(){const e=unsafeWindow.pageData?.map((e=>e.image))??unsafeWindow.images?.map((e=>e.url));return{title:document.querySelector("title")?.textContent?.replace(/^\[[\d/]+\]/,"").trim(),series:document.querySelector("#returnGalleryFooter a")?.getAttribute("href"),pages:e.length,prev:"#",next:"#",listImages:e}}},A={name:"HenTalk",url:/https?:\/\/(www.)?hentalk.pw/,homepage:"https://hentalk.pw/",language:["English"],category:"hentai",waitEle:"div div + img[alt^=Page]",async run(){const e=await fetch(`${window.location.pathname}/__data.json?x-sveltekit-invalidated=011`).then((async e=>e.json())),n=document.querySelector("div div + img[alt^=Page]")?.getAttribute("src")?.match(/image\/(.+)\//)?.[1],t=e.nodes[1].data.filter((e=>"string"==typeof e&&/\.(png|gif|jpg|jpeg|webp)$/.test(e)));return{title:document.querySelector("title")?.textContent?.trim().replace(/Page \d+ • /,""),series:window.location.href.replace(/read\/.+/,""),pages:t?.length,prev:"#",next:"#",listImages:t?.map(((e,t)=>`https://hentalk.pw/image/${n}/${t+1}${/\.(png|gif|jpg|jpeg|webp)$/.exec(e)?.[0]}`))}}},C={name:"hitomi",url:/https?:\/\/hitomi.la\/reader\/.+/,homepage:"https://hitomi.la/",language:["English"],category:"hentai",waitAttr:["#comicImages img","src"],waitVar:"galleryinfo",run:()=>({title:document.querySelector("title")?.textContent?.replace("| Hitomi.la","").trim(),series:document.querySelector(".brand")?.getAttribute("href"),pages:unsafeWindow.galleryinfo.files.length,prev:"#",next:"#",listImages:unsafeWindow.galleryinfo.files.map((e=>unsafeWindow.url_from_url_from_hash(unsafeWindow.galleryinfo,e,"webp",void 0,"a")))})};const I={name:"Imhentai",url:/https?:\/\/(www\.)?imhentai.xxx\/view\/.+\/.+\//,homepage:"https://imhentai.xxx/",language:["English"],category:"hentai",waitVar:"g_th",run(){const e=document.querySelector("#gallery_id")?.getAttribute("value"),n=document.querySelector("#image_dir")?.getAttribute("value"),t=parseInt(document.querySelector("#pages")?.getAttribute("value")??"",10),a=parseInt(document.querySelector("#u_id")?.getAttribute("value")??"",10),o=unsafeWindow.random_server??`${function(e){const n=[{min:0,max:274825,name:"m1"},{min:274826,max:403818,name:"m2"},{min:403819,max:527143,name:"m3"},{min:527144,max:632481,name:"m4"},{min:632482,max:816010,name:"m5"},{min:816011,max:970098,name:"m6"},{min:970099,max:1121113,name:"m7"},{min:1121114,max:1259410,name:"m8"},{min:1259411,max:1/0,name:"m9"}];return n.find((n=>e>=n.min&&e<=n.max))?.name}(a)}.imhentai.xxx`;return{title:document.querySelector("title")?.textContent?.trim(),series:document.querySelector(".return_btn")?.getAttribute("href"),pages:t,prev:"#",next:"#",listImages:Array(t).fill(0).map(((t,a)=>`//${o}/${n}/${e}/${a+1}.${k(unsafeWindow.g_th[a+1][0])}`))}}},L={name:["KingComix","Chochox","Comics18"],url:/https?:\/\/(www\.)?(kingcomix|chochox|comics18).(com|org)\/.+/,homepage:["https://kingcomix.com/","https://chochox.com/porno/","https://comics18.org/"],language:["English","Spanish"],category:"hentai",run(){const e=[...document.querySelectorAll("figure img, .entry-content img:not(a img), .wp-content img")];return{title:document.querySelector("h1.singleTitle-h1")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("data-src")??e.getAttribute("data-full-url")??e.getAttribute("data-lazy-src")??e.getAttribute("src")))}}},T={name:"Luscious",url:/https?:\/\/(www\.)?luscious.net\/.+\/read\/.+/,homepage:"https://luscious.net/",language:["English"],category:"hentai",waitEle:".album-info div",async run(){const e=parseInt(document.querySelector('input[name="page_number"] + span')?.textContent?.match(/\d+/)?.pop()??"0",10),n=Math.ceil(e/50),t=parseInt(document.querySelector(".album-heading a")?.getAttribute("href")?.match(/\d+\//)?.toString()??"0",10),a=Array(n).fill(0).map((async(e,n)=>{const a=`https://apicdn.luscious.net/graphql/nobatch/?operationName=PictureListInsideAlbum&variables={"input":{"filters":[{"name":"album_id","value":"${t}"}],"display":"position","items_per_page":50,"page":${n+1}}}&query=%20query%20PictureListInsideAlbum(%24input%3A%20PictureListInput!)%20%7B%20picture%20%7B%20list(input%3A%20%24input)%20%7B%20info%20%7B%20...FacetCollectionInfo%20%7D%20items%20%7B%20__typename%20id%20title%20description%20created%20like_status%20number_of_comments%20number_of_favorites%20moderation_status%20width%20height%20resolution%20aspect_ratio%20url_to_original%20url_to_video%20is_animated%20position%20permissions%20url%20tags%20%7B%20category%20text%20url%20%7D%20thumbnails%20%7B%20width%20height%20size%20url%20%7D%20%7D%20%7D%20%7D%20%7D%20fragment%20FacetCollectionInfo%20on%20FacetCollectionInfo%20%7B%20page%20has_next_page%20has_previous_page%20total_items%20total_pages%20items_per_page%20url_complete%20%7D%20`;return GM.xmlHttpRequest({method:"GET",url:a}).then((e=>JSON.parse(e.responseText)))})),o=(await Promise.all(a)).flatMap((e=>e.data.picture.list.items.map((e=>e.url_to_original))));return{title:document.querySelector(".album-heading a")?.textContent?.trim(),series:document.querySelector(".album-heading a")?.getAttribute("href"),pages:e,prev:"#",next:"#",listImages:o}}},R=/^([\t\n])*(https?:\/\/)?.+\.(jpg|jpeg|png|gif|bmp|webp).*$/;function D(){return[...document.querySelectorAll(".wp-manga-chapter-img, .blocks-gallery-item img, .reading-content img, #chapter-images img, #chapterContent img")].map((e=>[...e.attributes].filter((e=>/.*(src|url).*/i.test(e.name)&&!/^.*(blank|lazy|load).*$/.test(e.value))).find((e=>R.test(e.value)))?.value??e?.getAttribute("src")))}const B={...{name:["Madara WordPress Plugin","MangaHaus","Isekai Scan","Comic Kiba","Zinmanga","mangatx","Toonily","Mngazuki","JaiminisBox","DisasterScans","ManhuaPlus","TopManhua","NovelMic","Reset-Scans","LeviatanScans","Dragon Tea","SetsuScans","ToonGod"],url:/https?:\/\/.+\/(manga|series|manhua|comic|ch|novel|webtoon)\/.+\/.+/,homepage:["https://mangabooth.com/","https://manhuaus.com","https://isekaiscan.com/","https://comickiba.com/","https://zinmanga.com/","https://mangatx.com/","https://toonily.net/","https://mangazuki.me/","https://jaiminisbox.net","https://disasterscans.com/","https://manhuaplus.org/","https://www.topmanhua.com/","https://novelmic.com/","https://reset-scans.com/","https://leviatanscans.com/","https://dragontea.ink/","https://setsuscans.com/","https://toongod.org/home/"],language:["English"],obs:"Any Site that uses Madara Wordpress Plugin",category:"manga",waitFunc:()=>{const e=D();return e.length>0&&e.every((e=>e&&R.test(e)))},run(){const e=D();return{title:document.querySelector("#chapter-heading")?.textContent?.trim(),series:(document.querySelector(".breadcrumb li:nth-child(3) a")??document.querySelector(".breadcrumb li:nth-child(2) a"))?.getAttribute("href"),pages:e.length,prev:document.querySelector(".prev_page")?.getAttribute("href"),next:document.querySelector(".next_page")?.getAttribute("href"),listImages:e}}},name:["Madara WordPress Plugin","AllPornComic","Manytoon","Manga District"],url:/https?:\/\/.+\/(porncomic|read-scan)\/.+\/.+/,homepage:["#","https://allporncomic.com/","https://manytoon.com/","https://mangadistrict.com/"],category:"hentai"};function N(e,n,t="a"){return[...document.querySelectorAll(e)]?.filter((e=>e.textContent?.trim()===n))?.[0]?.closest(t)}const V={name:"ManhwaRead",url:/https?:\/\/(www\.)?manhwaread.com\/.+/,homepage:"https://www.manhwaread.com",language:["English"],category:"hentai",waitEle:"#readingContent img",run(){const e=[...document.querySelectorAll("#readingContent img")];return{title:document.querySelector("#readingNavTop div:has(>h1)")?.textContent?.trim().replace(/\n/g,""),series:document.querySelector("#readingNavTop a")?.getAttribute("href"),pages:e.length,prev:N("span","Previous")?.getAttribute("href"),next:N("span","Next")?.getAttribute("href"),listImages:e.map((e=>e.getAttribute("src")))}}},$={name:"MultPorn",url:/https?:\/\/(www\.)?multporn.net\/(comics|hentai_manga)\/.+/,homepage:"https://multporn.net/",language:["English"],category:"hentai",async run(){const e=document.head.textContent?.match(/"configUrl":"(.+?)",/)?.at(1)?.replaceAll("\\","")??"",n=await fetch(e).then((async e=>e.text())).then((e=>(new DOMParser).parseFromString(e,"text/xml"))),t=[...n.querySelectorAll("image")];return{title:document.querySelector("#page-title")?.textContent?.trim(),pages:t.length,prev:"#",next:"#",listImages:t.map((e=>e.getAttribute("imageURL")))}}},F={name:"MyHentaiGallery",url:/https?:\/\/(www\.)?myhentaigallery.com\/g\/.+\/\d+/,homepage:"https://www.myhentaigallery.com",language:["English"],category:"hentai",run(){const e=document.getElementById("js__pagination__next")?.parentElement?.previousElementSibling?.querySelector("a"),n=parseInt(e?.textContent??"",10);return{title:document.querySelector("title")?.textContent?.trim(),series:document.querySelector(".back-to-gallery a")?.getAttribute("href"),pages:n,prev:"#",next:"#",listPages:Array(n).fill(0).map(((e,n)=>window.location.href.replace(/\/\d+$/,`/${n+1}`))),img:".gallery-slide img"}}},G={name:["nHentai.net","nHentai.xxx","lhentai"],url:/https?:\/\/(www\.)?(nhentai|lhentai).(net|xxx|com|to)\/g\/.+\/.+/,homepage:["https://nhentai.net/","https://nhentai.xxx/","https://lhentai.com/"],language:["English"],category:"hentai",run(){const e=parseInt(document.querySelector(".num-pages")?.textContent??"",10),n=document.querySelector("#image-container img")?.getAttribute("src")?.replace(/\d+.\w+$/,""),t=unsafeWindow._gallery?.images?.pages?.map((e=>k(e.t)));return{title:document.querySelector("title")?.textContent?.split("- Page")[0].trim(),series:document.querySelector(".go-back")?.getAttribute("href"),pages:e,prev:"#",next:"#",listImages:Array(e).fill(0).map(((e,a)=>`${n}${a+1}.${t[a]}`))}}},z={name:"9Hentai",url:/https?:\/\/(www\.)?9hentai.(ru|to|com)\/g\/.+\/.+/,homepage:"https://9hentai.to",language:["English"],category:"hentai",waitAttr:["#jumpPageModal input","max"],async run(){const e={id:parseInt(/\d+/.exec(window.location.pathname)?.at(0)??"0",10)},n={method:"POST",body:JSON.stringify(e),headers:{"Content-Type":"application/json"}},t=await fetch("/api/getBookByID",n).then((async e=>e.json()));return{title:t.results.title,series:`/g/${t.results.id}/`,pages:t.results.total_page,prev:"#",next:"#",listImages:Array(t.results.total_page).fill(0).map(((e,n)=>`${t.results.image_server+t.results.id}/${n+1}.jpg`))}}},P={...{name:"YugenMangas",url:/https?:\/\/(www\.)?(yugenmangas).(com|net|lat)\/series\/.+/,homepage:"https://yugenmangas.lat/",language:["Spanish"],category:"manga",async run(){const e=[...document.querySelectorAll("p.flex > img")];return{title:document.querySelector("title")?.textContent?.trim(),series:document.querySelector("div.justify-between:nth-child(2) > a:nth-child(2)")?.getAttribute("href"),pages:e.length,prev:document.querySelector("div.justify-between:nth-child(2) > a:nth-child(1)")?.getAttribute("href"),next:document.querySelector("div.justify-between:nth-child(2) > a:nth-child(3)")?.getAttribute("href"),listImages:e.map((e=>e.classList.contains("lazy")?e.getAttribute("data-src"):e.getAttribute("src")))}}},name:["OmegaScans"],url:/https?:\/\/(www\.)?(omegascans).(org)\/.+/,homepage:["https://omegascans.org/"],language:["English"],category:"hentai"},Z={name:"PornComixOnline",url:/https?:\/\/(www\.)?porncomixone.net\/comic\/.+/,homepage:"https://www.porncomixone.net",language:["English"],category:"hentai",run(){const e=[...document.querySelectorAll("figure a")];return{title:document.querySelector(".post-title")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("href")))}}},H={name:"Pururin",url:/https?:\/\/(www\.)?pururin.me\/(view|read)\/.+\/.+\/.+/,homepage:"https://pururin.me/",language:["English"],category:"hentai",waitAttr:[".img-viewer img","src"],run(){const e=document.querySelector(".img-viewer img")?.getAttribute("src")??"",n=[...document.querySelectorAll(".img-select option")];return{title:document.querySelector(".title")?.textContent?.trim(),series:document.querySelector(".breadcrumb-item:nth-child(4) a")?.getAttribute("href"),pages:n.length,prev:"#",next:"#",listImages:n.map(((n,t)=>e.replace(/\/\d+\./,`/${t+1}.`)))}}};function W(...e){return console.log("MangaOnlineViewer: ",...e),e}const U="undefined"!=typeof GM_info?GM_info:{scriptHandler:"Console",script:{name:"Debug",version:"Testing"}};function q(e,n=null){const t=function(e,n=null){return"undefined"!=typeof GM_getValue?GM_getValue(e,n):(W("Fake Getting: ",e," = ",n),n)}(e,n);return"string"==typeof t?JSON.parse(t):t}function j(e){return function(e,n){return"undefined"!=typeof GM_setValue?(GM_setValue(e,n),n.toString()):(W("Fake Setting: ",e," = ",n),String(n))}("settings",e)}const Q=new UAParser,Y=()=>{const e=Q.getDevice().type;return"mobile"!==e&&"tablet"!==e?window.matchMedia("screen and (max-width: 600px)").matches?"mobile":window.matchMedia("screen and (max-width: 992px)").matches?"tablet":"desktop":e};async function X(e){return async function(e,n){return new Promise((t=>{W("Fetching page: ",e),fetch(e).then((async e=>e.text())).then((e=>{const a=(new DOMParser).parseFromString(e,n);t(a)})).catch((e=>{W("Failed to fetch page: ",e)}))}))}(e,"text/html")}async function K(e,...n){for(const t of n)try{const n=await fetch(t,e);if(n.ok)return await n.json();W(`Fetch ${t} failed.`)}catch(e){W(`Failed to fetch from ${t}:`,e)}throw new Error("All fetch attempts failed")}const J={name:"SchaleNetwork",url:/https?:\/\/(www\.)?(niyaniya|shupogaki|hoshino).(moe|one)/,homepage:"https://schale.network/",language:["English"],category:"hentai",lazy:!1,waitEle:"nav select option",async run(){const e={method:"GET",headers:{Accept:"*/*",Referer:`${window.location.host}/`,Origin:window.location.host}},n=["https://api.schale.network","https://api.gehenna.jp/"],t=window.location.pathname.split("/"),a=`${t[2]}/${t[3]}`,o=n.map((e=>`${e}/books/detail/${a}`)),i=await K(e,...o),r=Object.keys(i.data).map(Number).sort(((e,n)=>n-e))[0],l=n.map((e=>`${e}/books/data/${a}/${i.data[r].id}/${i.data[r].public_key}?v=${i.updated_at??i.created_at}&w=${r}`)),{base:s,entries:c}=await K(e,...l),d=c.map((e=>`${s}/${e.path}?w=${r}`));return{title:i.title,series:`/g/${a}/`,pages:d.length,prev:"#",next:"#",fetchOptions:{method:"GET",redirect:"follow"},listImages:d}}},ee={name:"Simply-Hentai",url:/https?:\/\/(www\.)?simply-hentai.com\/.+\/page\/.+/,homepage:"https://simply-hentai.com/",language:["English"],category:"hentai",waitEle:"#__NEXT_DATA__",async run(){const e=JSON.parse(document.querySelector("#__NEXT_DATA__")?.innerHTML??"").props.pageProps.data.pages.map((e=>e.sizes.full));return{title:document.querySelector(".content-headline a")?.textContent?.trim(),series:document.querySelector(".content-headline a")?.getAttribute("href"),pages:e.length,prev:"#",next:"#",listImages:e}}},ne={name:["3Hentai","HentaiVox"],url:/https?:\/\/(www\.)?(3hentai|hentaivox).(net|com)\/(d|view)\/.+\/.+/,homepage:["https://3hentai.net/","https://hentaivox.com/"],language:["English"],category:"hentai",waitVar:"readerPages",run:()=>({title:unsafeWindow.readerPages.title.replace(/- Page.+/,"").trim(),series:unsafeWindow.readerPages.baseUri.replace("%s",""),pages:unsafeWindow.readerPages.lastPage,prev:"#",next:"#",listImages:Object.keys(unsafeWindow.readerPages.pages).map((e=>unsafeWindow.readerPages.baseUriImg.replace("%s",unsafeWindow.readerPages.pages[e].f)))})},te={name:"TMOHentai",url:/https?:\/\/(www\.)?tmohentai.com\/reader\/.+\/(paginated\/\d+|cascade)/,homepage:"https://tmohentai.com/",language:["Spanish"],category:"hentai",run(){const e=[...document.querySelectorAll(".content-image")].map((e=>e.getAttribute("data-original")??e.getAttribute("src")));return{before(){window.location.pathname.includes("paginated")&&(window.location.pathname=window.location.pathname.replace(/paginated.*/,"cascade"))},title:document.querySelector(".reader-title")?.textContent?.trim(),series:document.querySelector(".nav-justified li a")?.getAttribute("href"),pages:e.length,prev:"#",next:"#",listImages:e}}},ae={name:"Tsumino",url:/https?:\/\/(www\.)?tsumino.com\/Read\/Index\/\d+(\?page=.+)?/,homepage:"https://tsumino.com/",language:["English"],category:"hentai",async run(){const e=document.querySelector("#image-container")?.getAttribute("data-opt"),n=document.querySelector("#image-container")?.getAttribute("data-cdn")??"",t=`https://www.tsumino.com/Read/Load?q=${e}`,a=await fetch(t).then((async e=>e.json()));return{title:document.querySelector("title")?.textContent?.replace(/.+Read/,"").trim(),series:a.reader_start_url,pages:a.reader_page_total,prev:"#",next:"#",listImages:Array(a.reader_page_total).fill(0).map(((e,t)=>n.replace("[PAGE]",`${t+1}`)))}}},oe={name:["vermangasporno","vercomicsporno"],url:/https?:\/\/(www\.)?(vermangasporno|vercomicsporno).com\/.+/,homepage:["https://vermangasporno.com/","https://vercomicsporno.com/"],language:["Spanish"],category:"hentai",waitEle:'img[loading="lazy"].size-full, .comicimg picture img, .wp-content img',run(){const e=[...document.querySelectorAll('img[loading="lazy"].size-full, .comicimg picture img, .wp-content img')];return{title:document.querySelector("h1.titl, title")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("data-lazy-src")??e.getAttribute("data-src")??e.getAttribute("src")))}}},ie={name:"wnacg",url:/https?:\/\/(www\.)?wnacg.com\/photos-view-id-.+/,homepage:"https://wnacg.com/",language:["English","Raw","Chinese"],category:"hentai",run(){const e=[...document.querySelectorAll(".pageselect option")];return{title:document.querySelector(".bread a:last-of-type")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listPages:e.map((e=>window.location.pathname.replace(/\d+/,e.value))),img:"#picarea"}}},re=[e,n,t,c,d,m,u,g,p,h,x,S,M,O,A,C,I,L,T,V,$,F,G,z,P,Z,H,J,ee,te,ne,ae,oe,ie,{name:"XlecxOne",url:/https?:\/\/(www\.)?xlecx.one\/.+/,homepage:"https://xlecx.one/",language:["English"],category:"hentai",run(){const e=[...new Set([...document.querySelectorAll("article .page__text img , article #content-2 img")].map((e=>e.getAttribute("data-src")??e.getAttribute("data-srce")??e.closest("a")?.getAttribute("href")??e.getAttribute("src"))))];return{title:document.querySelector("title")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e}}},{name:"xyzcomics",url:/https?:\/\/(www\.)?xyzcomics.com\/.+/,homepage:"https://xyzcomics.com/",language:["English"],category:"hentai",run(){const e=[...document.querySelectorAll(".jig-link")];return{title:document.querySelector(".entry-title")?.textContent?.trim(),pages:e.length,prev:"#",next:"#",listImages:e.map((e=>e.getAttribute("href")))}}},B],le=(e,...n)=>0===n.length?e[0]:String.raw({raw:e},...n),se=le,ce=le,de=[{ID:"en_US",NAME:"English (US)",STARTING:"Starting<br>Manga OnlineViewer",RESUME:"Resuming reading from Page ",WAITING:"Please wait, 3 seconds...",CHOOSE_BEGINNING:"Choose the Page to start from:",BUTTON_START:"Start Manga OnlineViewer",SETTINGS:"Settings",LANGUAGE:"Language",COLOR_SCHEME:"Color Scheme",THEME:"Theme",THEME_HUE:"Theme Primary Color Hue",THEME_SHADE:"Theme Primary Color Shade",DEFAULT_LOAD_MODE:"Default Load Mode",LOAD_MODE_NORMAL:"Normal(Wait 3 sec)",LOAD_MODE_ALWAYS:"Always(Immediately)",LOAD_MODE_NEVER:"Never(Manually)",LOAD_SPEED:"Load Speed Pages/Second",DEFAULT_ZOOM:"Default Zoom (between 5 and 200)",DEFAULT_ZOOM_MODE:"Default Zoom Mode",MINIMUM_ZOOM:"Minimum Zoom relative to the width of screen (between 30 and 100)",ZOOM_STEP:"Zoom Change Step (between 5 and 50)",DEFAULT_VIEW_MODE:"Default View Mode",VIEW_MODE_VERTICAL:"Vertical",VIEW_MODE_LEFT:"Left to Right",VIEW_MODE_RIGHT:"Right to Left",VIEW_MODE_WEBCOMIC:"WebComic",FIT_WIDTH_OVERSIZED:"Fit Width if Oversized",SHOW_THUMBNAILS:"Show Thumbnails",ENABLE_COMMENTS:"Capture Comments (When available)",HIDE_CONTROLS:"Always Hide Page Controls",HEADER_TYPE:"Change Header Type",HEADER_HOVER:"Hover",HEADER_SCROLL:"Scroll",HEADER_CLICK:"Click",HEADER_FIXED:"Fixed",HEADER_SIMPLE:"Simple",BUTTON_DOWNLOAD:"Download",DOWNLOAD_ZIP:"Download Zip file",DOWNLOAD_IMAGES:"Download Images as Zip Automatically",BUTTON_NEXT:"Next",NEXT_CHAPTER:"Next Chapter",BUTTON_PREVIOUS:"Previous",PREVIOUS_CHAPTER:"Previous Chapter",BOOKMARKS:"Bookmarks",BOOKMARK:"Bookmark",BOOKMARK_REMOVED:"Bookmark Removed",BOOKMARK_SAVED:"Bookmark Saved",BOOKMARK_MESSAGE:"Next time you open this chapter it will resume from:<h4>Page ##num##</h4>(Only <i>ONCE</i> per Bookmark)",KEYBINDINGS:"Keybindings",EDIT_KEYBINDS:"Edit KeyBindings",SAVE_KEYBINDS:"Save KeyBindings",BUTTON_EDIT:"Edit",BUTTON_SAVE:"Save",KEYBIND_RULES:"\n    <h3>Supported Keys</h3>\n    Allowed modifiers: shift, option, alt, ctrl, control, command. </br>\n    Special keys: backspace, tab, clear, enter, return, esc, escape, space, up, down, left, right, home, end, pageup, pagedown, del, delete, f1 - f19, num_0 - num_9, num_multiply, num_add, num_enter, num_subtract, num_decimal, num_divide. </br>\n    Examples: <kbd>a</kbd>, <kbd>ctrl+a</kbd> , <kbd>shift+a</kbd> , <kbd>num_2</kbd> , <kbd>2</kbd> \n  ",ATTENTION:"Attention",WARNING:"Warning",BUTTON_RESET_SETTINGS:"Reset Settings",SETTINGS_RESET:"Settings have been reset, reload the page to take effect",LANGUAGE_CHANGED:"Language has been changed, reload the page to take effect",AUTO_DOWNLOAD:"Next time a chapter finish loading you will be prompted to save automatically",LAZY_LOAD:"Lazy load is incompatible with zip download, you will not be able to download with this setting ON.<br/> Suggestion: <span style='color:red;font-weight:bold'>Disable Thumbnails</span> to save Bandwidth/Memory.",LAZY_LOAD_IMAGES_ENABLE:"Enable Lazy Load Images",LAZY_LOAD_IMAGES:"Lazy Start From Page (between 5 and 100)",RETURN_CHAPTER_LIST:"Return to Chapter List",PAGES_LOADED:"Pages Loaded",GO_TO_PAGE:"Go to Page",ENLARGE:"Enlarge",RESTORE:"Restore",REDUCE:"Restore",FIT_WIDTH:"Fit Width",FIT_HEIGHT:"Fit Height",PERCENT:"Percent",TOGGLE_CONTROLS:"Toggle page controls",ZOOM_IN:"Zoom In",ZOOM_OUT:"Zoom Out",ZOOM_RESET:"Zoom Reset",ZOOM_WIDTH:"Zoom to Width",ZOOM_HEIGHT:"Zoom to Height",HIDE:"Hide",RELOAD:"Reload",SLOWLY:"Slowly",NORMAL:"Normal",FAST:"Fast",EXTREME:"Extreme",ALL_PAGES:"All Pages",SPEED_WARNING:"Loading Speed too High",SPEED_WARNING_MESSAGE:"This speed is not recommended.<br> It may hurt some servers or get your IP marked as DDoS attacker.<br> Please use with caution!",SCROLL_UP:"Scroll Up",SCROLL_DOWN:"Scroll Down",CLOSE:"Close",LIST_EMPTY:"List Empty",DISPLAY_COMMENTS:"Display Comments",COMMENTS:"Comments Section",SCROLL_START:"Toggle Auto Scroll",AUTO_SCROLL_HEIGHT:"Auto Scroll Speed in Pixels",VERTICAL_SEPARATOR:"Show Vertical Separators",END:"End"},{ID:"es_ES",NAME:"Español (ES)",STARTING:"Iniciando<br>Manga OnlineViewer",RESUME:"Continuando lectura desde la Página ",WAITING:"Por favor espere, 3 segundos...",CHOOSE_BEGINNING:"Elija la página en la que comenzar:",BUTTON_START:"Iniciar Manga OnlineViewer",SETTINGS:"Ajustes",LANGUAGE:"Idioma",COLOR_SCHEME:"Esquema de color",THEME:"Tema",THEME_HUE:"Matiz del color primario",THEME_SHADE:"Saturación del color primario",DEFAULT_LOAD_MODE:"Modo de carga por defecto",LOAD_MODE_NORMAL:"Normal (Espera 3s)",LOAD_MODE_ALWAYS:"Siempre (Inmediatamente)",LOAD_MODE_NEVER:"Nunca (Manualmente)",LOAD_SPEED:"Velocidad carga página/segundo",DEFAULT_ZOOM:"Zoom por defecto (entre 5 y 200)",DEFAULT_ZOOM_MODE:"Modo de zoom por defecto",MINIMUM_ZOOM:"Zoom mínimo relativo al ancho de la pantalla",ZOOM_STEP:"Paso entre cambios de zoom (entre 5 y 50)",DEFAULT_VIEW_MODE:"Modo de visualización por defecto",VIEW_MODE_VERTICAL:"Vertical",VIEW_MODE_LEFT:"Izquierda a derecha",VIEW_MODE_RIGHT:"Derecha a izquierda",VIEW_MODE_WEBCOMIC:"WebComic",FIT_WIDTH_OVERSIZED:"Ajustar ancho si es demasiado grande",SHOW_THUMBNAILS:"Mostrar miniaturas",ENABLE_COMMENTS:"Capturar comentarios (cuando esté disponible)",HIDE_CONTROLS:"Ocultar siempre la barra de controles",HEADER_TYPE:"Cambiar tipo de cabecera",HEADER_HOVER:"Pasar por encima",HEADER_SCROLL:"Desplazamiento",HEADER_CLICK:"Hacer click",HEADER_FIXED:"Fijo",HEADER_SIMPLE:"Sencillo",BUTTON_DOWNLOAD:"Descargar",DOWNLOAD_ZIP:"Descargar fichero Zip",DOWNLOAD_IMAGES:"Autodescargar imágenes como Zip",BUTTON_NEXT:"Siguiente",NEXT_CHAPTER:"Siguiente capítulo",BUTTON_PREVIOUS:"Anterior",PREVIOUS_CHAPTER:"Capítulo anterior",BOOKMARKS:"Marcadores",BOOKMARK:"Marcador",BOOKMARK_REMOVED:"Marcador eliminado",BOOKMARK_SAVED:"Marcador guardado",BOOKMARK_MESSAGE:"La próxima vez que abra este capítulo, continuará desde la <h4>página ##num##</h4>(Sólo <i>UNA VEZ</i> por Marcador)",KEYBINDINGS:"Atajos de teclado",EDIT_KEYBINDS:"Editar atajos",SAVE_KEYBINDS:"Guardar atajos",BUTTON_EDIT:"Editar",BUTTON_SAVE:"Guardar",KEYBIND_RULES:"\n    <h3>Teclas soportadas</h3>\n    Modificadores permitidos: shift, option, alt, ctrl, control, command. </br>\n    Teclas especiales: backspace, tab, clear, enter, return, esc, escape, space, up, down, left, right, home, end, pageup, pagedown, del, delete, f1 - f19, num_0 - num_9, num_multiply, num_add, num_enter, num_subtract, num_decimal, num_divide. <br>\n    Ejemplos: <kbd>a</kbd>, <kbd>ctrl+a</kbd> , <kbd>shift+a</kbd> , <kbd>num_2</kbd> , <kbd>2</kbd> \n  ",ATTENTION:"Atención",WARNING:"Alerta",BUTTON_RESET_SETTINGS:"Reiniciar ajustes(Reset Settings)",SETTINGS_RESET:"Se han restablecido los ajustes, vuelve a cargar la página para que surta efecto",LANGUAGE_CHANGED:"Se ha cambiado el idioma, vuelve a cargar la página para que surta efecto",AUTO_DOWNLOAD:"La próxima vez que termine de cargarse un capítulo, se le pedirá que guarde automáticamente",LAZY_LOAD:"La carga diferida es incompatible con la descarga zip, no podrá descargar con este ajuste activado.<br/> Sugerencia: <span style='color:red;font-weight:bold'>Desactivar miniaturas</span> para ahorrar Ancho de banda/Memoria.",LAZY_LOAD_IMAGES_ENABLE:"Habilitar carga de imágenes diferida",LAZY_LOAD_IMAGES:"Empezar carga diferida a partir de la página (entre 5 y 100)",RETURN_CHAPTER_LIST:"Regresar a la lista de capítulos",PAGES_LOADED:"Páginas cargadas",GO_TO_PAGE:"Ir a página",ENLARGE:"Agrandar",RESTORE:"Restaurar",REDUCE:"Reducir",FIT_WIDTH:"Ajustar al ancho",FIT_HEIGHT:"Ajustar al alto",PERCENT:"Porcentual",TOGGLE_CONTROLS:"Alternar controles de página",ZOOM_IN:"Acercar",ZOOM_OUT:"Alejar",ZOOM_RESET:"Restablecer zoom",ZOOM_WIDTH:"Zoom al ancho",ZOOM_HEIGHT:"Zoom al alto",HIDE:"Ocultar",RELOAD:"Recargar",SLOWLY:"Lento",NORMAL:"Normal",FAST:"Rápido",EXTREME:"Extremo",ALL_PAGES:"Todas las páginas",SPEED_WARNING:"Velocidad de carga muy alta",SPEED_WARNING_MESSAGE:"No se recomienda esta velocidad.<br> Puede dañar algunos servidores o marcar su IP como atacante DDoS.<br> ¡Utilícelo con precaución!",SCROLL_UP:"Desplazar arriba",SCROLL_DOWN:"Desplazar abajo",CLOSE:"Cerrar",LIST_EMPTY:"Lista vacía",DISPLAY_COMMENTS:"Mostrar comentarios",COMMENTS:"Sección de comentarios",SCROLL_START:"Alternar desplazamiento automático",AUTO_SCROLL_HEIGHT:"Velocidad de desplazamiento automático en píxeles",VERTICAL_SEPARATOR:"Mostrar separadores verticales",END:"Fin"},{ID:"pt_BR",NAME:"Portugues (Brasil)",STARTING:"Iniciando<br>Manga OnlineViewer",RESUME:"Continuando leitura na Pagina ",WAITING:"Por Favor espere, 3 segundos...",CHOOSE_BEGINNING:"Escolha a pagina de onde começar:",BUTTON_START:"Iniciar Manga OnlineViewer",SETTINGS:"Configurações",LANGUAGE:"Idioma",COLOR_SCHEME:"Esquema de Color",THEME:"Tema",THEME_HUE:"Coloração primaria",THEME_SHADE:"Saturação de Cor",DEFAULT_LOAD_MODE:"Forma de Carregamento Padrão",LOAD_MODE_NORMAL:"Normal(Esperando 3 sec)",LOAD_MODE_ALWAYS:"Sempre(Imediatamente)",LOAD_MODE_NEVER:"Nunca(Manualmente)",LOAD_SPEED:"Velocidade de Carregamento Paginas/Segundo",DEFAULT_ZOOM:"Zoom padrão (entre 5 e 200)",DEFAULT_ZOOM_MODE:"Modo de Zoom padrão",MINIMUM_ZOOM:"Zoom minimo, relativo ao tamanho da tela (entre 30 e 100)",ZOOM_STEP:"Precisão da Mudança do Zoom (entre 5 e 50)",DEFAULT_VIEW_MODE:"Modo de Visualização Padrão",VIEW_MODE_VERTICAL:"Vertical",VIEW_MODE_LEFT:"Esquerda para Direita",VIEW_MODE_RIGHT:"Direita para Esquerda",VIEW_MODE_WEBCOMIC:"WebComic",FIT_WIDTH_OVERSIZED:"Encher a tela se grande demais",SHOW_THUMBNAILS:"Mostra Miniaturas",ENABLE_COMMENTS:"Capturar comentários (quando disponível)",HIDE_CONTROLS:"Sempre esconder controles das paginas",HEADER_TYPE:"Mudar Tipo de Cabeçalho",HEADER_HOVER:"Passar por perto",HEADER_SCROLL:"Rolagem do Mouse",HEADER_CLICK:"Click",HEADER_FIXED:"Fixo",HEADER_SIMPLE:"Simples",BUTTON_DOWNLOAD:"Download",DOWNLOAD_ZIP:"Baixar arquivo Zip",DOWNLOAD_IMAGES:"Download das Imagens como Zip Automaticamente",BUTTON_NEXT:"Proximo",NEXT_CHAPTER:"Proximo Capitulo",BUTTON_PREVIOUS:"Anterior",PREVIOUS_CHAPTER:"Capitulo Anterior",BOOKMARKS:"Marca paginas",BOOKMARK:"Marcar pagina",BOOKMARK_REMOVED:"Marca pagina Removido",BOOKMARK_SAVED:"Marca pagina Salvo",BOOKMARK_MESSAGE:"Proxima vez que abrir este capitulo continuará a partir da <h4>Pagina ##num##</h4>(Apenas <i>UMA VEZ</i> por marca pagina)",KEYBINDINGS:"Atalhos",EDIT_KEYBINDS:"Editar Atalhos",SAVE_KEYBINDS:"Salvar Atalhos",BUTTON_EDIT:"Editar",BUTTON_SAVE:"Salvar",KEYBIND_RULES:"\n    <h3>Teclas Suportadas</h3>\n    Modificadores permitidos: shift, option, alt, ctrl, control, command. </br>\n    Teclas Especiais: backspace, tab, clear, enter, return, esc, escape, space, up, down, left, right, home, end, pageup, pagedown, del, delete, f1 - f19, num_0 - num_9, num_multiply, num_add, num_enter, num_subtract, num_decimal, num_divide.</br>\n    Exemplos: <kbd>a</kbd>, <kbd>ctrl+a</kbd> , <kbd>shift+a</kbd> , <kbd>num_2</kbd> , <kbd>2</kbd> \n  ",ATTENTION:"Atenção",WARNING:"Alerta",BUTTON_RESET_SETTINGS:"Limpar Configurações(Reset Settings)",SETTINGS_RESET:"Configurações foram limpas, recarregue o site para efetivar a alteração",LANGUAGE_CHANGED:"Idioma foi alterado, recarregue o site para efetivar a alteração",AUTO_DOWNLOAD:"Proxima vez que abrir um capitulo download iniciara automaticamente",LAZY_LOAD:"Carregamento preguiçoso não é compativel com download de zip, não conseguira com essa configuração ativa.<br/> Sugestão: <span style='color:red;font-weight:bold'>Desative Miniaturas</span> para economizar memoria e cota de internet.",LAZY_LOAD_IMAGES_ENABLE:"Ativar Carregamento de imagens preguiçoso",LAZY_LOAD_IMAGES:"Carregamento de paginas preguiçoso começa a partir de (entre 5 e 100)",RETURN_CHAPTER_LIST:"Voltar a lista de Capitulos",PAGES_LOADED:"Paginas Carregadas",GO_TO_PAGE:"Pular para",ENLARGE:"Aumentar",RESTORE:"Restaurar",REDUCE:"Diminuir",FIT_WIDTH:"Preencher Largura",FIT_HEIGHT:"Preencher Altura ",PERCENT:"Percentual",TOGGLE_CONTROLS:"Mostar controles de pagina",ZOOM_IN:"Mais Zoom",ZOOM_OUT:"Menos Zoom",ZOOM_RESET:"Resetar Zoom",ZOOM_WIDTH:"Zoom para Largura",ZOOM_HEIGHT:"Zoom para Altura",HIDE:"Esconder",RELOAD:"Recarregar",SLOWLY:"Devagar",NORMAL:"Normal",FAST:"Rapido",EXTREME:"Extremo",ALL_PAGES:"Todas as Paginas",SPEED_WARNING:"Velocidade de Carregamento muito alta",SPEED_WARNING_MESSAGE:"Essa velocidade não é recomendada.<br> Ela pode derrubar um servidor or marcar voce como um ataque hacker de DDoS.<br> Use com cuidado!",SCROLL_UP:"Subir Pagina",SCROLL_DOWN:"Descer Pagina",CLOSE:"Fechar",LIST_EMPTY:"Lista Vazia",DISPLAY_COMMENTS:"Mostar Comentarios",COMMENTS:"Seção de comentários",SCROLL_START:"Ativar Rolagem Automatica",AUTO_SCROLL_HEIGHT:"Velocidade da Rolagem Automatica em Pixels",VERTICAL_SEPARATOR:"Mostrar Separadores Verticais",END:"Fin"},{ID:"zh_CN",NAME:"中文 (简体)",STARTING:"正在启动<br>Manga OnlineViewer",RESUME:"从页面继续阅读 ",WAITING:"请等待3秒钟...",CHOOSE_BEGINNING:"选择要开始的页数:",BUTTON_START:"启动Manga OnlineViewer",SETTINGS:"设置",LANGUAGE:"语言",COLOR_SCHEME:"配色方案",THEME:"主题",THEME_HUE:"主题色调",THEME_SHADE:"主题阴影",DEFAULT_LOAD_MODE:"默认加载模式",LOAD_MODE_NORMAL:"等待模式(等待3秒自动加载 )",LOAD_MODE_ALWAYS:"自动模式(无需等待)",LOAD_MODE_NEVER:"手动模式(点击启动)",LOAD_SPEED:"加载速度页数/秒",DEFAULT_ZOOM:"默认缩放 (最小 5 最大 200)",DEFAULT_ZOOM_MODE:"默认缩放模式",MINIMUM_ZOOM:"相对于屏幕宽度的最小缩放 (最小 30 最大 100)",ZOOM_STEP:"缩放级别 (最小 5 最大 50)",DEFAULT_VIEW_MODE:"默认视图模式",VIEW_MODE_VERTICAL:"垂直有缝",VIEW_MODE_LEFT:"从左到右",VIEW_MODE_RIGHT:"从右到左",VIEW_MODE_WEBCOMIC:"垂直无缝",FIT_WIDTH_OVERSIZED:"如果尺寸过大、则适合宽度",SHOW_THUMBNAILS:"显示缩略图",ENABLE_COMMENTS:"捕获评论（如果可用）",HIDE_CONTROLS:"始终隐藏页面控件",HEADER_TYPE:"更改标题显示方式",HEADER_HOVER:"悬停",HEADER_SCROLL:"滚动",HEADER_CLICK:"点击",HEADER_FIXED:"固定",HEADER_SIMPLE:"简单",BUTTON_DOWNLOAD:"下载",DOWNLOAD_ZIP:"下载压缩文件",DOWNLOAD_IMAGES:"自动将图片下载成ZIP",BUTTON_NEXT:"下一页",NEXT_CHAPTER:"下一章",BUTTON_PREVIOUS:"上一页",PREVIOUS_CHAPTER:"上一章",BOOKMARKS:"书签",BOOKMARK:"Bookmark",BOOKMARK_REMOVED:"删除书签",BOOKMARK_SAVED:"保存书签",BOOKMARK_MESSAGE:"下次打开本章时，将从:<h4>页码 ##num##</h4>(<i>仅一次</i> 每个书签)",KEYBINDINGS:"快捷键",EDIT_KEYBINDS:"编辑键绑定",SAVE_KEYBINDS:"保存键绑定",BUTTON_EDIT:"编辑",BUTTON_SAVE:"救",KEYBIND_RULES:"\n    <h3>支持的密钥</h3>\n    允许的修饰符: shift, option, alt, ctrl, control, command. </br>\n    特殊键: backspace, tab, clear, enter, return, esc, escape, space, up, down, left, right, home, end, pageup, pagedown, del, delete, f1 - f19, num_0 - num_9, num_multiply, num_add, num_enter, num_subtract, num_decimal, num_divide.</br>\n    例子: <kbd>a</kbd>, <kbd>ctrl+a</kbd> , <kbd>shift+a</kbd> , <kbd>num_2</kbd> , <kbd>2</kbd> \n  ",ATTENTION:"注意",WARNING:"警告",BUTTON_RESET_SETTINGS:"重置设置(Reset Settings)",SETTINGS_RESET:"设置已重置、重新加载页面才能生效",LANGUAGE_CHANGED:"语言已更改、重新加载页面才能生效",AUTO_DOWNLOAD:"下次章节加载完成时、系统将提示您自动保存",LAZY_LOAD:"延迟加载与zip下载不兼容、您将无法使用此设置下载.<br/> 建议: <span style='color:red;font-weight:bold'>禁用缩略图</span> 以节省流量和内存.",LAZY_LOAD_IMAGES_ENABLE:"启用延迟加载图像",LAZY_LOAD_IMAGES:"惰性加载从页面 (最小 5 最大 100)",RETURN_CHAPTER_LIST:"返回章节列表",PAGES_LOADED:"已加载的页数",GO_TO_PAGE:"转到页数",ENLARGE:"放大",RESTORE:"还原",REDUCE:"缩小",FIT_WIDTH:"适合宽度",FIT_HEIGHT:"适合高度",PERCENT:"百分之",TOGGLE_CONTROLS:"显示隐藏页面控件",ZOOM_IN:"放大",ZOOM_OUT:"缩小",ZOOM_RESET:"还原",ZOOM_WIDTH:"适合宽度",ZOOM_HEIGHT:"适合高度",HIDE:"显示隐藏页面控件",RELOAD:"重新加载",SLOWLY:"慢速",NORMAL:"正常",FAST:"快速",EXTREME:"极端",ALL_PAGES:"所有页面",SPEED_WARNING:"加载速度过高",SPEED_WARNING_MESSAGE:"不建议使用此速度.<br>它可能会伤害某些服务器或将您的 IP 标记为 DDoS 攻击者.<br>请谨慎使用!",SCROLL_UP:"向上滚动",SCROLL_DOWN:"向下滚动",CLOSE:"关闭",LIST_EMPTY:"没有收藏书签",DISPLAY_COMMENTS:"显示注释",COMMENTS:"评论部分",SCROLL_START:"切换自动滚动",AUTO_SCROLL_HEIGHT:"自动滚动速度（以像素为单位）",VERTICAL_SEPARATOR:"显示垂直分隔符",END:"结尾"}],me={locale:"en_US",theme:"darkblue",customTheme:"#263e3a",themeShade:600,colorScheme:"dark",fitWidthIfOversize:!0,showThumbnails:!0,enableComments:!0,downloadZip:!1,verticalSeparator:!1,throttlePageLoad:1e3,zoomMode:"percent",defaultZoom:100,zoomStep:25,minZoom:30,loadMode:"wait",viewMode:"WebComic",bookmarks:[],lazyLoadImages:!1,lazyStart:50,hidePageControls:!1,header:"hover",maxReload:5,scrollHeight:20,keybinds:{SCROLL_UP:["up","W","num_8"],SCROLL_DOWN:["down","S","num_2"],NEXT_CHAPTER:["right","/","D","num_6"],PREVIOUS_CHAPTER:["left",";","A","num_4"],ENLARGE:["-","num_add","E"],REDUCE:["=","num_subtract","Q"],RESTORE:["9","num_divide","R"],FIT_WIDTH:["0","num_multiply","F"],FIT_HEIGHT:["H"],SETTINGS:["num_divide","num_5","X"],VIEW_MODE_WEBCOMIC:["C"],VIEW_MODE_VERTICAL:["V"],VIEW_MODE_LEFT:["N"],VIEW_MODE_RIGHT:["B"],SCROLL_START:["space"]}},ue=()=>"mobile"!==Y()&&"tablet"!==Y()?me:_.defaultsDeep({lazyLoadImages:!0,fitWidthIfOversize:!0,showThumbnails:!1,viewMode:"WebComic",header:"click"},me);let ge=_.defaultsDeep(function(e){return q("settings",e)}(ue()),ue());function pe(){return ge}function he(e){const n=de.find((e=>e.ID===ge.locale));return n?.[e]?n[e]:de?.at(1)?.[e]?de[1][e]:"##MISSING_STRING##"}function we(e){W(JSON.stringify(e)),ge={...ge,...e},j(((e,n)=>{const t=(e,n)=>_.transform(e,((e,a,o)=>{_.isEqual(a,n[o])||(_.isArray(a)?e[o]=_.difference(a,n[o]):_.isObject(a)&&_.isObject(n[o])?e[o]=t(a,n[o]):e[o]=a)}));return t(e,n)})(ge,ue()))}function be(){("undefined"!=typeof GM_listValues?GM_listValues():[]).forEach((e=>{var n;n=e,"undefined"!=typeof GM_deleteValue?GM_deleteValue(n):W("Removing: ",n)})),we(ue())}function fe(e=window.location.href){return ge.bookmarks.find((n=>n.url===e))?.page}const ve=ge.bookmarks.filter((e=>Date.now()-new Date(e.date).valueOf()<31104e6));ge.bookmarks.length!==ve.length&&we({bookmarks:ve});const ye={dark:{name:"dark",50:"#C1C2C5",100:"#A6A7AB",200:"#909296",300:"#5c5f66",400:"#373A40",500:"#2C2E33",600:"#25262b",700:"#1A1B1E",800:"#141517",900:"#101113"},gray:{name:"gray",50:"#f8f9fa",100:"#f1f3f5",200:"#e9ecef",300:"#dee2e6",400:"#ced4da",500:"#adb5bd",600:"#868e96",700:"#495057",800:"#343a40",900:"#212529"},red:{name:"red",50:"#fff5f5",100:"#ffe3e3",200:"#ffc9c9",300:"#ffa8a8",400:"#ff8787",500:"#ff6b6b",600:"#fa5252",700:"#f03e3e",800:"#e03131",900:"#c92a2a"},pink:{name:"pink",50:"#fff0f6",100:"#ffdeeb",200:"#fcc2d7",300:"#faa2c1",400:"#f783ac",500:"#f06595",600:"#e64980",700:"#d6336c",800:"#c2255c",900:"#a61e4d"},grape:{name:"grape",50:"#f8f0fc",100:"#f3d9fa",200:"#eebefa",300:"#e599f7",400:"#da77f2",500:"#cc5de8",600:"#be4bdb",700:"#ae3ec9",800:"#9c36b5",900:"#862e9c"},violet:{name:"violet",50:"#f3f0ff",100:"#e5dbff",200:"#d0bfff",300:"#b197fc",400:"#9775fa",500:"#845ef7",600:"#7950f2",700:"#7048e8",800:"#6741d9",900:"#5f3dc4"},indigo:{name:"purple",50:"#edf2ff",100:"#dbe4ff",200:"#bac8ff",300:"#91a7ff",400:"#748ffc",500:"#5c7cfa",600:"#4c6ef5",700:"#4263eb",800:"#3b5bdb",900:"#364fc7"},blue:{name:"blue",50:"#e7f5ff",100:"#d0ebff",200:"#a5d8ff",300:"#74c0fc",400:"#4dabf7",500:"#339af0",600:"#228be6",700:"#1c7ed6",800:"#1971c2",900:"#1864ab"},cyan:{name:"cyan",50:"#e3fafc",100:"#c5f6fa",200:"#99e9f2",300:"#66d9e8",400:"#3bc9db",500:"#22b8cf",600:"#15aabf",700:"#1098ad",800:"#0c8599",900:"#0b7285"},teal:{name:"teal",50:"#e6fcf5",100:"#c3fae8",200:"#96f2d7",300:"#63e6be",400:"#38d9a9",500:"#20c997",600:"#12b886",700:"#0ca678",800:"#099268",900:"#087f5b"},green:{name:"green",50:"#ebfbee",100:"#d3f9d8",200:"#b2f2bb",300:"#8ce99a",400:"#69db7c",500:"#51cf66",600:"#40c057",700:"#37b24d",800:"#2f9e44",900:"#2b8a3e"},lime:{name:"lime",50:"#f4fce3",100:"#e9fac8",200:"#d8f5a2",300:"#c0eb75",400:"#a9e34b",500:"#94d82d",600:"#82c91e",700:"#74b816",800:"#66a80f",900:"#5c940d"},yellow:{name:"yellow",50:"#fff9db",100:"#fff3bf",200:"#ffec99",300:"#ffe066",400:"#ffd43b",500:"#fcc419",600:"#fab005",700:"#f59f00",800:"#f08c00",900:"#e67700"},orange:{name:"orange",50:"#fff4e6",100:"#ffe8cc",200:"#ffd8a8",300:"#ffc078",400:"#ffa94d",500:"#ff922b",600:"#fd7e14",700:"#f76707",800:"#e8590c",900:"#d9480f"},darkblue:{name:"darkblue",50:"#E8F4F9",100:"#D9DEE9",200:"#B7C2DA",300:"#6482C0",400:"#4267B2",500:"#385898",600:"#314E89",700:"#29487D",800:"#223B67",900:"#1E355B"}};function Ee(e){const n=tinycolor(e);return function(e,n){return e.l=n,tinycolor(e).toHexString()}(n.toHsl(),n.isDark()?95:10)}function ke(e){const n=e.replace(/[\t\n\r]/gim,"").replace(/\s\s+/g," ");return`data:image/svg+xml;charset=UTF-8,${encodeURIComponent(n).replace(/\(/g,"%28").replace(/\)/g,"%29")}`}const xe=e=>e%100==0?15:e%50==0?10:e%25==0?5:2.5;function Se(e,n,t="#0F1C3F",a="#ECEAD9"){const o=function(e,n,t,a){let o="";for(let n=0;n<=e;n+=5)o+=se` <line
      ...
      />`,0!==n&&n%50==0&&(o+=se` <text
        ...
        >
          ${n}
        </text>`);for(let e=0;e<=n;e+=5)o+=se` <line
        x1="0"
        y1="${e}"
        x2="${xe(e)}"
        y2="${e}"
      />`,0!==e&&e%50==0&&(o+=se` <text
          x="25"
          y="${e}"
          text-anchor="middle"
    ...
    #MangaOnlineViewer .Thumbnail .ThumbnailImg.imgBroken {
      background-image: url("${ke('<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-photo-off" width="24"\n     height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"\n     stroke-linecap="round" stroke-linejoin="round">\n    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n    <path d="M15 8h.01"/>\n    <path d="M7 3h11a3 3 0 0 1 3 3v11m-.856 3.099a2.991 2.991 0 0 1 -2.144 .901h-12a3 3 0 0 1 -3 -3v-12c0 -.845 .349 -1.608 .91 -2.153"/>\n    <path d="M3 16l5 -5c.928 -.893 2.072 -.893 3 0l5 5"/>\n    <path d="M16.33 12.338c.574 -.054 1.155 .166 1.67 .662l3 3"/>\n    <path d="M3 3l18 18" color="orange"/>\n</svg>\n\n\n')}");
    }

    #MangaOnlineViewer .ThemeRadio.custom {
      /*background-image: url("${ke(Be)}");*/
    }
  ...
  `;function Ge(e,n){if(!document.querySelector(`#${e}`)){(document.head??document.querySelector("head")).appendChild(function(e,n){const t=document.createElement("style");return t.id=e,t.appendChild(document.createTextNode(n)),t}(e,n))}}function ze(e,n){!function(e){document.querySelectorAll(`style[id="${e}"]`).forEach((e=>{e.remove()}))}(e),Ge(e,n)}function Pe(e,n){return se`
    ...
    <div id="ThemeSection">
      ...
      <div class="ControlLabel ThemeSelector">
        ...
        ${"custom"===pe().theme?"selected":""}"
          title="custom"
        >
          ${Be} ${Re}
        </span>
        ${[...Object.keys(ye).map((e=>ye[e].name))].map((e=>se`
          <span
            title="${e}"
            class="${e} ThemeRadio ${pe().theme===e?"selected":""}"
          >
            ${Re}
          </span>
        `)).join("")}
      ...
      ${pe().theme.startsWith("custom")?"show":""}"
      >
        ${he("THEME_HUE")}
        <input
          id="CustomThemeHue"
          type="color"
          value="${pe().customTheme}"
  ...
  `,Xe=se`
    <div class="ControlLabel loadMode">
      ${he("DEFAULT_LOAD_MODE")}
      <select id="loadMode">
        <option
          value="wait"
          ${"wait"===pe().loadMode?"selected":""}
        >
          ${he("LOAD_MODE_NORMAL")}
        </option>
        <option
          value="always"
          ${"always"===pe().loadMode?"selected":""}
        >
          ${he("LOAD_MODE_ALWAYS")}
        </option>
        <option
          value="never"
          ${"never"===pe().loadMode?"selected":""}
        >
          ${he("LOAD_MODE_NEVER")}
        </option>
      </select>
  ...
  `,Ke=se`
    <div class="ControlLabel PagesPerSecond">
      ...
      <select id="PagesPerSecond">
        <option
          value="3000"
          ${3e3===pe().throttlePageLoad?"selected":""}
        >
          0.3(${he("SLOWLY")})
        </option>
        <option
          value="2000"
          ${2e3===pe().throttlePageLoad?"selected":""}
        >
          0.5
        </option>
        <option
          value="1000"
          ${1e3===pe().throttlePageLoad?"selected":""}
        >
          01(${he("NORMAL")})
        </option>
        <option
          value="500"
          ${500===pe().throttlePageLoad?"selected":""}
        >
          02
        </option>
        <option
          value="250"
          ${250===pe().throttlePageLoad?"selected":""}
        >
          04(${he("FAST")})
        </option>
        <option
          value="125"
          ${125===pe().throttlePageLoad?"selected":""}
        >
          08
        </option>
        <option
          value="100"
          ${100===pe().throttlePageLoad?"selected":""}
        >
          10(${he("EXTREME")})
        </option>
        <option
          value="1"
          ${1===pe().throttlePageLoad?"selected":""}
        >
          ${he("ALL_PAGES")}
        </option>
      </select>
    </div>
  `,Je=se` <div class="ControlLabel DefaultZoomMode">
    ${he("DEFAULT_ZOOM_MODE")}
    <select id="DefaultZoomMode">
      <option
        value="percent"
        ${"percent"===pe().zoomMode?"selected":""}
      >
        ${he("PERCENT")}
      </option>
      <option
        value="width"
        ${"width"===pe().zoomMode?"selected":""}
      >
        ${he("FIT_WIDTH")}
      </option>
      <option
        value="height"
        ${"height"===pe().zoomMode?"selected":""}
      >
        ${he("FIT_HEIGHT")}
      </option>
    </select>
  ...
  `,an=se`
    <div class="ControlLabel viewMode">
      ${he("DEFAULT_VIEW_MODE")}
      <select id="viewMode">
        <option
          value="Vertical"
          ${"Vertical"===pe().viewMode?"selected":""}
        >
          ${he("VIEW_MODE_VERTICAL")}
        </option>
        <option
          value="WebComic"
          ${"WebComic"===pe().viewMode?"selected":""}
        >
          ${he("VIEW_MODE_WEBCOMIC")}
        </option>
        <option
          value="FluidLTR"
          ${"FluidLTR"===pe().viewMode?"selected":""}
        >
          ${he("VIEW_MODE_LEFT")}
        </option>
        <option
          value="FluidRTL"
          ${"FluidRTL"===pe().viewMode?"selected":""}
        >
          ${he("VIEW_MODE_RIGHT")}
        </option>
      </select>
  ...
  `,rn=se`
    <div class="ControlLabel headerType">
      ...
      <select id="headerType">
        <option
          value="hover"
          ${"hover"===pe().header?"selected":""}
        >
          ${he("HEADER_HOVER")}
        </option>
        <option
          value="scroll"
          ${"scroll"===pe().header?"selected":""}
        >
          ${he("HEADER_SCROLL")}
        </option>
        <option
          value="click"
          ${"click"===pe().header?"selected":""}
        >
          ${he("HEADER_CLICK")}
        </option>
        <option
          value="fixed"
          ${"fixed"===pe().header?"selected":""}
        >
          ${he("HEADER_FIXED")}
        </option>
        <option
          value="simple"
          ${"simple"===pe().header?"selected":""}
        >
          ${he("HEADER_SIMPLE")}
        </option>
      </select>
  ...
  `,ln=se`
    <div class="ControlLabel verticalSeparator">
      ${he("VERTICAL_SEPARATOR")}
      <input
        type="checkbox"
        value="true"
        name="verticalSeparator"
        id="verticalSeparator"
        ${pe().verticalSeparator?"checked":""}
      />
    </div>
    <div class="ControlLabel fitIfOversize">
      ${he("FIT_WIDTH_OVERSIZED")}
      <input
        type="checkbox"
        value="true"
        name="fitIfOversize"
        id="fitIfOversize"
        ${pe().fitWidthIfOversize?"checked":""}
      />
    </div>
    ...
    <div class="ControlLabel enableComments">
      ...
      <input
        ...
        name="enableComments"
        id="enableComments"
        ${pe().enableComments?"checked":""}
      />
    </div>
    <div class="ControlLabel lazyLoadImages">
      ${he("LAZY_LOAD_IMAGES_ENABLE")}
      <input
        type="checkbox"
        value="true"
        name="lazyLoadImages"
        id="lazyLoadImages"
        ${pe().lazyLoadImages?"checked":""}
      />
    </div>
    ${on}
    ...
    <div class="ControlLabel hidePageControls">
      ...
      <input
        ...
        id="hidePageControls"
        ${pe().hidePageControls?"checked":""}
      />
    </div>
  `,sn=se`
    <div class="ControlLabel autoScroll">
      <span>
        ${he("AUTO_SCROLL_HEIGHT")}
        <output id="scrollHeightVal" for="scrollHeight">
          ${pe().scrollHeight} </output
        >px
      </span>
      <input
        type="range"
        value="${pe().scrollHeight}"
        name="scrollHeight"
        id="scrollHeight"
        min="1"
        max="100"
  ...
  `,cn=()=>se`
    <div id="SettingsPanel" class="panel">
      ...
      <button id="ResetSettings" class="ControlButton">
        ${he("BUTTON_RESET_SETTINGS")}
      </button>
      ${Qe} ${Ye} ${Xe} ${Ke} ${Je}
      ${en} ${nn} ${tn} ${an} ${ln}
      ${rn} ${sn}
    </div>
  `,dn=()=>Object.keys(pe().keybinds).map((e=>{const n=pe().keybinds[e]?.length?pe().keybinds[e]?.map((e=>se`<kbd class="dark">${e}</kbd>`)).join(" / "):"";return se`<span>${he(e)}:</span> <span>${n}</span>`})),mn=()=>se`
    <div id="KeybindingsPanel" class="panel">
      <h2>${he("KEYBINDINGS")}</h2>
      <button
        id="CloseKeybindings"
        class="closeButton"
        title="${he("CLOSE")}"
      ...
      <div class="controls">
        ...
        <button
          ...
          type="button"
          title="${he("SAVE_KEYBINDS")}"
        >
          ${'<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-device-floppy" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M6 4h10l4 4v10a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2" />\n  <path d="M12 14m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" />\n  <path d="M14 4l0 4l-6 0l0 -4" />\n</svg>\n\n\n'} ${he("BUTTON_SAVE")}
        </button>
      </div>
      <div id="KeybindingsList">${dn().join("\n")}</div>
    </div>
  `;function un(e,n=1){return Array(e).fill(0).map(((e,n)=>n+1)).filter((e=>e>=n))}const gn=()=>se`
  ...
  `;function pn(){const e=document.getElementById("BookmarksList");e&&(e.innerHTML=(a(pe().bookmarks)?[he("LIST_EMPTY")]:pe().bookmarks.map(((e,n)=>se`
      ...
      `))).join(""))}const hn=e=>{return se`
    <header id="Header" class="${pe().header} headroom-top">
      <aside id="GlobalFunctions">
        ...
        <span id="ZoomSlider">
          <output id="ZoomVal" class="RangeValue" for="Zoom">
            ${"percent"===pe().zoomMode?`${pe().defaultZoom}%`:pe().zoomMode}
          </output>
          <input
            type="range"
            value="${pe().defaultZoom}"
      ...
      <nav id="ChapterNavigation">
        <div id="Counters" class="ControlLabel">
          ...
          >
          <span class="ControlLabel"> ${he("GO_TO_PAGE")}: </span>
          <select id="gotoPage">
            <option selected>#</option>
            ${(n=e.pages,t=e.begin,un(n,t).map((e=>se` <option value="${e}">${e}</option>`))).join("")}
          </select>
        </div>
        <div id="ChapterControl" class="ChapterControl">
          ...
          <span>
            ...
            <a
              ...
              type="button"
              href="${e.next??""}"
              title="${he("NEXT_CHAPTER")}"
            >
              ${he("BUTTON_NEXT")} ${'<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-big-right" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M4 9h8v-3.586a1 1 0 0 1 1.707 -.707l6.586 6.586a1 1 0 0 1 0 1.414l-6.586 6.586a1 1 0 0 1 -1.707 -.707v-3.586h-8a1 1 0 0 1 -1 -1v-4a1 1 0 0 1 1 -1z" />\n</svg>\n\n\n'}
            </a>
          </span>
        </div>
      </nav>
    </header>
  `;var n,t},wn=e=>{return se`
    <main
      id="Chapter"
      class="${pe().fitWidthIfOversize?"fitWidthIfOversize":""}
  ${pe().verticalSeparator?"separator":""}
  ${pe().viewMode}"
    >
      ${(n=e.pages,t=e.begin,un(n,t).map((e=>se`
  ...
  `;var n,t},bn=()=>se`
    <div id="CommentsPanel" class="panel">
      ...
      <h2>${he("COMMENTS")}</h2>
      <div id="CommentsArea" class="${pe().colorScheme}"></div>
      <button id="CommentsColorScheme" class="simpleButton ColorScheme">
        ${Ve} ${De}
      </button>
    </div>
  `;function fn(e){const n=document.querySelector("#Chapter");n?.classList.contains("FluidLTR")||n?.classList.contains("FluidRTL")?n?.scroll(e?.offsetLeft??0,e?.offsetTop??0):window?.scroll(e?.offsetLeft??0,e?.offsetTop??0)}function vn(e,n){return t=>t.addEventListener(e,n)}function yn(e){e.deltaY&&(e.currentTarget.scrollLeft+=e.deltaY+e.deltaX,e.preventDefault())}function En(e){e.deltaY&&(e.currentTarget.scrollLeft-=e.deltaY+e.deltaX,e.preventDefault())}function kn(){document.querySelector("#BookmarksPanel")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function xn(e=window.location.href){o(fe(e))||(W(`Bookmark Removed ${e}`),we({bookmarks:pe().bookmarks.filter((n=>n.url!==e))}),e===window.location.href&&document.querySelector("#MangaOnlineViewer")?.classList.remove("bookmarked"))}function Sn(e){const n=e.currentTarget.value;W(`Bookmark Removed ${n}`),Swal.fire({title:he("BOOKMARK_REMOVED"),timer:1e4,icon:"error"}),xn(n),pn(),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(vn("click",Sn))}function Mn(){pn(),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(vn("click",Sn)),document.querySelector("#BookmarksPanel")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function On(e){document.querySelector("#MangaOnlineViewer")?.classList.toggle("bookmarked");const n=[...document.querySelectorAll(".MangaPage")].map((e=>Math.abs(e.offsetTop-window.scrollY))),t=parseInt(e.currentTarget.parentElement?.querySelector(".PageIndex")?.textContent??"0",10)||n.indexOf(Math.min(...n))+1,a={name:document.querySelector("title")?.textContent?.trim().replace(/^\(\d+%\) */,"")??"",url:window.location.href,page:t,date:(new Date).toISOString().slice(0,10)};fe(a.url)?(we({bookmarks:pe().bookmarks.filter((e=>e.url!==a.url))}),Swal.fire({title:he("BOOKMARK_REMOVED"),timer:1e4,icon:"error"})):(we({bookmarks:[...pe().bookmarks,a]}),Swal.fire({title:he("BOOKMARK_SAVED"),html:he("BOOKMARK_SAVED").replace("##NUM##",t.toString()),icon:"success"})),pn(),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(vn("click",Sn))}var An,Cn="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},In={exports:{}};var Ln,Tn=(An||(An=1,Ln=In,function(){function e(e,n){return void 0===n?n={autoBom:!1}:"object"!=typeof n&&(console.warn("Deprecated: Expected third argument to be a object"),n={autoBom:!n}),n.autoBom&&/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(e.type)?new Blob(["\ufeff",e],{type:e.type}):e}function n(e,n,t){var a=new XMLHttpRequest;a.open("GET",e),a.responseType="blob",a.onload=function(){r(a.response,n,t)},a.onerror=function(){console.error("could not download file")},a.send()}function t(e){var n=new XMLHttpRequest;n.open("HEAD",e,!1);try{n.send()}catch(e){}return 200<=n.status&&299>=n.status}function a(e){try{e.dispatchEvent(new MouseEvent("click"))}catch(t){var n=document.createEvent("MouseEvents");n.initMouseEvent("click",!0,!0,window,0,0,0,80,20,!1,!1,!1,!1,0,null),e.dispatchEvent(n)}}var o="object"==typeof window&&window.window===window?window:"object"==typeof self&&self.self===self?self:"object"==typeof Cn&&Cn.global===Cn?Cn:void 0,i=o.navigator&&/Macintosh/.test(navigator.userAgent)&&/AppleWebKit/.test(navigator.userAgent)&&!/Safari/.test(navigator.userAgent),r=o.saveAs||("object"!=typeof window||window!==o?function(){}:"download"in HTMLAnchorElement.prototype&&!i?function(e,i,r){var l=o.URL||o.webkitURL,s=document.createElement("a");i=i||e.name||"download",s.download=i,s.rel="noopener","string"==typeof e?(s.href=e,s.origin===location.origin?a(s):t(s.href)?n(e,i,r):a(s,s.target="_blank")):(s.href=l.createObjectURL(e),setTimeout((function(){l.revokeObjectURL(s.href)}),4e4),setTimeout((function(){a(s)}),0))}:"msSaveOrOpenBlob"in navigator?function(o,i,r){if(i=i||o.name||"download","string"!=typeof o)navigator.msSaveOrOpenBlob(e(o,r),i);else if(t(o))n(o,i,r);else{var l=document.createElement("a");l.href=o,l.target="_blank",setTimeout((function(){a(l)}))}}:function(e,t,a,r){if((r=r||open("","_blank"))&&(r.document.title=r.document.body.innerText="downloading..."),"string"==typeof e)return n(e,t,a);var l="application/octet-stream"===e.type,s=/constructor/i.test(o.HTMLElement)||o.safari,c=/CriOS\/[\d]+/.test(navigator.userAgent);if((c||l&&s||i)&&"undefined"!=typeof FileReader){var d=new FileReader;d.onloadend=function(){var e=d.result;e=c?e:e.replace(/^data:[^;]*;/,"data:attachment/file;"),r?r.location.href=e:location=e,r=null},d.readAsDataURL(e)}else{var m=o.URL||o.webkitURL,u=m.createObjectURL(e);r?r.location=u:location.href=u,r=null,setTimeout((function(){m.revokeObjectURL(u)}),4e4)}});o.saveAs=r.saveAs=r,Ln.exports=r}()),In.exports);let _n;const Rn=(e,n,t,a)=>`${e}${(n+1).toString().padStart(Math.floor(Math.log10(t))+1,"0")}.${a.replace("jpeg","jpg")}`;async function Dn(e,n,t){const a=e.getAttribute("src")??e.getAttribute("data-src")??"";if(v(a))throw new Error("Image source unusable");return f(a)?Promise.resolve({name:Rn("Page-",n,t.length,E(a)),data:b(a)??""}):new Promise((e=>{var o;(async function(e){return new Promise(((n,t)=>{W(`Getting Image data: ${e}`),GM_xmlhttpRequest({method:"GET",url:e,headers:{referer:window.location.host,origin:window.location.host},responseType:"blob",onload(e){200!==e.status&&t(e),n(e)}})}))})(a).then((o=>{e({name:Rn("Page-",n,t.length,y(a)),data:o.response})})).catch((o="Image not Available",e=>W(o,e)[1]))}))}function Bn(e){W(`${e.name} Added to Zip from Base64 Image`),_n.file(e.name,e.data,{base64:!0,createFolders:!0,compression:"DEFLATE"})}function Nn(e){const n=e.currentTarget;n.classList.contains("loading")||(W("Downloading Chapter"),n.classList.add("loading"),async function(){_n=new JSZip;const e=[...document.querySelectorAll(".PageImg")];Promise.all(e.map(Dn)).then((e=>{e.forEach(Bn),W("Generating Zip"),_n.generateAsync({type:"blob"}).then((e=>{W("Download Ready");const n=`${document.querySelector("#MangaTitle")?.textContent?.trim()}.zip`;Tn.saveAs(e,n,{autoBom:!1}),document.getElementById("download")?.classList.remove("loading")})).catch(W)})).catch((e=>W("One or more images couldn't be Downloaded",e)))}().catch((e=>W("Error downloading chapter",e))))}function Vn(){document.querySelector("#MangaOnlineViewer")?.classList.toggle("hideControls")}function $n(e){const n=e.target,t=n.getAttribute("value")??n.getAttribute("href");1===e.button||e.ctrlKey||(t&&"#"!==t?window.location.href=t:"series"===n.id&&window.history.back())}function Fn(){document.querySelector("#CommentsPanel")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function Gn(){document.querySelector("#CommentsPanel")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function zn(){const e=document.querySelector("#CommentsArea");e?.classList.toggle("light"),e?.classList.toggle("dark")}const Pn=e=>document.querySelector(e)?.dispatchEvent(new Event("click"));function Zn(e){const n=document.querySelector("#Chapter");if(n?.classList.contains("FluidLTR")||n?.classList.contains("FluidRTL"))n.scrollBy({left:window.innerWidth/2*e*(n?.classList.contains("FluidRTL")?-1:1),behavior:"smooth"});else if("height"===pe().zoomMode){const n=[...document.querySelectorAll(".MangaPage")],t=n.map((e=>Math.abs(e.offsetTop-window.scrollY))),a=_.indexOf(t,_.min(t)),o=a+e,i=document.querySelector("#Header");o<0?fn(i):o>=n.length?i.classList.add("headroom-end"):(W(`Current array page ${a},`,`Scrolling to page ${o}`),fn(n.at(o)))}else window.scrollBy({top:e*window.innerHeight/2,behavior:"smooth"})}const Hn={SCROLL_UP(){Zn(-1)},SCROLL_DOWN(){Zn(1)},NEXT_CHAPTER(){Pn("#next")},PREVIOUS_CHAPTER(){Pn("#prev")},ENLARGE(){Pn("#enlarge")},REDUCE(){Pn("#reduce")},RESTORE(){Pn("#restore")},FIT_WIDTH(){Pn("#fitWidth")},FIT_HEIGHT(){Pn("#fitHeight")},SETTINGS(){Pn("#settings")},VIEW_MODE_WEBCOMIC(){Pn("#webComic")},VIEW_MODE_VERTICAL(){Pn("#verticalMode")},VIEW_MODE_LEFT(){Pn("#rtlMode")},VIEW_MODE_RIGHT(){Pn("#ltrMode")},SCROLL_START(){Pn("#AutoScroll")}};function Wn(){document.onkeydown=null,document.onkeyup=null,window.onkeydown=null,window.onkeyup=null,window.onload=null,document.body.onload=null,hotkeys.unbind(),Object.keys(pe().keybinds).forEach((e=>{hotkeys(pe().keybinds[e]?.join(",")??"",_.throttle((n=>{n.preventDefault(),n.stopImmediatePropagation(),n.stopPropagation(),Hn[e]()}),100))}))}const Un=2e3,qn=500,jn="data-src",Qn="src";let Yn=[],Xn=!1;function Kn(e){const{element:n}=e,t=n.getBoundingClientRect(),a=(window.innerHeight||document.documentElement.clientHeight)+Un;return t.top<=a||t.bottom<=a}async function Jn(e){let n=e.element.getAttribute(jn)??"";n&&(v(n)||f(n)||!e.fetchOptions||(n=await fetch(n,e.fetchOptions).then((e=>e.blob())).then((e=>blobUtil.blobToDataURL(e)))),e.element.setAttribute(Qn,n)),e.callback(e.element)?.catch(W)}const et=_.throttle((function(){const e=Yn.filter(Kn);Yn=Yn.filter((e=>!Kn(e))),e.forEach(Jn)}),qn);function nt(e,n,t){Xn||(window.addEventListener("scroll",et,{passive:!0}),window.addEventListener("touchmove",et,{passive:!0}),window.addEventListener("resize",et,{passive:!0}),Xn=!0),Yn.push({element:e,callback:n,fetchOptions:t}),et()}function tt(e=pe().zoomMode,n=".PageContent img"){[...document.querySelectorAll(n)].forEach((n=>{if(n.removeAttribute("width"),n.removeAttribute("height"),n.removeAttribute("style"),"width"===e)n.style.width=`${window.innerWidth}px`;else if("height"===e){const e=window.innerHeight+(pe().showThumbnails?-29:0);n.style.height=`${e}px`,n.style.minWidth="unset"}else"percent"===e?n.style.width=n.naturalWidth*(pe().defaultZoom/100)+"px":e>=0&&100!==e&&(n.style.width=n.naturalWidth*(e/100)+"px")}))}function at(e){let n=1;const t=e?.match(/forceReload=(\d+)$/);return t?.at(1)&&(n=parseInt(t[1],10)+1),n}function ot(e){const n=e.getAttribute("src");n&&(e.removeAttribute("src"),f(n)||v(n)?e.setAttribute("src",n):e.setAttribute("src",function(e,n){const t=e.replace(/[?&]forceReload=\d+$/,""),a=t.includes("?")?"&":"?";return`${t+a}forceReload=${n}`}(n,at(n))))}function it(){const e=document.querySelectorAll(".PageContent .PageImg").length,n=document.querySelectorAll(".PageContent .PageImg.imgLoaded").length,t=Math.floor(n/e*100),a=document.querySelector("title");a&&(a.innerHTML=se`(${t}%)
      ${document.querySelector("#MangaTitle")?.textContent}`),document.querySelectorAll("#Counters i, #NavigationCounters i").forEach((e=>{e.textContent=n.toString()})),NProgress.configure({showSpinner:!1}).set(n/e),W(`Progress: ${t}%`),n===e&&(W("Images Loading Complete"),pe().downloadZip&&document.getElementById("download")?.dispatchEvent(new Event("click")),document.getElementById("download")?.classList.remove("disabled"))}function rt(){return e=>{e.images.forEach((e=>{e.img.classList.add("imgLoaded"),e.img.classList.remove("imgBroken");const n=e.img.id.replace("PageImg","ThumbnailImg"),t=document.getElementById(n);t?.classList.remove("imgBroken"),t&&t.setAttribute("src",e.img.getAttribute("src")),((e=".PageContent img")=>{const n=document.querySelector("#ZoomVal")?.textContent?.trim();n?.match(/^\d+%$/)?tt(parseInt(n,10),e):tt(n,e)})(`#${e.img.id}`),it()}))}}function lt(e){return n=>{n.images.forEach((n=>{n.img.classList.add("imgBroken");const t=n.img.id.replace("PageImg","ThumbnailImg"),a=document.getElementById(t);a?.classList.add("imgBroken");const o=n.img.getAttribute("src");o&&at(o)<=pe().maxReload&&setTimeout((async()=>{if(e.reload){const t=parseInt(`0${/\d+/.exec(n.img.id)}`,10),a=await e.reload(t);n.img.setAttribute("src",a)}else ot(n.img);const t=imagesLoaded(n.img.parentElement);t.on("done",rt()),t.on("fail",lt(e))}),2e3)}))}}function st(e){if(e){let n=e.trim();return n.startsWith("//")&&(n=`https:${n}`),n}return""}function ct(e,n,t,a){const o=a-e.begin;let i=st(t);const r=document.querySelector(`#PageImg${n}`);r&&(!pe().lazyLoadImages||o<=pe().lazyStart?setTimeout((async()=>{v(i)||f(i)||!e.fetchOptions||(i=await fetch(i,e.fetchOptions).then((e=>e.blob())).then((e=>blobUtil.blobToDataURL(e))));const t=imagesLoaded(r.parentElement);t.on("done",rt()),t.on("fail",lt(e)),r.setAttribute("src",i),W("Loaded Image:",n,"Source:",i)}),(e.timer??pe().throttlePageLoad)*o):(r.setAttribute("data-src",st(i)),nt(r,(()=>{const t=imagesLoaded(r.parentElement);t.on("done",rt()),t.on("fail",lt(e)),W("Lazy Image: ",n," Source: ",r.getAttribute("src"))}),e.fetchOptions)),e.pages===a&&xn())}function dt(e,n,t,a){return async()=>{const o=await async function(e,n,t){return X(e).then((e=>e.querySelector(n)?.getAttribute(t)))}(t,e.img,e.lazyAttr??"src"),i=document.querySelector(`#PageImg${n}`);if(o&&i){i.style.width="auto";const t=imagesLoaded(i.parentElement);t.on("done",rt()),t.on("fail",lt(e)),i.setAttribute("src",o),W(`${a&&"Lazy "}Page: `,n," Source: ",i.getAttribute("src"))}}}function mt(e,n){un(n.pages,e).forEach(((e,t)=>{(async function(e,n,t,a){const o=a-e.begin,i=document.querySelector(`#PageImg${n}`);i&&(!pe().lazyLoadImages||o<=pe().lazyStart?setTimeout((()=>{dt(e,n,t,!1)().catch(W)}),(e.timer??pe().throttlePageLoad)*o):(i.setAttribute("data-src","data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),nt(i,dt(e,n,t,!0))),e.pages===a&&xn())})(n,e,n.listPages[e-1],t).catch(W)}))}function ut(e,n){un(n.pages,e).forEach(((e,t)=>{ct(n,e,n.listImages[e-1],t)}))}function gt(e,n=1){pe().lazyLoadImages=e.lazy??pe().lazyLoadImages,W("Loading Images"),W(`Intervals: ${e.timer??pe().throttlePageLoad??"Default(1000)"}`),W(`Lazy: ${pe().lazyLoadImages}, Starting from: ${pe().lazyStart}`),!function(e){return"listImages"in e&&!o(e.listImages)}(e)?!function(e){return"listPages"in e&&!o(e.listPages)}(e)?!function(e){return"bruteForce"in e&&!o(e.bruteForce)}(e)?W("No Loading Method Found"):(W("Method: Brute Force"),e.bruteForce({begin:n,addImg:ct,loadImages(t){ut(n,{...e,listImages:t})},loadPages(t,a,o){mt(n,{...e,listPages:t,img:a,lazyAttr:o})},wait:pe().throttlePageLoad})):(W("Method: Pages:",e.listPages),mt(n,e)):(W("Method: Images:",e.listImages),ut(n,e))}function pt(e){const n=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg");ot(n)}function ht(e){const n=e.currentTarget.parentElement?.parentElement;n.classList.toggle("hide")}function wt(e){const n=e.currentTarget.value;tt(),fn(document.querySelector(`#Page${n}`))}function bt(e){tt(),fn(document.querySelector(`#Page${e.currentTarget.querySelector(".ThumbnailIndex")?.textContent}`))}function ft(){be();const e=document.getElementById("MangaOnlineViewer");e?.removeAttribute("locale"),e?.dispatchEvent(new Event("locale"))}function vt(e){const n=e.currentTarget.value;we({locale:n});const t=document.getElementById("MangaOnlineViewer");t?.setAttribute("locale",n),t?.dispatchEvent(new Event("locale"))}function yt(e){we({loadMode:e.currentTarget.value})}function Et(e){document.querySelector("#Chapter")?.classList.toggle("fitWidthIfOversize"),we({fitWidthIfOversize:e.currentTarget.checked})}function kt(e){document.querySelector("#Chapter")?.classList.toggle("separator"),we({verticalSeparator:e.currentTarget.checked})}function xt(e){document.querySelector("#Navigation")?.classList.toggle("disabled"),we({showThumbnails:e.currentTarget.checked}),tt()}function St(e){document.querySelector("#CommentsButton")?.classList.toggle("disabled"),we({enableComments:e.currentTarget.checked}),tt()}function Mt(e){we({downloadZip:e.currentTarget.checked}),e.currentTarget.checked&&Swal.fire({title:he("ATTENTION"),text:he("AUTO_DOWNLOAD"),timer:1e4,icon:"info"})}function Ot(e){we({lazyLoadImages:e.currentTarget.checked});const n=document.querySelector(".lazyStart");pe().lazyLoadImages?n?.classList.add("show"):n?.classList.remove("show"),e.currentTarget.checked&&Swal.fire({title:he("WARNING"),html:he("LAZY_LOAD"),icon:"warning"})}function At(e){const n=e.currentTarget.value;we({lazyStart:parseInt(n,10)})}function Ct(e){const n=parseInt(e.currentTarget.value,10);we({throttlePageLoad:n}),n<100&&Swal.fire({title:he("SPEED_WARNING"),html:he("SPEED_WARNING_MESSAGE"),icon:"warning"})}function It(e){const n=e.currentTarget.value;we({zoomStep:parseInt(n,10)})}function Lt(e){const n=e.currentTarget.value;ze("MinZoom",`#MangaOnlineViewer .PageContent .PageImg {min-width: ${n}vw;}`),we({minZoom:parseInt(n,10)})}function Tt(e){document.querySelector("#MangaOnlineViewer")?.classList.toggle("hideControls"),we({hidePageControls:e.currentTarget.checked})}function _t(e){const n=document.querySelector("#Header");if(!n?.classList.contains(e)){const t=document.querySelector("#menu");n?.classList.remove("scroll","click","hover","fixed","simple","visible"),t?.classList.remove("scroll","click","hover","fixed","simple","hide"),n?.classList.add(e),t?.classList.add(e)}}function Rt(e){const n=e.currentTarget.value;_t(n),we({header:n})}function Dt(e){const{value:n}=e.currentTarget;we({scrollHeight:parseInt(n,10)})}function Bt(){const e=document.querySelector("#Header");e?.classList.contains("click")&&e?.classList.toggle("visible")}function Nt(e){const n=document.querySelector("#Header");n?.classList.contains("hover")&&(!function(e,n,t){return e.clientX>=0&&e.clientX<=n&&e.clientY>=0&&e.clientY<=t}(e,n.clientWidth,n.clientHeight)?(document.querySelector("#menu")?.classList.remove("hide"),n?.classList.remove("visible")):(document.querySelector("#menu")?.classList.add("hide"),n?.classList.add("visible")))}function Vt(){document.querySelector("#SettingsPanel")?.classList.add("visible"),document.querySelector("#Navigation")?.classList.add("visible"),document.querySelector("#Header")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function $t(){document.querySelector("#SettingsPanel")?.classList.remove("visible"),document.querySelector("#Navigation")?.classList.remove("visible"),document.querySelector("#Header")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function Ft(){document.querySelector("#KeybindingsList").innerHTML=dn().join("\n"),document.querySelector("#SaveKeybindings")?.classList.add("hidden"),document.querySelector("#EditKeybindings")?.classList.remove("hidden"),document.querySelector("#KeybindingsPanel")?.classList.add("visible"),document.querySelector("#Overlay")?.classList.add("visible")}function Gt(){document.querySelector("#SaveKeybindings")?.classList.add("hidden"),document.querySelector("#EditKeybindings")?.classList.remove("hidden"),document.querySelector("#KeybindingsPanel")?.classList.remove("visible"),document.querySelector("#Overlay")?.classList.remove("visible")}function zt(){const e=pe().keybinds;Object.keys(pe().keybinds).forEach((n=>{const t=document.querySelector(`#${n}`)?.value.split(",")?.map((e=>e.trim()));e[n]=o(t)?void 0:t})),we({keybinds:e}),document.querySelector("#KeybindingsList").innerHTML=dn().join("\n"),document.querySelector("#SaveKeybindings")?.classList.add("hidden"),document.querySelector("#EditKeybindings")?.classList.remove("hidden"),Wn()}function Pt(){document.querySelector("#KeybindingsList").innerHTML=Object.keys(pe().keybinds).map((e=>se`<label for="${e}">${he(e)}:</label>
            <input
              type="text"
              class="KeybindInput"
              id="${e}"
              name="${e}"
              value="${pe().keybinds[e]?.join(" , ")??""}"
            />`)).concat(se`<div id="HotKeysRules">${he("KEYBIND_RULES")}</div>`).join("\n"),document.querySelector("#SaveKeybindings")?.classList.remove("hidden"),document.querySelector("#EditKeybindings")?.classList.add("hidden")}function Zt(){document.querySelector("#menu")?.addEventListener("click",Bt),document.addEventListener("mousemove",_.throttle(Nt,300)),document.querySelector("#settings")?.addEventListener("click",function(e,n,t,a){return()=>{const o=document.querySelector(e)?.className.includes(n);o?a():t()}}("#SettingsPanel","visible",Vt,$t)),document.querySelectorAll(".closeButton")?.forEach(vn("click",$t)),document.querySelector("#Overlay")?.addEventListener("click",$t),document.querySelector("#keybindings")?.addEventListener("click",Ft),document.querySelectorAll(".closeButton")?.forEach(vn("click",Gt)),document.querySelector("#Overlay")?.addEventListener("click",Gt),document.querySelector("#EditKeybindings")?.addEventListener("click",Pt),document.querySelector("#SaveKeybindings")?.addEventListener("click",zt)}function Ht(e){const n=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg");tt(n.width/n.naturalWidth*(100+pe().zoomStep),`#${n.getAttribute("id")}`)}function Wt(e){const n=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg");tt(n.width/n.naturalWidth*(100-pe().zoomStep),`#${n.getAttribute("id")}`)}function Ut(){document.querySelector(".PageContent .PageImg")?.removeAttribute("width")}function qt(e){const n=e.currentTarget.parentElement?.parentElement,t=n?.querySelector(".PageImg");tt("width",`#${t.getAttribute("id")}`),n?.classList.toggle("DoublePage")}function jt(e){const n=e.currentTarget.parentElement?.parentElement?.querySelector(".PageImg");tt("height",`#${n.getAttribute("id")}`)}function Qt(){const e="dark"===pe().colorScheme;we({colorScheme:e?"light":"dark"});const n=document.getElementById("MangaOnlineViewer");n?.classList.remove(e?"dark":"light"),n?.classList.add(pe().colorScheme)}function Yt(e){const n=e.currentTarget;[...document.querySelectorAll(".ThemeRadio")].forEach((e=>{e.classList.remove("selected")})),n.classList.add("selected"),document.getElementById("MangaOnlineViewer")?.setAttribute("data-theme",n.title),we({theme:n.title});const t=document.querySelector("#Hue"),a=document.querySelector("#Shade");n.title.startsWith("custom")?(t?.classList.add("show"),a?.classList.remove("show")):(t?.classList.remove("show"),a?.classList.add("show"))}function Xt(e){const n=e.currentTarget.value;we({customTheme:n}),ze("custom",We(n))}function Kt(e){we({themeShade:parseInt(e.currentTarget.value,10)}),Ue().forEach((e=>{ze(e.name,He(e))})),ze("custom",We(pe().customTheme))}function Jt(e){return()=>{pe().zoomMode="number"!=typeof e?e:"percent",_t("height"===e?"click":pe().header);const n=document.querySelector("#ZoomVal");Number.isInteger(e)?(n.textContent=`${e}%`,document.querySelector("#Zoom").value=e.toString()):n.textContent=e,tt(e)}}function ea(e=1){return()=>{const n=document.querySelector("#Zoom"),t=parseInt(n.value,10)+e*pe().zoomStep;n.value=t.toString(),n?.dispatchEvent(new Event("input",{bubbles:!0}))}}function na(e){const n=e.currentTarget.value;we({zoomMode:n}),Jt(n)();const t=document.querySelector(".DefaultZoom");"percent"===pe().zoomMode?t?.classList.add("show"):t?.classList.remove("show")}function ta(e){const n=parseInt(e.currentTarget.value,10);we({defaultZoom:n}),Jt(n)()}function aa(e){const n=parseInt(e.currentTarget.value,10);Jt(n)(),document.querySelector("#ZoomVal").textContent=`${n}%`}function oa(e){const n=document.querySelector("#Chapter");document.querySelector("#Header")?.classList.remove("visible"),document.querySelector("#menu")?.classList.remove("hide"),Jt("height")(),fn(n),n?.addEventListener("wheel","FluidLTR"===e?yn:En)}function ia(e){return()=>{const n=document.querySelector("#Chapter");n?.classList.remove("Vertical","WebComic","FluidLTR","FluidRTL"),n?.classList.add(e),n?.removeEventListener("wheel",yn),n?.removeEventListener("wheel",En),"FluidLTR"===e||"FluidRTL"===e?oa(e):(document.querySelector("#Header").className=pe().header,document.querySelector("#menu").className=pe().header,Jt(100)())}}function ra(e){const n=e.currentTarget.value;ia(n)(),we({viewMode:n})}let la;function sa(){const e=document.querySelector("#Chapter");e?.classList.contains("FluidLTR")||e?.classList.contains("FluidRTL")?e?.scrollBy({top:0,left:pe().scrollHeight*(e?.classList.contains("FluidRTL")?-1:1),behavior:"smooth"}):window.scrollBy({top:pe().scrollHeight,left:0,behavior:"smooth"}),document.querySelector("#Header")?.classList.contains("headroom-end")&&(clearInterval(la),la=void 0,document.querySelector("#ScrollControl")?.classList.remove("running"),W("Finished auto scroll"))}function ca(){const e=document.querySelector("#AutoScroll");la?(clearInterval(la),la=void 0,e?.classList.remove("running"),W("Stopped auto scroll")):(sa(),la=setInterval(sa,1e3/60),e?.classList.add("running"),W("Start auto scroll"))}let da=!1;const ma=_.debounce((()=>{ca(),da=!1}),500);function ua(){!da&&la&&(ca(),da=!0),da&&!la&&ma()}let ga,pa=!1;function ha(){pa||(!function(e=0){let n=0;const t=e=>{const n=document.querySelector("#Header");n.classList.remove("headroom-end","headroom-hide","headroom-show","headroom-top"),e&&n.classList.add(`headroom-${e}`)};window.addEventListener("scroll",_.debounce((function(){const{scrollY:a}=window;e&&"height"!==pe().zoomMode&&a+window.innerHeight+e>document.body.scrollHeight?t("end"):t(a>n&&a>50?"hide":a<n&&a>50?"show":a<=100?"top":""),n=a}),50))}(100),Wn(),document.querySelectorAll(".Reload")?.forEach(vn("click",pt)),document.querySelectorAll(".Hide")?.forEach(vn("click",ht)),document.querySelectorAll(".ZoomIn")?.forEach(vn("click",Ht)),document.querySelectorAll(".ZoomOut")?.forEach(vn("click",Wt)),document.querySelectorAll(".ZoomRestore")?.forEach(vn("click",Ut)),document.querySelectorAll(".ZoomWidth")?.forEach(vn("click",qt)),document.querySelectorAll(".ZoomHeight")?.forEach(vn("click",jt)),window.addEventListener("resize",(()=>{const e=document.querySelector("#MangaOnlineViewer");e?.classList.remove("mobile","tablet","desktop"),e?.classList.add(Y())})),pa=!0),document.querySelector("#bookmarks")?.addEventListener("click",Mn),document.querySelectorAll(".closeButton")?.forEach(vn("click",kn)),document.querySelector("#Overlay")?.addEventListener("click",kn),document.querySelectorAll(".bookmarkFunctions .erase")?.forEach(vn("click",Sn)),document.querySelectorAll(".Bookmark")?.forEach(vn("click",On)),document.querySelector(".AddBookmark")?.addEventListener("click",On),document.querySelector("#download")?.addEventListener("click",Nn),document.querySelector("#pageControls")?.addEventListener("click",Vn),document.querySelector("#next")?.addEventListener("click",$n),document.querySelector("#prev")?.addEventListener("click",$n),document.querySelector("#series")?.addEventListener("click",$n),document.querySelector("#CommentsButton")?.addEventListener("click",Fn),document.querySelector("#CommentsColorScheme")?.addEventListener("click",zn),document.querySelectorAll(".closeButton")?.forEach(vn("click",Gn)),document.querySelector("#Overlay")?.addEventListener("click",Gn),document.querySelector("#gotoPage")?.addEventListener("change",wt),document.querySelectorAll(".Thumbnail")?.forEach(vn("click",bt)),document.querySelector("#Thumbnails")?.addEventListener("wheel",yn),document.querySelector("#ResetSettings")?.addEventListener("click",ft),document.querySelector("#locale")?.addEventListener("change",vt),document.querySelector("#fitIfOversize")?.addEventListener("change",Et),document.querySelector("#verticalSeparator")?.addEventListener("change",kt),document.querySelector("#loadMode")?.addEventListener("change",yt),document.querySelector("#showThumbnails")?.addEventListener("change",xt),document.querySelector("#enableComments")?.addEventListener("change",St),document.querySelector("#downloadZip")?.addEventListener("change",Mt),document.querySelector("#lazyLoadImages")?.addEventListener("change",Ot),document.querySelector("#lazyStart")?.addEventListener("change",At),document.querySelector("#PagesPerSecond")?.addEventListener("change",Ct),document.querySelector("#zoomStep")?.addEventListener("change",It),document.querySelector("#minZoom")?.addEventListener("input",Lt),document.querySelector("#hidePageControls")?.addEventListener("change",Tt),document.querySelector("#headerType")?.addEventListener("change",Rt),document.querySelector("#scrollHeight")?.addEventListener("change",Dt),Zt(),document.querySelector("#ColorScheme")?.addEventListener("click",Qt),document.querySelectorAll(".ThemeRadio").forEach(vn("click",Yt)),document.querySelector("#CustomThemeHue")?.addEventListener("change",Xt),document.querySelector("#ThemeShade")?.addEventListener("input",Kt),document.querySelector("#viewMode")?.addEventListener("change",ra),document.querySelector("#webComic")?.addEventListener("click",ia("WebComic")),document.querySelector("#ltrMode")?.addEventListener("click",ia("FluidLTR")),document.querySelector("#rtlMode")?.addEventListener("click",ia("FluidRTL")),document.querySelector("#verticalMode")?.addEventListener("click",ia("Vertical")),"FluidLTR"!==pe().viewMode&&"FluidRTL"!==pe().viewMode||oa(pe().viewMode),document.querySelector("#DefaultZoomMode")?.addEventListener("change",na),document.querySelector("#DefaultZoom")?.addEventListener("input",ta),document.querySelector("#Zoom")?.addEventListener("input",aa),document.querySelector("#enlarge")?.addEventListener("click",ea()),document.querySelector("#reduce")?.addEventListener("click",ea(-1)),document.querySelector("#restore")?.addEventListener("click",Jt(100)),document.querySelector("#fitWidth")?.addEventListener("click",Jt("width")),document.querySelector("#fitHeight")?.addEventListener("click",Jt("height")),window.addEventListener("wheel",_.throttle(ua,500)),document.querySelector("#AutoScroll")?.addEventListener("click",ca)}function wa(){ia(pe().viewMode)();const e={"#Header":hn(ga),"#CommentsPanel":bn(),"#SettingsPanel":cn(),"#KeybindingsPanel":mn(),"#Bookmarks":gn()};document.querySelector("#ScrollControl")?.classList.contains("running")&&ca();const n=document.querySelector("#MangaOnlineViewer");n&&(n.className=`${pe().colorScheme} \n        ${pe().hidePageControls?"hideControls":""}\n        ${fe()?"bookmarked":""}\n        ${Y()}`,n.setAttribute("data-theme",pe().theme));const t=document.querySelector("#Chapter");t&&(t.className=`${pe().fitWidthIfOversize?"fitWidthIfOversize":""}  ${pe().viewMode}`),Object.entries(e).forEach((([e,n])=>{const t=document.querySelector(e);t&&(t.outerHTML=n)})),document.querySelector("#Overlay")?.dispatchEvent(new Event("click")),ha()}const ba=e=>(ga=e,se`
      <div
        id="MangaOnlineViewer"
        class="${pe().colorScheme} 
        ${pe().hidePageControls?"hideControls":""}
        ${fe()?"bookmarked":""}
        ${Y()}"
        data-theme="${pe().theme}"
      >
        <div id="menu" class="${pe().header}">${'<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-menu-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>\n  <path d="M4 6l16 0" />\n  <path d="M4 12l16 0" />\n  <path d="M4 18l16 0" />\n</svg>\n\n\n'}</div>
        ${hn(e)} ${wn(e)} ${(e=>se`
    <nav
      id="Navigation"
      class="panel ${pe().showThumbnails?"":"disabled"}"
    >
  ...
  `)(e)}
    ...
    `);function fa(e){document.head.innerHTML=function(e){return se`
      <title>${e.title}</title>
      <meta charset="UTF-8" />
      ${Pe("externals",je)}
      ${Pe("reader",Fe)} ${qe}
      ${Pe("MinZoom",`#MangaOnlineViewer .PageContent .PageImg {min-width: ${pe().minZoom}vw;}`)}
    `}(e),document.body.innerHTML=ba(e),ha(),gt(e),document.querySelector("#MangaOnlineViewer")?.addEventListener("locale",wa),e.comments&&document.querySelector("#CommentsArea")?.append(e.comments)}async function va(){if(!pe().enableComments)return null;let e=document.querySelector("#disqus_thread, #fb-comments");return e&&(W("Waiting to Comments to load",e),window.scrollTo(0,document.body.scrollHeight),await async function(e,n=5e3){return Promise.race([e,l(n,!1)])}(i((()=>{e=document.querySelector("#disqus_thread, #fb-comments");const n=e?.querySelector("iframe:not(#indicator-north, #indicator-south)");return"complete"===n?.contentWindow?.document.readyState&&n?.contentWindow?.document?.body?.textContent?.length}))),e.children.length?W("Got Comments",e):W("Timeout Comments")),window.scrollTo(0,0),e}async function ya(e){void 0!==e.before&&await e.before(e.begin),pe().enableComments&&!e.comments&&(e.comments=await va()),setTimeout((()=>{try{((...e)=>{e.forEach((e=>{e.getAttributeNames().forEach((n=>{e.removeAttribute(n)}))}))})(document.documentElement,document.head,document.body),window.scrollTo(0,0),fa(e)}catch(e){W(e)}}),50)}async function Ea(e){if(void 0!==e.waitAttr){W(`Waiting for Attribute ${e.waitAttr[1]} of ${e.waitAttr[0]}`);const n=await r(e.waitAttr[0],e.waitAttr[1]);W(`Found Attribute ${e.waitAttr[1]} of ${e.waitAttr[0]} = ${n}`)}}async function ka(e){if(void 0!==e.waitEle){W(`Waiting for Element ${e.waitEle}`);const n=await function(e,n=document.body){return new Promise((t=>{if(document.querySelector(e))return void t(document.querySelector(e));const a=new MutationObserver((()=>{document.querySelector(e)&&(t(document.querySelector(e)),a.disconnect())}));a.observe(n,{childList:!0,subtree:!0,attributes:!0})}))}(e.waitEle);W(`Found Element ${e.waitEle} = `,n)}}async function xa(e){if(void 0!==e.waitVar){W(`Waiting for Variable ${e.waitVar}`);const n=await function(e,n=document.body){return new Promise((t=>{if(!o(unsafeWindow[e]))return void t(unsafeWindow[e]);const a=new MutationObserver((()=>{o(unsafeWindow[e])||(t(unsafeWindow[e]),a.disconnect())}));a.observe(n,{childList:!0,subtree:!0,attributes:!0})}))}(e.waitVar);W(`Found Variable ${e.waitVar} = ${n}`)}}async function Sa(e){if(void 0!==e.waitFunc){W(`Waiting to pass Function check ${e.waitFunc}`);const n=await i(e.waitFunc);W(`Found Function check ${e.waitFunc} = ${n}`)}}async function Ma(e){void 0!==e.waitTime&&(W(`Waiting to for ${e.waitTime} milliseconds`),await new Promise((n=>{setTimeout(n,e.waitTime)})),W("Continuing after timer"))}const Oa={name:"Local Files",url:/(file:\/\/\/.+(index)?.html)/,homepage:"/index.html?raw=1",language:["Raw"],category:"manga",run(){const e=parseInt(/\d+/.exec(window.location.search)?.toString()??"5",10),n=document.createElement("div");return n.innerHTML=Array(100).fill("Testing Comment<br/>").join(""),{title:"Placeholder Manga Loaded",series:"?reload",pages:e,begin:1,prev:"?pages=50",next:"?pages=1",listImages:[Se(1970,1400,"#2D1657"),Se(985,1400,"#152C55"),Se(985,1400,"#7A1420"),Se(985,1400,"#0F5B30"),Se(1970,1400,"#806D15"),...Array(e).fill(0).map(Ce)],comments:n}}},Aa=["image/apng","image/bmp","image/gif","image/jpeg","image/pjpeg","image/png","image/svg+xml","image/tiff","image/webp","image/x-icon"],Ca=/.(png|jpg|jpeg|gif|bmp|webp)$/i,Ia=(e,n)=>e.localeCompare(n,navigator.languages[0]||navigator.language,{numeric:!0,ignorePunctuation:!0});function La(e){return Aa.includes(e.type)}const Ta=e=>{const n=new Uint8Array(e),t=new Blob([n.buffer]);return URL.createObjectURL(t)};function _a(e,n){ya({title:e,series:"?reload",pages:n.length,begin:1,prev:"#",next:"#",lazy:!1,listImages:n}).then((()=>W("Page loaded")))}async function Ra(e){const n=await async function(e){const n=await JSZip.loadAsync(e),t=n.filter(((e,n)=>!n.dir&&Ca.test(n.name))).sort(((e,n)=>Ia(e.name,n.name)));return W("Files in zip:",n.files),Promise.all(t.map((e=>e.async("arraybuffer").then(Ta))))}(e);_a("string"==typeof e?e:e.name,n)}function Da(e){const n=e.target,t=Array.from(n.files).filter(La).sort(((e,n)=>Ia(e.webkitRelativePath||e.name,n.webkitRelativePath||n.name)));W("Local Files: ",t,t.map((e=>e.webkitRelativePath||e.name))),n.files?.[0]&&_a(n.files[0].webkitRelativePath.split("/")[0]||"Local Images",t.map(URL.createObjectURL))}async function Ba(e,n=1){const t=await e.run();W("LateStart");let a=n,o=t.pages;const i={title:he("STARTING"),html:se`
        ${he("CHOOSE_BEGINNING")}
      ...
      `,showCancelButton:!0,cancelButtonColor:"#d33",reverseButtons:!0,icon:"question",didOpen(){const e=document.querySelector("#pageBegin"),n=document.querySelector("#pageEnd"),i=rangeSlider(document.getElementById("pagesSlider"),{min:1,max:t.pages,value:[a,o],onInput(t,i){i&&([a,o]=t,e&&(e.value=a.toString()),n&&(n.value=o.toString()))}});const r=_.debounce((function(){if(""===e.value||""===n.value)return;const t=function(e,n,t){let a=e;return Number.isNaN(a)||a<t.min()?a=t.min():a>t.max()?a=t.max():a>n&&(a=n),a}(parseInt(e.value,10),o,i),r=function(e,n,t){let a=e;return Number.isNaN(a)||a>t.max()?a=t.max():a<t.min()?a=t.min():a<n&&(a=n),a}(parseInt(n.value,10),a,i);e.value=t.toString(),n.value=r.toString(),a=t,o=r,i.value([t,r])}),600);["change","mouseup","keyup","touchend"].forEach((t=>{e?.addEventListener(t,r),n?.addEventListener(t,r)}))}};Swal.fire(i).then((e=>{e.value?(W(`Choice: ${a} - ${o}`),t.begin=a,t.pages=o,ya(t).then((()=>W("Page loaded")))):W(e.dismiss)}))}function Na(e,n){const t=document.createElement("button");t.innerText=he("BUTTON_START"),t.id="StartMOV",t.onclick=()=>{Ba(e,n).catch(W)},document.body.appendChild(t);const a=document.createElement("style");a.appendChild(document.createTextNode("#StartMOV {\n    all: revert;\n    backface-visibility: hidden;\n    font-size: 2rem;\n    color: #fff;\n    cursor: pointer;\n    margin: 0 auto;\n    padding: 0.5rem 1rem;\n    text-align: center;\n    border: none;\n    border-radius: 10px;\n    min-height: 50px;\n    width: 80%;\n    position: fixed;\n    right: 0;\n    left: 0;\n    bottom: 0;\n    z-index: 105000;\n    transition: all 0.4s ease-in-out;\n    background-size: 300% 100%;\n    background-image: linear-gradient(to right, #667eea, #764ba2, #6b8dd6, #8e37d7);\n    box-shadow: 0 4px 15px 0 rgba(116, 79, 168, 0.75);\n}\n\n#StartMOV:hover {\n    background-position: 100% 0;\n    transition: all 0.4s ease-in-out;\n}\n\n#StartMOV:focus {\n    outline: none;\n}\n.range-slider{touch-action:none;-webkit-tap-highlight-color:transparent;-webkit-user-select:none;user-select:none;cursor:pointer;display:block;position:relative;width:100%;height:8px;background:#ddd;border-radius:4px}.range-slider[data-vertical]{height:100%;width:8px}.range-slider[data-disabled]{opacity:.5;cursor:not-allowed}.range-slider .range-slider__thumb{position:absolute;z-index:3;top:50%;width:24px;height:24px;transform:translate(-50%,-50%);border-radius:50%;background:#2196f3}.range-slider .range-slider__thumb:focus-visible{outline:0;box-shadow:0 0 0 6px rgba(33,150,243,.5)}.range-slider[data-vertical] .range-slider__thumb{left:50%}.range-slider .range-slider__thumb[data-disabled]{z-index:2}.range-slider .range-slider__range{position:absolute;z-index:1;transform:translate(0,-50%);top:50%;width:100%;height:100%;background:#51adf6}.range-slider[data-vertical] .range-slider__range{left:50%;transform:translate(-50%,0)}.range-slider input[type=range]{-webkit-appearance:none;pointer-events:none;position:absolute;z-index:2;top:0;left:0;width:0;height:0;background-color:transparent}.range-slider input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;appearance:none}.range-slider input[type=range]::-moz-range-thumb{width:0;height:0;border:0}.range-slider input[type=range]:focus{outline:0}")),document.head.appendChild(a),W("Start Button added to page",t)}async function Va([e,n]){W(`Found Pages: ${n.pages} in ${e.name}`),n.title||(n.title=document.querySelector("title")?.textContent?.trim()),n.begin=fe()??n.begin??1;const t=document.createElement("style");switch(t.appendChild(document.createTextNode(je)),document.body.appendChild(t),unsafeWindow.MOV=(e,t)=>{void 0!==e&&(n.begin=e),void 0!==t&&(n.pages=t),ya(n).then((()=>W("Page loaded")))},e.start??pe()?.loadMode){case"never":Na(e,n.begin);break;case"always":ya(n).then((()=>W("Page loaded")));break;default:!function(e,n){Swal.fire({title:he("STARTING"),html:se`${n.begin>1?`${he("RESUME")}${n.begin}.<br/>`:""}${he("WAITING")}`,showCancelButton:!0,cancelButtonColor:"#d33",reverseButtons:!0,timer:3e3}).then((t=>{t.value||t.dismiss===Swal.DismissReason.timer?ya(n).then((()=>W("Page loaded"))):(Na(e,n.begin),W(t.dismiss))}))}(e,n)}}(async function(e){if(W(`Starting ${U.script.name} ${U.script.version} on ${function(){let e;const n=/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i.exec(navigator.userAgent)??[];if(/trident/i.test(n[1]))return e=/\brv[ :]+(\d+)/g.exec(navigator.userAgent)??[],`IE ${e[1]??""}`;if("Chrome"===n[1]&&(e=/\b(OPR|Edge)\/(\d+)/.exec(navigator.userAgent),null!==e))return e.slice(1).join(" ").replace("OPR","Opera");const t=[n[1],n[2]];return e=/version\/(\d+)/i.exec(navigator.userAgent),null!==e&&t.splice(1,1,e[1]),t.join(" ")}()} with ${U.scriptHandler??"Greasemonkey"}`),Oa.url.test(window.location.href)&&(document.querySelector("#MangaOnlineViewer, #LocalTest")&&(document.querySelector("#LocalTest")?.setAttribute("style","display:none"),document.querySelector("#file")?.addEventListener("change",(e=>{const n=e.target;n.files?.[0]&&Ra(n.files[0])})),document.querySelector("#folder")?.addEventListener("change",Da),document.querySelector("#images")?.addEventListener("change",Da),W("Waiting for zip/images upload")),1))return;W(e.length,"Known Manga Sites:",e);const n=e.filter((e=>e.url.test(window.location.href)));W(n.length,"Found sites:",n);const t=n.map((async e=>(W(`Testing site: ${e.name}`),new Promise(((n,t)=>{Promise.all([Ma(e),ka(e),Ea(e),xa(e),Sa(e)]).then((async()=>e.run())).then((a=>a.pages>0?n([e,a]):t(new Error(`${e.name} found ${a.pages} pages`))))})))));Promise.race(t.map(((e,n)=>e.then((()=>n))))).then((e=>{t.forEach(((t,a)=>{a!==e&&W(`Failed/Skipped: ${n[a].name}`)})),t[e].then((e=>{Va(e)}))}))})(re).catch(W)}();