...
// ==/UserScript==
(async()=>{const e={appName:"ChatGPT Infinity",appSymbol:"∞",keyPrefix:"chatGPTinfinity",gitHubURL:"https://github.com/adamlui/chatgpt-infinity",greasyForkURL:"https://greasyfork.org/scripts/465051-chatgpt-infinity",mediaHostURL:"https://media.chatgptinfinity.com/",latestAssetCommitHash:"f5402e4"};e.updateURL=e.greasyForkURL.replace("https://","https://update.").replace(/(\d+)-?([a-zA-Z-]*)$/,((e,t,n)=>`${t}/${n||"script"}.meta.js`)),e.supportURL="https://support.chatgptinfinity.com",e.assetHostURL=e.gitHubURL.replace("github.com","cdn.jsdelivr.net/gh")+`@${e.latestAssetCommitHash}/`,e.userLanguage=chatgpt.getUserLanguage(),function(...t){t.forEach((t=>{e[t]=GM_getValue(e.keyPrefix+"_"+t,!1)}))}("autoScrollDisabled","autoStart","replyInterval","replyLanguage","replyTopic","toggleHidden"),e.replyLanguage||s("replyLanguage",e.userLanguage),e.replyTopic||s("replyTopic","ALL"),e.replyInterval||s("replyInterval",7);const t="OrangeMonkey"==r()?GM_xmlhttpRequest:GM.xmlHttpRequest;let n={};const a=new Promise((n=>{const a=e.assetHostURL+"greasemonkey/_locales/",i=(e.userLanguage?e.userLanguage.replace("-","_"):"en")+"/";let o=a+i+"messages.json",s=0;t({method:"GET",url:o,onload:function i(l){try{const e=JSON.parse(l.responseText),t={};for(const n in e)"object"==typeof e[n]&&"message"in e[n]&&(t[n]=e[n].message);n(t)}catch(l){if(s++,3==s)return n({});o=e.userLanguage.includes("-")&&1==s?o.replace(/([^_]+_[^_]+)_[^/]*(\/.*)/,"$1$2"):a+"en/messages.json",t({method:"GET",url:o,onload:i})}}})}));if(!e.userLanguage.startsWith("en"))try{n=await a}catch(e){}const i=[],o={symbol:["❌","✔️"],word:["OFF","ON"],separator:"Tampermonkey"==r()?" — ":": "};if(await Promise.race([new Promise((e=>{!function t(){document.querySelector("[cif-extension-installed]")?e(!0):setTimeout(t,200)}()})),new Promise((e=>setTimeout((()=>e(!1)),1500)))]))return void GM_registerMenuCommand(o.symbol[0]+" "+(n.menuLabel_disabled||"Disabled (extension installed)"),(()=>{}));function s(t,n){GM_setValue(e.keyPrefix+"_"+t,n),e[t]=n}function l(e){window.open(e,"_blank","noopener")}function r(){try{return GM_info.scriptHandler}catch(e){return"other"}}function c(){const t=o.symbol[+e.infinityMode]+" "+(n.menuLabel_infinityMode||"Infinity Mode")+" ∞ "+o.separator+o.word[+e.infinityMode];i.push(GM_registerMenuCommand(t,(()=>{document.getElementById("infinity-toggle-label").click()})));const a=o.symbol[+e.autoStart]+" "+(n.menuLabel_autoStart||"Auto-Start")+o.separator+o.word[+e.autoStart];i.push(GM_registerMenuCommand(a,(()=>{s("autoStart",!e.autoStart),u((n.menuLabel_autoStart||"Auto-Start")+": "+o.word[+e.autoStart]),p()})));const l=o.symbol[+!e.toggleHidden]+" "+(n.menuLabel_toggleVis||"Toggle Visibility")+o.separator+o.word[+!e.toggleHidden];i.push(GM_registerMenuCommand(l,(()=>{s("toggleHidden",!e.toggleHidden),k.style.display=e.toggleHidden?"none":"flex",u((n.menuLabel_toggleVis||"Toggle Visibility")+": "+o.word[+!e.toggleHidden]),p()})));const r=o.symbol[+!e.autoScrollDisabled]+" "+(n.menuLabel_autoScroll||"Auto-Scroll")+o.separator+o.word[+!e.autoScrollDisabled];i.push(GM_registerMenuCommand(r,(()=>{s("autoScrollDisabled",!e.autoScrollDisabled),u((n.menuLabel_autoScroll||"Auto-Scroll")+": "+o.word[+!e.autoScrollDisabled]),p()})));const c="🌐 "+(n.menuLabel_replyLang||"Reply Language")+o.separator+e.replyLanguage;i.push(GM_registerMenuCommand(c,(()=>{for(;;){let t=prompt(`${n.prompt_updateReplyLang||"Update reply language"}:`,e.replyLanguage);if(null===t)break;if(!/\d/.test(t)){t=[2,3].includes(t.length)||t.includes("-")?t.toUpperCase():t.charAt(0).toUpperCase()+t.slice(1).toLowerCase(),s("replyLanguage",t||e.userLanguage),g((n.alert_replyLangUpdated||"Language updated")+"!",(n.appName||e.appName)+" "+(n.alert_willReplyIn||"will reply in")+" "+(t||n.alert_yourSysLang||"your system language")+"."),e.infinityMode&&h(),p();break}}})));const m=new RegExp("^("+(n.menuLabel_all||"all")+"|all|any|every)$","i"),y="🧠 "+(n.menuLabel_replyTopic||"Reply Topic")+o.separator+(m.test(e.replyTopic)?n.menuLabel_all||"all":function(e){const t=e.toLowerCase().split(" ");for(let e=0;e<t.length;e++)t[e]=t[e][0].toUpperCase()+t[e].slice(1);return t.join(" ")}(e.replyTopic));i.push(GM_registerMenuCommand(y,(()=>{const t=prompt((n.prompt_updateReplyTopic||"Update reply topic")+" ("+(n.prompt_orEnter||"or enter")+" 'ALL'):",e.replyTopic);if(null!==t){const a=t.toString();s("replyTopic",!t||m.test(a)?"ALL":a),g((n.alert_replyTopicUpdated||"Topic updated")+"!",(n.appName||e.appName)+" "+(n.alert_willAnswer||"will answer questions")+" "+(!t||m.test(a)?n.alert_onAllTopics||"on ALL topics":(n.alert_onTopicOf||"on the topic of")+" "+a)+"!"),e.infinityMode&&(chatgpt.stop(),document.getElementById("infinity-toggle-label").click(),setTimeout((()=>{document.getElementById("infinity-toggle-label").click()}),500)),p()}})));const f="⌚ "+(n.menuLabel_replyInt||"Reply Interval")+o.separator+e.replyInterval+"s";i.push(GM_registerMenuCommand(f,(async()=>{for(;;){const t=prompt(`${n.prompt_updateReplyInt||"Update reply interval (minimum 5 secs)"}:`,e.replyInterval);if(null===t)break;if(!isNaN(parseInt(t,10))&&parseInt(t,10)>4){s("replyInterval",parseInt(t,10)),g((n.alert_replyIntUpdated||"Interval updated")+"!",(n.appName||e.appName)+" "+(n.alert_willReplyEvery||"will reply every")+" "+t+" "+(n.unit_seconds||"seconds")+"."),e.infinityMode&&b(),p();break}}})));const L=`💡 ${n.menuLabel_about||"About"} ${n.appName||e.appName}`;i.push(GM_registerMenuCommand(L,d))}function p(){if("OrangeMonkey"!=r()){for(const e of i)GM_unregisterMenuCommand(e);c()}}function d(){const a=(/chatgpt-([\d.]+)\.min/.exec(GM_info.script.header)||[null,""])[1],i="font-size: 1.15rem",o="position: relative ; left: 3px",s="color: "+(chatgpt.isDarkMode()?"#c67afb":"#8325c4"),r=g(n.appName||e.appName,`<span style="${i}"><b>🏷️ <i>${n.about_version||"Version"}</i></b>: </span><span style="${o}">${GM_info.script.version}</span>\n<span style="${i}"><b>⚡ <i>${n.about_poweredBy||"Powered by"}</i></b>: </span><span style="${o}"><a style="${s}" href="https://chatgpt.js.org" target="_blank" rel="noopener">chatgpt.js</a>`+(a?" v"+a:"")+"</span>\n"+`<span style="${i}"><b>📜 <i>${n.about_sourceCode||"Source code"}</i></b>:</span>\n`+`<span style="position: relative ; left: 4px "><a href="${e.gitHubURL}" target="_blank" rel="nopener">`+e.gitHubURL+"</a></span>",[function(){!function(){const a=GM_info.script.version;t({method:"GET",url:e.updateURL+"?t="+Date.now(),headers:{"Cache-Control":"no-cache"},onload:t=>{const i=377,o=/@version +(.*)/.exec(t.responseText)[1];for(let t=0;t<4;t++){const s=parseInt(a.split(".")[t],10)||0,r=parseInt(o.split(".")[t],10)||0;if(s>r)break;if(r>s){const t=g((n.alert_updateAvail||"Update available")+"! 🚀",(n.alert_newerVer||"An update to")+" "+(n.appName||e.appName)+" "+`(v${o}) ${n.alert_isAvail||"is available"}!  <a target="_blank" rel="noopener" style="font-size: 0.7rem" href="`+e.gitHubURL+"/commits/main/greasemonkey/"+e.updateURL.replace(/.*\/(.*)meta\.js/,"$1user.js")+'"'+`> ${n.link_viewChanges||"View changes"}</a>`,(function(){l(e.updateURL.replace("meta.js","user.js")+"?t="+Date.now())}),"",i);if(!e.userLanguage.startsWith("en")){const e=document.querySelector(`[id="${t}"]`).querySelectorAll("button");e[1].textContent=n.btnLabel_update||"Update",e[0].textContent=n.btnLabel_dismiss||"Dismiss"}return}}g((n.alert_upToDate||"Up-to-date")+"!",`${n.appName||e.appName} (v${a}) `+(n.alert_isUpToDate||"is up-to-date")+"!","","",i),d()}})}()},function(){l(e.supportURL)},function(){const t=chatgpt.alert((n.alert_choosePlatform||"Choose a Platform")+":","",[function(){l(e.greasyForkURL+"/feedback#post-discussion")},function(){l("https://www.producthunt.com/products/chatgpt-infinity/reviews/new")},function(){l("https://alternativeto.net/software/chatgpt-infinity/about/")}]),a=document.getElementById(t).querySelectorAll("button");a[0].style.display="none",a[1].textContent=a[1].textContent.replace(/\s/g,"")},function(){l("https://github.com/adamlui/chatgpt-apps")}],"",478);for(const e of document.getElementById(r).querySelectorAll("button"))/updates/i.test(e.textContent)?e.textContent="🚀 "+(n.btnLabel_updateCheck||"Check for Updates"):/support/i.test(e.textContent)?e.textContent="🧠 "+(n.btnLabel_getSupport||"Get Support"):/review/i.test(e.textContent)?e.textContent="⭐ "+(n.btnLabel_leaveReview||"Leave a Review"):/apps/i.test(e.textContent)?e.textContent="🤖 "+(n.btnLabel_moreApps||"More ChatGPT Apps"):e.style.display="none"}function u(t,n="",a="",i=""){const s=o.word.find((e=>t.includes(e)));s&&(t=t.replace(s,"")),chatgpt.notify(`${e.appSymbol} ${t}`,n,a,i||chatgpt.isDarkMode()?"":"shadow");const l=document.querySelectorAll(".chatgpt-notif"),r=l[l.length-1];if(s){const e=document.createElement("span");e.style.cssText="color: "+(s==o.word[0]?"#ef4848 ; text-shadow: rgba(255, 169, 225, 0.44) 2px 1px 5px":"#5cef48 ; text-shadow: rgba(255, 250, 169, 0.38) 2px 1px 5px"),e.append(s),r.append(e)}}function g(t="",n="",a="",i="",o=""){return chatgpt.alert(`${e.appSymbol} ${t}`,n,a,i,o)}async function m(){const t=document.querySelector("nav");t.contains(k)||t.insertBefore(k,t.children[1]),k.style.flexGrow="unset",k.style.paddingLeft="8px";const n=document.getElementById("infinity-toggle-navicon");n&&(n.src=`${e.mediaHostURL}images/icons/infinity-symbol/${chatgpt.isDarkMode()?"white":"black"}/icon32.png?${e.latestAssetCommitHash}`)}function y(){const t=document.getElementById("infinity-toggle-navicon")||document.createElement("img");t.id="infinity-toggle-navicon",t.style.width=t.style.height="1.25rem",t.style.marginLeft="2px",t.style.marginRight="4px";const a=document.getElementById("infinity-toggle-input")||document.createElement("input");a.id="infinity-toggle-input",a.type="checkbox",a.disabled=!0,a.style.display="none",a.checked=e.infinityMode;const i=document.getElementById("infinity-switch-span")||document.createElement("span");i.id="infinity-switch-span";const o={position:"relative",left:(chatgpt.browser.isMobile()?211:_?w?147:154:160)+"px",backgroundColor:a.checked?"#ccc":"#AD68FF",bottom:(_?L||!w?.05:0:-.15)+"em",width:"30px",height:"15px","-webkit-transition":".4s",transition:"0.4s",borderRadius:"28px"};Object.assign(i.style,o);const s=document.getElementById("infinity-toggle-knob-span")||document.createElement("span");s.id="infinity-toggle-knob-span";const l={position:"absolute",left:"3px",bottom:(L&&!_?.075:.055)+"em",width:"13px",height:"13px",content:'""',borderRadius:"28px",transform:a.checked?"translateX(0)":"translateX(13px) translateY(0)",backgroundColor:"white","-webkit-transition":"0.4s",transition:"0.4s"};Object.assign(s.style,l),i.append(s);const r=document.getElementById("infinity-toggle-label")||document.createElement("label");r.id="infinity-toggle-label",_||(r.style.fontSize="0.875rem",r.style.fontWeight=600),r.style.marginLeft=`-${_?41:23}px`,r.style.cursor="pointer",r.style.width=(chatgpt.browser.isMobile()?201:w?145:148)+"px",r.style.overflow="hidden",r.style.textOverflow="ellipsis",r.innerText=(n.menuLabel_infinityMode||"Infinity Mode")+" "+(a.checked?n.state_enabled||"enabled":n.state_disabled||"disabled");for(const e of[t,a,i,r])k.append(e);k.style.display=e.toggleHidden?"none":"flex",setTimeout((()=>{i.style.backgroundColor=a.checked?"#ad68ff":"#ccc",i.style.boxShadow=a.checked?"2px 1px 9px #d8a9ff":"none",s.style.transform=a.checked?"translateX(13px) translateY(0)":"translateX(0)"}),1)}c();const f={async activate(){if(u((n.menuLabel_infinityMode||"Infinity Mode")+": ON"),chatgpt.browser.isMobile()&&chatgpt.sidebar.isOn()&&chatgpt.sidebar.hide(),!new URL(document.location).pathname.startsWith("/g/"))try{chatgpt.startNewChat()}catch(e){return}setTimeout((()=>{chatgpt.send("Generate a single random question"+(e.replyLanguage?" in "+e.replyLanguage:"")+" on "+("ALL"==e.replyTopic?"ALL topics":"the topic of "+e.replyTopic)+" then answer it. Don't type anything else.")}),500),await chatgpt.isIdle(),e.infinityMode&&!f.isActive&&(f.isActive=setTimeout(f.continue,1e3*parseInt(e.replyInterval,10)))},async continue(){if(chatgpt.send("Do it again."),!e.autoScrollDisabled)try{chatgpt.scrollToBottom()}catch(e){}await chatgpt.isIdle(),f.isActive&&(f.isActive=setTimeout(f.continue,1e3*parseInt(e.replyInterval,10)))},deactivate(){chatgpt.stop(),clearTimeout(f.isActive),f.isActive=null,document.getElementById("infinity-toggle-input").checked=!1,u((n.menuLabel_infinityMode||"Infinity Mode")+": OFF"),e.infinityMode=!1},toggle(){e.infinityMode?f.activate():f.deactivate()}};function h(){chatgpt.stop(),document.getElementById("infinity-toggle-label").click(),setTimeout((()=>{document.getElementById("infinity-toggle-label").click()}),500)}async function b(){clearTimeout(f.isActive),f.isActive=null,await chatgpt.isIdle(),e.infinityMode&&!f.isActive&&(f.isActive=setTimeout(f.continue,1e3*parseInt(e.replyInterval,10)))}await Promise.race([chatgpt.isLoaded(),new Promise((e=>setTimeout(e,5e3)))]),await chatgpt.sidebar.isLoaded();const L=chatgpt.browser.isFirefox(),w=document.documentElement.className.includes(" "),_=chatgpt.getNewChatLink();void 0!==document.hidden&&(document.onvisibilitychange=()=>{e.infinityMode&&(document.getElementById("infinity-toggle-label")?document.getElementById("infinity-toggle-label").click():f.deactivate(),p())});const v=20240724;let x=document.getElementById("tweaks-style");(!x||parseInt(x.getAttribute("last-updated"),10)<v)&&(x||(x=document.createElement("style"),x.id="tweaks-style",x.setAttribute("last-updated",v.toString()),document.head.append(x)),x.innerText=(chatgpt.isDarkMode()?".chatgpt-modal > div { border: 1px solid white }":"")+".chatgpt-modal button {font-size: 0.77rem ; text-transform: uppercase ;border-radius: 0 !important ; padding: 5px !important ; min-width: 102px }.chatgpt-modal button:hover { transform: scale(1.055) }.modal-buttons { margin-left: -13px !important }* { scrollbar-width: thin }.sticky div:active, .sticky div:focus {transform: none !important }");const k=document.createElement("div");if(k.style.height="37px",k.style.margin="2px 0",k.style.userSelect="none",k.style.cursor="pointer",y(),_){const e=_.querySelector("div:first-child"),t=_.querySelector("div:nth-child(2)");k.classList.add(..._.classList,...t.classList),k.querySelector("img")?.classList.add(...e.classList)}if(m(),k.onclick=()=>{const t=document.getElementById("infinity-toggle-input");t.checked=!t.checked,e.infinityMode=t.checked,y(),p(),f.toggle()},e.autoStart){const t=document.getElementById("infinity-toggle-input");t?t.parentNode.click():(f.activate(),e.infinityMode=!0,p())}new MutationObserver((e=>{e.forEach((e=>{"childList"==e.type&&e.addedNodes.length&&m()}))})).observe(document.documentElement,{childList:!0,subtree:!0})})();