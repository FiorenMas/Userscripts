...
// @name:lv AdGuard Extra (Beta)
// @name:ms Adguard Tambahan (Beta)
...
// @name:sv AdGuard Extra (Beta)
// @name:th AdGuard Extra (Beta)
// @name:tr AdGuard Extra (Beta)
// @name:uk AdGuard Extra (Beta)
// @name:vi AdGuard Extra (Beta)
// @name:zh-HK AdGuard Extra (Beta)
