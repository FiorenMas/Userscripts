...
`).pop():/^\[[\s\S]+[^\]]$/.test(f)&&(f=f+"]")),JSON.parse(f)}catch{return null}};d.read().then(function f({done:h,value:m}){if(ri==l){if(h){t({text:p,json:u,finalUrl:n.finalUrl||l});return}a=e.streamMode==="standalone"?Array.from(m):a.concat(Array.from(m));try{p=new TextDecoder("utf-8").decode(new Uint8Array(a)),e.onstream({text:p,json:u,finalUrl:n.finalUrl||l})}catch(y){console.log(y)}return d.read().then(f)}})}),Be(s)})):null:Ge=fetch,St?nt=(l,e)=>{}:typeof GM_registerMenuCommand<"u"?nt=GM_registerMenuCommand:typeof GM<"u"&&typeof GM.registerMenuCommand<"u"?nt=GM.registerMenuCommand:nt=(l,e)=>{},typeof GM_openInTab<"u"?ge=GM_openInTab:typeof GM<"u"&&typeof GM.openInTab<"u"?ge=GM.openInTab:ge=(l,e)=>{window.open(l)},typeof GM_notification<"u"?Ce=l=>GM_notification({text:l,onclick:e=>ge(Ae,{active:!0})}):typeof GM<"u"&&typeof GM.notification<"u"?Ce=l=>GM.notification({text:l,onclick:e=>ge(Ae,{active:!0})}):Ce=l=>{},typeof GM_setClipboard<"u"?Oe=GM_setClipboard:typeof GM<"u"&&typeof GM.setClipboard<"u"?Oe=GM.setClipboard:Oe=(l,e)=>{try{nr.writeText(l).then(()=>{console.log("Text copied to clipboard")}).catch(t=>{document.execCommand("copy"),console.error("Failed to copy text: ",t)})}catch{document.execCommand("copy")}},Me=l=>{if(l=l.replace(/\n\s*/g,""),typeof GM_addStyle<"u")return GM_addStyle(l);{let e=document.createElement("style");return e.innerHTML=ee(l),document.head.appendChild(e),e}},typeof GM_info<"u"?pt=GM_info:typeof GM<"u"&&typeof GM.info<"u"?pt=GM.info:pt={script:{name:"SearchJumper",version:0}},xe.searchJumperAddons||(xe.searchJumperAddons=[]);const $i=document.referrer;let de=location.href.slice(0,500);var U={supportGM:typeof GM_getValue=="function"&&typeof GM_getValue("a","b")<"u",supportGMPromise:typeof GM<"u"&&typeof GM.getValue=="function"&&typeof GM.getValue("a","b")<"u",supportCrossSave:function(){return this.supportGM||this.supportGMPromise},listItemCache:[],mxAppStorage:function(){try{return window.external.mxGetRuntime().storage}catch{}}(),operaUJSStorage:function(){try{return window.opera.scriptStorage}catch{}}(),setItem:function(l,e){this.supportGMPromise?(GM.setValue(l,e),e===""&&typeof GM<"u"&&typeof GM.deleteValue<"u"&&GM.deleteValue(l)):this.supportGM?(GM_setValue(l,e),e===""&&typeof GM_deleteValue<"u"&&GM_deleteValue(l)):this.operaUJSStorage?this.operaUJSStorage.setItem(l,e):this.mxAppStorage?this.mxAppStorage.setConfig(l,e):window.localStorage&&window.localStorage.setItem(l,e)},getItem:async function(l,e){var t;return this.supportGMPromise?t=await GM.getValue(l):this.supportGM?t=GM_getValue(l):this.operaUJSStorage?t=this.operaUJSStorage.getItem(l):this.mxAppStorage?t=this.mxAppStorage.getConfig(l):window.localStorage&&(t=window.localStorage.getItem(l)),e&&e(t),t},getListItem:async function(l,e){var t=this.listItemCache[l];if(typeof t>"u"&&(t=await this.getItem(l),this.listItemCache[l]=t||null),!t)return null;for(var r=0;r<t.length;r++){let i=t[r];if(i.k==e)return i.v}return null},setListItem:async function(l,e,t){var r=this.listItemCache[l];typeof r>"u"&&(r=await this.getItem(l)),r||(r=[]),r=r.filter(i=>i&&i.k!=e),t&&(r.unshift({k:e,v:t}),r.length>50&&r.pop()),this.setItem(l,r),this.listItemCache[l]=r}};class cr{constructor(e,t,r){this.webDAVUrl=e,this.username=t,this.password=r}init(){this.inited||(this.inited=!0,this.auth=btoa(`${this.username}:${this.password}`))}request(e,t,r,i,s,n){{this.init();let a=this.webDAVUrl+r,o={referer:a,origin:a,"Content-Type":"text/xml; charset=UTF-8",Authorization:`Basic ${this.auth}`};for(let p in n)o[p]=n[p];Be({method:e,url:a,data:t,headers:o,onload:function(p){let d=p.response;if((p.status>=400||!d)&&(d=""),i=="xml"){var u=p.responseXML;u&&(d=u.firstChild.nextSibling?u.firstChild.nextSibling:u.firstChild)}s&&s(d)},onerror:function(p){pe(p),s&&s(p)},ontimeout:function(p){pe(p),s&&s(p)}})}}GET(e,t){return this.request("GET",null,e,"text",t,{})}PROPFIND(e,t){return this.request("PROPFIND",null,e,"xml",t,{Depth:"1"})}MKCOL(e,t){return this.request("MKCOL",null,e,"text",t,{})}DELETE(e,t){return this.request("DELETE",null,e,"text",t,{})}PUT(e,t,r){return this.request("PUT",t,e,"text",r,{})}async read(e){let t=this;return new Promise(r=>{t.GET(e,r)})}async write(e,t){let r=this;return new Promise(i=>{r.PUT(e,t,i)})}async rm(e){let t=this;return new Promise(r=>{t.DELETE(e,r)})}}var ot;async function Dt(l,e){if(Te)return;let t=await U.getItem("searchData");if(t&&(c=t),!ot)return l&&l();if(!e){let r=await ot.read("lastModified");if(r&&(r=parseFloat(r)),r&&(!c.lastModified||r>c.lastModified)){c.lastModified=r,jt=c.lastModified;let i=await ot.read("sitesConfig.json");if(i)try{i=JSON.parse(i),c.sitesConfig=i}catch(n){pe(n)}let s=await ot.read("inPageRule.json");if(s)try{s=JSON.parse(s),c.prefConfig.inPageRule=s}catch(n){pe(n)}}}l&&l(),await ot.write("lastModified",""+c.lastModified),await ot.write("sitesConfig.json",JSON.stringify(c.sitesConfig)),await ot.write("inPageRule.json",JSON.stringify(c.prefConfig.inPageRule))}var si;xe.trustedTypes&&xe.trustedTypes.createPolicy&&(si=xe.trustedTypes.createPolicy("searchjumper_default",{createHTML:(l,e)=>l}));const ai=Object.getPrototypeOf(async function(){}).constructor;typeof String.prototype.replaceAll!="function"&&(String.prototype.replaceAll=function(l,e){var t=this;return t.split(l).join(e)}),typeof String.prototype.endsWith!="function"&&(String.prototype.endsWith=function(l,e){return(e===void 0||e>this.length)&&(e=this.length),this.substring(e-l.length,e)===l}),typeof String.prototype.startsWith!="function"&&(String.prototype.startsWith=function(l,e){return this.slice(e||0,l.length)===l});function _(l){return l.body||l.querySelector("body")}function ht(l){return l.type.indexOf("touch")===0?l.changedTouches?l.changedTouches[0].clientX:0:l.clientX}function dt(l){return l.type.indexOf("touch")===0?l.changedTouches?l.changedTouches[0].clientY:0:l.clientY}function pr(l){return l.type.indexOf("touch")===0?l.changedTouches?l.changedTouches[0].pageX:0:l.pageX}function hr(l){return l.type.indexOf("touch")===0?l.changedTouches?l.changedTouches[0].pageY:0:l.pageY}function dr(l,e,t){t=t||document,e=e||t;var r=[];try{for(var i=t.evaluate(l,e,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null),s=0;s<i.snapshotLength;s++){var n=i.snapshotItem(s);n.nodeType===1&&r.push(n)}}catch{pe(`Invalid xpath: ${l}`)}return r}function ur(l,e,t){t=t||document,e=e||t;try{let r=(s,n,a)=>{let o=n.evaluate(s,a,null,XPathResult.ANY_UNORDERED_NODE_TYPE,null);return o.singleNodeValue&&o.singleNodeValue.nodeType===1&&o.singleNodeValue},i=l.split(" =>> ");if(i.length===2){let s=r(i[0],t,e);if(s&&s.shadowRoot)return r(i[1],s.shadowRoot,s.shadowRoot)}else return r(l,t,e)}catch{return pe(`Invalid xpath: ${l}`),!1}}function Wi(l){return l?/^\(*(descendant::|\.\/|\/\/|id\()/.test(l):!1}function ni(l,e,t){e||(e=document);try{if(!Wi(l))return e.querySelectorAll(l)}catch(r){pe(r,"Error selector")}return dr(l,t,e)}function bt(l,e){e||(e=document);try{if(!Wi(l)){let t=l.split(" =>> ");if(t.length===2){let r=e.querySelector(t[0]);return r&&r.shadowRoot&&r.shadowRoot.querySelector(t[1])}else return e.querySelector(l)}}catch(t){pe(t)}return ur(l,e,e)}function fr(l,e){for(var t=l.offsetTop,r=l.offsetParent;r;)t+=r.offsetTop,r=r.offsetParent;if(e){for(r=e;r;)t+=r.offsetTop,r=r.offsetParent;try{let i=e.contentWindow.parent;for(e=i.frameElement;e;){for(r=e;r;)t+=r.offsetTop,r=r.offsetParent;i=i.parent,e=i.frameElement}}catch{}}return t}function Or(l){for(var e=l.offsetLeft,t=l.offsetParent;t;)e+=t.offsetLeft,t=t.offsetParent;if(!document.isSameNode(l.ownerDocument)){let r=document.getElementsByTagName("iframe");for(let i=0;i<r.length;i++){let s=r[i],n;try{n=s.contentDocument||s.contentWindow.document}catch{break}if(n.isSameNode(l.ownerDocument)){for(t=s;t;)e+=t.offsetLeft,t=t.offsetParent;break}}}return e}function oi(l){const e=l.activeElement;return e?e.shadowRoot?oi(e.shadowRoot):e:null}function Di(l){if(l&&(/INPUT|TEXTAREA/i.test(l.nodeName)&&l.getAttribute("aria-readonly")!="true"||l.contentEditable=="true"))return!0;for(;l&&l.nodeName;){if(l.contentEditable=="true")return!0;if(l.nodeName.toUpperCase()=="BODY")break;l=l.parentNode}return!1}function Ct(l){let e=oi(l);return Di(e)}async function mr(l){for(;document.hidden;)await $e(500);var e=100,t="\uF0C8",r=function(){var i,s;e-=1,i=document.createElement("canvas"),i.width=20,i.height=20,s=i.getContext("2d",{willReadFrequently:!0}),s.fillStyle="rgba(0,0,0,1.0)",s.fillRect(0,0,20,20),s.font="16pt FontAwesome",s.textAlign="center",s.fillStyle="rgba(255,255,255,1.0)",s.fillText(t,10,18);var n=s.getImageData(2,10,1,1).data;n[0]==0&&n[1]==0&&n[2]==0?(s.font='16pt "Font Awesome 6 Free"',s.fillText(t,10,18),n=s.getImageData(2,10,1,1).data,n[0]==0&&n[1]==0&&n[2]==0?e>0&&setTimeout(r,150):typeof l=="function"&&l()):typeof l=="function"&&l()};setTimeout(r,100)}var lt,k,Se=[],le=!1,li=!1,Ee,xt,tt,Fe,Tt,Ve,ye,Ye,kt,Le,Pe,He=[],Jt=[],It,Ne,_e,Ht,zt,Ji,ci,Hi=!1,jt=0,Ze;const pi=`<svg class="search-jumper-logoBtnSvg" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><title>${pt.script.name}</title><path d="M.736 510.464c0-281.942 228.335-510.5 510-510.5 135.26 0 264.981 53.784 360.625 149.522 95.643 95.737 149.375 225.585 149.375 360.978 0 281.94-228.335 510.5-510 510.5-281.665 0-510-228.56-510-510.5zm510-510.5v1021m-510-510.5h1020" fill="#fefefe"/><path d="M237.44 346.624a48.64 48.64 0 1 0 97.28 0 48.64 48.64 0 1 0-97.28 0zM699.904 346.624a48.64 48.64 0 1 0 97.28 0 48.64 48.64 0 1 0-97.28 0zM423.296 759.296c-64 0-115.712-52.224-115.712-115.712 0-26.624 9.216-52.224 25.6-72.704 9.216-11.776 26.112-13.312 37.888-4.096s13.312 26.112 4.096 37.888c-9.216 11.264-13.824 24.576-13.824 38.912 0 34.304 27.648 61.952 61.952 61.952s61.952-27.648 61.952-61.952c0-4.096-.512-8.192-1.024-11.776-2.56-14.848 6.656-28.672 21.504-31.744 14.848-2.56 28.672 6.656 31.744 21.504 1.536 7.168 2.048 14.336 2.048 22.016-.512 63.488-52.224 115.712-116.224 115.712z" fill="#333"/><path d="M602.08 760.296c-64 0-115.712-52.224-115.712-115.712 0-14.848 12.288-27.136 27.136-27.136s27.136 12.288 27.136 27.136c0 34.304 27.648 61.952 61.952 61.952s61.952-27.648 61.952-61.952c0-15.36-5.632-30.208-15.872-41.472-9.728-11.264-9.216-28.16 2.048-37.888 11.264-9.728 28.16-9.216 37.888 2.048 19.456 21.504 29.696 48.64 29.696 77.824 0 62.976-52.224 115.2-116.224 115.2z" fill="#333"/><ellipse ry="58" rx="125" cy="506.284" cx="201.183" fill="#faf"/><ellipse ry="58" rx="125" cy="506.284" cx="823.183" fill="#faf"/></svg>`,ut="data:image/svg+xml;base64,",hi="data:image/svg+xml;base64,",zi='<path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64z m165.4 618.2l-66-0.3L512 563.4l-99.3 118.4-66.1 0.3c-4.4 0-8-3.5-8-8 0-1.9 0.7-3.7 1.9-5.2l130.1-155L340.5 359c-1.2-1.5-1.9-3.3-1.9-5.2 0-4.4 3.6-8 8-8l66.1 0.3L512 464.6l99.3-118.4 66-0.3c4.4 0 8 3.5 8 8 0 1.9-0.7 3.7-1.9 5.2L553.5 514l130 155c1.2 1.5 1.9 3.3 1.9 5.2 0 4.4-3.6 8-8 8z"></path>',di="%s[lurest]?\\b",ft=new RegExp(di);var M,ui,Et,Xe,Ri=!1;function gr(l,e,t){if(!l&&!e&&!t){let L=new Date,W=L.getFullYear(),T=L.getMonth(),K=L.getDate();l=L.getFullYear(),e=L.getMonth()+1,t=L.getDate()}let r=2e3,i=2,s=5,n=[51552,55636,54432,55888,30034,22176,43959,9680,37584,51893,43344,46240,47780,44368,21977,19360,42416,86390,21168,43312,31060,27296,44368,23378,19296,42726,42208,53856,60005,54576,23200,30371,38608,19195,19152,42192,118966,53840,54560,56645,46496,22224,21938,18864,42359,42160,43600,111189,27936,44448,84835,37744,18936,18800,25776,92326,59984,27424,108228,43744,41696,53987,51552,54615,54432,55888,23893,22176,42704,21972,21200,43448,43344,46240,46758,44368,21920,43940,42416,21168,45683,26928,29495,27296,44368,84821,19296,42352,21732,53600,59752,54560,55968,92838,22224,19168,43476,41680,53584,62034,54560],a="\u6B63\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u51AC\u81D8",o="\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u521D\u5EFF",p="\u7532\u4E59\u4E19\u4E01\u620A\u5DF1\u5E9A\u8F9B\u58EC\u7678",d="\u5B50\u4E11\u5BC5\u536F\u8FB0\u5DF3\u5348\u672A\u7533\u9149\u620C\u4EA5",u="\u9F20\u725B\u864E\u5154\u9F8D\u86C7\u99AC\u7F8A\u7334\u96DE\u72D7\u8C6C";function f(L,W,T){W-=1;let K=(Date.UTC(L,W,T)-Date.UTC(r,i-1,s))/(24*60*60*1e3)+1,z,A,b,P;for(let J=0;J<n.length;J++)if(K-=y(n[J]),K<=0){z=r+J,P=n[J],K+=y(P);break}if(!P)return null;for(let J=0;J<C(P).length;J++)if(K-=C(P)[J],K<=0){h(P)&&h(P)<=J?h(P)<J?A=J:h(P)===J?A="\u95F0"+J:A=J+1:A=J+1,K+=C(P)[J];break}return b=K,h(P)&&typeof A=="string"&&A.indexOf("\u95F0")>-1?A=`\u95F0${a[/\d/.exec(A)-1]}`:A=a[A-1],z=j(z)+x(z),b<11?b=`${o[10]}${o[b-1]}`:b>10&&b<20?b=`${o[9]}${o[b-11]}`:b===20?b=`${o[1]}${o[9]}`:b>20&&b<30?b=`${o[11]}${o[b-21]}`:b===30&&(b=`${o[2]}${o[9]}`),{lunarYear:z,lunarMonth:A,lunarDay:b}}function h(L){return L&15?L&15:!1}function m(L){return h(L)?L&983040?30:29:0}function y(L){let W=0;for(let T=32768;T>8;T>>=1){let K=L&T?30:29;W+=K}return h(L)&&(W+=m(L)),W}function C(L){let W=[];for(let T=32768;T>8;T>>=1)W.push(L&T?30:29);return h(L)&&W.splice(h(L),0,m(L)),W}function j(L){let W=(L-3)%10;return W===0&&(W=10),p[W-1]}function x(L){let W=(L-3)%12;return W===0&&(W=12),W--,d[W]+` (${u[W]}) `}return f(l,e,t)}class yr{constructor(){let e=this;this.scale=c.prefConfig.customSize/100,this.tilesZoom=c.prefConfig.tilesZoom/100,this.tipsZoom=c.prefConfig.tipsZoom/100,Et=`
                 ...
                 #search-jumper-alllist>.dayInAll {
                     left: 50px;
                     font-size: ${Ke.indexOf("zh")==0?"1.5":"2"}vw;
                 }
                 #search-jumper-alllist>.timeInAll {
                     right: 50px;
                     font-size: 2vw;
                ...
                `,c.prefConfig.cssText&&(Et+=c.prefConfig.cssText);let t=document.createElement("span");t.className="search-jumper-logo",lt=document.createElement("span"),lt.innerHTML=ee(pi),lt.className="search-jumper-btn",t.addEventListener("mouseenter",A=>{this.preList&&(this.preList.style.visibility="hidden",this.listArrow.style.cssText="")}),t.appendChild(lt);let r=document.createElement("span");r.className="search-jumper-searchBar",r.appendChild(t);let i=document.createElement("div");i.id="search-jumper",i.style.display="none",i.className="search-jumper-searchBarCon",i.appendChild(r),i.setAttribute("translate","no");let s=document.createElement("div");s.id="search-jumper-alllist",i.appendChild(s),this.alllist=s;let n=document.createElement("span");n.className="groupTab",i.appendChild(n),this.groupTab=n;let a=document.createElement("div");a.className="search-jumper-showallBg",i.appendChild(a);let o=document.createElement("div");o.className="sitelistBox",s.appendChild(o),this.sitelistBox=o;const p=/#[^\s#]+/g;o.addEventListener("mouseover",A=>{if(!s.classList.contains("new-mode"))return;let b=A.target;b.parentNode&&b.parentNode.dataset.name&&(b=b.parentNode);let P=b.title;if(!b.dataset.name||!P||b.initedTag)return;let J=document.createElement("p"),N=P.match(p);N&&(N.forEach($=>{let Z=document.createElement("span");Z.innerText=$.slice(1),Z.addEventListener("click",ue=>{e.searchInput.value=$,e.searchInput.dispatchEvent(new CustomEvent("input"))}),J.appendChild(Z)}),b.appendChild(J)),b.initedTag=!0});let d=document.createElement("span");d.className="timeInAll",s.appendChild(d),this.timeInAll=d,this.modeSwitch=document.createElement("div"),this.modeSwitch.className="modeSwitch",this.modeSwitch.innerHTML=ee('<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" version="1.1"><rect height="450" width="520" y="287" x="253" fill="#fff"></rect><path d="m511.8,64.2c-247.5,0 -448.2,200.7 -448.2,448.2s200.7,448.2 448.2,448.2s448.2,-200.6 448.2,-448.2s-200.7,-448.2 -448.2,-448.2zm-260.4,353.9c0,-7.8 6.3,-14.2 14.2,-14.2l315.6,0l0,-102.5c0,-12.3 14.7,-18.8 23.7,-10.4l165.1,151.7c9.5,8.7 3.3,24.6 -9.6,24.6l-495,0c-7.8,0 -14.2,-6.3 -14.2,-14.2l0,-35l0.2,0zm523.2,188.5c0,7.8 -6.3,14.2 -14.2,14.2l-315.5,0l0,102.6c0,12.3 -14.7,18.8 -23.7,10.4l-165.2,-151.8c-9.5,-8.7 -3.3,-24.6 9.6,-24.6l495,0c7.8,0 14.2,6.3 14.2,14.2l0,35l-0.2,0z"></path></svg>'),s.appendChild(this.modeSwitch),this.modeSwitch.addEventListener("click",A=>{A.preventDefault(),A.stopPropagation(),s.classList.toggle("new-mode"),s.classList.remove("showbg"),U.setItem("allPageNewMode",s.classList.contains("new-mode"))}),this.modeSwitch.addEventListener("mouseenter",A=>{Ze&&(A.preventDefault(),A.stopPropagation(),s.classList.add("showbg"))}),this.modeSwitch.addEventListener("mouseleave",A=>{Ze&&(A.preventDefault(),A.stopPropagation(),s.classList.remove("showbg"))}),this.modeSwitch.addEventListener("contextmenu",A=>{Ze&&(A.preventDefault(),A.stopPropagation(),s.classList.remove("showbg"),ge(Ze,{active:!0,insert:!0}))}),Hi&&s.classList.add("new-mode");let u=document.createElement("span");u.className="dayInAll",s.appendChild(u),this.dayInAll=u,s.addEventListener(Mt(),A=>{if(e.tips.style.display="none",clearTimeout(e.requestShowTipsTimer),!(A.target!=s&&A.target!=a&&A.target!=o)&&!s.classList.contains("new-mode")){var b,P;if(A.type!=="wheel"){var J=0,N=0;typeof A.axis=="number"?A.axis==2?N=A.detail:J=A.detail:typeof A.wheelDeltaY>"u"||A.wheelDeltaY!=0?N=-A.wheelDelta/40:J=-A.wheelDelta/40,P=N,b=J}else b=A.deltaX,P=A.deltaY;A.preventDefault(),A.stopPropagation(),s.scrollLeft+=P}},{passive:!1,capture:!1});let f=document.createElement("span");f.innerHTML=ee(pi),f.className="search-jumper-btn",f.addEventListener("click",A=>{ge(Ae,{active:!0,insert:!0})}),s.appendChild(f);let h=document.createElement("div");h.className="search-jumper-historylistcon",s.appendChild(h);let m=document.createElement("div");if(m.className="search-jumper-historylist",h.appendChild(m),this.historylist=m,r.addEventListener("mouseenter",A=>{r.classList.contains("grabbing")||(this.hideTimeout&&clearTimeout(this.hideTimeout),this.checkScroll(!0),c.prefConfig.mouseLeaveToHide&&r.classList.remove("initShow"))},!1),r.addEventListener("mouseleave",A=>{if(c.prefConfig.mouseLeaveToHide){if(r.classList.contains("grabbing"))return;e.waitForHide()}e.preList&&(e.preList.style.visibility="hidden",e.listArrow.style.cssText="")},!1),this.touched=!0,c.prefConfig.initShow?r.classList.add("initShow"):this.touched=!1,c.prefConfig.minSizeMode&&(r.classList.add("minSizeMode"),r.classList.add("minSizeModeClose")),Wt&&!c.prefConfig.resizePage){let A=P=>{this.touched=!1,r.classList.remove("initShow")},b=P=>{this.touched||this.funcKeyCall||(this.touched=!0,r.classList.add("disable-pointer"),P.stopPropagation(),setTimeout(()=>{r.classList.remove("disable-pointer")},250))};_(document).addEventListener("touchstart",A,{passive:!0,capture:!1}),r.addEventListener("touchstart",b,{passive:!1,capture:!0})}this.bar=r,this.con=i;let y=document.createElement("span");y.className="search-jumper-tips",y.style.opacity=0,i.appendChild(y),y.addEventListener("mouseenter",A=>{e.hideTimeout&&clearTimeout(e.hideTimeout)},!1),y.addEventListener("click",A=>{let b=A.target.dataset,P=A.target.innerText;if(b){if(typeof b.read<"u"){let J=new SpeechSynthesisUtterance("");J.volume=b.volume||1,J.rate=b.rate||1,J.pitch=b.pitch||1,J.lang=b.lang||"",J.text=b.read||P,window.speechSynthesis.speak(J)}typeof b.copy<"u"&&Oe(b.copy||P),b.search&&(Nt=P,e.searchBySiteName(b.search)),typeof b.paste<"u"&&M&&(/INPUT|TEXTAREA/i.test(M.nodeName)&&M.getAttribute("aria-readonly")!="true"||M.contentEditable=="true")&&Ot(M,b.paste||P),typeof b.close<"u"&&(e.tips.style.opacity=0,e.tips.style.display="none",e.tips.innerHTML=ee(""))}},!1);let C,j,x=A=>{let b=ht(A)-C.x,P=dt(A)-C.y;Math.abs(b)+Math.abs(P)<5||(y.style.right===""?y.style.setProperty("left",j.left+b+"px","important"):y.style.setProperty("right",j.right-b+"px","important"),y.style.bottom===""?y.style.setProperty("top",j.top+P+"px","important"):y.style.setProperty("bottom",j.bottom-P+"px","important"),y.classList.add("draging"))},L=A=>{document.removeEventListener("mouseup",L,!1),document.removeEventListener("mousemove",x,!1),document.removeEventListener("touchend",L,!1),document.removeEventListener("touchmove",x,!1),y.classList.remove("draging")},W=(A,b)=>{if(!A.target||A.target!==y&&typeof A.target.dataset.drag>"u")return;A.preventDefault(),A.stopPropagation(),C={x:ht(A),y:dt(A)};let P=getComputedStyle(y);j={left:parseFloat(P.left),right:parseFloat(P.right),top:parseFloat(P.top),bottom:parseFloat(P.bottom)},b&&b()};y.addEventListener("mousedown",A=>{W(A,()=>{document.addEventListener("mouseup",L,!1),document.addEventListener("mousemove",x,!1)})},!1),y.addEventListener("touchstart",A=>{W(A,()=>{document.addEventListener("touchend",L,!1),document.addEventListener("touchmove",x,!1)})},{passive:!1,capture:!1}),this.tips=y;let T=document.createElement("div");T.className="searchJumperNavBar",T.style.display="none",T.innerHTML=ee(`
                ...
                `),i.appendChild(T);let K=document.createElement("span");K.title=E("expand"),K.className="searchJumperExpand search-jumper-btn",K.innerHTML=ee(`
...
`)),document.body.removeChild(st)}catch(rt){console.error(rt)}X=F(X,V[0],re?me:encodeURIComponent(me)),V=X.match(/%element{(.*?)}(\.prop\((.*?)\))?/)}V=X.match(/%date({(.*?)})?/),q=0;let ce=new Date().getTime();for(;V&&!(q++>100);){let ve=V[2],he=ce;if(ve){ve=ve.replace(/\s/g,"");let me=ve.match(/(\D*)?(\d+)/);for(;me;){switch(me[1]){case"-":he-=parseInt(me[2]);break;case"*":he*=parseInt(me[2]);break;case"/":me[2]&&me[2]!="0"&&(he=parseInt(he/parseInt(me[2])));break;default:he+=parseInt(me[2]);break}ve=ve.replace(me[0],""),me=ve.match(/(\D*)?(\d+)/)}}else he=ce;X=X.replace(V[0],he),V=X.match(/%date({(.*?)})?/)}return X};if(!o.dataset.url){let X=T;j&&(X=X.replace(D[0],"")),o.dataset.url=X.replace(/%e\b/g,document.characterSet).replace(/%c\b/g,Wt?"mobile":"pc")}let be="",vt="",Ei=z||document.title,Qe="",oe=zr(o.dataset.url);if(M&&M.nodeName){if(be=M.href||M.parentNode&&M.parentNode.href||"",vt=be||M.parentNode&&M.parentNode.parentNode&&M.parentNode.parentNode.href||"",(s.selectImg||s.selectAudio||s.selectVideo)&&M.src&&(be=M.src),M.nodeName.toUpperCase()=="VIDEO"||M.nodeName.toUpperCase()=="AUDIO"){if(!be){let X=M.querySelector("source");X&&(be=X.src)}be&&(be=be.replace(/^blob:/,""))}Ei=M.title||M.alt||document.title,M.nodeName.toUpperCase()=="IMG"&&/%i\b/.test(T)?M.src&&(/^data/.test(M.src)?Qe=M.src:(a.tipsPos(o,"<span class='loader'></span><font>Loading...</font>"),Qe=await qi(M)),oe=oe.replace(/%i\b/g,Qe)):(M.nodeName.toUpperCase()=="A"||M.parentNode&&M.parentNode.nodeName.toUpperCase()=="A")&&K&&!S&&M.textContent.trim()&&(S=M.textContent.trim())}for(;oe.indexOf("%template{")!==-1;){let X=oe.match(/%template{(.*?[^\\])}/);if(!X)return!1;let V=X[1];c.prefConfig.templateData||(c.prefConfig.templateData={});let q=c.prefConfig.templateData[V];if(!q){if(a.stopInput)return!1;if(q=window.prompt(E("template",V))||"",q)c.prefConfig.templateData[V]=q,U.setItem("searchData",c);else return!1}oe=oe.replace(X[0],q)}for(;oe.indexOf("%input{")!==-1;){let X=oe.match(/%input{(.*?[^\\])}/);if(!X||(a.customInput=!0,a.stopInput))return!1;if(a.batchOpening){let V;if(X[1].indexOf('"')===0&&X[1].indexOf('","')!==-1?V=X[1].substr(1,X[1].length-2).split('","'):V=X[1].split(","),V.length===2?V=window.prompt(V[0],V[1]):V=window.prompt(X[1]),V===null)return!1;oe=oe.replace(X[0],V)}else break}be&&(be=be.replace(/%(\w{2})/g,(X,V)=>`%${V.toUpperCase()}`)),vt&&(vt=vt.replace(/%(\w{2})/g,(X,V)=>`%${V.toUpperCase()}`));let wt=be.replace(/^https?:\/\//i,"");S||(S=le&&Ee);try{if(typeof navigator.clipboard.readText<"u"&&(!S&&K&&(S=await navigator.clipboard.readText(),S&&!g&&(z=S)),!Qe&&/%i\b/.test(T))){if((await navigator.permissions.query({name:"clipboard-read"})).state!=="denied"){const V=await navigator.clipboard.read();for(const q of V)if(q.types.includes("image/png")){const ce=await q.getType("image/png");Qe=await new Promise(ve=>{const he=new FileReader;he.onload=function(me){ve(me.target&&me.target.result)},he.readAsDataURL(ce)}),Qe&&(oe=oe.replace(/%i\b/g,Qe))}}if(!Qe){a.customInput=!0;let V=window.prompt(E("targetUrl"),"https://www.google.com/favicon.ico");if(V)a.tipsPos(o,"<span class='loader'></span><font>Loading...</font>"),Qe=await Ft(V);else return!1}}}catch(X){console.error(X.message)}if(!S&&K){if(a.customInput=!0,a.con.classList.contains("search-jumper-showall")||a.inInput||u||a.stopInput)return!1;let X=window.prompt(E("keywords"));if(X===null)return!1;Fe=X,setTimeout(()=>{Fe=""},1),S=X,ae=S,se=ae.toUpperCase(),fe=ae.toLowerCase(),We=xe.tc2sc?xe.tc2sc(ae):ae,Ii=xe.sc2tc?xe.sc2tc(ae):ae,re||(S=encodeURIComponent(S)),oe=ji(oe)}else S&&!se&&!fe&&!ae&&(ae=S,se=ae.toUpperCase(),fe=ae.toLowerCase(),We=xe.tc2sc?xe.tc2sc(ae):ae,Ii=xe.sc2tc?xe.sc2tc(ae):ae,re||(S=encodeURIComponent(S)));if(be===""){let X=De()||a.searchJumperInputKeyWords.value;if(!K&&X&&/^(http|ftp)/i.test(X))be=X,be=be.replace(/%(\w{2})/g,(V,q)=>`%${q.toUpperCase()}`);else{let V=!1,q=()=>!(a.stopInput||u||(V===!1&&(V=window.prompt(E("targetUrl"),"https://www.google.com/favicon.ico"),V&&(V=V.replace(/%(\w{2})/g,(ce,ve)=>`%${ve.toUpperCase()}`),M={src:V})),V===null));if(/%t\b/.test(oe)){if(a.customInput=!0,q()===!1)return!1;oe=F(oe,"%t",V)}if(/%T\b/.test(oe)){if(a.customInput=!0,q()===!1)return!1;oe=oe.replace(/%T\b/g,encodeURIComponent(V))}if(/%τ\b/.test(oe)){if(a.customInput=!0,q()===!1)return!1;oe=oe.replace(/%τ\b/g,encodeURIComponent(encodeURIComponent(V)))}if(/%b\b/.test(oe)){if(a.customInput=!0,q()===!1)return!1;oe=oe.replace(/%b\b/g,V.replace(/^https?:\/\//i,""))}if(/%B\b/.test(oe)){if(a.customInput=!0,q()===!1)return!1;oe=oe.replace(/%B\b/g,encodeURIComponent(V.replace(/^https?:\/\//i,"")))}if(/%β\b/.test(oe)){if(a.customInput=!0,q()===!1)return!1;oe=oe.replace(/%β\b/g,encodeURIComponent(encodeURIComponent(V.replace(/^https?:\/\//i,""))))}}}let Li=B;if((vt||be)&&!o.dataset.link&&(Y=vt||be,Li=Y.replace(/^\w+:\/\/([^\/]+).*/,"$1")),j){let X=[],V=!1;if(D[1].replace(/([^\\])&/g,"$1SJ^PARAM").split("SJ^PARAM").forEach(q=>{if(q=q.trim(),/^loopStart\(\d+\)$/.test(q)){let ce=q.match(/loopStart\((.*)\)/);X.push(["@loopStart",ce[1]])}else if(q=="loopEnd")X.push(["@loopEnd",""]);else if(q.startsWith("click(")&&q.endsWith(")")){let ce=q.slice(6,q.length-1);ce&&X.push(["@click",ce.replace(/\\([\=&])/g,"$1").trim()])}else if(q.startsWith("dblclick(")&&q.endsWith(")")){let ce=q.slice(9,q.length-1);ce&&X.push(["@dblclick",ce.replace(/\\([\=&])/g,"$1").trim()])}else if(q.startsWith("rclick(")&&q.endsWith(")")){let ce=q.slice(7,q.length-1);ce&&X.push(["@rclick",ce.replace(/\\([\=&])/g,"$1").trim()])}else if(q.startsWith("copy(")&&q.endsWith(")")){let ce=q.slice(5,q.length-1);ce&&X.push(["@copy",ce.replace(/\\([\=&])/g,"$1").trim()])}else if(q.startsWith("call(")&&q.endsWith(")")){let ce=q.slice(5,q.length-1);ce&&(X.push(["@call",ce.replace(/\\([\=&])/g,"$1").trim()]),V=!0)}else if(q.startsWith("reload(")&&q.endsWith(")")){let ce=q.slice(7,q.length-1);X.push(["@reload",ce.trim()])}else if(q.startsWith("wait(")&&q.endsWith(")")){let ce=q.slice(5,q.length-1);X.push(["@wait",ce.replace(/\\([\=&])/g,"$1").trim()])}else if(q.startsWith("open(")&&q.endsWith(")")){let ce=q.slice(5,q.length-1);ce&&X.push(["@open",ce.replace(/\\([\=&])/g,"$1").trim()])}else if(/^sleep\(\d+\)$/.test(q)){let ce=q.match(/sleep\((.*)\)/);ce&&X.push(["@sleep",ce[1]])}else{q=q.replace(/([^\\])\=/g,"$1SJ^PARAM").replace(/\\([\=&])/g,"$1");let ce=q.split("SJ^PARAM");if(ce.length===2){let ve=ce[0],he=ji(ce[1].replace(/\\([\=&])/g,"$1").replace(/%e\b/g,document.characterSet).replace(/%i\b/g,Qe).replace(/%c\b/g,Wt?"mobile":"pc").replace(/%U\b/g,encodeURIComponent(Y)).replace(/%υ\b/g,encodeURIComponent(encodeURIComponent(Y))).replace(/%h\b/g,Li).replace(/%T\b/g,encodeURIComponent(be)).replace(/%τ\b/g,encodeURIComponent(encodeURIComponent(be))).replace(/%b\b/g,wt).replace(/%B\b/g,encodeURIComponent(wt)).replace(/%β\b/g,encodeURIComponent(encodeURIComponent(wt))).replace(/%n\b/g,Ei));he=F(he,"%t",be),he=F(he,"%u",Y),X.push([ve,he])}else(q.endsWith(".click()")||q.endsWith(".click"))&&X.push(["@"+q.replace(/\.click(\(\))?$/,""),"click"])}}),V&&a.updateCacheKeywords(),oe===""||oe===location.href)return Ve=X,this.submitAction(X),!1;U.setListItem("inPagePostParams",oe.replace(/^https?:\/\/([^\/:]+).*/,"$1"),X)}return oe=F(oe,"%h",Li),oe=F(oe,"%t",be),oe=F(oe,"%u",Y),oe=ji(oe.replace(/%U\b/g,encodeURIComponent(Y)).replace(/%υ\b/g,encodeURIComponent(encodeURIComponent(Y))).replace(/%T\b/g,encodeURIComponent(be)).replace(/%τ\b/g,encodeURIComponent(encodeURIComponent(be))).replace(/%b\b/g,wt).replace(/%B\b/g,encodeURIComponent(wt)).replace(/%β\b/g,encodeURIComponent(encodeURIComponent(wt))).replace(/%n\b/g,Ei)),r&&/^(https?|ftp):/.test(oe)?(o.setAttribute("target","_blank"),o.dataset.target=1):o.dataset.target=0,oe},b,P=!1,J,N,$,Z,ue=async g=>{if(delete o.href,g||(g={}),J=g.altKey,N=g.ctrlKey,$=g.metaKey,Z=g.shiftKey,!J&&!N&&!$&&!Z&&(g.button==1||g.button==2?(J=!1,N=!0,$=!1,Z=!1):r===2?(J=!1,N=!0,$=!1,Z=!0):r===3?(J=!0,N=!1,$=!1,Z=!1):r===4&&(J=!1,N=!0,$=!1,Z=!1)),u){o.removeAttribute("target"),f&&(/^(https?|ftp):/.test(f)?(b=f,o.href=b,r?o.setAttribute("target","_blank"):o.setAttribute("target","_self")):(/^copy:/.test(f)&&(f=f.replace(/^copy:/,"")),Oe(f))),o.dispatchEvent(new Event("actionOver"));return}if(P=!1,b="",b=await A(),/^(https?|ftp):/.test(b)&&g.stopPropagation&&g.stopPropagation(),/^c(opy)?:|^paste:/.test(t.url)||/^javascript:/.test(t.url)||/^\[/.test(t.url)||/[:%]P{/.test(t.url)||t.charset&&t.charset!="utf-8"||/[:%]p{/.test(t.url))(g.button==1||g.button==2)&&(P=!0);else{if(!b){a.stopInput||(a.stopInput=!0,setTimeout(()=>{a.stopInput=!1},1));return}o.href=b}a.customInput&&b&&(P=!0),o.dispatchEvent(new Event("actionOver")),P&&(g.preventDefault&&g.preventDefault(),o.click())},te=()=>{let g=Math.max(c.prefConfig.historyLength,20),S=o.dataset.current;if(!t.hideNotMatch&&!t.kwFilter&&!o.dataset.clone&&!o.dataset.paste&&d!=="0"&&g&&!S&&U.getItem("historySites",D=>{Ye=D||[],Ye=Ye.filter(B=>B&&B!=p),Ye.unshift(p),Ye.length>g&&(Ye=Ye.slice(0,g)),U.setItem("historySites",Ye)}),c.prefConfig.shiftLastUsedType&&!S){let D=o.parentNode;!(D&&(D.classList.contains("search-jumper-targetAll")||D.classList.contains("search-jumper-targetImg")||D.classList.contains("search-jumper-targetAudio")||D.classList.contains("search-jumper-targetVideo")||D.classList.contains("search-jumper-targetLink")||D.classList.contains("search-jumper-targetPage")||D.classList.contains("search-jumper-needInPage")))&&kt!=o.dataset.type&&(kt=o.dataset.type,U.setItem("historyType",kt))}c.prefConfig.sortType&&U.getItem("sortTypeNames",D=>{Le=D||{},Le[o.dataset.type]?Le[o.dataset.type]=Le[o.dataset.type]+1:Le[o.dataset.type]=1,U.setItem("sortTypeNames",Le)}),c.prefConfig.sortSite&&U.getItem("sortSiteNames",D=>{Pe=D||{},Pe[o.dataset.name]?Pe[o.dataset.name]=Pe[o.dataset.name]+1:Pe[o.dataset.name]=1,U.setItem("sortSiteNames",Pe)})},w=(g,S)=>{Oe(S);let D=o;g||(a.appendBar(),a.closeOpenType(),a.con.style.display="",a.setFuncKeyCall(!0),window.getSelection().toString()?D=M||o:D=_(document)),a.tipsPos(D,E("copyOver")),clearTimeout(a.hideTips),a.hideTips=setTimeout(()=>{a.tips.style.opacity=="1"&&(a.tips.style.opacity=0)},1500)},R=g=>{if(g&&g.stopPropagation&&g.stopPropagation(),M&&M.focus&&M.focus(),u&&a.waitForShowTips)return H(o,0),g&&g.preventDefault&&g.preventDefault(),!1;if(P=!0,!b)return g&&g.preventDefault&&g.preventDefault(),!1;g||(g={});let S=/^(https?|ftp):/.test(b);if(!a.batchOpening&&!i&&te(),(c.prefConfig.multiline==1||c.prefConfig.multiline==2)&&z&&ft.test(o.dataset.url)&&z.indexOf(`
`)!==-1&&!/^(c|show)/.test(o.dataset.url)&&(c.prefConfig.multiline==1||confirm(E("multiline")))){let B=z.split(`
`);if(B.length>10&&!confirm(E("multilineTooMuch")))return;let Y=0,F=o.target;o.target="_blank";let re=async()=>{b=await A(B[Y++]),o.href=b,o.click(),Y<B.length?setTimeout(()=>{re()},c.prefConfig.multilineGap||1e3):o.target=F};return re(),o.href="",g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),!1}if(b.indexOf("%input{")!==-1){a.showCustomInputWindow(b,B=>{b=B,o.href=B,o.click()}),g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation();return}let D=b.match(/^find(\.addto\((.*?)\))?:(.*)/);if(D){g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation();let B=D[2],Y=D[3];if(Y)B&&c.prefConfig.inPageRule&&B.indexOf("@")!==0&&(B="@"+B),Y.indexOf("%input{")!==-1?a.showCustomInputWindow(Y,F=>{B?a.addToHighlightGroup(F,B):(a.searchJumperInPageInput.value=F,a.submitInPageWords(),a.waitForHide(0))}):B?a.addToHighlightGroup(Y,B):(a.searchJumperInPageInput.value=Y,a.submitInPageWords(),a.waitForHide(0));else return!1;return!1}else if(/^javascript:/.test(t.url)){g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),xe.targetElement=M,xe.keywords=it(),b=b.replace(/^javascript:/,"");try{b=decodeURIComponent(b)}catch{}let B=/^[_a-zA-Z0-9]+$/.test(b)&&xe[b]||new ai(b);return B&&B(),!1}else if(/^c(opy)?:/.test(t.url)){if(g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),b)b.indexOf("%input{")!==-1?a.showCustomInputWindow(b,B=>{w(!0,B.replace(/^c(opy)?:/,""))}):w(g.isTrusted,b.replace(/^c(opy)?:/,""));else return!1;return!1}else if(/^paste:/.test(t.url)){let B=!1;if(M&&/INPUT|TEXTAREA/i.test(M.nodeName)&&M.getAttribute("aria-readonly")!="true")B=!0;else{let Y=M;for(;Y&&(B=Y.contentEditable=="true",!(B||Y.nodeName.toUpperCase()=="BODY"));)Y=Y.parentNode}if(B){if(!b)return!1;b=b.replace(/^paste:/,""),b.indexOf("%input{")!==-1?a.showCustomInputWindow(b,Y=>{Ot(M,Y)}):b?Ot(M,b):typeof navigator.clipboard.readText<"u"&&navigator.clipboard.readText().then(Y=>{Ot(M,Y)})}}else if(/^\[/.test(t.url)){g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation();let B=JSON.parse(t.url);return a.batchOpen(B,{button:2,altKey:J||g.altKey,ctrlKey:N||g.ctrlKey,shiftKey:Z||g.shiftKey,metaKey:$||g.metaKey},r===1),!1}else if(/[:%]P{/.test(t.url)){if(g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),b===!1)return!1;let B=Y=>{let F=Y.match(/[:%]P{(.*)}/),re="";if(F)if(Y=Y.replace(F[0],""),F=F[1],F.charAt(0)==='"'&&F.charAt(F.length-1)==='"')re=F.substring(1,F.length-1);else{F=new URLSearchParams(F);let se={};F.forEach((fe,ae)=>{se[ae]=fe}),re=JSON.stringify(se)}Be({method:"POST",url:Y,data:re,onload:se=>{pe(se)},onerror:se=>{Ce(E("postError")+(se.statusText||se.error))},ontimeout:se=>{Ce(E("postError")+(se.statusText||se.error))}})};return b.indexOf("%input{")!==-1?a.showCustomInputWindow(b,Y=>{B(Y)}):B(b),!1}else if(t.charset&&t.charset!="utf-8"||/[:%]p{/.test(t.url)){if(b===!1)return!1;let B=t.url.match(/#(j(umpFrom|f)?|from){(.*?)}/),Y=F=>(B?(U.setItem("postUrl",[F,t.charset]),B=B[3],B.indexOf("http")!==0&&(B=F.replace(/(:\/\/.*?\/)[\s\S]*/,"$1"+B)),F=B):(U.setItem("postUrl",[F,t.charset]),F=F.replace(/(:\/\/.*?)\/[\s\S]*/,"$1").replace(/[:%]p{[\s\S]*/,"")),F);if(b.indexOf("%input{")!==-1){a.showCustomInputWindow(b,F=>{F=Y(F),F&&(o.href=F,o.target==="_blank"?ge(o.href,{active:!0,insert:!0}):location.href=o.href)}),g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation();return}else{if(b=Y(b),!b)return;o.href=b}}if(!(Z&&!N&&!$&&!J&&g.isTrusted)){if(/^(chrome|edge|about|extension|moz-extension)/.test(b))return g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),N?ge(b,{active:!1,insert:!0}):ge(b,{active:!0,insert:!0,close:o.getAttribute("target")!=="_blank"}),!1;if((J||N||$||Z)&&S){if((N||$)&&Z)ge(b,{incognito:!0});else if(N||$)ge(b,{active:!1,insert:!0});else if(J){if(t.match){let ae=t.match.replace(/\\/g,""),We=ae.match(/\((www)\|([^\)\|]+)/);for(;We;)b=b.replace(We[1],We[2]),ae=ae.replace(We[0],""),We=ae.match(/\(([^\)\|]+)\|([^\)\|]+)/)}let B=window.screen.availWidth||window.innerWidth||document.documentElement.clientWidth,Y=window.screen.availHeight||window.innerHeight||document.documentElement.clientHeight,F=c.prefConfig.popupWidth,re=c.prefConfig.popupHeight,se=c.prefConfig.popupLeft,fe=c.prefConfig.popupTop;re?(re=parseFloat(re),re=Y/100*re):re=Math.max(Y/3*2,Y-250),F?(F=parseFloat(F),F=B/100*F):F=Math.min(B,650),se?(se=parseFloat(se),se=B/100*se-F/2):se=B-F-30,fe?(fe=parseFloat(fe),fe=Y/100*fe-re/2):fe=(Y-re)/2,a.closePopupWindow(),a.popupWindow=window.open(b+"#searchJumperMin"+(/#p{/.test(t.url)?"Post":""),"_blank",`width=${F}, height=${re}, location=0, resizable=1, status=0, toolbar=0, menubar=0, scrollbars=0, left=${se}, top=${fe}`)}else Z&&ge(b,{active:!0,insert:!0});return g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),!1}else if(S&&o.getAttribute("target")==="_blank"&&!(J||N||$||Z)&&g.button===0)return ge(b,{active:!0,insert:!0}),g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),!1}};o.addEventListener("mousedown",ue,!0),o.addEventListener("mouseup",g=>{g.stopPropagation&&g.stopPropagation()},!0),o.addEventListener("click",R,!0),o.addEventListener("auxclick",g=>{if(P&&g.preventDefault)return g.preventDefault(),!1},!0),o.addEventListener("contextmenu",g=>{if(P&&g.preventDefault)return g.preventDefault(),!1},!0);let G=o.dataset.name;y&&(G+=` (${t.ctrl?"Ctrl + ":""}${t.shift?"Shift + ":""}${t.alt?"Alt + ":""}${t.meta?"Meta + ":""}${y.replace("Key","")})`);let O=!1,ie=!1,ne=async(g,S,D)=>{if(a.tipsPos(g,'<span class="loader"></span><font>Loading...</font>'),ie=!1,S)try{S=S.replace(/^showTips:/,""),O=!0;let B=await a.anylizeShowTips(S,o.dataset.name,g);if(O=!1,a.tips.style.opacity==0||a.tips.innerHTML.indexOf('<span class="loader">')!==0){ie=!0;return}Array&&Array.isArray&&Array.isArray(B)&&(f=B[1],B=B[0]),B&&(B!="null"&&B!="No result"&&(B=`<div>${B}</div>`,ie=!0),a.tipsPos(g,B),te(),setTimeout(()=>{a.tips.style.pointerEvents="all"},100))}catch(B){pe(B)}},H=async(g,S=1e3)=>{if(!(!g||g.nodeType!==1)&&(a.preList&&(a.preList.style.visibility="hidden",a.listArrow.style.cssText=""),f=null,clearTimeout(a.requestShowTipsTimer),a.waitForShowTips=!1,a.tipsPos(g,G),u)){a.stopInput=!0;let D=await A();a.stopInput=!1,D&&a.lastUrl===D?O?a.tipsPos(g,"<span class='loader'></span><font>Loading...</font>"):ne(g,D):(a.waitForShowTips=!0,a.requestShowTipsTimer=setTimeout(async()=>{if(D=D||await A(),!!D){if(D.indexOf("%input{")!==-1){a.showCustomInputWindow(D,B=>{D=B,ne(g,D)});return}a.lastUrl=D,ne(g,D),a.waitForShowTips=!1}},S))}},I=!1;o.addEventListener("touchend",g=>{g.stopPropagation&&g.stopPropagation(),u&&(I=!0,a.waitForShowTips=!0)},!1);let v=g=>{if(a.funcKeyCall||c.prefConfig.noAni)return;let S=a.con.classList.contains("search-jumper-left")||a.con.classList.contains("search-jumper-right"),D=[],B=o.getBoundingClientRect(),Y=S?Math.abs(g.clientY-B.top)/B.height:Math.abs(g.clientX-B.left)/B.width,F=.1,re=.1;o.style.setProperty("--scale",1+F+re),D.push(o);let se=o.previousElementSibling;if(se&&/^A$/i.test(se.nodeName)){se.style.setProperty("--scale",1+re+F*(1-Y)),D.push(se);let ae=se.previousElementSibling;ae&&/^A$/i.test(ae.nodeName)&&(ae.style.setProperty("--scale",1+re*(1-Y)),D.push(ae))}let fe=o.nextElementSibling;if(fe&&/^A$/i.test(fe.nodeName)){fe.style.setProperty("--scale",1+re+F*Y),D.push(fe);let ae=fe.nextElementSibling;ae&&/^A$/i.test(ae.nodeName)&&(ae.style.setProperty("--scale",1+re*Y),D.push(ae))}a.dockerScaleBtns.forEach(ae=>{D.indexOf(ae)===-1&&ae.style.setProperty("--scale",1)}),a.dockerScaleBtns=D};return o.addEventListener("mouseenter",g=>{if(g.stopPropagation&&g.stopPropagation(),!(ie&&a.lastTips===o&&a.tips.style.opacity==1)){if(a.lastTips=o,u){if(I){I=!1;return}if(K&&!(a.searchJumperInputKeyWords.value||it())){a.waitForShowTips=!0,a.tipsPos(o,G);return}}H(o)}},!0),o.addEventListener("mousemove",g=>{v(g),a.clingPos(o,a.tips)},!1),o.addEventListener("showTips",g=>{a.appendBar(),a.closeOpenType(),a.con.style.display="",a.setFuncKeyCall(!0),H(M,0)},!1),o.addEventListener("mouseleave",g=>{ie||(a.tips.style.opacity=0,clearTimeout(a.requestShowTipsTimer))},!1),o.addEventListener("drop",g=>{a.searchBySiteName(p,g)},!1),o.addEventListener("dragover",g=>{g.preventDefault()},!1),o}closePopupWindow(){c.prefConfig.closePopupWhenClick&&this.popupWindow&&(this.popupWindow.close(),this.popupWindow=null)}closeOpenType(){let e=this.bar.querySelector(".search-jumper-type.search-jumper-open>span");if(e)if(this.funcKeyCall=!1,e.onmouseup)e.onmouseup();else{let t=new PointerEvent("mouseup");e.dispatchEvent(t)}}addToHighlightGroup(e,t){let r=c.prefConfig.inPageRule[t];if(r){let i=r.match(/^\/(.*)\/([il]*)$/);i?r=`/${i[1]}|${e}/${i[2]||""}`:r=`/${r}|${e}/`}else r=`/${e}/`;c.prefConfig.inPageRule[t]=r,U.setItem("searchData",c),this.refreshPageWords(this.lockWords)}streamUpdate(e){this.streamUpdateCallBack&&this.streamUpdateCallBack(e)}async anylizeShowTips(e,t,r){let i,s=this;try{const n=/([^\\]|^)([\+\-*/])([\d\.]+)$/,a=/\|cache\=(\d+)$/,o=/%p(\{+)/,p=/#headers({.*?})/,d=/#stream({(.*?)})?/,u=/.then{(.*?)}/;if(e=e.replace(/^showTips:/,"").replace(/{name}/g,t).trim(),/^https?:/.test(e)){let f=e.split(`
`);f.length==1&&(f=e.split(" ")),f=f[0],e=e.replace(f,"").trim().replace(/\\{/g,"showTipsLeftBrace").replace(/\\}/g,"showTipsRightBrace").replace(/{url}/g,"\u3010SEARCHJUMPERURL\u3011");let h=f.match(a);h?(h=parseInt(h[1]),f=f.replace(a,"")):h=7200;let m=Date.now()/1e3,y=tt.filter(L=>m<L.time?(!i&&L.url==f&&(i=L.data),!0):!1);y.length!=tt.length&&(tt=y,U.setItem("tipsStorage",tt));let C=[],j=(L,W)=>{let T=e,K=!0;for(;W;){let z=W[1].replace(/\\\|/g,"\u3010searchJumperJsonSplit\u3011").split("|"),A=z[0].replace(/【searchJumperJsonSplit】/g,"|").replace(/\[(\d+)\]/g,".$1").replace(/\[all\]/g,".all").split("."),b=L,P=null;if(A.shift(),A.forEach(J=>{if(P){let N=[];for(let $=0;$<P.length;$++){let Z=P[$];Z&&(Array.isArray(Z)?Z=Z.at?Z.at(J):Z[J]:Z=Z[J]),N.push(Z)}P=N}else if(b&&(Array.isArray(b)?J==="all"?P=b:b=b.at?b.at(J):b[J]:b=b[J]),!b)return null}),P&&(b=P.join("")),z.length!=1){let J=z[1],N=J.match(n);if(N){let $=[];for(;N;)J=J.replace(n,"$1"),$.unshift([N[2],N[3]]),N=J.match(n);$.forEach(Z=>{let ue=parseFloat(Z[1]);switch(Z[0]){case"+":b+=ue;break;case"-":b-=ue;break;case"*":b*=ue;break;case"/":b/=ue;break}}),b=b.toFixed(2)}else{let $=J.match(/^\/(.*)\/(\w?)$/),Z=$?new RegExp($[1],$[2]):new RegExp(J),ue=b.match(Z);ue&&(b=ue[1])}}b?K=!1:b="",C.push(b),T=T.replace(W[0],b),W=T.match(/{(.*?)}/)}return K&&console.log("Error:",L),T=T.replace(/showTipsLeftBrace/g,"{").replace(/showTipsRightBrace/g,"}"),T},x=e.match(/{(.*?)}/);if(i)x&&x[1].indexOf("json")===0&&(e=e.replace(/【SEARCHJUMPERURL】/g,f),i=j(i,x),i=[i,`
`+C.join(",")]);else{let L,W=f.match(o),T={},K=f;if(W){let N=W[1].length;if(W=f.match(new RegExp(`%p{+(.*?)}{${N}}`)),W){let $=W[1];if($.indexOf("%")===0)try{$=decodeURIComponent($)}catch{}T.body=$,T.method="POST",K=K.replace(W[0],"")}}let z=f.match(p);if(z){let N=z[1];if(N.indexOf("%")===0||N.indexOf("%")===1)try{N=decodeURIComponent(N)}catch{}T.headers=JSON.parse(N),K=K.replace(z[0],"")}let A=!1,b,P=x&&x[1].indexOf("json")===0,J=f.match(d);if(J)T.responseType="stream",T.streamMode=J[2]||"concat",K=K.replace(J[0],""),i=await new Promise(N=>{T.onstream=$=>{let Z;if(P){if(Z=$.json(),!Z)return;Z=j(Z,x)}else Z=$.text;s.tipsPos(r,Z),s.tips.style.pointerEvents="all",N&&N(Z)},b=Ge(K,T).then($=>(e=e.replace(/【SEARCHJUMPERURL】/g,$.finalUrl),P?$.json():$.text)),b.then($=>{let Z=P?$&&j($,x):$;Z&&(s.tipsPos(r,Z),N&&N(Z))})}),i||(i="No result",A=!0);else if(P){let N=[];b=Ge(K,T).then($=>(e=e.replace(/【SEARCHJUMPERURL】/g,$.finalUrl),$.json())),i=await b.then($=>$?(L=$,j($,x)):null),i||(i="No result",A=!0),i=[i,`
`+N.join(",")]}else{let N=!1,$=K.match(u),Z=[];for(;$;){let te=$[1];Z.push(te),K=K.replace($[0],""),$=K.match(u)}for(b=Ge(K,T).then(te=>(e.indexOf("\u3010SEARCHJUMPERURL\u3011")!=-1&&(e=e.replace(/【SEARCHJUMPERURL】/g,te.finalUrl),N=!0),te.text()));Z.length;){let te=Z.shift(),w=await b.then(R=>{let G=document.implementation.createHTMLDocument("");G.documentElement.innerHTML=ee(R);let O=bt(te,G);if(!O)return null;let ie=G.querySelector("base");return _i(O.getAttribute("href"),ie?ie.href:K)});if(w)b=Ge(w).then(R=>R.text());else return"No result"}let ue;i=await b.then(te=>{if(!e)return te;let w=document.implementation.createHTMLDocument("");w.documentElement.innerHTML=ee(te),ue=w.title;let R=e;for(;x;){let G="";if(x[1]=="title")G=w.title;else{let O=x[1].split("|"),ie=ni(O[0],w);if(ie&&ie.length)if(N=!0,O.length==1)G=ie[0].innerText;else{let ne=O[1],H=ne.match(/\(.*?\)/g);H?[].forEach.call(ie,I=>{let v=O[1];H.forEach(g=>{g==="()"?v=v.replace(g,I.innerText):(ne=g.match(/\((.*)\)/)[1],v=v.replace(g,I.getAttribute(ne)||I[ne]))}),G+=v}):G=ie[0].getAttribute(ne)||ie[0][ne]}}R=R.replace(x[0],G),x=R.match(/{(.*?)}/)}return N?(R=R.replace(/showTipsLeftBrace/g,"{").replace(/showTipsRightBrace/g,"}"),R):null}),i?this.insertHistoryUrl(f,ue):(i="No result",A=!0),i=[i,f],L=i}A||(i=this.calcResult(i),tt.push({url:f,data:L,time:Date.now()/1e3+h}),tt.length>50&&tt.shift(),U.setItem("tipsStorage",tt))}}else if(i=/\breturn\b/.test(e)?await new ai("fetch","storage","name",'"use strict";'+e)(Ge,U,t):e,i=this.calcResult(i),M&&M.href){let f=M.title||M.alt||M.innerText;this.insertHistoryUrl(M.href,f)}}catch(n){pe(n)}return i}calcResult(e){let t=typeof e=="string",r=t?e:e[0];const i=/{([\d\.]+)(([\+\-*/][\d\.]+)+)}/,s=/([\+\-*/])([\d\.]+)/;let n=r.match(i);if(n){let a=[],o=n[0],p=parseFloat(n[1]),d=n[2];for(n=d.match(s);n;)d=d.replace(n[0],""),a.push([n[1],n[2]]),n=d.match(s);a.forEach(u=>{let f=parseFloat(u[1]);switch(u[0]){case"+":p+=f;break;case"-":p-=f;break;case"*":p*=f;break;case"/":p/=f;break}}),p=p.toFixed(2),r=r.replace(o,p)}return t?e=r:e[0]=r,e}insertHistoryUrl(e,t){if(e.indexOf(location.host)===-1)return;let r=location.href,i=document.title;xe.history.pushState("",t,e),document.title=t,xe.history.replaceState("",i,r),document.title=i}checkScroll(e,t){if(this.funcKeyCall||this.bar.style.display=="none")return;let r=window.innerWidth||document.documentElement.clientWidth,i=window.innerHeight||document.documentElement.clientHeight;if(this.bar.scrollWidth>r||this.bar.scrollHeight>i?this.con.classList.contains("search-jumper-scroll")||(this.bar.style.cssText="",this.con.classList.add("search-jumper-scroll"),this.con.style.display=""):this.con.classList.contains("search-jumper-scroll")&&(this.bar.style.cssText="",this.con.classList.remove("search-jumper-scroll")),e)return;let s=this.bar.querySelector(".search-jumper-type.search-jumper-open");s&&(s.style.width==="0px"&&(s.style.width="auto"),s.style.height==="0px"&&(s.style.height="auto"),s!=this.bar.firstElementChild&&setTimeout(()=>{s.scrollIntoView(t?{}:{behavior:"smooth"})},0))}reopenType(e){let t=new PointerEvent("mouseup");e.parentNode.classList.contains("search-jumper-open")&&(e.onmouseup?e.onmouseup():e.dispatchEvent(t)),e.onmouseup?e.onmouseup():e.dispatchEvent(t)}showInPage(e,t){if(this.contains(M)||this.inInput&&Xe||!e&&this.funcKeyCall)return;(!Xe||!Xe.parentNode)&&(Xe=Me(Et),qe||this.addToShadow(Xe));let r=De();if(e&&r&&r.length<(c.prefConfig.limitPopupLen||1)||this.con&&this.con.classList.contains("search-jumper-showall"))return;if(c.prefConfig.hidePopup&&(e=!1),!M)M=_(document);else if(!r&&M!=_(document)&&(M.className!="searchJumper"||!/^MARK$/i.test(M.nodeName))){let u=M,f;for(;u&&u.nodeName&&!/^(img|audio|video|a)$/i.test(u.nodeName);){if(u.parentNode){if(/^(img|audio|video|a)$/i.test(u.parentNode.nodeName)){u=u.parentNode;break}if(f=u.parentNode.querySelectorAll("audio,video"),f&&f.length!==1&&(f=u.parentNode.querySelectorAll("img")),f&&f.length!==1&&(f=u.parentNode.querySelectorAll("a")),f&&f.length===1){f[0].scrollHeight&&u.scrollHeight/f[0].scrollHeight<2&&(u=f[0]);break}}u=u.parentNode}u&&(M=u)}this.appendBar();let i=this;this.hideTimeout&&clearTimeout(this.hideTimeout);var s=c.prefConfig.autoDelay||1e3,n=()=>{i.bar.classList.remove("search-jumper-isInPage"),i.bar.classList.remove("search-jumper-isTargetImg"),i.bar.classList.remove("search-jumper-isTargetAudio"),i.bar.classList.remove("search-jumper-isTargetVideo"),i.bar.classList.remove("search-jumper-isTargetLink"),i.bar.classList.remove("search-jumper-isTargetPage"),i.bar.classList.remove("initShow"),i.hideTimeout=null};c.prefConfig.autoHide&&(this.hideTimeout=setTimeout(n,s)),this.bar.classList.remove("search-jumper-isInPage"),this.bar.classList.remove("search-jumper-isTargetImg"),this.bar.classList.remove("search-jumper-isTargetAudio"),this.bar.classList.remove("search-jumper-isTargetVideo"),this.bar.classList.remove("search-jumper-isTargetLink"),this.bar.classList.remove("search-jumper-isTargetPage"),this.bar.classList.remove("initShow"),this.tips.style.opacity=0,this.tips.style.display="none",this.tips.style.transition="none",this.tips.innerHTML=ee(""),setTimeout(()=>{this.bar.classList.add("initShow")},10);let a="",o="";if(r)if(this.bar.classList.add("search-jumper-isInPage"),this.bar.style.display=="none"||e)a="needInPage";else{let u=this.bar.querySelector(".search-jumper-type.search-jumper-open");(!u||u.classList.contains("notmatch")||u.classList.contains("search-jumper-targetPage")||u.classList.contains("search-jumper-targetImg")||u.classList.contains("search-jumper-targetAudio")||u.classList.contains("search-jumper-targetVideo")||u.classList.contains("search-jumper-targetLink"))&&(a="needInPage")}else{switch(M.children.length==1&&M.children[0].nodeName.toUpperCase()==="A"&&(M=M.children[0]),M.nodeName.toUpperCase()){case"IMG":this.bar.classList.add("search-jumper-isTargetImg"),a="targetImg";break;case"AUDIO":this.bar.classList.add("search-jumper-isTargetAudio"),a="targetAudio";break;case"VIDEO":this.bar.classList.add("search-jumper-isTargetVideo"),a="targetVideo";break;case"A":this.bar.classList.add("search-jumper-isTargetLink"),a="targetLink";break;default:break}let u=M.parentNode;u&&u.nodeName.toUpperCase()==="A"&&(this.bar.classList.add("search-jumper-isTargetLink"),a?o="targetLink":a="targetLink"),a||(this.bar.classList.add("search-jumper-isTargetPage"),a="targetPage"),a||(a="targetAll")}this.bar.style.display=="none"&&(this.bar.style.display="");let p,d;if(a&&(p=this.bar.querySelector(`.search-jumper-${a}:not(.notmatch)>span`),d=this.bar.querySelectorAll(`.search-jumper-${a}:not(.notmatch)>a>img`)),i.setFuncKeyCall(!1),p&&(!c.prefConfig.disableAutoOpen&&!c.prefConfig.disableTypeOpen||e)){let u=this.bar.querySelectorAll(`.search-jumper-${a}:not(.notmatch)>span:first-child`);[].forEach.call(u,f=>{f!==p&&i.reopenType(f)}),i.reopenType(p),i.insertHistory(p.parentNode),o&&(u=this.bar.querySelectorAll(`.search-jumper-${o}:not(.notmatch)>span:first-child`),[].forEach.call(u,f=>{f!==p&&i.reopenType(f)}),i.reopenType(p))}if(!e&&(c.prefConfig.disableAutoOpen||c.prefConfig.disableTypeOpen)&&this.closeOpenType(),i.setFuncKeyCall(e),e){d&&[].forEach.call(d,j=>{j.parentNode.style.display!="none"&&j.dataset.src&&(j.src=j.dataset.src,delete j.dataset.src)}),i.con.classList.remove("search-jumper-scroll"),i.bar.style.cssText="",i.con.style.cssText="";let u=window.innerWidth||document.documentElement.clientWidth,f=document.documentElement.scrollLeft||document.body.scrollLeft,h=window.innerHeight||document.documentElement.clientHeight,m=c.prefConfig.tileOffset||0,y=pr(t)-i.bar.clientWidth/2-(getComputedStyle(document.documentElement).position!=="static"?document.documentElement.offsetLeft:0);y<0?y=5:y+i.bar.clientWidth>u+f&&(y=u+f-i.bar.clientWidth-20);let C=hr(t);dt(t)>h/5?C-=i.bar.clientHeight+20+m:C+=20+m,ht(t)<u/2?(i.bar.style.left=y+f+"px",i.bar.style.transformOrigin="0 0"):(i.bar.style.right=u-y-i.bar.clientWidth-15+"px",i.bar.style.transformOrigin="100% 0"),i.bar.style.top=C+"px",i.removeBar(),i.bar.style.opacity=0,setTimeout(()=>{i.appendBar(),setTimeout(()=>{i.bar.style.opacity=1,setTimeout(()=>{let j=document.querySelector("#saladict-saladbowl-root>.saladict-external");if(j){let x=j.shadowRoot.querySelector(".saladbowl");x.style.transform=x.style.transform.replace(/\d+px\)/,`${t.clientY-15}px)`)}},100)},1)},1)}else i.bar.style.display="",i.initPos()}setFuncKeyCall(e){this.funcKeyCall=e,this.con.classList.contains("search-jumper-showall")||(e?this.con.classList.add("funcKeyCall"):this.con.classList.remove("funcKeyCall"))}initPos(e,t,r,i){this.preList&&(this.preList.style.visibility="hidden",this.preList.style.opacity=0,this.listArrow.style.cssText=""),typeof e>"u"&&(e=c.prefConfig.position.x),typeof t>"u"&&(t=c.prefConfig.position.y),typeof r>"u"&&(r=c.prefConfig.offset.x),typeof i>"u"&&(i=c.prefConfig.offset.y);let s=this,n=a=>{if(s.bar.style.cssText="",s.con.style.cssText="",s.con.className="search-jumper-searchBarCon "+a,c.prefConfig.resizePage)switch(typeof s.initBodyStyle>"u"?s.initBodyStyle=_(document).style.cssText:_(document).style.cssText=s.initBodyStyle,s.con.classList.add("resizePage"),_(document).style.position="absolute",a){case"search-jumper-left":_(document).style.width=`calc(100vw - ${s.scale*42}px)`,_(document).style.right="0px";break;case"search-jumper-right":_(document).style.width=`calc(100vw - ${s.scale*42}px)`,_(document).style.left="0px";break;case"search-jumper-bottom":_(document).style.width="100%",_(document).style.height=`calc(100vh - ${s.scale*42}px)`,_(document).style.top="0px",_(document).style.overflow="auto";break;default:_(document).style.width="100%",_(document).style.height=`calc(100vh - ${s.scale*42}px)`,_(document).style.bottom="0px",_(document).style.overflow="auto";break}else c.prefConfig.autoHideAll&&s.con.classList.add("hideAll");let o=s.scale*40;setTimeout(()=>{let p=s.con.classList.contains("search-jumper-left")||s.con.classList.contains("search-jumper-right");Se.forEach(d=>{if(!d.classList.contains("search-jumper-open"))p?(d.style.width="",d.style.height=o+"px"):(d.style.width=o+"px",d.style.height="");else{let u=Math.max(d.scrollWidth,d.scrollHeight);u&&(u+="px",p?(d.style.width="",d.style.height=u):(d.style.width=u,d.style.height=""))}})},1)};r<0&&(r=0),i<0&&(i=0),e=="center"&&t=="top"?(n(""),s.bar.style.position="relative"):e=="left"&&t=="top"?r>i?(n(""),s.bar.style.position="fixed",s.bar.style.left=r+"px"):(n("search-jumper-left"),s.bar.style.position="fixed",s.bar.style.top=i+"px"):e=="right"&&t=="top"?r>i?(n(""),s.bar.style.position="fixed",s.bar.style.right=r+"px"):(n("search-jumper-right"),s.bar.style.position="fixed",s.bar.style.top=i+"px"):e=="center"&&t=="bottom"?(n("search-jumper-bottom"),s.bar.style.position="relative"):e=="left"&&t=="bottom"?r>i?(n("search-jumper-bottom"),s.bar.style.position="fixed",s.bar.style.left=r+"px",s.bar.style.bottom="0px",s.bar.style.top="unset"):(n("search-jumper-left"),s.bar.style.position="fixed",s.bar.style.bottom=i+"px"):e=="right"&&t=="bottom"?r>i?(n("search-jumper-bottom"),s.bar.style.position="fixed",s.bar.style.right=r+"px",s.bar.style.bottom="0px",s.bar.style.top="unset"):(n("search-jumper-right"),s.bar.style.position="fixed",s.bar.style.bottom=i+"px"):e=="left"&&t=="center"?(n("search-jumper-left"),s.bar.style.position="relative",s.bar.style.marginTop=i+"px",s.con.style.display="flex",s.con.style.justifyContent="center"):e=="right"&&t=="center"&&(n("search-jumper-right"),s.bar.style.position="absolute",s.bar.style.marginTop=i+"px",s.con.style.display="flex",s.con.style.justifyContent="center",s.con.style.alignItems="flex-end"),c.prefConfig.position.x=e,c.prefConfig.position.y=t,c.prefConfig.offset.x=r,c.prefConfig.offset.y=i,c.prefConfig.disableAutoOpen||c.prefConfig.disableTypeOpen?s.checkScroll(!1,!0):setTimeout(()=>{let a=s.bar.querySelector(".search-jumper-type.search-jumper-open");a&&(a.style.transition="none",a.style.width="auto",a.style.height="auto",setTimeout(()=>{a.style.width=a.scrollWidth+"px",a.style.height=a.scrollHeight+"px",setTimeout(()=>{a.style.transition=""},1),s.checkScroll(!1,!0)},0))},251)}}class br{constructor(){this.clickedIndex=0,this.signList=[],this.clickedEles={},this.exact=!0,this.accu=0,this.wheelScrolling=!1}getSelector(e,t=!0){this.exact=t,this.close(),this.toggle(),this.callback=e}init(){if(this.inited)return;this.inited=!0;let e=this;Me(`
...
`);for(let s=0;s<i.length;s++){let n=i[s];if(!n||!n.trim())continue;let a=i[s].match(/^(.*?)\.replace\(\//);if(a&&(n=a[1]),r){if(/^\w[\w\|]*$/.test(n)){let o=n.split("|"),p=new URLSearchParams(location.search);for(let d=0;d<o.length&&(t=p.get(o[d]),!t);d++);}else if(/\(.+\)/.test(n)&&n.indexOf("@")!==0)try{e=de.match(new RegExp(n)),e&&(t=e[1]),t&&(t=decodeURIComponent(t))}catch{t=""}}if(!t&&_(document))try{let o=bt(n);o&&(t=o.value||o.innerText)}catch{t=""}if(t&&a&&(t=gi(i[s],n,t)),t)break}}else if(r&&ft.test(le.url)&&!/[#:%]p{/.test(le.url)&&(de.indexOf("?")!=-1&&(e=le.url.match(new RegExp(`[\\?&]([^&]*?)=${di}.*`)),e&&(t=new URLSearchParams(location.search).get(e[1]))),!t&&(e=le.url.match(new RegExp(`https?://[^/]*/(.*)${di}`)),e&&(e=de.match(new RegExp((e[1].replace(/\?/g,"\\?")||location.host.replace(/\./g,"\\.")+"/")+"(.*?)(/|$)")),e&&(t=e[1]),t))))try{t=decodeURIComponent(t)}catch{t=""}if(t==""&&_(document)){let i=_(document).querySelector("input[type=text]:not([readonly]),input:not([type])");i&&(t=i.value)}t&&(Fe=t)}catch(i){pe(i)}return Fe||"";//!localKeywords ? cacheKeywords : localKeywords;
                ...
                `),qe||Q.appendChild(p);let d=Q.children[0];Yt=Q.querySelector("[name='siteName']"),Bt=Q.querySelector("[name='description']"),ze=Q.querySelector("[name='url']"),gt=Q.querySelector("[name='icon']"),Re=Q.querySelector(".searchJumperFrame-inputs>img"),At=Q.querySelector(".iconsCon"),er=Q.querySelector("#test"),tr=Q.querySelector("#cancel"),ir=Q.querySelector("#add"),$t=Q.querySelector("select[name='typeSelect']"),_t=Q.querySelector("[name='siteKeywords']"),Zt=Q.querySelector("[name='siteMatch']"),Xt=Q.querySelector("select[name='openSelect']");let u=Q.querySelector(".searchJumperFrame-title"),f,h,m=!1,y=I=>{m||(Q.classList.add("draging"),m=!0);let v=I.clientX-f.x+h.x,g=I.clientY-f.y+h.y;d.style.marginLeft=v+"px",d.style.marginTop=g+"px"},C=I=>{I.preventDefault(),I.stopPropagation(),Q.classList.remove("draging"),document.removeEventListener("mousemove",y),document.removeEventListener("mouseup",C)};u.addEventListener("mousedown",I=>{I.preventDefault(),I.stopPropagation(),m=!1,f={x:I.clientX,y:I.clientY};let v=getComputedStyle(d);h={x:parseInt(v.marginLeft||0),y:parseInt(v.marginTop||0)},document.addEventListener("mousemove",y),document.addEventListener("mouseup",C)}),Re.onload=I=>{Re.style.display=""},Q.querySelector("#maxBtn").addEventListener("click",I=>{Q.classList.add("maxContent")}),Q.querySelector("#minBtn").addEventListener("click",I=>{Q.classList.remove("maxContent")});for(let I=0;I<c.sitesConfig.length;I++){let v=c.sitesConfig[I],g=document.createElement("option");g.value=I,ci!==""&&ci==I&&(g.selected="selected"),g.innerText=v.type,$t.appendChild(g)}er.addEventListener("click",I=>{if(/#p{/.test(ze.value)){let v=ze.value.match(/#p{(.*)}/);if(!v)return;let g=[];v[1].replace(/([^\\])&/g,"$1SJ^PARAM").split("SJ^PARAM").forEach(S=>{if(S=S.trim(),/^loopStart\(\d+\)$/.test(S)){let D=S.match(/loopStart\((.*)\)/);g.push(["@loopStart",D[1]])}else if(S=="loopEnd")g.push(["@loopEnd",""]);else if(S.startsWith("click(")&&S.endsWith(")")){let D=S.slice(6,S.length-1);D&&g.push(["@click",D.replace(/\\([\=&])/g,"$1").trim()])}else if(S.startsWith("dblclick(")&&S.endsWith(")")){let D=S.slice(9,S.length-1);D&&g.push(["@dblclick",D.replace(/\\([\=&])/g,"$1").trim()])}else if(S.startsWith("rclick(")&&S.endsWith(")")){let D=S.slice(7,S.length-1);D&&g.push(["@rclick",D.replace(/\\([\=&])/g,"$1").trim()])}else if(S.startsWith("copy(")&&S.endsWith(")")){let D=S.slice(5,S.length-1);D&&g.push(["@copy",D.replace(/\\([\=&])/g,"$1").trim()])}else if(S.startsWith("call(")&&S.endsWith(")")){let D=S.slice(5,S.length-1);D&&g.push(["@call",D.replace(/\\([\=&])/g,"$1").trim()])}else if(S.startsWith("wait(")&&S.endsWith(")")){let D=S.slice(5,S.length-1);g.push(["@wait",D.replace(/\\([\=&])/g,"$1").trim()])}else if(/^sleep\(\d+\)$/.test(S)){let D=S.match(/sleep\((.*)\)/);D&&g.push(["@sleep",D[1]])}else if(/^reload\(\d?\)$/.test(S)){let D=S.match(/reload\((.*)\)/);g.push(["@reload",D[1]])}else{S=S.replace(/([^\\])\=/g,"$1SJ^PARAM").replace(/\\([\=&])/g,"$1");let D=S.split("SJ^PARAM");if(D.length===2){let B=D[0],Y=D[1].replace(/\\([\=&])/g,"$1");g.push([B,Y])}else(S.endsWith(".click()")||S.endsWith(".click"))&&g.push(["@"+S.replace(/\.click(\(\))?$/,""),"click"])}}),Ve=g,k.submitAction(g)}else/[:%]p{/.test(ze.value)||i&&i.toLowerCase()!="utf-8"?fi(i,ze.value.replace(/%se?\b/g,"searchJumper"),"_blank"):ge(ze.value.replace(/%se?\b/g,"searchJumper"),{active:!0,insert:!0})}),tr.addEventListener("click",I=>{Q.parentNode&&Q.parentNode.removeChild(Q)}),ir.addEventListener("click",I=>{Te||Dt(()=>{let v=null;for(let g=0;g<c.sitesConfig.length;g++){let S=c.sitesConfig[g];for(let D=0;D<S.sites.length;D++){let B=S.sites[D];if(B.url==ze.value){if(g==parseInt($t.value)){alert("Already added!");return}if(window.confirm(E("siteExist")))v={name:B.name+" - "+S.type,url:`["${B.name}"]`};else return}}}v==null&&(v={name:Yt.value,url:ze.value},gt.value&&gt.value!=ze.value.replace(/\?.*/,"").replace(/^(https?:\/\/[^\/]*\/)[\s\S]*$/,"$1favicon.ico")&&(v.icon=gt.value),Bt.value&&Bt.value!=Yt.value&&(v.description=Bt.value),_t.value&&(v.keywords=_t.value),Zt.value&&(v.match=Zt.value),Xt.value&&Xt.value!="-1"&&(v.openInNewTab=Xt.value==="true"),self.charset&&i.toLowerCase()!="utf-8"&&(v.charset=self.charset),self.kwFilter&&(v.kwFilter=self.kwFilter),self.match&&(v.match=self.match),self.hideNotMatch&&(v.hideNotMatch=self.hideNotMatch)),c.sitesConfig[$t.value].sites.push(v),c.lastModified=new Date().getTime(),U.setItem("lastAddType",$t.value),U.setItem("searchData",c),Ce(E("siteAddOver")),Q.parentNode&&Q.parentNode.removeChild(Q),window.postMessage({searchData:c,version:pt.script.version||0,command:"loadConfig"},"*"),k.refreshEngines()})}),rr=Q.querySelector("#crawlBtn");let L=Q.querySelector(".searchJumperFrame-closeBtn"),W=Q.querySelector(".actionCon"),T=Q.querySelector("#input"),K=Q.querySelector("#click"),z=Q.querySelector("#sleep"),A=Q.querySelector("#copy"),b=Q.querySelector("#submitCrawl"),P=Q.querySelector("#record"),J=Q.querySelector("#loop"),N,$=(I,v="",g="")=>{let S=document.createElement("div"),D=I;switch(I){case"input":D=E("inputOutput",[v,g]);break;case"click":D=E("clickOutput",v);break;case"dblclick":D=E("dblclickOutput",v);break;case"rclick":D=E("rclickOutput",v);break;case"copy":D=E("copyOutput",v);break;case"loopStart":D=E("loopStart",g);break;case"loopEnd":D=E("loopEnd");break;case"sleep":D=E("sleepOutput",g);break;default:break}D&&(S.innerHTML=ee(D),S.dataset.type=I,S.dataset.sel=v,S.dataset.val=g,S.draggable="true",S.ondragover=B=>{B.preventDefault()},S.ondragstart=B=>{N=S},S.ondrop=B=>{W.insertBefore(N,S)},S.onclick=B=>{let Y=B.target;if(Y.nodeName.toUpperCase()=="SPAN")if(Y.className=="element")ke.getSelector(F=>{Y.innerText=F,Y.title=F,Q.style.display="",S.dataset.sel=F}),Q.style.display="none";else{let F=prompt(E("inputNewValue"),Y.innerText);F&&(Y.innerText=F,Y.title=F,S.dataset.val=F)}else confirm(E("deleteConfirm"))&&W.removeChild(S)},S.oncontextmenu=B=>{let Y=B.target;if(Y.nodeName.toUpperCase()=="SPAN")if(B.preventDefault(),Y.className=="element"){let F=prompt("Selector",Y.innerText);F&&(Y.innerText=F,Y.title=F,S.dataset.sel=F)}else{let F=prompt(E("inputNewValue"),Y.innerText);F&&(Y.innerText=F,Y.title=F,S.dataset.val=F)}},W.appendChild(S))},Z=()=>{W.innerHTML=ee();let I=ze.value.match(/#p{(.*)}/);I&&I[1].replace(/([^\\])&/g,"$1SJ^PARAM").split("SJ^PARAM").forEach(v=>{if(v=v.trim(),/^loopStart\(\d+\)$/.test(v)){let g=v.match(/loopStart\((.*)\)/);$("loopStart","",g[1])}else if(v=="loopEnd")$("loopEnd");else if(v.startsWith("click(")&&v.endsWith(")")){let g=v.slice(6,v.length-1);g&&$("click",g.replace(/\\([\=&])/g,"$1").trim())}else if(v.startsWith("dblclick(")&&v.endsWith(")")){let g=v.slice(9,v.length-1);g&&$("dblclick",g.replace(/\\([\=&])/g,"$1").trim())}else if(v.startsWith("rclick(")&&v.endsWith(")")){let g=v.slice(7,v.length-1);g&&$("rclick",g.replace(/\\([\=&])/g,"$1").trim())}else if(v.startsWith("copy(")&&v.endsWith(")")){let g=v.slice(5,v.length-1);g&&$("copy",g.replace(/\\([\=&])/g,"$1").trim())}else if(v.startsWith("call(")&&v.endsWith(")")){let g=v.slice(5,v.length-1);g&&$("call","",g.replace(/\\([\=&])/g,"$1").trim())}else if(v.startsWith("wait(")&&v.endsWith(")")){let g=v.slice(5,v.length-1);g&&$("wait","",g.replace(/\\([\=&])/g,"$1").trim())}else if(v.startsWith("open(")&&v.endsWith(")")){let g=v.slice(5,v.length-1);g&&$("open","",g.replace(/\\([\=&])/g,"$1").trim())}else if(/^sleep\(\d+\)$/.test(v)){let g=v.match(/sleep\((.*)\)/);g&&$("sleep","",g[1])}else if(/^reload\(\d?\)$/.test(v)){let g=v.match(/reload\((.*)\)/);$("reload","",g[1])}else{v=v.replace(/([^\\])\=/g,"$1SJ^PARAM").replace(/\\([\=&])/g,"$1");let g=v.split("SJ^PARAM");g.length===2?$("input",g[0],g[1].replace(/\\([\=&])/g,"$1")):(v.endsWith(".click()")||v.endsWith(".click"))&&$("click",v.replace(/\.click(\(\))?$/,""))}})},ue=()=>{let I=[];return[].forEach.call(W.children,v=>{if(!v)return;let g=v.dataset.sel,S=v.dataset.val||"";switch(v.dataset.type){case"click":I.push(`click(${g.replace(/([=&])/g,"\\$1")})`);break;case"dblclick":I.push(`dblclick(${g.replace(/([=&])/g,"\\$1")})`);break;case"rclick":I.push(`rclick(${g.replace(/([=&])/g,"\\$1")})`);break;case"copy":I.push(`copy(${g.replace(/([=&])/g,"\\$1")})`);break;case"input":I.push(`${g.replace(/([=&])/g,"\\$1")}=${S}`);break;case"sleep":I.push(`sleep(${S})`);break;case"loopEnd":I.push("loopEnd");break;default:I.push(`${v.dataset.type}(${S.replace(/([=&])/g,"\\$1")})`);break}}),I.join("&")};rr.addEventListener("click",I=>{Z(),Q.classList.add("crawling")}),L.addEventListener("click",I=>{Q.classList.remove("crawling")});let te,w,R=I=>{Q.style.display!==""&&(/INPUT|TEXTAREA|SELECT|OPTION/i.test(I.target.nodeName)||(clearTimeout(w),w=setTimeout(()=>{$("click",ke.geneSelector(I.target,!0))},300)))},G=I=>{Q.style.display!==""&&(/INPUT|TEXTAREA|SELECT|OPTION/i.test(I.target.nodeName)||(clearTimeout(w),$("dblclick",ke.geneSelector(I.target,!0))))},O=I=>{Q.style.display!==""&&(/INPUT|TEXTAREA|SELECT|OPTION/i.test(I.target.nodeName)||(I.preventDefault(),clearTimeout(w),$("rclick",ke.geneSelector(I.target,!0))))},ie=I=>{Q.style.display!==""&&$("input",ke.geneSelector(I.target,!0),I.target.value)},ne=I=>{if(Q.style.display==="")return;let v=!1;I.keyCode==27?v=!0:I.keyCode==13&&(I.preventDefault(),I.stopPropagation(),I.target&&I.target.blur&&I.target.blur(),v=!0),v&&(Q.style.display="",document.removeEventListener("keydown",ne,!0),document.removeEventListener("click",R),document.removeEventListener("dblclick",G),document.removeEventListener("contextmenu",O),document.removeEventListener("change",ie))};P.addEventListener("click",I=>{alert(E("startRecord")),Q.style.display="none",setTimeout(()=>{document.addEventListener("keydown",ne,!0),document.addEventListener("click",R),document.addEventListener("dblclick",G),document.addEventListener("contextmenu",O),document.addEventListener("change",ie)},100)});let H=!1;J.addEventListener("click",I=>{if(H)$("loopEnd"),J.innerText=E("loopAction");else{let v=prompt(E("loopTimes"),1);if(!v)return;$("loopStart","",v||"1"),J.innerText=E("loopActionEnd")}H=!H}),T.addEventListener("click",I=>{ke.getSelector(v=>{$("input",v,"%s"),Q.style.display=""},!H),Q.style.display="none"}),A.addEventListener("click",I=>{ke.getSelector(v=>{$("copy",v,"%s"),Q.style.display=""},!H),Q.style.display="none"}),K.addEventListener("dblclick",I=>{clearTimeout(w),I.preventDefault(),I.stopPropagation(),ke.getSelector(v=>{$("dblclick",v),Q.style.display=""},!H),Q.style.display="none"}),K.addEventListener("contextmenu",I=>{clearTimeout(w),I.preventDefault(),I.stopPropagation(),ke.getSelector(v=>{$("rclick",v),Q.style.display=""},!H),Q.style.display="none"}),K.addEventListener("click",I=>{clearTimeout(w),w=setTimeout(()=>{ke.getSelector(v=>{$("click",v),Q.style.display=""},!H),Q.style.display="none"},250)}),z.addEventListener("click",I=>{let v=prompt(E("sleepPrompt"),1e3);v=v&&parseInt(v),v&&$("sleep","",v)}),b.addEventListener("click",I=>{let v=ue();v&&(ze.value=location.href+"#p{"+v+"}"),Q.classList.remove("crawling")})}k.addToShadow(Q),_t.value="",Zt.value="",Yt.value=l||"",Bt.value=e||"",ze.value=t||"",r&&r[0]?(Re.style.display="",t.indexOf(location.origin)===0?(Re.onerror=o=>{Re.onerror=null,gt.value=r[0],Re.src=r[0]},Re.src=location.origin+"/favicon.ico"):(gt.value=r[0],Re.src=r[0])):(Re.style.display="none",Re.src=(/^(showTips:)?https?:/.test(t)?t.split(`
